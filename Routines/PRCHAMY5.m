PRCHAMY5 ;WISC/DJM-PRINT AMENDMENT,ROUTINE #5 ;7/20/94  9:45 AM ;5/13/94  10:37 AM
...
E36 ;ITEM DISCOUNT Add/Edit
 ...
 ..K DIS2,PCT2 ;removing old values of DIS2,PCT2 before they are reset with new values in the loop.
 ..S:FIELD=.01 DIS2=OLD
 ..S:FIELD=1 PCT2=OLD
 ...
 ..;if an entry is found in 'AC' x-ref for the ITEM field #.01, then look-up for PERCENT/DOLLAR AMOUNT field #1 and then for same item define var PCT2.
 ...
 ..;I DIS2=0 S DATA=" *ADDED THROUGH AMENDMENT*" D DATA^PRCHPAM5(.LCNT,DATA) D
 ...
 ..;The new entry is completed with FLAGDISC=0, the existing entries are dealt with following conditions code
 ...
 ...S DATA=" Will now be AMENDED to read "_$S(NEWP["$":NEWP,1:NEWP_"%")_" discount for an item: "_NEWI D DATA^PRCHPAM5(.LCNT,DATA) Q
 ...
 ..I PCT2]"" S DATA=" The discount on item "_NEWI_" will now be AMENDED to read "_$S(NEWP["$":NEWP,1:NEWP_"%") D DATA^PRCHPAM5(.LCNT,DATA) Q
 .Q
