DVBCQDN1 ;;ALB-CIOFO/ECF - DIABETIC PERIPHERAL NEUROPATHY QUESTIONNAIRE ; 6/15/2011
 ;;2.7;AMIE;**172**;Apr 10, 1995;Build 3
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Diabetic Sensory-Motor Peripheral Neuropathy",TT=40-($L(DVBAX)\2),PG=1
 W !,?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQDN2","DVBCQDN3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 ;
 ...
 W "Diabetic Sensory-Motor Peripheral Neuropathy",!!!
 Q
