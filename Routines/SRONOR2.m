SRONOR2 ;B'HAM ISC/MAM - REPORT OF NON-O.R. PROCEDURES ; [ 07/27/98   2:33 PM ]
 ...
 Q
SROP S SROP=0 F  S SROP=$O(^TMP("SR",$J,SRSS,SRSD,SROP)) Q:'SROP!(SRSOUT)  D SET
 Q
SET ; set and print info
 ...
 W !!,SRSDATE,?15,SRNM_" ("_VA("PID")_")",?64,SRSUR,?116,SRST,!,SROP,?15,SRLOC_" ("_SRINOUT_")",?64,SROPS(1),?116,SRET
