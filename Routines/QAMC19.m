QAMC19 ;HISC/DAD-CONDITION: ON TREATING SPECIALTY ;4/30/93  12:36
...
EN1 ; *** CONDITION CODE
 ...
 K QAMGRP,QAMDFN,QAMMOV,QAMMOVDT,QAMMOVD0,QAMWRD,TXSP,X
 Q
...
LOOP11 I QAMXREF="AMV3" D DC Q:QAMMOVD0'>0
 ...
 I QAMGRP S TXSP=+$S($D(^DGPM(QAMMOVD0,0))#2:$P(^(0),"^",9),1:0) Q:$O(^QA(743.5,QAMGRP,"GRP","AB",+TXSP,0))'>0
...
DC S QAMMOVDT=9999999.9999999-QAMMOV,QAMMOVDT=+$O(^DGPM("ATID6",QAMDFN,QAMMOVDT)),QAMMOVD0=$O(^DGPM("ATID6",QAMDFN,QAMMOVDT,0))
 Q
EN2 ; *** PARAMETER CODE
21 K DIC,DIR,DIRUT S DIC=743.5,DIC(0)="EMNQZ",DIC("S")="I $P(^QA(743.5,+Y,0),""^"",2)=45.7"
