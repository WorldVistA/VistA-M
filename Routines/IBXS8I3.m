...
X6 S:$P(DIPA("NVA_PRV-0"),U,3)'="" Y="@835"
 Q
...
X10 S:$P(DIPA("NVA_PRV-0"),U,5)'=""&($P(DIPA("NVA_PRV-0"),U,6)'="")&($P(DIPA("NVA_PRV-0"),U,7)'="") Y="@833"
 Q
...
X17 S:$P(DIPA("NVA_PRV-0"),U,9)'="" Y="@834"
 Q
...
X20 S:$P(DIPA("NVA_PRV-0"),U,11)'="" Y="@835"
 Q
...
X23 S:$P(DIPA("NVA_PRV-0"),U,14)'="" Y="@836"
 Q
...
X26 S:$D(^IBA(355.93,DIPA("NVA_PRV"),"TAXONOMY"))>0 Y="@837"
 Q
27 S D=0 K DE(1) ;42
 S DIFLD=42,DGO="^IBXS8I9",DC="3^355.9342IP^TAXONOMY^",DV="355.9342M*P8932.1'",DW="0;1",DOW="TAXONOMY CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="USC(8932.1,"
