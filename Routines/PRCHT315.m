...
C1 G C1S:$D(DE(1))[0 K DB S X=DE(1),DIC=DIE
 ...
 S X=DE(1),DIC=DIE
 I $P(^PRC(442.8,DA,0),U,2) K ^PRC(442.8,"AC",$E(X,1,30),$P(^(0),U,2),DA)
 S X=DE(1),DIC=DIE
 I $P(^PRC(442.8,DA,0),U,3) K ^PRC(442.8,"AF",$E(X,1,30),$P(^(0),U,3),DA)
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 S ^PRC(442.8,"B",$E(X,1,30),DA)=""
 S X=DG(DQ),DIC=DIE
 I $P(^PRC(442.8,DA,0),U,2) S ^PRC(442.8,"AC",$E(X,1,30),$P(^(0),U,2),DA)=""
 S X=DG(DQ),DIC=DIE
