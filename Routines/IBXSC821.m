...
BEGIN S DNM="IBXSC821",DQ=1+D G B
...
X4 K DLAYGO S DIPA("PRF")=X S:DIPA("PRF")="" Y="@98"
 Q
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,DW="0;15",DV="P8932.1'",DU="",DLB="TAXONOMY",DIFLD=.15
 S DU="USC(8932.1,"
 G RE
X5 Q
6 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=6 D X6 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X6 D DISPTAX^IBCEP81($P($G(^DGCR(399,DA(1),"PRV",DA,0)),U,15),"")
 Q
7 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=7 D X7 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X7 N Z S Z=$$EXPAND^IBTRE(399.0222,.08,$P($G(^DGCR(399,DA(1),"PRV",DA,0)),U,8)),DIPA("SPC")=$S(Z'="":Z,1:"UNSPECIFIED") W !,"    Prov Specialty On File: ",DIPA("SPC")
 Q
8 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=8 D X8 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X8 S DIPA("CRD")=$$CRED^IBCEU($P($G(^DGCR(399,DA(1),"PRV",DA,0)),U,2))
 Q
9 S DW="0;3",DV="F",DU="",DLB="CREDENTIALS",DIFLD=.03
 G RE
X9 K:$L(X)>3!($L(X)<1) X
 I $D(X),X'?.ANP K X
 Q
