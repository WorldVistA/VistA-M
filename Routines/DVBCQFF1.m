DVBCQFF1 ;;ALB-CIOFO/ECF - FLATFOOT QUESTIONNAIRE ; 5/10/2011
 ;;2.7;AMIE;**173**;Apr 10, 1995;Build 2
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Flatfoot (Pes Planus)",TT=40-($L(DVBAX)\2),PG=1
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQFF2" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
