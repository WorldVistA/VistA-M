DVBCWME ;ALB/ESW MENTAL DISORDERS (EXCEPT INITIAL PSTD AND EATING DISORDER) WKS ; 10 Oct 2000
 ;;2.7;AMIE;**34**;Apr 10, 1955
 ;    modified DVBCWMO, WS # 0905
...
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWME1" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
