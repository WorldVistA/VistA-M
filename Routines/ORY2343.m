ORY2343 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*234) ;MAY 13,2005 at 09:31
...
ADDMULT(OCXCREF,OCXDD,OCXFLD) ;
 ...
 ;
 S OCXGREF=$$GETREF^ORY2342(+OCXFLD,.OCXDA,1)
...
DELMULT(OCXCREF,OCXDD) ;
 ...
 S DA=$G(DA(0)) K DA(0)
 S OCXGREF=$$GETREF^ORY2342(+OCXDD,.DA,1)
 ;
 D DIE^ORY2342(+OCXDD,OCXGREF,.01,"@",.DA,$L(DDPATH,",")-1)
