...
BEGIN ;
 ...
 D T Q:'DN  D N D N:$X>2 Q:'DN  W ?2 S DIP(1)=$S($D(^MCAR(698.1,D0,0)):^(0),1:"") S X="R WAVE AMPLITUDE (mV): "_$P(DIP(1),U,9) K DIP K:DN Y W X
 D N:$X>44 Q:'DN  W ?44 S DIP(1)=$S($D(^MCAR(698.1,D0,0)):^(0),1:"") S X="PSA USED: "_$S('$D(^MCAR(698.4,+$P(DIP(1),U,10),0)):"",1:$P(^(0),U,1)) K DIP K:DN Y W X
 D T Q:'DN  D N D N:$X>2 Q:'DN  W ?2 X DXS(2,9) K DIP K:DN Y W X
