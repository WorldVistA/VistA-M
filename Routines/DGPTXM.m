DGPTXM ; GENERATED FROM 'DG PTF ADD MESSAGE' INPUT TEMPLATE(#454), FILE 45.5;12/10/01
 D DE G BEGIN
...
BEGIN S DNM="DGPTXM",DQ=1
 N DIEZTMP,DIEZAR,DIEZRXR,DIIENS,DIXR K DIEFIRE,DIEBADK S DIEZTMP=$$GETTMP^DIKC1("DIEZ")
 M DIEZAR=^DIE(454,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=454,U="^"
