DVBCQFM1 ;;ALB-CIOFO/ECF - FOOT MISCELLANEOUS QUESTIONNAIRE ; 20/JUNE/2011
 ;;2.7;AMIE;**173**;Apr 10, 1995;Build 2
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Foot Miscellaneous",TT=40-($L(DVBAX)\2),PG=1
 W !,?TT,DVBAX
 S DVBAX="(other than Flatfoot/Pes Planus)",TT=40-($L(DVBAX)\2)
 W !,?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQFM2" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 ;
 ...
 W "Foot Miscellaneous (other than Flatfoot/Pes Planus)",!!
 Q
