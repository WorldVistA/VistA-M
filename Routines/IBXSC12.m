...
BEGIN S DNM="IBXSC12",DQ=1+D G B
1 S DW="0;1",DV="MFa",DU="",DLB="ALIAS",DIFLD=.01
 S DE(DW)="C1^IBXSC12",DE(DW,"INDEX")=1
 G RE:'D S DQ=2 G 2
...
X1 K:$L(X)>30!($L(X)<3) X I $D(X) S DG20NAME=X,(X,DG20NAME)=$$FORMAT^XLFNAME7(.DG20NAME,3,30) K:'$L(X) X,DG20NAME
 ...
 Q
 ;
2 D:$D(DG)>9 F^DIE17,DE S DQ=2,DW="0;2",DV="Fa",DU="",DLB="ALIAS SSN",DIFLD=1
 S DE(DW)="C2^IBXSC12"
 G RE
