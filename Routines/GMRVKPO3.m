GMRVKPO3 ;HIRMFO/YH-KYOCERA PULSE OXIMETRY/RESP. GRAPH - MACRO 2 ;5/20/97
 ;;4.0;Vitals/Measurements;**1**;Apr 25, 1997
EN2 ;CONTINUATION OF GMRVKPO2
PULSEG W !,"MCRO PLSG; SPD 0.03;MAP %1, %2; DAP 2.2, %3; DAP 3.8, %4; DAP 5.4, %5; DAP 7, %6; DAP 8.6, %7; DAP 10.2, %8; DAP 11.8, %9;"
 ...
 W !,"ENDM;"
PULSE W !,"MCRO PULS;" S J=20.7 D WRTEXT^GMRVBP2
 W !,"ENDM;"
POXL ;PULSE OX. L/MIN
 W !,"MCRO POXL;" S J=21.1 D WRTEXT^GMRVBP2
 W !,"ENDM;"
POXP ;PULSE OX. %
 W !,"MCRO POXP;" S J=21.5 D WRTEXT^GMRVBP2
 W !,"ENDM;"
POXM W !,"MCRO POXM;" S J=21.9 D WRTEXT^GMRVBP2
 W !,"ENDM;"
 ;PULSE DATA
 W !,"MCRO NEWP;" S J=22.3 D WRTEXT^GMRVBP2
 W !,"ENDM;"
PULSEQ W !,"MCRO PLQ;" S J=22.7 D WRTEXT^GMRVBP2
 W !,"ENDM;"
RPG W !,"MCRO RPG; SPD 0.03; MAP %1, %2; DAP 1.8, %3; DAP 3.4, %4; DAP 5, %5; DAP 6.6, %6; DAP 8.2, %7; DAP 9.8, %8; DAP 11.4, %9;"
 ...
 W !,"ENDM;"
RESP W !,"MCRO RSP;" S J=20.3 D WRTEXT^GMRVBP2
 W !,"ENDM;"
