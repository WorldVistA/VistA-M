DVBCWJW2 ;ALB/CMM JOINTS WKS ; 6 MARCH 1997
 ;;2.7;AMIE;**63**;FEB 17, 2004
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For JOINTS (SHOULDER/ELBOW/WRIST/HIP/KNEE/ANKLE)",PG=1
 W !?22,"Compensation and Pension Examination",!,?(IOM-$L(DVBAX)\2),DVBAX,!?33,"# 1430 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWJW3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 S PG=PG+1 W @IOF,!,"Page: ",PG,!!,"Compensation and Pension Exam for "_NAME,!
 W "For JOINTS (SHOULDER/ELBOW/WRIST/HIP/KNEE/ANKLE)",!!!
 Q
