PRCHDAM2 ;WISC/DJM-PRINT AMENDMENT, ROUTINE #2 ;9/15/95  11:41 AM
...
E22 ;LINE ITEM Delete PRINT
 ...
 ..D LINE^PRCHDAM4(.LCNT,2) S DATA="The following line item has been cancelled:" D DATA^PRCHDAM4(.LCNT,DATA)
 ...
 ..S AUC=$$FETCH(5,ITEM)
 ..S UOP=$S($P(ITEM0,U,3)>0:$P($G(^PRCD(420.5,$P(ITEM0,U,3),0)),U),1:"")
 ..S DATA="    "_QTY_" "_UOP_" at $"_$J(AUC,12,4)_" = $"_$J(QTY*AUC,9,2) D DATA^PRCHDAM4(.LCNT,DATA),LCNT1^PRCHDAM4(LCNT)
 Q
 ;
E23 ;LINE ITEM Edit PRINT
 ...
 ..S DATA="**Currently:" D DATA^PRCHDAM4(.LCNT,DATA)
 ..S DATA="Item No. "_$P(ITEM0,U)_"     Item Master File No. "_IMF_"     BOC: "_BOC_"   CONTRACT: "_CON442 D DATA^PRCHDAM4(.LCNT,DATA)
 ..I $L(ABC)>0 D OLD^PRCHDAM4
 ..I $L(ABC)'>0 S ITEMZ=ITEM1 D NEW^PRCHDAM4
 ..S UOP1=$S($L(UOP)>0:$P($G(^PRCD(420.5,UOP,0)),U),1:"")
 ..S DATA="    Items per "_UOP1_": "_UCF
 ..F I=1:1:26-$L(DATA) S DATA=DATA_" "
 ..S DATA=DATA_"NSN: "_NSN D DATA^PRCHDAM4(.LCNT,DATA)
 ..I $L(VSN)>0 S DATA="    STK#: "_VSN D DATA^PRCHDAM4(.LCNT,DATA)
 ..S UOP1=$S($L(UOP)>0:$P($G(^PRCD(420.5,UOP,0)),U),1:"")
 ..S DATA="    "_QTY_" "_UOP1_" at $"_$J(AUC,12,4)_" = $"_$J(QTY*AUC,9,2) D DATA^PRCHDAM4(.LCNT,DATA)
 ..S DATA="                               " D DATA^PRCHDAM4(.LCNT,DATA)
 ..S DATA=" **Will now be AMENDED to read:" D DATA^PRCHDAM4(.LCNT,DATA)
 ..S DATA="Item No. "_$P(ITEM0,U)_"     Item Master File No. "
 ..S DATA=DATA_$P(ITEM0,U,5)_"     BOC: "_+$P(ITEM0,U,4)_"   CONTRACT: "
 ..S DATA=DATA_CON4436 D DATA^PRCHDAM4(.LCNT,DATA)
 ..S:$D(ITEMZ) ITEM1=ITEMZ D NEW^PRCHDAM4
