LABL330 ;SLC/ECB/RWF/DLG - ABL330 BLOOD GAS ANALYZER; ;9/17/90  12:47
 ...
 ;CROSS LINK BY IDE;PARAM 3 OF AUTO INST FILE EXACT;PARAM 2 FOR DECIMAL
LA1 S:$D(ZTQUEUED) ZTREQ="@"
 S LANM=$T(+0),TSK=$O(^LAB(62.4,"C",LANM,0)) Q:TSK<1
 Q:'$D(^LA(TSK,"I",0))
 K LATOP D ^LASET Q:'TSK  S X="TRAP^"_LANM,@^%ZOSF("TRAP")
LA2 K TV S TOUT=0 D IN G QUIT:TOUT,LA2:IN'["PTID"
LA2A S V=$E(IN,8,24) D NUM S (ID,IDE)=+V
 F I=0:0 S TOUT=0 D IN G QUIT:TOUT Q:$E(IN)="*"  S V=$E(IN,1,6) D NUM S TEST=V,V=$E(IN,7,14) D NUM,LA2B
 D LA3 G LA2
