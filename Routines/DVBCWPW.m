DVBCWPW ;ALB/CMM PULMONARY TB AND MYCO DISEASE WKS ; 6 MARCH 1997
 ;;2.7;AMIE;**12**;Apr 10, 1995
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For PULMONARY TUBERCULOSIS AND MYCOBACTERIAL DISEASES",PG=1
 W !?22,"Compensation and Pension Examination",!,?(IOM-$L(DVBAX)\2),DVBAX,!?33,"# 1515 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWPW1" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 S PG=PG+1 W @IOF,!,"Page: ",PG,!!,"Compensation and Pension Exam for "_NAME,!
 W "For PULMONARY TUBERCULOSIS AND MYCOBACTERIAL DISEASES",!!!
 Q
