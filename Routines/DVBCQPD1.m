DVBCQPD1 ;;ALB-CIOFO/ECF - PARKINSONS DISEASE QUESTIONNAIRE ; 5/10/2010
 ;;2.7;AMIE;**154**;Apr 10, 1995;Build 7
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Parkinson's Disease",TT=40-($L(DVBAX)\2),PG=1
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQPD2" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
 ...
 K ^TMP($J,"DVBAW"),TEXT,STOP,LP,PG,DVBAX,X,NAME,SSN,TT,DVBY
 Q
 ;
HD2 ;
