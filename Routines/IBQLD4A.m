IBQLD4A ;LEB/MRY - ACUTE/NON-ACUTE DOWNLOAD ; 17-MAY-95
...
PRINT S (IBTEXT,IBDATA,IBQUIT,IBHDR,IBDIAG)="",IBPAG=0 D MONTH
 ...
 ;
 I '$D(^TMP("IBQLD4",$J)) W !!,?20,"<<<   NO PATIENTS TO PRINT   >>>" Q
DIAG F  S IBDIAG=$O(^TMP("IBQLD4",$J,IBDIAG)) Q:IBDIAG=""  D  Q:IBQUIT
 .S IBSUBH="ADMITTING DIAGNOSIS: "_IBDIAG
 .D PLINE
 .F IBDAY=1,2 D  Q:IBQUIT
 ..S (IBCAT,IBCATF)=""
 ..F  S IBCAT=$O(^TMP("IBQLD4",$J,IBDIAG,IBDAY,IBCAT)) Q:IBCAT=""  D  Q:IBQUIT
...
ACUTE ;
 ...
 .S IBRES=$G(^TMP("IBQLD4",$J,IBDIAG,IBDAY,IBCAT,IBMONTH)) S:'IBRES IBRES=0 D MDATA
 D PLINE Q:IBQUIT
 Q
REASON ;
 S IBREA=""
 W:IBDAY=1 !,"REASONS FOR NON-ACUTE ADMISSIONS" W:IBDAY=2 !,"REASONS FOR NON-ACUTE STAY DAYS"
 F  S IBREA=$O(^TMP("IBQLD4",$J,IBDIAG,IBDAY,IBCAT,IBREA)) Q:'IBREA  D  Q:IBQUIT 
 .S IBMONTH="" F  S IBMONTH=$O(IBMONTH(IBMONTH)) Q:'IBMONTH  D  Q:IBQUIT
 ..S IBRES=$G(^TMP("IBQLD4",$J,IBDIAG,IBDAY,IBCAT,IBREA,IBMONTH)) S:'IBRES IBRES=0 D MDATA
 .D PLINE Q:IBQUIT
 Q
MDATA ;
