...
X1 S RADTI=DA
 Q
2 S DW="0;2",DV="P79.2'",DU="",DLB="TYPE OF IMAGING",DIFLD=2
 S DU="RA(79.2,"
 S X=$P(RAMLC,U,6)
 S Y=X
 ...
 G RD:X="@",Z
X2 Q
3 S DW="0;3",DV="RP79'",DU="",DLB="HOSPITAL DIVISION",DIFLD=3
 S DU="RA(79,"
 S X=+RAMDIV
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD:X="@",Z
X3 Q
4 S DW="0;4",DV="RP79.1'",DU="",DLB="IMAGING LOCATION",DIFLD=4
 S DU="RA(79.1,"
 S X=+RAMLC
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
