...
X3 I $D(^PRCS(410,DA(1),3)),$P(^(3),"^",4),$D(^(2)),$P(^(2),"^",1)'="" S PRCSV=$P(^(3),"^",4)
 Q
4 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=4 D X4 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X4 I '$D(PRCSV) S Y=1
 Q
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,DW="0;5",DV="FX",DU="",DLB="ITEM MASTER FILE NO.",DIFLD=5
 S DE(DW)="C5^PRCST22"
 G RE
...
C5S S X="" Q:DG(DQ)=X  K DB
 ...
 Q
X5 K:X[""""!($A(X)=45) X I $D(X) D ITEM^PRCSES1
 I $D(X),X'?.ANP K X
 Q
 ;
6 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=6 D X6 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X6 K PRCSSUB I X="" S Y=1
 Q
7 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=7 D X7 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X7 S PRCSSUB=$S($D(^PRCD(420.1,+$S($D(^PRCS(410,DA(1),3)):$P(^(3),U,3),1:""),1,+$S($D(^PRC(441,+$S($D(^PRCS(410,DA(1),"IT",DA,0)):$P(^(0),U,5),1:""),0)):$P(^(0),U,10),1:""),0)):$P(^(0),U),1:"")
 Q
...
X9 K:X[""""!($A(X)=45) X I $D(X) D SUB^PRCSES
 ...
 ;
10 S DQ=11 ;@44
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="0;2",DV="RNJ9,2",DU="",DLB="QUANTITY",DIFLD=2
 S DE(DW)="C11^PRCST22"
 G RE
...
C11S S X="" Q:DG(DQ)=X  K DB
 ...
 Q
X11 K:+X'=X!(X>999999)!(X<.01)!(X?.E1"."3N.N) X
 Q
 ;
12 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=12 D X12 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X12 S Y="@4"
 Q
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,D=0 K DE(1) ;1
...
X14 S X=$P($G(^PRCS(410,DA(1),3)),U,3) I X]"" S X=$$GETBOCNT^PRCSECP(PRC("SITE"),+PRC("CP"),+X) I (+X=1) S $P(^PRCS(410,DA(1),"IT",DA,0),U,4)=$P(X,U,2),Y="@444" W !,"BOC: ",$P(X,U,2)
 Q
15 S DW="0;4",DV="RFX",DU="",DLB="BOC",DIFLD=4
 S DE(DW)="C15^PRCST22"
 G RE
...
C15S S X="" Q:DG(DQ)=X  K DB
 ...
 S ^PRCS(410,"AD",$E(X,1,30),DA(1))=""
 Q
X15 K:X[""""!($A(X)=45) X I $D(X) D SUB^PRCSES
 I $D(X),X'?.ANP K X
 Q
 ;
16 S DQ=17 ;@444
17 S DQ=18 ;@2
18 D:$D(DG)>9 F^DIE17,DE S DQ=18,DW="0;2",DV="RNJ9,2",DU="",DLB="QUANTITY",DIFLD=2
 S DE(DW)="C18^PRCST22"
 G RE
...
X18 K:+X'=X!(X>999999)!(X<.01)!(X?.E1"."3N.N) X
 Q
 ;
19 D:$D(DG)>9 F^DIE17,DE S DQ=19,DW="0;3",DV="RP420.5'",DU="",DLB="UNIT OF PURCHASE",DIFLD=3
 S DU="PRCD(420.5,"
 G RE
X19 Q
20 S DW="0;6",DV="FX",DU="",DLB="STOCK NUMBER",DIFLD=6
 G RE
X20 K:$L(X)>24!($L(X)<1)!(X'?.ANP) X
 I $D(X),X'?.ANP K X
 Q
 ;
21 S DW="0;7",DV="RNJ10,2X",DU="",DLB="EST. ITEM (UNIT) COST",DIFLD=7
 S DE(DW)="C21^PRCST22"
 G RE
