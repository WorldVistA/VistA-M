DVBCWNS2 ;BPIOFO/ESW - SPINE WKS ; 10/1/02 5:42pm
...
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 ...
 W !?TT,DVBAX
 S DVBAX="SPINE (Cervical, Thoracic and Lumbar)",PG=1
 S TT=IOM-$L(DVBAX)\2
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWNS3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 S PG=PG+1 W @IOF,!,"Page: ",PG,!?10,"Compensation and Pension Exam for "_NAME,!!
 W "SPINE (Cervical, Thoracic and Lumbar)",!!!
 Q
