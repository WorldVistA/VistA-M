ECTP1S0 ;B'ham ISC/PTD-PAID Data for One Service - CONTINUED ;01/29/91 08:00
V ;;1.05;INTERIM MANAGEMENT SUPPORT;**4,8,10**;
ENQ ;ENTRY POINT WHEN QUEUED
 K ^TMP($J) S YP=(BYRPP-1)
LP1 ;LOOP THROUGH DATE/PAY PERIOD REQUESTED
 F J=0:0 S YP=$O(^PRST(455,YP)) G:'YP EN1^ECTP1S1 G:YP>EYRPP EN1^ECTP1S1 S (EMPDA,PAL,PSL,PLWOP,PAA,PCTE,PCTU,PUNS,POT)=0 D LP2 D:$D(TMP(SRVDA,YP)) SETGL
 ;
...
PHYS ;IS INDIVIDUAL FULL-TIME PHYSICIAN OR RESIDENT
 I (($P(LOC0,"^",10)="J")!($P(LOC0,"^",10)="L")),($P(LOC0,"^",11)=1) D CONV^ECTPAS0 G SETPP
