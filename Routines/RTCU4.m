...
SET I X'?.ANP S DDER=1 Q 
 ...
 Q
BEGIN S DNM="RTCU4",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;11",DV="P190.1'",DU="",DLB="PARENT REQUEST",DIFLD=11
 S DE(DW)="C1^RTCU4"
 S DU="RTV(190.1,"
 S X=$S($D(RTPAR):RTPAR,1:"")
 S Y=X
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G Z
C1 G C1S:$D(DE(1))[0 K DB S X=DE(1),DIC=DIE
 K ^RTV(190.1,"APAR",$E(X,1,30),DA)
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 S ^RTV(190.1,"APAR",$E(X,1,30),DA)=""
 Q
X1 Q
2 S DQ=3 ;@999
