SRONOR4 ;B'HAM ISC/MAM - REPORT OF NON-O.R. PROCEDURES ; [ 07/27/98   2:33 PM ]
 ...
 Q
SROP S SROP=0 F  S SROP=$O(^TMP("SR",$J,SRSUR,SRSD,SROP)) Q:'SROP!(SRSOUT)  D SET
 Q
SET ; set and print info
 ...
 W !!,SRSDATE,?15,SRNM_" ("_VA("PID")_")",?64,SRSS,?116,SRST,!,SROP,?15,SRLOC_" ("_SRINOUT_")",?64,SROPS(1),?116,SRET
...
HDR I $D(ZTQUEUED) D ^SROSTOP I SRHALT S SRSOUT=1 Q
 ...
 W !!,"DATE",?15,"PATIENT (ID#)",?64,"SPECIALTY",?116,"START TIME",!,"CASE #",?15,"LOCATION (IN/OUT-PAT STATUS)",?64,"PROCEDURE(S)",?116,"FINISH TIME",! F LINE=1:1:132 W "="
