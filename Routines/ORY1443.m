ORY1443 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*144) ;JUN 12,2002 at 12:20
...
ADDMULT(OCXCREF,OCXDD,OCXFLD) ;
 ...
 ;
 S OCXGREF=$$GETREF^ORY1442(+OCXFLD,.OCXDA,1)
...
DELMULT(OCXCREF,OCXDD) ;
 ...
 S DA=$G(DA(0)) K DA(0)
 S OCXGREF=$$GETREF^ORY1442(+OCXDD,.DA,1)
 ;
 D DIE^ORY1442(+OCXDD,OCXGREF,.01,"@",.DA,$L(DDPATH,",")-1)
