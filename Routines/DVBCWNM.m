DVBCWNM ;ALB/CMM NEUROLOGICAL MISC. DISORDERS WKS ; 6 MARCH 1997
 ;;2.7;AMIE;**12**;Apr 10, 1995
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For NEUROLOGICAL DISORDERS, MISCELLANEOUS",PG=1
 W !?22,"Compensation and Pension Examination",!,?(IOM-$L(DVBAX)\2),DVBAX,!?33,"# 1225 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWNM1" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 S PG=PG+1 W @IOF,!,"Page: ",PG,!!,"Compensation and Pension Exam for "_NAME,!
 W "For NEUROLOGICAL DISORDERS, MISCELLANEOUS",!!!
 Q
