PRCATW3 ; GENERATED FROM 'PRCAP CARE WV' PRINT TEMPLATE (#403) ; 10/02/99 ; (FILE 433, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 D N:$X>34 Q:'DN  W ?34 W "PRIN.BAL.(WAIVED)"
 S I(1)=4,J(1)=433.01 F D1=0:0 Q:$O(^PRCA(433,D0,4,D1))'>0  X:$D(DSC(433.01)) DSC(433.01) S D1=$O(^(D1)) Q:D1'>0  D:$X>53 T Q:'DN  D A1
 G A1R
A1 ;
