LEX2054P ;ISL/KER - LEX*2.0*54 Pre/Post Install ;06/06/2007
 ;;2.0;LEXICON UTILITY;**54**;Sep 23, 1996;Build 1
 ;              
...
POST ; LEX*2.0*54 Post-Install
 ...
 ;            
 N LEXEDT,LEXPTYPE,LEXLREV,LEXREQP,LEXBUILD,LEXIGHF,LEXFY,LEXQTR,LEXB,LEXCD,LEXSTR,LEXLAST D IMP^LEX2054
...
KLEXM ; Subscripted Kill of ^LEXM
 ...
 Q
 ;            
PRE ; LEX*2.0*54 Pre-Install   (N/A for patch 54)
 Q
 ;            
