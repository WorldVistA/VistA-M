DVBCQPT4 ;;ALB-CIOFO/SBW -  PTSD QUESTIONNAIRE (v2) ; 14/JUNE/2011
 ;;2.7;AMIE;**171**;Apr 10, 1995;Build 2
 ;
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Initial Post Traumatic Stress Disorder (PTSD)",TT=40-($L(DVBAX)\2),PG=1
 W !?TT,DVBAX,!?40-($L("Disability Benefits Questionnaire")\2),"Disability Benefits Questionnaire",!
 S DVBAX="* Internal VA or DoD Use Only *",TT=40-($L(DVBAX)\2)
 W ?TT,DVBAX,!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQPT5","DVBCQPT6" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 ;
 ...
 W "Initial Post Traumatic Stress Disorder (PTSD)",!!
 Q
