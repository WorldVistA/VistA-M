GMRVVS2 ;HIRMFO/YH-PATIENT VITAL SIGNS-I/O SF 511 GRAPH - 2 ;7/15/97
...
FOOTER ;PRINT VITAL SIGNS-I/O SHEET FOOTER
 ...
 W !,"Division: "_$S(GMRVHLOC>0:$$GET1^DIQ(4,+$$GET1^DIQ(44,+GMRVHLOC,3,"I"),.01,"I"),1:""),?55,"Page "_GMRPGC,?95,"VAF 10-7987 VICE SF 511",!
 W GSTRFIN Q
...
BP ;
 ...
 I GMRSITE(1)'="" S GI="B" D SYNOARY^GMRVLGQU
