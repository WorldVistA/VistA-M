DVBCQPT1 ;;ALB-CIOFO/ECF -  PTSD QUESTIONNAIRE ; 10/6/2010
 ;;2.7;AMIE;**161**;Apr 10, 1995;Build 8
 ;
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Post Traumatic Stress Disorder (PTSD)",TT=40-($L(DVBAX)\2),PG=1
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQPT2","DVBCQPT3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
