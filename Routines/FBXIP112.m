FBXIP112 ;ALB/RC-PATCH INSTALL ROUTINE ; 1/7/10 9:03pm
 ;;3.5;FEE BASIS;**112**;JAN 30, 1995;Build 6
 Q
 ;
PS ; post-install entry point
 ...
 N FBX
 F FBX="EN" D
 . S Y=$$NEWCP^XPDUTL(FBX,FBX_"^FBXIP112")
...
CF ; add conversion factors for calendar year 2010 RBRVS fee schedule
 ...
 D BMES^XPDUTL("  Filing conversion factor for RBRVS 2010 fee schedule.")
 ...
 . S DR=".02///"_$S(DA(1)=1:21.114,1:36.0846)
 . D ^DIE
 Q
 ;FBXIP112
