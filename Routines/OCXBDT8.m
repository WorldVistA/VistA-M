OCXBDT8 ;SLC/RJS,CLA - BUILD OCX PACKAGE DIAGNOSTIC ROUTINES (Build Runtime Library Routine OCXDI4) ;8/04/98  13:21
...
EN() ;
 ...
 ;
 S DIE="^TMP(""OCXBDT"","_$J_",""RTN"",",XCN=0,X="OCXDI4"
 W !,X X ^%ZOSF("SAVE") W "  ... ",XCM," Lines filed" K ^TMP("OCXBDT",$J,"RTN")
 ;
 Q XCM
 ;
TEXT ;
 ;;OCXDI4 ;SLC/RJS,CLA - OCX PACKAGE DIAGNOSTIC UTILITY ROUTINE ;|NOW|
 ;;|OCXLIN2|
 ;;|OCXLIN3|
 ;; ;
 ;;S ;
 ...
 ;; .N RESP
 ;; .Q:'OCXFLGC  I (OCXFLGA) S RESP=$$READ("Y"," Do you want to change the local '"_$$FILENAME^OCXBDTD(+OCXDD)_"' field ?","YES") I 'RESP S QUIT=(RESP[U) Q
 ;; .S OCXGREF=$$GETREF^OCXDI2(+OCXDD,.OCXDA,OCXLVL-1) Q:'$L(OCXGREF)
 ;; .D DIE^OCXDI2(OCXDD,OCXGREF,OCXFLD,@OCXCREF@(OCXDD,OCXFLD,"E"),.OCXDA,OCXLVL-1)
 ;; ;
 ;; Q QUIT
 ;; ;
 ...
 ;; F OCXPC=1:1:OCXLVL S OCXDA(OCXLVL-OCXPC)=+$P($P(DDPATH,",",OCXPC),":",2)
 ;; S OCXDA=OCXDA(0) K OCXDA(0)
 ;; Q:'OCXFLGC 0 I (OCXFLGA) S RESP=$$READ("Y"," Do you want to Delete the local '"_$$FILENAME^OCXBDTD(+OCXDD)_"' value ?","YES") I 'RESP S QUIT=(RESP[U) Q QUIT
 ;; S OCXGREF=$$GETREF^OCXDI2(+OCXDD,.OCXDA,OCXLVL-1) Q:'$L(OCXGREF)
 ;; D DIE^OCXDI2(OCXDD,OCXGREF,OCXFLD,"@",.OCXDA,OCXLVL-1)
 ;; ;
 ;; Q QUIT
 ;; ;
