ICD18109P ;ALB/JDG - YEARLY DRG UPDATE; March 01, 2022@15:42
 ;;18.0;DRG Grouper;**109**;October 20, 2000;Build 2
 ;
 ;This routine will kick off routines needed for 
 ;FY 2022 COVID updates to the DRG Grouper.
 ;
 ;
 Q
 ;
EN ; start update
 D PRES
 ;D DRG^ICD18109A ;FY2022 updates to MS-DRGS
 ; ********************************************************************************
 ; *****routines ICD18109F-K contain the data needed for the DRG Grouper update*****
 ; ********************************************************************************
 ;D INACTDRG^ICD18109O ; Inactivate DRGs (no DRG inactivations for FY2022)
 Q
 ;
PRES ;
