ICDTBL0C ;ALB/MJB - GROUPER UTILITY FUNCTIONS;08/09/2010
 ;;18.0;DRG Grouper;**50,49,55**;Oct 20, 2000;Build 20
...
DRG14 ;LINE TAG FOR 014,015
DRG15 ;
 S ICDRG=14 D 
 . I $D(ICDOP(" 41.00")) S ICDRG=15 Q
 . I $D(ICDOP(" 41.01")) S ICDRG=15 Q
 . I $D(ICDOP(" 41.04")) S ICDRG=15 Q
 . I $D(ICDOP(" 41.07")) S ICDRG=15 Q
 . I $D(ICDOP(" 41.09")) S ICDRG=15 Q
 Q
...
DRG24 ;
 ...
 S ICDRG=$S($D(ICDOP(" 02.93"))&($D(ICDOP(" 86.95")))&(ICDMCC=2):23,$D(ICDOP(" 02.93"))&($D(ICDOP(" 86.95"))):24,1:ICDRG) Q
