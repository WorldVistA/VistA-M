ICDTBL9B ;ALB/EG/MRY - GROUPER UTILITY FUNCTIONS ; 11/9/07 1:02pm
 ;;18.0;DRG Grouper;**45,54**;Oct 20, 2000;Build 12
DRG901 ;
DRG902 ;
...
DRG981 ;
DRG982 ;
DRG983 I ICDDX(1)=$O(^ICD9("AB","278.01 ",0))&($D(ICDDXT("V85.43"))) S ICDRG=983  Q
