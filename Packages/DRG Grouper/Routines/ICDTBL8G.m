ICDTBL8G ;ALB/JDG - GROUPER UTILITY FUNCTIONS;08/09/2010
...
DRG829 I ICDPD["L"!($G(ICDMAJ)),('$D(ICDOP(" 92.30"))),('$D(ICDOP(" 92.31"))),('$D(ICDOP(" 92.32"))),('$D(ICDOP(" 92.33"))),('$D(ICDOP(" 92.39"))) D DRG826 Q
 I ICDSD["l" D DRG837 Q
 I ICDSD'["l"&(ICDOR'["O"),('$D(ICDOP(" 92.30"))),('$D(ICDOP(" 92.31"))),('$D(ICDOP(" 92.32"))),('$D(ICDOP(" 92.33"))),('$D(ICDOP(" 92.39"))) D DRG846 Q
...
DRG845 I ICDPD["L"  D DRG840 Q
 ...
 I $D(ICDDX(1))&(ICDOPCT=0) D  Q:"837^838^839^846^847^848"[ICDRG
 ...
 I ICDOR["N"&(ICDOR'["V")&($D(ICDPDRG(844))) S ICDRG=844 Q
...
DRG853 ;
DRG854 ;
DRG855  I ICDOR="",ICDDX(1)=7322!(ICDDX(1)=13271)!(ICDDX(1)=13272) D DRG862 Q
...
DRG867 ;
DRG868 ;
DRG869 I ICDOR["O",$D(ICDOP)>10,ICDDX(1)'=7322!(ICDDX(1)'=13271)!(ICDDX(1)'=13272)!(ICDDX(1)'=14543) D DRG853 Q
 S ICDRG=$S(ICDMCC=2:867,ICDMCC=1:868,1:869) Q
DRG870 ;DRGs 870-872
