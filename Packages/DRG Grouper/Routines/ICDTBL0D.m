ICDTBL0D ;ALB/MJB - GROUPER UTILITY FUNCTIONS;08/09/2010
 ;;18.0;DRG Grouper;**56**;Oct 20, 2000;Build 18
...
DRG24 ;
 ...
 S ICDRG=$S($D(ICDOP(" 02.93"))&($D(ICDOP(" 86.98")))&(ICDMCC=2):23,$D(ICDOP(" 02.93"))&($D(ICDOP(" 86.98"))):24,1:ICDRG) Q
