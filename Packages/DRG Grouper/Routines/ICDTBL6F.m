ICDTBL6F ;ALB/JDG - GROUPER UTILITY FUNCTIONS;08/09/2010
 ;;18.0;DRG Grouper;**72,74,78**;Oct 20, 2000;Build 15
DRG600 ;
DRG601 S ICDRG=$S(ICDMCC>0:600,1:601) Q
DRG602 ;
DRG603 I ICDOR["x",ICDOR["O" D DRG983^ICDTBL9F Q
...
DRG614 ;
DRG615 I $D(ICDODRG(614)),ICDF["619^620^621",$D(ICDOP(" 07.62")),$D(ICDOP(" 86.87")) D DRG621 Q
 S ICDRG=$S(ICDMCC>0:614,1:615) Q
DRG616 ;
DRG617 ;
...
DRG662 ;
DRG663 ;
DRG664 I ICDOR["f",'$D(ICDJJ(664)),ICDRG'="" Q
...
DRG682 ;
DRG683 ;
DRG684 I ICDDX(1)=12434,$D(ICDDXT("585.6")),ICDMCC'=2 S ICDMCC=2
