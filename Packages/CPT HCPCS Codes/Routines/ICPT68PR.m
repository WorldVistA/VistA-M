ICPT68PR ;ALB/GTS- ICPT Pre-Init Driver; 2/18/2000
 ;;6.0;CPT/HCPCS;**8**;May 19, 1997
 ;
 ...
 ;  The associated file saves (from %GTO) are ICPT6_8.GLB (file 81) and ICPT6_8A.GLB (files 81.1-81.3)
 ;
EN ;- Main entry point
 ;
 N I,ICPTX,XPDIDTOT
 ...
 D MES^XPDUTL("    to restore the CPT global files from ICPT6_8.GLB (CPT file, #81)")
 D MES^XPDUTL("    and ICPT6_8A.GLB [CPT CATEGORY (#81.1); CPT COPYRIGHT (#81.2)")
