TIUFLF4 ; SLC/MAM - Lib: ANCESTOR(FILEDA,NODE0,ANCESTOR,DOCFLAG), ORPHAN(FILEDA,NODE0,ANCESTOR), STUFFLDS(FILEDA,PFILEDA), ADDTEN(PFILEDA,FILEDA,NODE0,TENDA),NUMITEMS(FILEDA), MISSITEM(FILEDA) ; Sep 22, 2025@15:36:20
 ;;1.0;TEXT INTEGRATION UTILITIES;**11,43,236,232,369**;Jun 20, 1997;Build 4
 ;
...
ORPHAN(FILEDA,NODE0,ANCESTOR) ; Function traces ancestors of FILEDA,
 ...
 . N DIC,DINUM,DLAYGO,DTOUT,DUOUT,X
