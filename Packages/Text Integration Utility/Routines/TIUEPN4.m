...
DE S DIE="^TIU(8925,",DIC=DIE,DP=8925,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^TIU(8925,DA,""))=""
 I $D(^(12)) S %Z=^(12) S %=$P(%Z,U,5) S:%]"" DE(1)=%
...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="TIUEPN4",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="12;5",DV="P44'",DU="",DLB="HOSPITAL LOCATION",DIFLD=1205
 S DE(DW)="C1^TIUEPN4"
 S DU="SC("
 S X=$P($G(TIU("LOC")),U,2)
 S Y=X
...
X1 Q
2 S DQ=3 ;@4
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW="13;1",DV="D",DU="",DLB="DATE/TIME OF NOTE",DIFLD=1301
 S DE(DW)="C3^TIUEPN4"
...
C3S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 Q
X3 S %DT="ESTX" D ^%DT S X=Y K:Y<1 X
 Q
 ;
4 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=4 D X4 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X4 I +$$DATENOTE^TIULA3($$DATE^TIULS(X,"MM/DD/YY@HR:MIN:SEC"))'>0 S Y="@4"
 Q
5 D:$D(DG)>9 F^DIE17 G ^TIUEPN5
