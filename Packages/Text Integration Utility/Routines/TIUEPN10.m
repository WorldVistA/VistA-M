...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="12;2",DV="*P200'R",DU="",DLB="AUTHOR OF NOTE",DIFLD=1202
...
X9 I +$P($G(^TIU(8925,+DA,12)),U) S Y="@6"
 Q
10 D:$D(DG)>9 F^DIE17,DE S DQ=10,DW="12;1",DV="D",DU="",DLB="ENTRY DATE/TIME",DIFLD=1201
...
X15 W !!,"No cosignature is required for this author.",!
 Q
16 D:$D(DG)>9 F^DIE17,DE S DQ=16,DW="12;8",DV="*P200'",DU="",DLB="EXPECTED COSIGNER",DIFLD=1208
...
X22 I TIUDCSNR="UNKNOWN" S Y="@11"
 Q
23 S DW="12;8",DV="*P200'R",DU="",DLB="EXPECTED COSIGNER",DIFLD=1208
...
X25 S Y="@9"
 Q
26 S DQ=27 ;@11
27 D:$D(DG)>9 F^DIE17,DE S DQ=27,DW="12;8",DV="*P200'R",DU="",DLB="EXPECTED COSIGNER",DIFLD=1208
...
X28 S Y="@9"
 Q
29 S DQ=30 ;@8
30 D:$D(DG)>9 F^DIE17,DE S DQ=30,DW="12;8",DV="*P200'",DU="",DLB="EXPECTED COSIGNER",DIFLD=1208
...
X30 S DIC("S")="I +$G(DA),+$$SCRCSNR^TIULA3(+DA,+Y)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 ...
 ;
31 S DQ=32 ;@9
32 D:$D(DG)>9 F^DIE17,DE S DQ=32,DW="15;6",DV="S",DU="",DLB="COSIGNATURE NEEDED",DIFLD=1506
 S DU="1:YES;0:NO;"
 S Y="1"
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD:X="@",Z
...
X34 I +$P($G(TIUPREF),U,8)'>0,($G(^TIU(8925,+DA,17))']"") S Y="@10"
 Q
35 S DW="17;1",DV="F",DU="",DLB="SUBJECT (OPTIONAL description)",DIFLD=1701
...
X38 I $P($G(^TIU(8925,+DA,13)),U,3)]"" S Y="@12"
 Q
39 D:$D(DG)>9 F^DIE17,DE S DQ=39,DW="13;3",DV="S",DU="",DLB="CAPTURE METHOD",DIFLD=1303
