...
DE S DIE="^TIU(8925,",DIC=DIE,DP=8925,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^TIU(8925,DA,""))=""
 I $D(^(12)) S %Z=^(12) S %=$P(%Z,U,1) S:%]"" DE(10)=% S %=$P(%Z,U,2) S:%]"" DE(1)=% S %=$P(%Z,U,4) S:%]"" DE(4)=% S %=$P(%Z,U,8) S:%]"" DE(16)=%,DE(23)=%,DE(27)=%,DE(30)=%
 I $D(^(13)) S %Z=^(13) S %=$P(%Z,U,2) S:%]"" DE(7)=% S %=$P(%Z,U,3) S:%]"" DE(39)=%
 I $D(^(15)) S %Z=^(15) S %=$P(%Z,U,6) S:%]"" DE(17)=%,DE(32)=%
 I $D(^(17)) S %Z=^(17) S %=$P(%Z,U,1) S:%]"" DE(35)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="TIUEPN10",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="12;2",DV="*P200'R",DU="",DIFLD=1202,DLB="AUTHOR OF NOTE"
 S DE(DW)="C1^TIUEPN10",DE(DW,"INDEX")=1
 S DU="VA(200,"
...
X2 I +$G(TIUAUTH),(+$P(^TIU(8925,+DA,12),U,2)'=+$G(TIUAUTH)) S TIU("SVC")=$$PROVSVC^TIULV(+$P(^(12),U,2)),TIUAUTH=+$P(^TIU(8925,+DA,12),U,2)
 Q
3 S DQ=4 ;@2
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="12;4",DV="P200'O",DU="",DIFLD=1204,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X6 I +$P($G(^TIU(8925,+DA,13)),U,2) S Y="@5"
 Q
7 S DW="13;2",DV="P200'O",DU="",DIFLD=1302,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X9 I +$P($G(^TIU(8925,+DA,12)),U) S Y="@6"
 Q
10 D:$D(DG)>9 F^DIE17,DE S DQ=10,DW="12;1",DV="D",DU="",DIFLD=1201,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C10^TIUEPN10",DE(DW,"INDEX")=1
 S X=$$NOW^TIULC
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD:X="@",Z
...
C10F1 S DIEZRXR(8925,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=557 S DIEZRXR(8925,DIXR)=""
 Q
X10 Q
11 S DQ=12 ;@6
12 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=12 D X12 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X12 S TIURQCS=+$$REQCOSIG^TIULP(+$G(TIUTYP),+DA,+$G(TIUESNR))
 Q
13 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=13 D X13 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X13 I 'TIURQCS,($L($P($G(^TIU(8925,+DA,12)),U,8))'>0) S Y="@7"
 Q
14 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=14 D X14 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X14 I +TIURQCS S Y="@15"
 Q
15 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=15 D X15 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X15 W !!,"No cosignature is required for this author.",!
 Q
16 D:$D(DG)>9 F^DIE17,DE S DQ=16,DW="12;8",DV="*P200'",DU="",DIFLD=1208,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C16^TIUEPN10"
 S DU="VA(200,"
 S Y="@"
...
C16F1 Q
X16 S DIC("S")="I +$G(DA),+$$SCRCSNR^TIULA3(+DA,+Y)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
...
C23S S X="" G:DG(DQ)=X C23F1 K DB
 ...
 D SACLEC^TIUDD0(1208,X)
C23F1 Q
X23 S DIC("S")="I +$G(DA),+$$SCRCSNR^TIULA3(+DA,+Y)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
...
X25 S Y="@9"
 Q
26 S DQ=27 ;@11
27 D:$D(DG)>9 F^DIE17,DE S DQ=27,DW="12;8",DV="*P200'R",DU="",DIFLD=1208,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C27^TIUEPN10"
 S DU="VA(200,"
 G RE
...
C27S S X="" G:DG(DQ)=X C27F1 K DB
 ...
 D SACLEC^TIUDD0(1208,X)
C27F1 Q
X27 S DIC("S")="I +$G(DA),+$$SCRCSNR^TIULA3(+DA,+Y)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
...
X28 S Y="@9"
 Q
29 S DQ=30 ;@8
30 D:$D(DG)>9 F^DIE17,DE S DQ=30,DW="12;8",DV="*P200'",DU="",DIFLD=1208,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C30^TIUEPN10"
 S DU="VA(200,"
 G RE
...
C30S S X="" G:DG(DQ)=X C30F1 K DB
 ...
 D SACLEC^TIUDD0(1208,X)
C30F1 Q
X30 S DIC("S")="I +$G(DA),+$$SCRCSNR^TIULA3(+DA,+Y)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
31 S DQ=32 ;@9
32 D:$D(DG)>9 F^DIE17,DE S DQ=32,DW="15;6",DV="S",DU="",DIFLD=1506,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="1:YES;0:NO;"
 S Y="1"
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD:X="@",Z
...
X34 I +$P($G(TIUPREF),U,8)'>0,($G(^TIU(8925,+DA,17))']"") S Y="@10"
 Q
35 S DW="17;1",DV="F",DU="",DIFLD=1701,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C35^TIUEPN10",DE(DW,"INDEX")=1
 G RE
C35 G C35S:$D(DE(35))[0 K DB
 D ^TIUEPN11
C35S S X="" G:DG(DQ)=X C35F1 K DB
 D ^TIUEPN12
C35F1 S DIEZRXR(8925,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=323 S DIEZRXR(8925,DIXR)=""
 Q
X35 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>80!($L(X)<3) X
 I $D(X),X'?.ANP K X
 Q
 ;
36 S DQ=37 ;@10
37 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=37 D X37 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X37 K TIUESNR,TIURQCS
 Q
38 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=38 D X38 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X38 I $P($G(^TIU(8925,+DA,13)),U,3)]"" S Y="@12"
 Q
39 D:$D(DG)>9 F^DIE17,DE S DQ=39,DW="13;3",DV="S",DU="",DIFLD=1303,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
