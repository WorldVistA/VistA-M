TIUXRC3 ; COMPILED XREF FOR FILE #8925 ; 05/09/23
 ; 
 S DIKZK=1
 ...
 S X=$P($G(DIKZ(0)),U,1)
 I X'="" S DH=8925,DV=.01,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(0)),U,2)
 ...
 S X=$P($G(DIKZ(0)),U,2)
 I X'="" S DH=8925,DV=.02,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(0)),U,3)
 ...
 S X=$P($G(DIKZ(0)),U,5)
 I X'="" S DH=8925,DV=.05,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(0)),U,6)
 ...
 S X=$P($G(DIKZ(12)),U,1)
 I X'="" S DH=8925,DV=1201,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(12)),U,2)
 ...
 S X=$P($G(DIKZ(12)),U,2)
 I X'="" S DH=8925,DV=1202,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S DIKZ(12)=$G(^TIU(8925,DA,12))
 S X=$P($G(DIKZ(12)),U,4)
 I X'="" S DH=8925,DV=1204,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(12)),U,5)
 ...
 S X=$P($G(DIKZ(12)),U,8)
 I X'="" S DH=8925,DV=1208,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(12)),U,9)
 I X'="" S DH=8925,DV=1209,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 ...
 S X=$P($G(DIKZ(13)),U,1)
 I X'="" S DH=8925,DV=1301,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(13)),U,2)
 ...
 S X=$P($G(DIKZ(13)),U,2)
 I X'="" S DH=8925,DV=1302,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(13)),U,4)
 ...
 S X=$P($G(DIKZ(14)),U,6)
 I X'="" S DH=8925,DV=1406,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 ...
 S X=$P($G(DIKZ(15)),U,1)
 I X'="" S DH=8925,DV=1501,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(15)),U,2)
 I X'="" D SACLSB^TIUDD0(1502,X)
 S X=$P($G(DIKZ(15)),U,2)
 I X'="" S DH=8925,DV=1502,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(15)),U,3)
 I X'="" S DH=8925,DV=1503,DU=1 S DIIX=3 D:$G(DIK(0))'["A" AUDIT^DIK1
 S X=$P($G(DIKZ(15)),U,4)
END G ^TIUXRC4
