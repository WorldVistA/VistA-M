TIUCCRHL7P4 ; CCRA/PB - TIU CCRA HL7 Msg Processing; January 6, 2006
 ;;1.0;TEXT INTEGRATION UTILITIES;**344,356,371,375**;Sep 27, 2023;Build 7
 ;
...
WORD ;
 ...
 ;Patch 375 - modification to only do the final formatting. should not need to do any custom formatting for addenda 
 I $G(ADDENDUM)["ADDENDUM" D FORMAT
