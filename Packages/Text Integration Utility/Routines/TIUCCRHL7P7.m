...
PCA ;
 ...
 ;K T2,T4 S T4="VETERAN'S"_$C(160)_"CAREGIVER"_$C(160)_"CONTACT INFO",T2(T4)=$C(10)_"VETERAN'S CAREGIVER CONTACT INFO" S WORDS=$$REPLACE^XLFSTR(WORDS,.T2)
...
VHA ;
 ...
 ;K T2,T4 S T4="VETERAN'S CAREGIVER CONTACT INFO",T2(T4)=$C(10)_$C(10)_T4_$C(10) S WORDS=$$REPLACE^XLFSTR(WORDS,.T2)
 ;K T2,T4 S T4="Case Management:",T2(T4)=$C(10)_T4 S WORDS=$$REPLACE^XLFSTR(WORDS,.T2)
 ;K T2,T4 S T4="Case Management:",T2(T4)=$C(10)_T4 S WORDS=$$REPLACE^XLFSTR(WORDS,.T2)
 ;K T2,T4 S T4="Case Management:",T2(T4)=$C(10)_T4 S WORDS=$$REPLACE^XLFSTR(WORDS,.T2)
 ;K T2,T4 S T4="Case Management:",T2(T4)=$C(10)_T4 S WORDS=$$REPLACE^XLFSTR(WORDS,.T2)
