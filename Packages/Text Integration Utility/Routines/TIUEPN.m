TIUEPN ; GENERATED FROM 'TIU ENTER/EDIT PROGRESS NOTE' INPUT TEMPLATE(#1493), FILE 8925;10/06/97
 D DE G BEGIN
...
BEGIN S DNM="TIUEPN",DQ=1
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIEZ=1493,U="^"
