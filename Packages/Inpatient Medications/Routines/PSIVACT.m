PSIVACT ;BIR/PR,MLM - UPDATE ORDER STATUS AFTER PATIENT SELECTION ;Feb 16, 2018@09:00
 ;;5.0;INPATIENT MEDICATIONS;**15,38,58,110,181,275,304,336**;16 DEC 97;Build 6
 ;
...
NVACT ; Non-verified but have active status
 NEW ON S PSGP=DFN  ;added PSGP #336
...
PEND ; Get pending and non-verified orders from 53.1
 N PSJCOM,PSJCOM1 S (PSJCOM,PSJCOM1)=0,PSGP=DFN  ;added PSGP #336
...
CHK ; Check if order is active or expired and save accordingly.
 N CLIN,PSIVSTAT,CLINSORT,SORT S PSIVSTAT="A",PSGP=DFN   ;336 added PSGP
...
ACTO ; Active orders
 ...
 N CLINSORT,SORT,CLIN,PSIVSTAT S PSIVSTAT="A",PSGP=DFN  ;added PSGP #336
 S CLIN=$$CLINIC^PSJO1(PSGP,ON) I (CLIN]"") S CLINSORT=$$CLINSORT^PSJO1(PSIVSTAT) S PSIVSTAT="Cz^"_CLIN_"^"_CLINSORT_"^A"
...
NACTO ; Inactive orders
 ...
 N CLIN,PSIVSTAT,SORT,CLINSORT S PSIVSTAT="",PSGP=DFN  ;added PSGP #336
