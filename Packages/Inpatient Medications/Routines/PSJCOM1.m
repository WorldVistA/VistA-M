PSJCOM1 ;BIR/CML - DISPLAY COMPLEX ORDERS FOR DISCONTINUE; Dec 15, 2025@10:00
 ;;5.0;INPATIENT MEDICATIONS;**110,127,281,315,327,393,465**;16 DEC 97;Build 1
...
NEW ;
 ...
 K ND4,DA,ND15,ND18 D NOW^%DTC S PSGDT=+$E(%,1,12),DA=+PSGORD
 ...
 S ND18=$G(PSGIND)
 I $G(PSJFSI) M ND15=^TMP("PSJCOM",$J,+PSGORD,15)
 ...
 S @(F_"18)")=ND18 ;465
 I $G(PSJFSI) M @(F_"15)")=ND15 ;465
 W "."
OUT ;
 K PSGOETOF
DONE ;
 K C,D,ND,ND2,ND2P1,ND4,ND15,ND18,PSGDO,PSGDRG,PSGDRGN,PSGFOK,PSGHSM,PSGMR,PSGMRN,PSGNEDFD,PSGNEFD,PSGNESD,PSGPDRG,PSGPDRGN,PSGSI,PSGSTN,PSJDOSE,%,Q
 Q
