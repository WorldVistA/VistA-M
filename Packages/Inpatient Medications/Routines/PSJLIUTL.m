PSJLIUTL ;BIR/MV - IV LM utilities modules ;Apr 30, 2018@13:40
 ;;5.0;INPATIENT MEDICATIONS ;**39,50,58,81,85,110,180,263,267,336**;16 DEC 97;Build 6
 ;
...
STARTDT() ; Start Date
 ...
 Q $$ENDTC^PSGMI(P(2))
 ;
STARTDT2() ; Start Date with 4 digit year #336
 S X="" I $D(PSIVNUM) S:P("DTYP") X=$S(P(17)="P"!(PSIVAC="PN"):" ",1:"*")_$S(P("DTYP")=1:"(12)",$E(P("OT"))="I":"(10)",1:"(8)")
 Q $$ENDTC2^PSGMI(P(2))
 ;
STOPDT() ; Stop Date
 ...
 Q $$ENDTC^PSGMI(P(3))
 ;
STOPDT2() ; Stop Date with 4 digit year #336
 S X="" I $D(PSIVNUM) S:P("DTYP") X=$S(P(17)="P"!(PSIVAC="PN"):" ",1:"*")_$S(P("DTYP")=1:"(13)",$E(P("OT"))="I":"(11)",1:"(9)")
 Q $$ENDTC2^PSGMI(P(3))
 ;
PROVIDER() ; Provider
...
REQDT(ORDER) ;
 ...
 I $G(PSGSD) S PSGSDN=$$ENDD^PSGMI(PSGSD)_U_$$ENDTC2^PSGMI(PSGSD)   ;#336 ENDTC2 call replaces ENDTC call
 ...
 I $G(PSGFD) S PSGFDN=$$ENDD^PSGMI(PSGFD)_U_$$ENDTC2^PSGMI(PSGFD)   ;#336 ENDTC2 call replaces ENDTC call
