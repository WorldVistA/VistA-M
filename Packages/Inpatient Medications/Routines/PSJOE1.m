PSJOE1 ;BIR/CML3 - UD OE FOR COMBINED OE ;Feb 16, 2018@09:15
 ;;5.0;INPATIENT MEDICATIONS;**2,7,25,30,47,56,64,179,181,252,281,315,338,336**;16 DEC 97;Build 6
...
AD ; Ask Drug
 ...
 S:$D(PSJOCFG) PSGSDN=$$ENDD^PSGMI(PSGNESD)_U_$$ENDTC2^PSGMI(PSGNESD),PSGFDN=$$ENDD^PSGMI(PSGNEFD)_U_$$ENDTC2^PSGMI(PSGNEFD) ;#336
...
EDIT(PROMPT) ;
 ...
 .S VALMSG="This change will cause a new order to be created." D GTSTATUS^PSGOEE,CHKDD^PSGOEE,CKDT^PSGOEE ;*336
