PSGPLR ;BIR/CML3-PRINTS PICK LIST REPORT ; 6/15/07 1:12pm
 ;;5.0;INPATIENT MEDICATIONS;**10,50,67,119,129,191,317,364**;16 DEC 97;Build 47
 ;
...
DD ;
 ...
 .;introduces hazardous to handle/dispose warnings                     *364
 .K PSHAZ N PSHAZ S PSHAZ=$$HAZ^PSSUTIL(+DRN) I $P(PSHAZ,"^")=1 W !,"<<HAZ Handle>>"
 .I $P(PSHAZ,"^",2)=1 W " <<HAZ Dispose>>"
...
EXDD ;
 ...
 .K PSHAZ N PSHAZ,PSHAZH,PSHAZD S (PSHAZH,PSHAZD)=0 S PSHAZ=$$HAZ^PSSUTIL(+DRN)    ;*364
 .I $P(PSHAZ,"^")=1 S PSHAZH=1
 .I $P(PSHAZ,"^",2)=1 S PSHAZD=1
 .I (PSHAZH&PSHAZD) W !?6,"<<HAZ Handle>> <<HAZ Dispose>>"
 .I (PSHAZH&'PSHAZD) W !?6,"<<HAZ Handle>>"
 .I ('PSHAZH&PSHAZD) W !?6,"<<HAZ Dispose>>"
