PSJLIVMD ;BIR/MV - SETUP LM TEMPLATE FOR INPT MED. IV ;Feb 16, 2018@09:08
 ;;5.0;INPATIENT MEDICATIONS;**37,50,63,58,81,91,80,116,110,111,180,134,209,254,267,275,279,336**;16 DEC 97;Build 6
 ;
...
START ;
 ...
 ;S PSJL=$$SETSTR^VALM1("Start:",PSJL,56,7)_$$STARTDT^PSJLIUTL ;#336
 S PSJL=$$SETSTR^VALM1("Start:",PSJL,56,7)_$$STARTDT2^PSJLIUTL ;#336
 D SETTMP^PSJLMPRU("PSJI",PSJL)
INFRATE ;
...
RSTART ;
 ...
 . ;I PSGRNDT S PSGRNDT=$$ENDTC^PSGMI(+PSGRNDT),PSJL=$$SETSTR^VALM1("Renewed: "_PSGRNDT,PSJL,54,32) Q  ;#336
 . I PSGRNDT S PSGRNDT=$$ENDTC2^PSGMI(+PSGRNDT),PSJL=$$SETSTR^VALM1("Renewed: "_PSGRNDT,PSJL,54,32) Q  ;#336
 ...
 ;I $G(ON)["V" N PSGRNDT S PSGRNDT=$$LASTREN^PSJLMPRI(DFN,ON) I PSGRNDT S PSGRNDT=$$ENDTC^PSGMI(+PSGRNDT),PSJL=$$SETSTR^VALM1("Renewed: "_PSGRNDT,PSJL,54,32)  ;#336
 I $G(ON)["V" N PSGRNDT S PSGRNDT=$$LASTREN^PSJLMPRI(DFN,ON) I PSGRNDT S PSGRNDT=$$ENDTC2^PSGMI(+PSGRNDT),PSJL=$$SETSTR^VALM1("Renewed: "_PSGRNDT,PSJL,54,32)  ;#336
...
STOP ;
 ...
 ;S PSJL=$$SETSTR^VALM1("Stop:",PSJL,57,6)_$S($G(PSJBADD)=1:"CANNOT CALCULATE",1:$$STOPDT^PSJLIUTL) ;#336
 S PSJL=$$SETSTR^VALM1("Stop:",PSJL,57,6)_$S($G(PSJBADD)=1:"CANNOT CALCULATE",1:$$STOPDT2^PSJLIUTL) ;#336
 D SETTMP^PSJLMPRU("PSJI",PSJL)
 S PSJL=""
...
LASTFL ;
 ...
 ;S PSJL=PSJL_$$ENDTC^PSGMI(P("LF"))  ;#336
 S PSJL=PSJL_$$ENDTC2^PSGMI(P("LF"))  ;#336
 D SETTMP^PSJLMPRU("PSJI",PSJL)
ADM ;
