PSIVOCDS ;BIR/MV - PROCESS DOSING ORDER CHECKS FOR IV ; Jun 06, 2007@15:37
 ;;5.0;INPATIENT MEDICATIONS ;**181,252,257,256,347,358,423**;16 DEC 97;Build 12
 ;
...
SINGLE ;Set fields needed for Single Dose type
 ...
 I PSJFDB(PSJCNT,"ROUTE")=("CONTINUOUS IV INFUSION") Q     ;*423 FDB 4.4 value
...
FDBRT(PSJDD,PSJRT) ;Check if the ordered route can be admin by FDB for this drug
 ...
 D TOUPPER(.PSJFDBRT)   ;423
 I $D(PSJFDBRT(PSJRT)) Q 1
 Q 0
TOUPPER(ROUTES)  ;423
 ;Upper case entries in the ROUTES array and add to the ROUTES array
 ;ROUTES has a 0 node
 NEW RTE,UPRTES
 S RTE=0
 F  S RTE=$O(ROUTES(RTE)) Q:RTE=""  S UPRTES($$UPPER^PSSHRCOM(RTE))=""
 M ROUTES=UPRTES
 Q
RTESCRN(PSJRT) ; Screen routes for none "VT or "TN"
 ...
 ;*423 updating the hardcoded values below to FDB version 4.4 values
 I PSJRT="INTRA-ARTERIAL" Q "CONTINUOUS INTRA-ARTERIAL INFUSION"
 I PSJRT="INFILTRATION" Q "CONTINUOUS INFILTRATION"
 I PSJRT="INTRACAUDAL" Q "CONTINUOUS CAUDAL INFUSION"
 I PSJRT="INTRAOSSEOUS" Q "CONTINUOUS INTRAOSSEOUS INFUSION"
 I PSJRT="INTRATHECAL" Q "CONTINUOUS INTRATHECAL INFUSION"
 I PSJRT="INTRAVENOUS" Q "CONTINUOUS IV INFUSION"
 I PSJRT="NEBULIZATION" Q "CONTINUOUS NEBULIZATION"
 I PSJRT="SUBCUTANEOUS" Q "CONTINUOUS SUBCUTANEOUS INFUSION"
 ;423 additional values in 4.5
 I PSJRT="ADDUCTOR CANAL BLOCK" Q "CONTINUOUS ADDUCTOR CANAL BLOCK"
 I PSJRT="EPIDURAL" Q "CONTINUOUS EPIDURAL"
 I PSJRT="INFRACLAVICULAR" Q "CONTINUOUS INFRACLAVICULAR"
 I PSJRT="INHALATION" Q "CONTINUOUS INHALATION"
 I PSJRT="INTERSCALENE" Q "CONTINUOUS INTERSCALENE"
 I PSJRT="INTRACATHETER" Q "CONTINUOUS INTRA-CATHETER INFUSION"
 I PSJRT="INTRAPERITONEAL" Q "CONTINUOUS INTRAPERITONEAL INFUSION"
 I PSJRT="INTRA-UMBILICAL VEIN" Q "CONTINUOUS INTRA-UMBILICAL VEIN INFUSION"
 Q 0
