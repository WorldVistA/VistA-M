PSIVOREN ;BIR/MLM-UTILITIES FOR IV FLUIDS - OE/RR INTERFACE; Apr 29, 2025@14:30
 ;;5.0;INPATIENT MEDICATIONS;**3,18,69,110,127,133,140,134,207,279,458**;16 DEC 97;Build 2
 ;
...
RUPDATE(DFN,ON,NSTRT) ;
 ...
 ;PSJ*5.0*458: update clinic for clinic infusion orders
 I ON["P",$G(OLDON)["V" D
 . N PSJCLINX,DIE,DR,DA
 . S PSJCLINX=$P($G(^PS(53.1,+ON,"DSS")),U)
 . S DIE="^PS(55,DFN,""IV"",",DR="136////"_PSJCLINX,DA=+ON55,DA(1)=DFN
 . D ^DIE
 ;end PSJ*5.0*458
