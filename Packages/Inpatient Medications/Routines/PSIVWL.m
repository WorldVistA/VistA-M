PSIVWL ;BIR/RGY,PR - COMPILE AND PRT WARD LIST ;13 MAR 97 / 10:18 AM
 ;;5.0;INPATIENT MEDICATIONS;**41,54,74,84,93,110,111,141,305,341**;16 DEC 97;Build 6
 ;
...
ENP4 Q:PSIVSD>CD  S PSIVSD=OD\1 I $G(P(2)),PSIVSD<P(2) S PSIVSD=P(2)\1
 ...
 .. F ADM=1:1:$L(P(11),"-") S ADMTM=$P(P(11),"-",ADM),ADMSD=+(ADMSD\1_"."_ADMTM) Q:ADMSD>CD  I OD'>ADMSD,CD'<ADMSD,ADMSD'=P(3) S PSGSA=PSGSA_$S(PSGSA'="":"",1:ADMSD)_"."_ADMTM_" "
