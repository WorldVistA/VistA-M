PSGOEEW ;BIR/CML3 - SHOW FIELDS FOR EDIT ;Feb 16, 2018@08:58
 ;;5.0;INPATIENT MEDICATIONS;**7,58,111,315,336**;16 DEC 97;Build 6
...
EN2 ;
 ...
 ;
SET ;
 ;S PSGOSTN=$$ENSTN^PSGMI(ST),(PSGOFDN,PSGOSDN)="" I SD S PSGOSDN=$$ENDD^PSGMI(SD)_"^"_$$ENDTC^PSGMI(SD)  ;336
 S PSGOSTN=$$ENSTN^PSGMI(ST),(PSGOFDN,PSGOSDN)="" I SD S PSGOSDN=$$ENDD^PSGMI(SD)_"^"_$$ENDTC2^PSGMI(SD)  ;336
 ;I FD S PSGOFDN=$$ENDD^PSGMI(FD)_"^"_$$ENDTC^PSGMI(FD)   ;336
 I FD S PSGOFDN=$$ENDD^PSGMI(FD)_"^"_$$ENDTC2^PSGMI(FD)   ;336
