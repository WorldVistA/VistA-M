...
SET I X'?.ANP S DDER=1 Q 
 ...
 Q
BEGIN S DNM="RTCC4",DQ=1
1 S DW="I;1",DV="D",DU="",DLB="INACTIVATION DATE",DIFLD=50
 S X=$S('$D(RTINACFL):0,1:RTINACFL),X=$S(X:"T-1",$P(RTMV0,"^")'["CHECK-IN":"",'$D(^DIC(195.2,+$P(RT0,"^",3),0)):0,$P(^(0),"^",15)="y":"T-1",1:"")
 S Y=X
