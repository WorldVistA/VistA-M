RMPRN7PL ;HINES/HNC -NPPD CALCULATIONS - SINGLE LINE; 02/14/01
 ;;3.0;PROSTHETICS;**57,70,72**;Feb 09, 1996
 ;
...
DESP ;desplay detail records
 ...
 .I HCPCSD="" S HCPCSD=$P(^RMPR(661.1,HCPCS,0),U,2)
 ...
 .I ITEM="" S ITEM=$P(^PRC(441,$P(^RMPR(661,$P(^RMPR(660,RDX,0),U,6),0),U,1),0),U,2)
