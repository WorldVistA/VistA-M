RACTOE ; GENERATED FROM 'RA ORDER EXAM' INPUT TEMPLATE(#1087), FILE 75.1;06/12/18
 D DE G BEGIN
...
C72F1 N X,X1,X2 S DIXR=1458 D C72X1(U) K X2 M X2=X D C72X1("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C75S S X="" G:DG(DQ)=X C75F1 K DB
 S X=DG(DQ),DIC=DIE
 S ^RAO(75.1,"AP",+$P(^RAO(75.1,DA,0),U),+$P(^(0),U,2),9999999.9999-$E(X,1,30),DA)=""
C75F1 N X,X1,X2 S DIXR=1458 D C75X1(U) K X2 M X2=X D C75X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^RAO(75.1,"BDD",$E(X,1,30),DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^RAO(75.1,"BDD",$E(X,1,30),DA)=""
...
C79S S X="" G:DG(DQ)=X C79F1 K DB
 S X=DG(DQ),DIC=DIE
 S ^RAO(75.1,"AP",+$P(^RAO(75.1,DA,0),U),+$P(^(0),U,2),9999999.9999-$E(X,1,30),DA)=""
C79F1 N X,X1,X2 S DIXR=1458 D C79X1(U) K X2 M X2=X D C79X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^RAO(75.1,"BDD",$E(X,1,30),DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^RAO(75.1,"BDD",$E(X,1,30),DA)=""
