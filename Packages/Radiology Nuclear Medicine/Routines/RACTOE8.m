RACTOE8 ; ;05/01/18
 D DE G BEGIN
DE S DIE="^RAO(75.1,D0,""T"",",DIC=DIE,DP=75.12,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^RAO(75.1,D0,"T",DA,""))=""
...
BEGIN S DNM="RACTOE8",DQ=1
1 S DW="0;2",DV="S",DU="",DIFLD=2,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RD:X="@",Z
X1 Q
2 S DW="0;3",DV="P200'",DU="",DIFLD=3,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="VA(200,"
 S X=DUZ
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
