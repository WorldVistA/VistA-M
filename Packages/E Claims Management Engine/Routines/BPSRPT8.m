BPSRPT8 ;BHAM ISC/BEE - ECME REPORTS ;14-FEB-05
 ;;1.0;E CLAIMS MGMT ENGINE;**1,3,5,7,8,10,11,19,20,23,24,28,41**;JUN 2004;Build 11
...
WRLINE2(BPRTYPE,BPREC,BPX,BPRX,BPREF,BPBIL,BPGRPLAN,BPPSEQ) ;
 ...
 I BPRTYPE=7 D  Q
 . N BPSDOS
 . S BPSDOS=$$GET1^DIQ(9002313.02,BP02,401)
 . S BPREC=BPREC_$E($$GRPID^BPSRPT2(+$P(BPX,U,3)),3,10)_U  ;Group ID
 . S BPREC=BPREC_$TR($J(BPBIL,10,2)," ")_U ;$Billed
 . S BPREC=BPREC_$E(BPSDOS,5,6)_"/"_$E(BPSDOS,7,8)_"/"_$E(BPSDOS,3,4)_U ;DOS
