BPSOSRX3 ;ALB/SS - ECME REQUESTS ;02-JAN-08
 ;;1.0;E CLAIMS MGMT ENGINE;**7,8,10,11,23,24,40,41**;JUN 2004;Build 11
...
MKRQST(BPREQTYP,KEY1,KEY2,MOREDATA,BPIENS78,BPCOBIND,BILLNDC,BPSKIP) ;
 ...
 I $G(MOREDATA("BPSPREG"))'="" I $$FILLFLDS^BPSUTIL2(9002313.77,"2.12",BPIEN77,$G(MOREDATA("BPSPREG")))<1 Q "0^"_$$ERRFIELD(BPIEN77,1,BPERRMSG,9002313.77,2.12)
