PXRMDLLB ;SLC/PJH - REMINDER DIALOG LOADER ;01/24/2017
 ;;2.0;CLINICAL REMINDERS;**6,12,16,26,47**;Feb 04, 2005;Build 289
 ;
 ;
...
MST(DFTYP,DFIEN) ;
 ...
 Q
 ;
REPLACE(DFN,TERMNODE,DITEM,DATA,TERMSTAT,FAIL) ;
 ...
 N TERMOUT
 S FAIL=0,TERMSTAT=1 I +$P(TERMNODE,U),$P($G(TERMNODE),U,2)'="" D  Q:+TERMSTAT=0
 .N DITEMO
 .S TERMOUT=$$TERM($P(TERMNODE,U),DFN,$G(DITEM),"D")
 .I TERMOUT=-1 S FAIL=1 D SENDMSG^PXRMORCH(DFN,"dialog",$P($G(^PXRMD(801.41,DIALOGIEN,0)),U),"term",$P(TERMNODE,U)) Q
