PXRMDTAX ; SLC/AGP - Reminder Dialog Taxonomy Field editor/List Manager ;Sep 04, 2025@08:42:29
 ;;2.0;CLINICAL REMINDERS;**26,47,65,87**;Feb 04, 2005;Build 35
 ;
 ; Reference to File ^LEX(757.5, in ICR #6224
 ;
 Q
...
CHECKER(DIEN,TIEN,FIELD,OUTPUT) ;
 N CNT,FAIL,NAME,NODE,RESULT,TAXSEL,TDX,TDXNODE,TNAME,TPR,TPRNODE,TSC,TSCNODE,TYPE
 S FAIL=""
...
TAXDISP(FIEN,SEQ,DIEN,NLINE,NODE,ADDFIND,ISMAIL) ;
 ...
 N CNT,DTXT,FNODE,RSUB,STR,TAXSEL,TDX,TNAME,TPAR,TPR,TYP
 N TCUR,TDTXT,TDHTXT,TEXT,THIS,TPTXT,TPHTXT,TSC
