PXRMOUTM ; SLC/PKR - MyHealtheVet output. ;05/14/2020
 ;;2.0;CLINICAL REMINDERS;**4,6,17,47,46**;Feb 04, 2005;Build 236
 ;
 ;================================================
...
MHVC(DEFARR,PXRMPDEM,PCLOGIC,RESLOGIC,RESDATE,FIEVAL) ;Prepare the 
 ...
 S ^TMP("PXRMMHVC",$J,RIEN,"FREQ")=^TMP("PXRHM",$J,RIEN,PNAME,"FREQ")
