PXRMEXPS ;SLC/PKR - Packing save routines. ;10/16/2019
 ;;2.0;CLINICAL REMINDERS;**12,16,18,22,24,26,45**;Feb 04, 2005;Build 566
 ;==========================================
...
SDIALOG(FILENUM,DIEN,PACKLIST) ;Reminder dialogs.
 ...
 ..I EVALITEM["811.9" D
 ... S ROUTINE=$$GETSRTN(811.9)_"(811.9,+EVALITEM,.PACKLIST)"
 ... D @ROUTINE
 .. I EVALITEM["811.5" D
