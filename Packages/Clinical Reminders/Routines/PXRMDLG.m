PXRMDLG ;SLC/PJH - Reminder Dialog Edit/Inquiry 09/27/2018
 ;;2.0;CLINICAL REMINDERS;**12,45**;Feb 04, 2005;Build 566
 ;
...
BUILD(INP) ;Build workfile (protocols PXRM DIALOG VIEW/LIST)
 ...
 ;5= DIALOG OVERVIEW
 ;6= DIALOG TEST
 ;7= DIALOG CHECKER - NO LISTMAN
 ;
 N DNAM,DNAME,VIEW
 S VIEW=INP,PXRMMODE=VIEW,VALMCNT=0,VALMBCK="R",PXRMDTST=0
 I VIEW=5 S VALMBG=1
 K ^TMP("PXRMDLG",$J),^TMP("PXRMDLG PROMPTS",$J)
 ;Headers
 ...
 I VIEW=6 D EN^PXRMDLG7,XQORM Q
 ;Build Listman array
 D ARRAY(PXRMDIEN)
 Q
 ;
