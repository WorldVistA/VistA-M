ONCACDU1 ;Hines OIFO/GWB - NAACCR extract utilities #1 ;05/08/12
 ;;2.11;Oncology;**12,14,16,20,21,22,24,26,27,28,33,36,37,42,45,46,49,51,56,57**;Mar 07, 1995;Build 6
 ;rvd - p56
...
BEHAV(IEN) ;Behavior Code (called by extract RULES)
 ...
 Q BEHAV
 ;
ICD9(ACD160,ONIEN) ;COMOR/COMP 1-10, for ICD9
 N ONCDANS
 S ONCDANS=$$GET1^DIQ(160,ACD160,ONIEN,"I")
 S:ONCDANS'="" ONCDANS=$$GET1^DIQ(80,ONCDANS,.01,"I")
 S ONCDANS=$P(ONCDANS,".",1)_$P(ONCDANS,".",2)
 I $D(^XPD(9.7,"B","ICD*18.0*57")) S ONCDANS=""
 Q ONCDANS
 ;
ICD10(ACD160,ONIEN) ;SECONDARY DIAGNOSIS 1-10, ICD10 installed
 N ONCDANS
 S ONCDANS=$$GET1^DIQ(160,ACD160,ONIEN,"I")
 S:ONCDANS'="" ONCDANS=$$GET1^DIQ(80,ONCDANS,.01,"I")
 S ONCDANS=$P(ONCDANS,".",1)_$P(ONCDANS,".",2)
