ONCPAT ;HINES OIFO/GWB - PATIENT IDENTIFICATION ;10/07/11
 ...
 S DR(1,160,20)="W !,""    RACE 3.....................: No additional races (Race 2 - Race 5)"""
 S DR(1,160,21)="W !,""    RACE 4.....................: No additional races (Race 2 - Race 5)"""
 S DR(1,160,22)="W !,""    RACE 5.....................: No additional races (Race 2 - Race 5)"""
 S DR(1,160,23)="S Y=9"
 S DR(1,160,24)="@8299"
 ...
 S DR(1,160,46)="W !,""    RACE 4.....................: No additional races (Race 2 - Race 5)"""
 S DR(1,160,47)="W !,""    RACE 5.....................: No additional races (Race 2 - Race 5)"""
 S DR(1,160,48)="S Y=9"
 S DR(1,160,49)="@8399"
 ...
 S DR(1,160,66)="W !,""    RACE 5.....................: No additional races (Race 2 - Race 5)"""
 S DR(1,160,67)="S Y=9"
 S DR(1,160,68)="@8499"
 ...
 S DR(1,160,81)="50    EXPOSURE IONIZING RADIATION//^S X=IRE"
 S DR(1,160,82)="52    EXPOSURE CHEMICAL..........//^S X=CEX"
 S DR(1,160,83)="61    EXPOSURE ASBESTOS..........//^S X=AEX"
 S DR(1,160,83.1)="72    EXPOSURE BURN PIT..........//^S X=BPE"
 S DR(1,160,83.2)="73    EXPOSURE OTHER TOXIC.......//^S X=OTE"
 ...
 S DR(1,160,246)="@999"
 D ^DIE
 K AOE,DIE,DR,IRE,GSI,LSI,OEF,OIF,PGS,PSI,SSI,VSI,YSI,ONCSDPMT,CEX,AEX,BPE,OTE
 Q
 ;
CLEANUP ;Cleanup
 K ONCOD0
