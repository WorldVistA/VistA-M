ONCEDIT ;Hines OIFO/GWB - Inter-field edits ;12/06/10
 ;;2.11;ONCOLOGY;**27,28,34,36,39,42,43,45,46,47,49,50,51,52**;Mar 07, 1995;Build 13
 ;
...
PHCSEQ S SEQ=$$GET1^DIQ(165.5,PRM,.06,"I")
 ...
 I PHC="No",SEQ'="00" D  D ERRMSG
 .S MSG(1)="OTHER CANCER = "_PHC
 .S MSG(2)="SEQUENCE NUMBER = "_SEQ
 .S MSG(3)="SEQUENCE NUMBER must be 00"
 K SEQ,PHC,MSG
 ;
 G ^ONCEDIT2
 ;
