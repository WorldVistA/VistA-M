ONCOAIP ;HINES OIFO/GWB - [EE Abstract Edit Primary] ;09/26/11
 ;;2.2;ONCOLOGY;**1,4,5,6,10,15,16,20,21,22**;Jul 31, 2013;Build 6
...
MEN ;Primary Menu Options
 ...
 ;
 ; Patch 21 - Stuff Reporting Facility (.03) and Type of Reporting
 ;  Source (1.2) and don't allow editing (fields .03 and 1.2 removed
 ;  from [ONC ABSTRACT])
 ; Patch 22 - Remove/change back for Reporting Facility based on
 ;  whether COC Accredited in Site Params
 S $P(^ONCO(165.5,D0,0),"^",3)=IIN  ;Patch 22 remove above
...
NTX ;DATE OF NO TREATMENT (165.5,124)
 ...
 I (NTDD="")!(NTDD="0000000")!(NTDD=9999999) S Y=138.4 Q
 ;I $P($G(^ONCO(165.5,D0,2.1)),U,11)="" S Y=138.4 Q
 K NTDD
 W !!?5,"You have entered a DATE OF NO TREATMENT.  Relevant treatment"
 W !?5,"fields will be stuffed with the appropriate value indicating no"
 W !?5,"treatment.",!
