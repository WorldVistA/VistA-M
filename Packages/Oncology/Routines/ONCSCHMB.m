ONCSCHMB ;HINES OIFO/RTK - Schema derivation, related code continued ;05/09/18
 ;;2.2;ONCOLOGY;**10,12,18,22**;Jul 31, 2013;Build 6
 ;
 ...
 ;
 ;LUNG: <2025 -- C340-C343,C348-C349 H8000-8700,8720-8790,8972,8980,9700,9701
 ;  for 2025+ -- C340-C343,C348-C349 H8000-8700,8720-8790,8972,8980,8982
 I (ONCTPCD="C340")!(ONCTPCD="C341")!(ONCTPCD="C342")!(ONCTPCD="C343")!(ONCTPCD="C348")!(ONCTPCD="C349") D  I ONCSCMA'=0 Q
 .I $P($G(^ONCO(165.5,D0,0)),U,16)<3250000 I ((HST14>7999)&(HST14<8701))!((HST14>8719)&(HST14<8791))!(HST14=8972)!(HST14=8980)!(HST14=9700)!(HST14=9701) S ONCSCMA="00360"
 .I $P($G(^ONCO(165.5,D0,0)),U,16)>3241231 I ((HST14>7999)&(HST14<8701))!((HST14>8719)&(HST14<8791))!(HST14=8972)!(HST14=8980)!(HST14=8982) S ONCSCMA="09360"
 ;
