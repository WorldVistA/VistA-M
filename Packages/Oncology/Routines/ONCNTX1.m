ONCNTX1 ;HINES OIFO/GWB - No treatment stuffing ;09/09/10
 ;;2.2;ONCOLOGY;**1,5,15,20,21,22**;Jul 31, 2013;Build 6
 ;
...
SURATF ;SURGERY OF PRIMARY @FAC (F) (165.5,58.7)
 ...
 .I (TOPSRCDZ=67180)!(TOPSRCDZ=67250)!(TOPSRCDZ=67340)!(TOPSRCDZ=67440)!(TOPSRCDZ=67500)!(TOPSRCDZ=67739) S $P(^ONCO(165.5,DA,3.2),U,8)="B000"
 .I (TOPSRCDZ=67420)!(TOPSRCDZ=67760) S $P(^ONCO(165.5,DA,3.2),U,8)="A980"
 .Q
