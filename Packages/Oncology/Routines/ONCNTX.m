ONCNTX ;HINES OIFO/GWB - No treatment stuffing ;03/31/11
 ;;2.2;ONCOLOGY;**1,6,10,15,20,21,22**;Jul 31, 2013;Build 6
 ;
...
SUR ;SURGERY OF PRIMARY (F) (165.5,58.6)
 ...
 .I (TOPSRCDZ=67180)!(TOPSRCDZ=67250)!(TOPSRCDZ=67340)!(TOPSRCDZ=67440)!(TOPSRCDZ=67500)!(TOPSRCDZ=67739) S $P(^ONCO(165.5,DA,3.2),U,9)="B000"
 .I (TOPSRCDZ=67420)!(TOPSRCDZ=67760) S $P(^ONCO(165.5,DA,3.2),U,9)="A980"
 .Q
