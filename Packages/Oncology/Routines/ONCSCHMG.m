ONCSCHMG ;HINES OIFO/RTK - Grade, Discriminator, Stage Help and Utlts ;06/11/18
 ;;2.2;ONCOLOGY;**10,12,13,14,20,21**;Jul 31, 2013;Build 6
 ;
 ;
...
AJCCHP ;Help for AJCC TNM fields (Clin, Path, Post Therapy)
 ...
 W !?5,"Chapter Name: ",$E($P($G(^ONCO(165.8,ONCAJIEN,0)),U,2),1,75)
...
GTAJIEN ;Utility to get AJIEN, AJCC ID, AJCC CHAPTER
 ...
 D AJCCV9^ONCSCHMN S $P(^ONCO(165.5,D0,"AJCC8"),U,1)=ONCAJID  ;check V9 (9xxx)
 D CHKAJID^ONCSCHMX S $P(^ONCO(165.5,D0,"AJCC8"),U,1)=ONCAJID  ;check "XX"
