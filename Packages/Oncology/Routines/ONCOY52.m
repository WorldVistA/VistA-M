ONCOY52 ; GENERATED FROM 'ONCOY52' PRINT TEMPLATE (#862) ; 09/06/11 ; (FILE 165.5, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 D N:$X>34 Q:'DN  W ?34 N DIERR X DXS(5,9.2) X "F %=2:1:$L(X) I $E(X,%)?1U,$E(X,%-1)?1A S X=$E(X,0,%-1)_$C($A(X,%)+32)_$E(X,%+1,999)" K DIP K:DN Y W X
