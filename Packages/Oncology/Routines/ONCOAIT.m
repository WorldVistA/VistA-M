ONCOAIT ;HINES OIFO/GWB - Topography functions, Comorbidity List, SEER; 8/05/10
 ;;2.2;ONCOLOGY;**1,4,6,12,18,22**;Jul 31, 2013;Build 6
...
NCST(ACDANS,ONCPHI) ;Comorbidity extract, p2.2*4
 ...
 I $G(ONCPHI)'=1 S:ACDANS'="" ACDANS=$$GET1^DIQ(80,ACDANS,.01,"I") S ACDANS=$P(ACDANS,".",1)_$P(ACDANS,".",2) S:ACDANS'="" ACDANS=ACDANS_$E("00000",1,(5-$L(ACDANS))) Q ACDANS
 ...
 K ^TMP($J,"ONCOMO")
 S:ACDANS'="" ACDANS=ACDANS_$E("00000",1,(5-$L(ACDANS))) Q ACDANS
 ;
