...
FORDS ;Surgical Procedures (FORDS)
 ...
 N DI,DIC,DR,DA,DIQ K ONC
 S DIC="^ONCO(165.5,"
 S DR="50;58.6;50.3;58.7;58.8;58.9;59;138:138.5;139:139.7;435;14;58;23;74;58.2;50.2;140;140.1;170;46;47;234"
 S DA=D0,DIQ="ONC(" D EN^DIQ1
 F I=58.6,58.7,58.8,58.9,59,138,138.1,138.4,138.5,139,139.1,139.4,139.5,139.6,435,14,58,23,74,58.2,50.2,140,140.1,234,46,47 S X=ONC(165.5,D0,I) D UCASE S ONC(165.5,D0,I)=X
 D FST^ONCOAIP
 ;W !," SURGICAL PROCEDURES (FORDS)"
 ;W !," ---------------------------"
 S TXT=ONC(165.5,D0,58.6),LEN=38 D TXT
 W:DATEDX<3230000 !," RX Summ Surg Primsite 03-2022: ",$E(ONC(165.5,D0,50),1,6)_$E(ONC(165.5,D0,50),9,10),?41,TXT1
 I DATEDX<3230000 W:TXT2'="" !?41,TXT2
 S TXT=ONC(165.5,D0,58.7),LEN=38 D TXT
 W:DATEDX<3230000 !," RX Hosp Surg Primsite 03-2022: ",$E(ONC(165.5,D0,50.3),1,6)_$E(ONC(165.5,D0,50.3),9,10),?41,TXT1
 I DATEDX<3230000 W:TXT2'="" !?41,TXT2
 S TXT=ONC(165.5,D0,58.9),LEN=38 D TXT
 W:DATEDX>3221231 !," RX Summ Surg Prim Site 2023..: ",$E(ONC(165.5,D0,50),1,6)_$E(ONC(165.5,D0,50),9,10),?41,TXT1
 I DATEDX>3221231 W:TXT2'="" !?41,TXT2
 S TXT=ONC(165.5,D0,58.8),LEN=38 D TXT
 W:DATEDX>3221231 !," RX Hosp Surg Prim Site 2023..: ",$E(ONC(165.5,D0,50.3),1,6)_$E(ONC(165.5,D0,50.3),9,10),?41,TXT1
 I DATEDX>3221231 W:TXT2'="" !?41,TXT2
