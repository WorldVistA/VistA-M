ONCOXU ; GENERATED FROM 'ONCO XABSTRACT RECORD' PRINT TEMPLATE (#826) ; 01/20/16 ; (FILE 165.5, MARGIN=80)
 G BEGIN
N W !
...
A1 ;
 ...
 D N:$X>33 Q:'DN  W ?33 S Y=$P(X,U,3) S Y(0)=Y S X=Y D SDOT^ONCFUNC W $E(Y,1,30)
 Q
A1R ;
