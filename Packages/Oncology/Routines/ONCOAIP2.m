ONCOAIP2 ;HINES OIFO/GWB,RTK - ONCO ABSTRACT-I SUB-ROUTINES ;04/12/01
 ;;2.2;ONCOLOGY;**1,4,5,6,10,12,13,17,22**;Jul 31, 2013;Build 6
 ;
...
BLOOD ;PERIPHERAL BLOOD INVOLVEMENT (165.5,30.5)
 ...
 Q
 ;
COCACC() ;CHECK IF USER AT COC ACCREDITED FACILITY
 N OSP,COCACC,ISACC
 S OSP=$O(^ONCO(160.1,"C",DUZ(2),0))
 I OSP="" S OSP=$O(^ONCO(160.1,0))
 S COCACC=$P($G(^ONCO(160.1,OSP,7)),U,2)
 S ISACC=$S(COCACC="01":1,1:0)
 Q ISACC
 ;
