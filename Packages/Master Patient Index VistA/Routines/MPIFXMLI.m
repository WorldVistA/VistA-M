MPIFXMLI ;ALB/CKN - MPIF IMPLICIT/EXPLICIT ADD ; 9/6/19 5:05pm
 ;;1.0;MASTER PATIENT INDEX VISTA;**61,71,73**;30 Apr 99;Build 1
 ;
...
XMLBLD(MPIARR) ; setup xml for explicit Add
 ...
 S QUOTE="""",ADDTYPE=$S(MPIARR("AddType")="Explicit":"ADD ICN OVERRIDE",MPIARR("AddType")="ADDPREFTF":"ADDPREFTF",1:"ADD ICN")  ;Setting add type on implicit or explicit flag
 M PATARR=MPIARR(1)
 I $G(PATARR("AddType"))="ADDPREFTF" S PATARR("DFN")="PROXY_VISTA"
 ...
 S MPITHRES=80
 ;
 I $G(PATARR("AddType"))="ADDPREFTF" S MPIXML="<IDM_REQUEST type="_QUOTE_"ADDPREFTF"_QUOTE_"><METADATA>"
 I $G(PATARR("AddType"))'="ADDPREFTF" S MPIXML="<IDM_REQUEST type="_QUOTE_"ADD_PROFILE"_QUOTE_"><METADATA>"
 ...
 I $G(PATARR("AddType"))'="ADDPREFTF" S MPIXML=MPIXML_"<ARGUMENT name="_QUOTE_"ACTIVEPROFILE"_QUOTE_"><PROFILE>"
 I $G(PATARR("AddType"))="ADDPREFTF" S MPIXML=MPIXML_"<ARGUMENT name="_QUOTE_"PROFILE"_QUOTE_"><PROFILE>" S MPIXML=MPIXML_"<IDENTIFIER type='NI'><ID>"_$G(PATARR("ICN"))_"</ID></IDENTIFIER>"
 ;Name Traits
 ...
 I $G(PATARR("AddType"))="ADDPREFTF" S MPIXML=MPIXML_"<SOURCE>"_PATARR("preferredFacilityNumber")_"</SOURCE><ISSUER>USVHA</ISSUER></IDENTIFIER>"
 I $G(PATARR("AddType"))'="ADDPREFTF" S MPIXML=MPIXML_"<SOURCE>"_MPISITE_"</SOURCE><ISSUER>USVHA</ISSUER></IDENTIFIER>"
 I $G(PATARR("SSN"))'="" D
 ...
 I $G(PATARR("AddType"))="ADDPREFTF" D
