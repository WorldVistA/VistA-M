MPIFWSC ;ALB/CMC - MPIF HEALTHEVET WEB SERVICES CLIENT TOOLS ; 5/26/16 1:23pm
 ;;1.0;MASTER PATIENT INDEX VISTA;**63,70**;30 Apr 99;Build 1
...
CHANGE(RETURN,USER,PASS,SWITCH,SERV,PORT) ; **70 STORY 864667 adding new parameters
 ...
 .N MPIFERR,FDA,IEN S IEN=$O(^XOB(18.12,"B","MPI_PSIM_NEW EXECUTE",""))
 .S FDA(18.12,IEN_",",.04)=SERV D FILE^DIE("E","FDA","MPIFERR") I $D(MPIERR("DIERR")) S RETURN(4)="-1^ERROR SETTING NEW SERVER" Q
 I $G(PORT)'="" D
 .S RETURN(5)="1^SUCCESS SSL PORT"
 .N MPIFERR,FDA,IEN S IEN=$O(^XOB(18.12,"B","MPI_PSIM_NEW EXECUTE",""))
 .S FDA(18.12,IEN_",",3.03)=PORT D FILE^DIE("E","FDA","MPIFERR") I $D(MPIERR("DIERR")) S RETURN(5)="-1^ERROR SETTING NEW SSL PORT" Q
 Q
