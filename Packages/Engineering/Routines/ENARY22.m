ENARX22 ;(WASH ISC)/SAW-2162 Archive ;7-19-93
 ...
 D DT^DICRW K ^UTILITY(U,$J),^UTILITY("DIK",$J) D WAIT^DICD F R=1001:1:1003 D @("^ENARX2"_$E(R,3,4)) W "."
 F D=6919.2,6919.21,6919.22,6919.23,6919.24 D IX
