PRCST4 ; GENERATED FROM 'PRCSEN2237S' INPUT TEMPLATE(#609), FILE 410;10/27/00
 D DE G BEGIN
...
BEGIN S DNM="PRCST4",DQ=1
 N DIEZTMP,DIEZAR,DIEZRXR,DIIENS,DIXR K DIEFIRE,DIEBADK S DIEZTMP=$$GETTMP^DIKC1("DIEZ")
 M DIEZAR=^DIE(609,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=609,U="^"
