...
V ;;5.1;IFCAP;**108,156,192,208,250**;Oct 20, 2000;Build 3
 ...
 ;
 ;PRC*5.1*250 Modify $10000 limit to be $15000 for micro-purchase threshold 
...
START1 ;
 ...
 I $P($G(^PRCS(410,DA,4)),U)>15000 W !,"The dollar amount for this transaction exceeds the $15000 purchase card cutoff." H 4 Q    ;PRC*5.1*208, PRC*5.1*250
