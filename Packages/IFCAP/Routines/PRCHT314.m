...
X9 I PRCHTOT>$P(^PRC(442,PRCHDA1,2,PRCHDA,0),U,2) W *7,!,"Total quantity for the delivery schedules exceeds the purchase order quantity" S Y="@9"
 Q
...
X12 W *7,!,"Delivery Schedule DELETED!!",!
 Q
13 D:$D(DG)>9 F^DIE17 G ^PRCHT315
