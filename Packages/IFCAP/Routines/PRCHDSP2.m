PRCHDSP2 ;TKW/BOISE,ID/RSD,WISC/AKS-DISPLAY AMENDMENT ;2/12/98  2:46 PM
V ;;5.1;IFCAP;;Oct 20, 2000
 ;Per VHA Directive 10-93-142, this routine should not be modified.
 ;THIS WILL DISPLAY UNOBLIGATED DATA FROM FILES 443.6 AND 441.7 ONLY
 N %X,%Y,DIWF,DIWL,DIWR,I,J,P,PRCH0,PRCH1,PRCHAV,PRCHP0,PRCHP1,PRCHPG,PRCHPGT,PRCHUL,X,Y,PRCHREPR,PRCHTPG,PRCHTYP,PRCHX,Z,PRCHDY,SITE
 S D0=$S($D(PRCHPO):PRCHPO,1:D0),D1=$S($D(PRCHAM):PRCHAM,1:D1)
 S U="^" Q:'$D(^PRC(443.6,D0,6,D1))  S PRCH0=^(D1,0),PRCH1=^(1),PRCHAV=$S($P(PRCH0,U,8)="Y":1,1:0),PRCHP0=^PRC(443.6,D0,0),PRCHP1=^(1),PRC("SITE")=$P(+PRCHP0,"-",1),PRCHUL="",$P(PRCHUL,"_",80)=""
