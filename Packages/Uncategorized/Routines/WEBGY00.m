WEBGY00 ;SLC/SRM - Post-init for patch WEBG*1.0*0 ;3/5/19  15:49
 ;;1.0;WEB VISTA REMOTE ACCESS MANAGEMENT;;Mar 05, 2019;Build 5
 ;
...
BSESETUP(APCODE,APNAME,APIP,APPORT,APPATH,APCONTEXT) ;
 ...
 I +$$DELBSE(APCODE,APNAME) D  Q $$SAVEBSE(APCODE,APNAME,APIP,APPORT,APPATH,APCONTEXT)
