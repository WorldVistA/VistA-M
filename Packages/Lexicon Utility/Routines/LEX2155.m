LEX2155 ;ISL/TJH - LEX*2.0*155 Env Check ; 09/09/2025
 ;;2.0;LEXICON UTILITY;**155**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*154 SEQ #145^3250625^CODE SET FY25 4TH QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
  ;     This Build Name
 S LEXBUILD="LEX*2.0*155"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_155.GBL"
 ;     Fiscal Year
 S LEXFY="FY26"
 ;     Quarter
 S LEXQTR="1st"
