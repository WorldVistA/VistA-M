LEX2112 ;ISL/KER - LEX*2.0*112 Env Check ;07/10/2017
 ;;2.0;LEXICON UTILITY;**112**;Sep 23, 1996;Build 3
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*111 SEQ #101^3170522^Code Set FY17 3rd Qtr"
 S LEXREQP(2)="LEX*2.0*103 SEQ #102^^Lexicon API/DD Updates"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*112"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_112.GBL"
 ;     Fiscal Year
 S LEXFY="FY17"
 ;     Quarter
 S LEXQTR="4th"
