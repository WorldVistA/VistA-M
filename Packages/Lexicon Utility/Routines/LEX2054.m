LEX2054 ;ISL/KER - LEX*2.0*54 Env Check ;06/06/2007
 ...
 ;              
ENV ; LEX*2.0*54 Environment Check
 ;                    
 ;   General
 ;
...
ABRT ;     Abort  Failed Environment Check, KILL the distribution
 D:$D(LEXE) ED S XPDABORT=1,XPDQUIT=1,XPDQUIT("LEX*2.0*54")=1
 K LEXE,LEXFULL
 Q
 ;               
 ; Checks
...
IMP ;   Import names
 ...
 S LEXLREV=54
 ;     Required Builds
 S LEXREQP="LEX*2.0*52"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*54"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_54.GBL"
 ;     Fiscal Year
 S LEXFY="FY08"
 ;     Quarter
 S LEXQTR="2nd"
