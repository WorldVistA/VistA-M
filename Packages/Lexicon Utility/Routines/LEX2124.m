LEX2124 ;ISL/TJH - LEX*2.0*124 Env Check ;11/16/2019
 ;;2.0;LEXICON UTILITY;**124**;Sep 23, 1996;Build 5
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*123 SEQ #114^3190923^CODE SET FY20 1ST QTR UPDATE"  ;seq # from FORUM
 ;     This Build Name
 S LEXBUILD="LEX*2.0*124"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_124.GBL"
 ;     Fiscal Year
 S LEXFY="FY20"
 ;     Quarter
 S LEXQTR="2nd"
