LEX2084 ;ISL/KER - LEX*2.0*84 Env Check ;09/10/2012
 ;;2.0;LEXICON UTILITY;**84**;Sep 23, 1996;Build 1
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*83^3120808^Code Set FY12 4th Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*84"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_84.GBL"
 ;     Fiscal Year
 S LEXFY="FY13"
 ;     Quarter
 S LEXQTR="1st"
