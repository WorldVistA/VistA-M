LEX2115 ;ISL/CED - LEX*2.0*115 Env Check ;09/13/2017
 ;;2.0;LEXICON UTILITY;**115**;Sep 23, 1996;Build 2
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*113 SEQ #104^3051017^Code Set FY18 1st Qtr Update"
 ; S LEXREQP(2)="LEX*2.0*103 SEQ #102^^Lexicon API/DD Updates"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*115"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_115.GBL"
 ;     Fiscal Year
 S LEXFY="FY18"
 ;     Quarter
 S LEXQTR="1st"
