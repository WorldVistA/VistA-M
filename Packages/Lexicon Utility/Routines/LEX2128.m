LEX2128 ;ISL/TJH - LEX*2.0*128 Env Check ;05/28/2020
 ;;2.0;LEXICON UTILITY;**128**;Sep 23, 1996;Build 3
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*127 SEQ #118^3200512^CODE SET FY20 3RD QTR INTERIM DATA UPDATE & API DEFECT REPAIR:COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*128"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_128.GBL"
 ;     Fiscal Year
 S LEXFY="FY20"
 ;     Quarter
 S LEXQTR="4th"
