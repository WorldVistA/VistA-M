LEX2153 ;ISL/TJH - LEX*2.0*153 Env Check ; 03/18/2025
 ;;2.0;LEXICON UTILITY;**153**;Sep 23, 1996;Build 2
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*152 SEQ #143^3241223^CODE SET FY25 2ND QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*153"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_153.GBL"
 ;     Fiscal Year
 S LEXFY="FY25"
 ;     Quarter
 S LEXQTR="3rd"
