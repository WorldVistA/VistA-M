LEX2105 ;ISL/KER - LEX*2.0*105 Env Check ;02/25/2016
 ;;2.0;LEXICON UTILITY;**105**;Sep 23, 1996;Build 4
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
GBLS ;   Check Write access on globals
 ...
 . D M(("      "_LEXRT_LEXB1_LEXT_LEXB2_LEXF)) S @LEXGBL=$G(@LEXGBL)
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*104 SEQ #94^3151229^Code Set FY16 2nd Qtr"
 S LEXREQP(2)="ICD*18.0*82 SEQ #77^3160218^FY16 ICD-10 Annual DRG Upd"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*105"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_105.GBL"
 ;     Fiscal Year
 S LEXFY="FY16"
 ;     Quarter
 S LEXQTR="3rd"
