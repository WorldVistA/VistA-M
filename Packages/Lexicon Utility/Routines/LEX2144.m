LEX2144 ;ISL/TJH - LEX*2.0*144 Env Check ; 05/18/2023
 ;;2.0;LEXICON UTILITY;**144**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*143 SEQ #134^3230327^CODE SET FY23 3RD QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*144"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_144.GBL"
 ;     Fiscal Year
 S LEXFY="FY23"
 ;     Quarter
 S LEXQTR="4th"
