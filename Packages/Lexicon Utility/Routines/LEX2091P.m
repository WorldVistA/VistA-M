LEX2091P ;ISL/KER - LEX*2.0*91 Pre/Post Install ;06/06/2013
 ;;2.0;LEXICON UTILITY;**91**;Sep 23, 1996;Build 1
 ;               
 ; Global Variables 
 ;    ^LEXM(              N/A
 ;               
...
CON ; Conversion of data
 ...
 S $P(^DIC(81.1,5,0),"^",1)="PATHOLOGY AND LABORATORY"
 N DA,DIK S DA=5,DIK="^DIC(81.1," D IX1^DIK
 N DA,DIK S DA=194,DIK="^DIC(81.1," D IX2^DIK
 S $P(^DIC(81.1,194,0),"^",1)="LABORATORY SERVICES"
