LEX2094 ;ISL/KER - LEX*2.0*94 Env Check ;12/09/2013
 ;;2.0;LEXICON UTILITY;**94**;Sep 23, 1996;Build 5
 ;               
 ; Global Variables 
 ;    ^LEXM               N/A
 ;               
...
ENV ; Environment Check
 ...
 ; ICD-10
 ; N LEXOK,LEXG,LEXR,LEXB S (LEXOK,LEXG,LEXR,LEXB)=1
 ; S:$$PATCH^XPDUTL("LEX*2.0*80")>0 LEXOK=0,LEXG=0,LEXB=0
 ; S:$L($G(^ICD9(2,0)),"^")'>1 LEXOK=0,LEXG=0
 ; S:$D(^LEX(757.03,1,2)) LEXOK=0,LEXG=0
 ; S:$L($T(^ICD0IDX))'>0 LEXOK=0,LEXR=0
 ; S:$P($T(LEXAS+1^LEXAS),";",5)["," LEXOK=0,LEXR=0
 ; S:$D(^ICD9(500001,0)) LEXOK=0,LEXG=0 I 'LEXOK D  D ABRT Q
 ;. I LEXR'>0,LEXG'>0 D
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*93 SEQ #82^3131021^Code Set FY14 1st Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*94"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_94.GBL"
 ;     Fiscal Year
 S LEXFY="FY14"
 ;     Quarter
 S LEXQTR="2nd"
