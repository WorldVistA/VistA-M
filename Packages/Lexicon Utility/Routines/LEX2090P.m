LEX2090P ;ISL/KER - LEX*2.0*90 Pre/Post Install ;12/29/2012
 ;;2.0;LEXICON UTILITY;**90**;Sep 23, 1996;Build 7
 ;               
 ; Global Variables 
 ;    ^LEXM(              N/A
 ;               
...
CON ; Conversion of data
 N DA,DIK S DA=5,DIK="^DIC(81.1," D IX2^DIK
 S ^DIC(81.1,5,0)="PATHOLOGY AND LABORATORY^m^^80047^89398^C"
 N DA,DIK S DA=5,DIK="^DIC(81.1," D IX1^DIK
 N DA,DIK S DA=194,DIK="^DIC(81.1," D IX2^DIK
 S ^DIC(81.1,194,0)="PATHOLOGY AND LABORATORY SERVICES^s^^P0000^P9999^H"
 N DA,DIK S DA=194,DIK="^DIC(81.1," D IX1^DIK
 Q
 ;            
 ; Miscellaneous
PIEN(X) ;   Package IEN
