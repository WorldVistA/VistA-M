LEX2118 ;ISL/CED - LEX*2.0*118 Env Check ;04/26/2018
 ;;2.0;LEXICON UTILITY;**118**;Sep 23, 1996;Build 7
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*117 SEQ #108^3180412^Code Set FY18 3rd Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*118"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_118.GBL"
 ;     Fiscal Year
 S LEXFY="FY18"
 ;     Quarter
 S LEXQTR="4th"
