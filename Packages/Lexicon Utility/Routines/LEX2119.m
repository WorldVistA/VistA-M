LEX2119 ;ISL/CED - LEX*2.0*119 Env Check ;07/16/2018
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*118 SEQ #109^3180627^Code Set FY18 4rd Qtr"  ;seq # from FORUM
 ;     This Build Name
 S LEXBUILD="LEX*2.0*119"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_119.GBL"
 ;     Fiscal Year
 S LEXFY="FY19"
 ;     Quarter
 S LEXQTR="1st"
