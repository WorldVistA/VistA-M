LEX2143 ;ISL/TJH - LEX*2.0*143 Env Check ; 02/19/2023
 ;;2.0;LEXICON UTILITY;**143**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*142 SEQ #133^3221220^CODE SET FY23 2ND QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*143"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_143.GBL"
 ;     Fiscal Year
 S LEXFY="FY23"
 ;     Quarter
 S LEXQTR="3rd"
