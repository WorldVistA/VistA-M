LEX2104 ;ISL/KER - LEX*2.0*104 Env Check ;11/24/2015
 ;;2.0;LEXICON UTILITY;**104**;Sep 23, 1996;Build 1
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*101 SEQ #93^3150930^Code Set FY16 1st Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*104"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_104.GBL"
 ;     Fiscal Year
 S LEXFY="FY16"
 ;     Quarter
 S LEXQTR="2nd"
