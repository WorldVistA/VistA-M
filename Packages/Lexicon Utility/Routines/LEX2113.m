LEX2113 ;ISL/CED - LEX*2.0*113 Env Check ;08/28/2017
 ;;2.0;LEXICON UTILITY;**113**;Sep 23, 1996;Build 4
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*112 SEQ #103^3170817^Code Set FY17 4th Qtr"
 ; S LEXREQP(2)="LEX*2.0*103 SEQ #102^^Lexicon API/DD Updates"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*113"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_113.GBL"
 ;     Fiscal Year
 S LEXFY="FY18"
 ;     Quarter
 S LEXQTR="1st"
