LEX2129 ;ISL/TJH - LEX*2.0*129 Env Check ;08/20/2020
 ;;2.0;LEXICON UTILITY;**129**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*128 SEQ #119^3200616^CODE SET FY20 4TH QTR UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*129"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_129.GBL"
 ;     Fiscal Year
 S LEXFY="FY21"
 ;     Quarter
 S LEXQTR="1st"
