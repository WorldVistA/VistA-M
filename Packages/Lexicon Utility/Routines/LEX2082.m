LEX2082 ;ISL/KER - LEX*2.0*82 Env Check ;04/12/2012
 ;;2.0;LEXICON UTILITY;**82**;Sep 23, 1996;Build 2
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*79^3120111^Code Set FY12 2nd Qtr"
 S LEXREQP(2)="LEX*2.0*81^3120214^AWRD Index/Code Fix"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*82"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_82.GBL"
 ;     Fiscal Year
 S LEXFY="FY12"
 ;     Quarter
 S LEXQTR="3rd"
