LEX2061P ;ISL/KER - LEX*2.0*61 Pre/Post Install ;06/06/2007
 ;;2.0;LEXICON UTILITY;**61**;Sep 23, 1996;Build 1
 ;              
...
POST ; LEX*2.0*61 Post-Install
 ...
 ;            
 N LEXEDT,LEXPTYPE,LEXLREV,LEXREQP,LEXBUILD,LEXIGHF,LEXFY,LEXQTR,LEXB,LEXCD,LEXSTR,LEXLAST D IMP^LEX2061
...
KLEXM ; Subscripted Kill of ^LEXM
 ...
 Q
 ;            
PRE ; LEX*2.0*61 Pre-Install   (N/A for patch 61)
 Q
 ;            
CON ; Conversion of data       (N/A for patch 61)
 Q
