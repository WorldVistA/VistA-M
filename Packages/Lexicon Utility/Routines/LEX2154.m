LEX2154 ;ISL/TJH - LEX*2.0*154 Env Check ; 06/09/2025
 ;;2.0;LEXICON UTILITY;**154**;Sep 23, 1996;Build 7
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
 ...
 ;     accompany this patch.  It consists of a patch name 
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*153 SEQ #144^3250331^CODE SET FY25 3RD QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*154"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_154.GBL"
 ;     Fiscal Year
 S LEXFY="FY25"
 ;     Quarter
 S LEXQTR="4th"
