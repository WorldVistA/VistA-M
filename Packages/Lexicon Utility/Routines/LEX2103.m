...
IMP ;   Import names
 ...
 S LEXPTYPE="Lexicon Defect/DD Fixes"
 ;     Revision
 S LEXLREV=103
 ;     Required Builds Array
 ;        LEX(1)=build SEQ #^released date^subject
 ;        LEX(n)=build SEQ #^released date^subject
 S LEXREQP(1)="LEX*2.0*86 SEQ #90^3150225^Data Dictionary/APIs Fixes"
 S LEXREQP(2)="LEX*2.0*111 SEQ #101^3170522^Code Set FY17 3rd Qtr"
 S LEXREQP(3)="DI*22.2*3 SEQ #2^3161011^VA FileMan 22.2 Defects"
 ;     This Build Name
