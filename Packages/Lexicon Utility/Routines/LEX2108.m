LEX2108 ;ISL/KER - LEX*2.0*108 Env Check ;09/06/2016
 ;;2.0;LEXICON UTILITY;**108**;Sep 23, 1996;Build 2
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*107 SEQ #97^3160701^Code Set FY16 4th Qtr"
 S LEXREQP(2)="ICD*18.0*82 SEQ #77^3160218^FY2016 Annual DRG Update"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*108"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_108.GBL"
 ;     Fiscal Year
 S LEXFY="FY17"
 ;     Quarter
 S LEXQTR="1st"
