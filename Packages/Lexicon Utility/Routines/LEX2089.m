LEX2089 ;ISL/KER - LEX*2.0*89 Env Check ;12/29/2012
...
IMP ;   Import names
 ...
 ;        LEX(1)=build^released date^subject
 ;        LEX(n)=build^released date^subject
 S LEXREQP(1)="LEX*2.0*84 SEQ #76^3121026^Code Set FY13 1st Qtr"
 S LEXREQP(2)="LEX*2.0*51 SEQ #77^3121218^LEX/GMPL Standardization"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*89"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_89.GBL"
 ;     Fiscal Year
 S LEXFY="FY13"
 ;     Quarter
 S LEXQTR="2nd"
