LEX2078P ;ISL/KER - LEX*2.0*78 Pre/Post Install ;07/01/2011
 ;;2.0;LEXICON UTILITY;**78**;Sep 23, 1996;Build 7
 ;               
 ; Global Variables
 ;    ^LEXM(              N/A
 ;               
...
CON ; Conversion of data       
 N DA,DIK S DA=10,DIK="^DIC(81.3," D IX1^DIK
 K DA,DIK S DA=50,DIK="^DIC(81.3," D IX1^DIK
 K DA,DIK F DA=16,17,18,19,20,21 D
 . S DA(1)=47,DIK="^DIC(81.3,"_DA(1)_",10," Q:'$D(^DIC(81.3,DA(1),10,DA,0))
 . Q:$P($G(^DIC(81.3,DA(1),10,DA,0)),"^",1)'=90818  D ^DIK
 K DA,DIK S ^DIC(81.3,47,10,15,0)="90818^90818^3050101^"
 S DA=47,DIK="^DIC(81.3," D IX1^DIK
 Q
 ;            
 ; Miscellaneous
PIEN(X) ;   Package IEN
