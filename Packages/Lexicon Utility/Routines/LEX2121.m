LEX2121 ;ISL/CED - LEX*2.0*121 Env Check ;12/21/2018
 ;;2.0;LEXICON UTILITY;**121**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*120 SEQ #111^3181210^Code Set FY19 2nd Qtr"  ;seq # from FORUM
 ;     This Build Name
 S LEXBUILD="LEX*2.0*121"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_121.GBL"
 ;     Fiscal Year
 S LEXFY="FY19"
 ;     Quarter
 S LEXQTR="3rd"
