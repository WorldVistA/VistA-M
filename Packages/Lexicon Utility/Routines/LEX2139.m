LEX2139 ;ISL/TJH - LEX*2.0*139 Env Check ;03/06/2022
 ;;2.0;LEXICON UTILITY;**139**;Sep 23, 1996;Build 4
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*138 SEQ #129^3211221^CODE SET FY22 2ND QTR UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*139"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_139.GBL"
 ;     Fiscal Year
 S LEXFY="FY22"
 ;     Quarter
 S LEXQTR="3rd"
