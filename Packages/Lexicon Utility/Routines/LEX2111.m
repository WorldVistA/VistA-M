LEX2111 ;ISL/KER - LEX*2.0*111 Env Check ;03/27/2017
 ;;2.0;LEXICON UTILITY;**111**;Sep 23, 1996;Build 1
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*109 SEQ #100^3170302^Code Set FY17 2nd Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*111"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_111.GBL"
 ;     Fiscal Year
 S LEXFY="FY17"
 ;     Quarter
 S LEXQTR="3rd"
