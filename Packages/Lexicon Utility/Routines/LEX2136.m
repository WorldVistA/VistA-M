LEX2136 ;ISL/TJH - LEX*2.0*136 Env Check ;08/25/2021
 ;;2.0;LEXICON UTILITY;**136**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*135 SEQ #126^3210726^DUPLICATE CPT MODIFIER INACTIVATION"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*136"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_136.GBL"
 ;     Fiscal Year
 S LEXFY="FY22"
 ;     Quarter
 S LEXQTR="1st"
