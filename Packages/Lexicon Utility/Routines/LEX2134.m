LEX2134 ;ISL/TJH - LEX*2.0*134 Env Check ;06/17/2021
 ;;2.0;LEXICON UTILITY;**134**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*133 SEQ #124^3210602^VA SNOMED EXTENSION"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*134"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_134.GBL"
 ;     Fiscal Year
 S LEXFY="FY21"
 ;     Quarter
 S LEXQTR="4th"
