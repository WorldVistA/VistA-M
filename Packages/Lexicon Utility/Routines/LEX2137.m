LEX2137 ;ISL/TJH - LEX*2.0*137 Env Check ;09/08/2021
 ;;2.0;LEXICON UTILITY;**137**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*136 SEQ #127^3210907^CODE SET FY22 1ST QTR UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*137"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_137.GBL"
 ;     Fiscal Year
 S LEXFY="FY22"
 ;     Quarter
 S LEXQTR="1st"
