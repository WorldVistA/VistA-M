LEX2122 ;ISL/CED - LEX*2.0*122 Env Check ;04/04/2019
 ;;2.0;LEXICON UTILITY;**122**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*121 SEQ #112^3180325^CODE SET FY19 3RD QTR UPDATE"  ;seq # from FORUM
 ;     This Build Name
 S LEXBUILD="LEX*2.0*122"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_122.GBL"
 ;     Fiscal Year
 S LEXFY="FY19"
 ;     Quarter
 S LEXQTR="4th"
