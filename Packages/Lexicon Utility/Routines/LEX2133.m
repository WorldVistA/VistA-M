LEX2133 ;ISL/TJH - LEX*2.0*133 Env Check ;04/04/2021
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*132 SEQ #123^3210304^CODE SET FY21 3RD QTR UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*133"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_133.GBL"
 ;     Fiscal Year
 S LEXFY="FY21"
 ;     Quarter
 S LEXQTR="4th"
