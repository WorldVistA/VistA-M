LEX2138 ;ISL/TJH - LEX*2.0*138 Env Check ;12/05/2021
 ;;2.0;LEXICON UTILITY;**138**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*137 SEQ #128^3211027^CODE SET FY22 1ST QTR INTERIM UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*138"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_138.GBL"
 ;     Fiscal Year
 S LEXFY="FY22"
 ;     Quarter
 S LEXQTR="2nd"
