LEX2104P ;ISL/KER - LEX*2.0*104 Pre/Post Install ;11/24/2015
...
CON ; Conversion of data
 N LEXAMSO,LEXENV,LEXFI,LEXFN,LEXOK,LEXRUN,LEXT,LEXTY S LEXAMSO="O",LEXENV=1,LEXFI=757.21
 S LEXFN="Subsets",LEXOK=1,LEXRUN=0,LEXT="757.21 (Subsets)",LEXTY=1 D ONE^LEXRXXT
 Q
 ;            
 ; Miscellaneous
PIEN(X) ;   Package IEN
