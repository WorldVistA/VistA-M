LEX2132 ;ISL/TJH - LEX*2.0*132 Env Check ;02/28/2021
 ;;2.0;LEXICON UTILITY;**132**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*131 SEQ #122^3201222^CODE SET FY21 2ND QTR INTERIM UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*132"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_132.GBL"
 ;     Fiscal Year
 S LEXFY="FY21"
 ;     Quarter
 S LEXQTR="3rd"
