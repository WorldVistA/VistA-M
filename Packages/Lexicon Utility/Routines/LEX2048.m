LEX2048 ; CIO ISL - LEX*2.0*48 Env Check                  ; 04/01/2007
 ...
 ;                            
ENV ; LEX*2.0*48 Environment Check
 ;                    
 ;   General
 ;
...
ABRT ;     Abort  Failed Environment Check, KILL the distribution
 D:$D(LEXE) ED S XPDABORT=1,XPDQUIT=1,XPDQUIT("LEX*2.0*48")=1
 K LEXE,LEXFULL
 Q
 ;               
 ; Checks
...
IMP ;   Import names
 ...
 S LEXLREV=48
 ;     Required Builds
 S LEXREQP="LEX*2.0*47"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*48"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_48.GBL"
 ;     Fiscal Year
 S LEXFY="FY07"
 ;     Quarter
 S LEXQTR="3rd"
