LEX2157 ;ISL/TJH - LEX*2.0*157 Env Check ; 12/15/2025
 ;;2.0;LEXICON UTILITY;**157**;Sep 23, 1996;Build 2
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*155 SEQ #147^3250930^CODE SET FY26 1ST QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
  ;     This Build Name
 S LEXBUILD="LEX*2.0*157"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_157.GBL"
 ;     Fiscal Year
 S LEXFY="FY26"
 ;     Quarter
 S LEXQTR="2nd"
