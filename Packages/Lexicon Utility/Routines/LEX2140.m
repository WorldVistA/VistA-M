LEX2140 ;ISL/TJH - LEX*2.0*140 Env Check ;05/09/2022
 ;;2.0;LEXICON UTILITY;**140**;Sep 23, 1996;Build 3
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*139 SEQ #130^3220322^CODE SET FY22 3RD QTR UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*140"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_140.GBL"
 ;     Fiscal Year
 S LEXFY="FY22"
 ;     Quarter
 S LEXQTR="4th"
