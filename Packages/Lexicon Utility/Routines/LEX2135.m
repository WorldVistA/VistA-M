LEX2135 ;ISL/TJH - LEX*2.0*135 Env Check ;07/14/2021
 ;;2.0;LEXICON UTILITY;**135**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*134 SEQ #125^3210707^CODE SET FY21 4TH QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*135"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_135.GBL"
 ;     Fiscal Year
 S LEXFY="FY21"
 ;     Quarter
 S LEXQTR="4th"
