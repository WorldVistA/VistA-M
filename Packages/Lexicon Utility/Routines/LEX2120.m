LEX2120 ;ISL/CED - LEX*2.0*120 Env Check ;10/16/2018
 ;;2.0;LEXICON UTILITY;**120**;Sep 23, 1996;Build 2
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*119 SEQ #110^3180925^Code Set FY19 1st Qtr"  ;seq # from FORUM
 ;     This Build Name
 S LEXBUILD="LEX*2.0*120"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_120.GBL"
 ;     Fiscal Year
 S LEXFY="FY19"
 ;     Quarter
 S LEXQTR="2nd"
