LEX2091 ;ISL/KER - LEX*2.0*91 Env Check ;06/06/2013
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*90 SEQ #80^3130404^Code Set FY13 3rd Qtr"
 S LEXREQP(2)="VBEC*1.0*56^^VBECS HCPCS Lookup"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*91"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_91.GBL"
 ;     Fiscal Year
 S LEXFY="FY13"
 ;     Quarter
 S LEXQTR="4th"
