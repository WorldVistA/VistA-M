LEX2131 ;ISL/TJH - LEX*2.0*131 Env Check ;12/15/2020
 ;;2.0;LEXICON UTILITY;**131**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*130 SEQ #121^3201204^CODE SET FY21 2ND QTR UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*131"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_131.GBL"
 ;     Fiscal Year
 S LEXFY="FY21"
 ;     Quarter
 S LEXQTR="2nd"
