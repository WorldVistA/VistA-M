...
ENV ; LEX*2.0*40 Environment Check
 ...
 W !," Code Set Update for FY06 3rd Quarter - includes 108 CPT/HCPCS late releases"
 W !," and 14 Remedy Ticket repairs",!
 D IMP S U="^"
 ;     No user
...
ABRT ;     Abort  Failed Environment Check, KILL the distribution
 D:$D(LEXE) ED S XPDABORT=1,XPDQUIT=1,XPDQUIT("LEX*2.0*40")=1
...
ED ;   Error Display
 ...
 ;
IMP ;   Import names
 S LEXLREV=40,LEXREQP="LEX*2.0*38",LEXBUILD="LEX*2.0*40"
 S LEXIGHF="LEX_2_40.GBL"
 Q
