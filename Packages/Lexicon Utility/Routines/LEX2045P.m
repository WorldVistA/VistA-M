LEX2045P ; ISL/KER - Pre/Post Install ; 09/13/2006
 ;;2.0;LEXICON UTILITY;**45**;Sep 23, 1996
 ;
 ; External References
 ;   DBIA 10086  HOME^%ZIS
 ;   DBIA  2052  $$GET1^DID
...
POST ; LEX*2.0*45 Post-Install
 ...
 ;
 ;-----------------------------
 ;   Re-Index Files - N/A for LEX*2.0*45
...
LOAD ; Load Data from ^LEXM into IC*/LEX Files
 N LEXPTYPE,LEXLREV,LEXREQP,LEXBUILD,LEXIGHF,LEXFY,LEXQTR,LEXB,LEXCD,LEXSTR,LEXLAST D IMP^LEX2045
...
MSG ; Send Installation Message to G.LEXICON
 Q:+($G(DUZ))=0!($$NOTDEF^LEX2045($G(DUZ)))
 D HOME^%ZIS N DIFROM,LEXLAST,LEXPTYPE,LEXLREV,LEXREQP,LEXBUILD,LEXIGHF,LEXFY,LEXQTR
 D IMP^LEX2045,POST^LEXXFI Q
 ;
...
KLEXM ; Subscripted Kill of ^LEXM
 ...
 Q
 ;
PRE ; LEX*2.0*45 Pre-Install
 ; Delete IENS entered in error
 N DA,DIK S DIK="^ICD9(",DA=14245 D ^DIK S DA=14246 D ^DIK
 Q
 ;
RX ; Reindex files            (N/A for patch 45)
 Q
 ...
 Q
 ;
CON ; Conversion of data       (N/A for patch 45)
 Q
