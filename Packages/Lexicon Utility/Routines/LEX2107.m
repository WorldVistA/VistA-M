LEX2107 ;ISL/KER - LEX*2.0*107 Env Check ;05/23/2016
 ;;2.0;LEXICON UTILITY;**107**;Sep 23, 1996;Build 2
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*105 SEQ #96^3120330^Code Set FY16 3rd Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*107"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_107.GBL"
 ;     Fiscal Year
 S LEXFY="FY16"
 ;     Quarter
 S LEXQTR="4th"
