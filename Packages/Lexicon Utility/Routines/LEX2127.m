LEX2127 ;ISL/TJH - LEX*2.0*127 Env Check ;04/19/2020
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*126 SEQ #117^3200401^CODE SET FY20 3RD QTR INTERIM DATA UPDATE: COVID-19"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*127"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_127.GBL"
 ;     Fiscal Year
 S LEXFY="FY20"
 ;     Quarter
 S LEXQTR="3rd"
