LEX2109 ;ISL/KER - LEX*2.0*109 Env Check ;12/12/2016
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*108 SEQ #98^3161006^Code Set FY17 1st Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*109"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_109.GBL"
 ;     Fiscal Year
 S LEXFY="FY17"
 ;     Quarter
 S LEXQTR="2nd"
