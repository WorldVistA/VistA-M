LEX2158 ;ISL/TJH - LEX*2.0*158 Env Check ; 01/09/2026
 ;;2.0;LEXICON UTILITY;**158**;Sep 23, 1996;Build 3
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*157 SEQ #148^3251230^CODE SET FY26 2ND QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
  ;     This Build Name
 S LEXBUILD="LEX*2.0*158"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_158.GBL"
 ;     Fiscal Year
 S LEXFY="FY26"
 ;     Quarter
 S LEXQTR="2nd"
