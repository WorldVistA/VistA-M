LEX2130 ;ISL/TJH - LEX*2.0*130 Env Check ;11/25/2020
 ;;2.0;LEXICON UTILITY;**130**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*129 SEQ #120^3200928^CODE SET FY21 1ST QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*130"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_130.GBL"
 ;     Fiscal Year
 S LEXFY="FY21"
 ;     Quarter
 S LEXQTR="2nd"
