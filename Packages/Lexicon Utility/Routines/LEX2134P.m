LEX2134P ;ISL/TJH - LEX*2.0*134 Pre/Post Install ;06/17/2021
...
CON ; Conversion of data
 N IEN,FDA,U S IEN=0,U="^"
 F  S IEN=$O(^ICD9(IEN)) Q:'IEN  D
 .I '$D(^ICD9(IEN,1)) Q
 .I $P(^ICD9(IEN,1),U,1)'=30 Q
 .I $P(^ICD9(IEN,1),U,3)="" Q
 .K FDA S FDA(80,IEN_",",1.3)="@" D FILE^DIE(,"FDA",)
 Q
 ;            
 ; Miscellaneous
PIEN(X) ;   Package IEN
