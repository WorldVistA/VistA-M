LEX2142 ;ISL/TJH - LEX*2.0*142 Env Check ; 11/20/2022
 ;;2.0;LEXICON UTILITY;**142**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*141 SEQ #132^3220914^CODE SET FY23 1ST QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*142"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_142.GBL"
 ;     Fiscal Year
 S LEXFY="FY23"
 ;     Quarter
 S LEXQTR="2nd"
