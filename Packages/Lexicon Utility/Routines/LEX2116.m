LEX2116 ;ISL/CED - LEX*2.0*116 Env Check ;10/20/2017
 ;;2.0;LEXICON UTILITY;**116**;Sep 23, 1996;Build 5
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*115 SEQ #105^3171115^Code Set FY18 Q1 Interim Upd"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*116"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_116.GBL"
 ;     Fiscal Year
 S LEXFY="FY18"
 ;     Quarter
 S LEXQTR="2nd"
