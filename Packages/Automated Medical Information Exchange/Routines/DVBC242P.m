DVBC242P ;ALB/FSB - PATCH DVBA*2.7*242 POST-INSTALL ROUTINE; SEP 7, 2022@16:20
 ;;2.7;AMIE;**242**;Apr 10, 1995;Build 5
...
VUPDATE ; MINIMUM AND PREVIOUS CAPRI VERSION UPDATES
 N DVBVER
 D MES^XPDUTL("Patch DVBA*2.7*242 post install started")
 S DVBVER=$$ENXPAR("PKG","DVBAB CAPRI MINIMUM VERSION","CAPRI GUI V2.7*242.8*1*A*3221226*1.3*1.3")
 D UPDMSG("CAPRI MINIMUM VERSION",DVBVER)
 S DVBVER=$$ENXPAR("PKG","DVBAB CAPRI PREVIOUS VERSION","DVBA*2.7*238.2")
 D UPDMSG("DVBAB CAPRI PREVIOUS VERSION",DVBVER)
 D BMES^XPDUTL("Patch DVBA*2.7*242 post install finished")
 Q
 ;
