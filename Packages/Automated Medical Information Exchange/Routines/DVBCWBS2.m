DVBCWBS2 ;ALB/RLC BRAIN AND SPINAL CORD WKS ; 6 MARCH 1997
 ;;2.7;AMIE;**183**;Apr 10, 1995;Build 8
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For BRAIN AND SPINAL CORD",PG=1
 W !?22,"Compensation and Pension Examination",!,?(IOM-$L(DVBAX)\2),DVBAX,!?33,"# 1210 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWBS3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
