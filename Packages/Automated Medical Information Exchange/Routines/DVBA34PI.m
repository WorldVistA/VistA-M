DVBA34PI ;ALB/ESW  EXAM FILE UPDATE - POST INT ; 16 OCT 2000
 ;;2.7;AMIE;**34**;Apr 10, 1995
 ;
 ; This is the post-install for patch 34 to inactivate the old entries
 ; in AMIE EXAM file (396.6), adding the new ones and to create one
 ; new entry for the newly created worksheet # 0920
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*34 Post Installation --")
...
TXTOLD ;
 ;;138;RESPIRATORY DISEASES, MISCELLANEOUS; ; ;DVBCWRM;I; ;1520
 ;;133;RESPIRATORY (OBSTRUCTIVE, RESTRICTIVE, AND INTERSTITIAL); ; ;DVBCWRZ;I; ;1505
 ;;136;PULMONARY TUBERCULOSIS AND MYCOBACTERIAL DISEASES; ; ;DVBCWPW;I; ;1515
 ;;152;POST-TRAUMATIC STRESS DISORDER (PTSD); ; ;DVBCWPT;I; ;0910
 ;;158;MENTAL DISORDERS (NOT INITIAL PTSD OR EATING DISORDERS); ; ;DVBCWMO;I; ;0905
 ;;QUIT
 ;
 ;
...
TXTNEW ;
 ;;164;REVIEW EXAMINATION FOR POST-TRAUMATIC STRESS DISORDER;REV EXAM FOR PTSD;MENTAL;DVBCWPE;A; ;0920
 ;;165;INITIAL EVALUATION FOR POST-TRAUMATIC STRESS DISORDER (PTSD);STRESS DISORDER;MENTAL;DVBCWPD;A; ;0910
 ;;166;PULMONARY TUBERCULOSIS AND MYCOBACTERIAL DISEASES;PUL TUB & MYCO DIS;RESPIRATORY;DVBCWPM;A; ;1515
 ;;167;MENTAL DISORDERS (EXCEPT PTSD AND EATING DISORDERS);MENTAL DISORDER;MENTAL;DVBCWME;A; ;0905
 ;;168;RESPIRATORY DISEASES, MISCELLANEOUS;RESPIRATORY-MISC;RESPIRATORY;DVBCWSM;A; ;1520
 ;;169;RESPIRATORY (OBSTRUCTIVE, RESTRICTIVE, AND INTERSTITIAL);RESP (OBST, RESTR,INTERS);RESPIRATORY;DVBCWRO;A; ;1505
 ;;QUIT
