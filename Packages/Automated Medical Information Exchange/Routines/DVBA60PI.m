DVBA60PI ;ALB/JER - Post Init Exam file Update ; 08/07/03 11:41am
 ;;2.7;AMIE;**60**;AUG 7,2003
 ;
 ; This is the post-install for DVBA*2.7*60 to inactivate the old
 ; entries and create new entries in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*60 Post Installation --")
...
TXTOLD ;
 ;;174;SPINE (CERVICAL, THORACIC & LUMBAR); ; ;DVBCWNS2;I; ;1440
 ;;QUIT
 ;
 ;
...
TXTNEW ;
 ;;182;SPINE;SPINE;2;DVBCWNS4;A; ;1440
 ;;QUIT
