DVBA141P ;ALB/RLC - Post Init Exam file Update ; 14 Jun 2005
 ;;2.7;AMIE;**141**;AUG 7,2003;Build 3
 ;
 ; This is the post-install for DVBA*2.7*141 to inactivate the old
 ; entry and create a new entry in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*141 Post Installation --")
...
TXTOLD ;
 ;;210;SCARS;SCARS;11;DVBCWSW4;I; ;1605
 ;;QUIT
 ;
 ;
...
TXTNEW ;
 ;;230;SCARS;SCARS;11;DVBCWSW6;A; ;1605
 ;;QUIT
