DVBCWEN2 ;ALB/RLC EPILEPSY AND NARCOLEPSY WKS ; 6 MARCH 1997
 ;;2.7;AMIE;**170**;Apr 10, 1995;Build 1
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For EPILEPSY AND NARCOLESPY",PG=1
 W !?22,"Compensation and Pension Examination",!,?(IOM-$L(DVBAX)\2),DVBAX,!?33,"# 1220 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWEN3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
