DVBA87PI ;ALB/RLC - Post Init Exam file Update ; 08 Feb 2005
 ;;2.7;AMIE;**87**;AUG 7,2003;Build 6
 ;
 ; This is the post-install for DVBA*2.7*87 to inactivate the old
 ; entries and create new entries in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*87 Post Installation --")
...
TXTOLD ;
 ;;177;INITIAL EVALUATION FOR POST-TRAUMATIC STRESS DISORDER (PTSD);STRESS DISORDER;14;DVBCWPD6;I; ;0910
 ;;176;REVIEW EXAMINATION FOR POST-TRAUMATIC STRESS DISORDER (PTSD);REV EXAM FOR PTSD;14;DVBCWPE6;I; ;0920
 ;;QUIT
 ;
 ;
...
TXTNEW ;
 ;;196;INITIAL EVALUATION FOR POST-TRAUMATIC STRESS DISORDER (PTSD);STRESS DISORDER;14;DVBCWPF;A; ;0910
 ;;197;REVIEW EXAMINATION FOR POST-TRAUMATIC STRESS DISORDER (PTSD);REV EXAM FOR PTSD;14;DVBCWPG;A; ;0920
 ;;QUIT
