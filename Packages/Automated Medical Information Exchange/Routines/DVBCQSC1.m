DVBCQSC1 ;;ALB-CIOFO/ECF - SCARS DISFIGUREMENT QUESTIONNAIRE ; 6/15/2011
 ;;2.7;AMIE;**172**;Apr 10, 1995;Build 3
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Scars/Disfigurement",TT=40-($L(DVBAX)\2),PG=1
 W !,?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQSC2","DVBCQSC3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
