DVBCQHL1 ;;ALB-CIOFO/ECF,SBW - HEARING LOSS QUESTIONNAIRE ;  4/APR/2011
 ;;2.7;AMIE;**166**;Apr 10, 1995;Build 6
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Hearing Loss and Tinnitus",TT=40-($L(DVBAX)\2),PG=1
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQHL2","DVBCQHL3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
