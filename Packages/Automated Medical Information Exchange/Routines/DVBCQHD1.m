DVBCQHD1 ;;ALB-CIOFO/ECF - HEART CONDITION QUESTIONNAIRE ; 6/15/2011
 ;;2.7;AMIE;**172**;Apr 10, 1995;Build 3
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Heart Conditions ",TT=40-($L(DVBAX)\2),PG=1
 W !,?TT,DVBAX
 S DVBAX="(Including Ischemic & Non-ischemic Heart Disease, Arrhythmias, ",TT=40-($L(DVBAX)\2)
 W !,?TT,DVBAX
 S DVBAX="Valvular Disease and Cardiac Surgery) ",TT=40-($L(DVBAX)\2)
 W !,?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQHD2","DVBCQHD3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
