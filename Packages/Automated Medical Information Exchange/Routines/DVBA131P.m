DVBA131P ;ALB/RLC - Post Init Exam file Update ; 14 Jun 2005
 ;;2.7;AMIE;**131**;AUG 7,2003;Build 4
 ;
 ; This is the post-install for DVBA*2.7*131 to inactivate the old
 ; entry and create a new entry in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*131 Post Installation --")
...
TXTOLD ;
 ;;186;DIABETES MELLITUS;DIABETES MELLITUS;12;DVBCWDIA;I; ;0410
 ;;QUIT
 ;
 ;
