DVBCWLW ;ALB/CMM LIVER, GALL BLADDER AND PANCREAS WKS ; 5 MARCH 1997
 ;;2.7;AMIE;**12**;Apr 10, 1995
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For LIVER, GALL BLADDER AND PANCREAS",PG=1
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWLW1" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 S PG=PG+1 W @IOF,!,"Page: ",PG,!!,"Compensation and Pension Exam for "_NAME,!
 W "For LIVER, GALL BLADDER, AND PANCREAS",!!!
 Q
