DVBCWCN2 ;ALB/RLC CRANIAL NERVES WKS ; 12 FEB 2007
 ;;2.7;AMIE;**121**;Apr 10, 1995;Build 9
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For CRANIAL NERVES",PG=1
 W !?22,"Compensation and Pension Examination",!,?(IOM-$L(DVBAX)\2),DVBAX,!?33,"# 1205 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWCN3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
