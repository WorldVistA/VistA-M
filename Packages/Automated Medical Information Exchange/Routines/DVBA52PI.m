DVBA52PI ;ALB/JER - Post Init Exam file Update ; 12/12/02 11:41am
 ;;2.7;AMIE;**52**;Apr 10, 1995
 ;
 ; This is the post-install for DVBA*2.7*52 to inactivate the old
 ; entries and create new entries in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*52 Post Installation --")
...
TXTNEW ;
 ;;147;COLD INJURY PROTOCOL EXAMINATION;COLD INJURY EXAM;17;DVBCWCI4;A; ;1730
 ;;QUIT
