DVBCQMI1 ;;ALB-CIOFO/ECF - ARTERIES AND VEINS QUESTIONNAIRE ; 5/15/2011
 ;;2.7;AMIE;**173**;Apr 10, 1995;Build 2
 ;
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Muscle Injuries",TT=40-($L(DVBAX)\2),PG=1
 W ?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQMI2","DVBCQMI3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
