DVBA49PI ;BPOIFO/ESW - Post Init Exam file Update ; 12/12/02 11:41am
 ;;2.7;AMIE;**49**;Apr 10, 1995
 ;
 ; This is the post-install for DVBA*2.7*49 to inactivate the old
 ; entries and create new entries in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*49 Post Installation --")
...
TXTOLD ;
 ;;139;SCARS; ; ;DVBCWSW;I; ;1605
 ;;142;SKIN DISEASES (OTHER THAN SCARS); ; ;DVBCWSD;I;1610
 ;;QUIT
 ;
 ;
...
TXTNEW ;
 ;;179;SCARS;SCARS;SKIN;DVBCWSW2;A; ;1605
 ;;180;SKIN DISEASES (OTHER THAN SCARS);SKIN(OTHER THAN SCARS);SKIN;DVBCWSD2;A; ;1610
 ;;QUIT
