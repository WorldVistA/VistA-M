DVBA138P ;ALB/RLC - Post Init Exam file Update ; 14 Jun 2005
 ;;2.7;AMIE;**138**;AUG 7,2003;Build 6
 ;
 ; This is the post-install for DVBA*2.7*138 to inactivate the old
 ; entry and create a new entry in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*138 Post Installation --")
...
TXTOLD ;
 ;;216;EYE EXAMINATION;EYE;3;DVBCWEE3;I; ;1330
 ;;QUIT
 ;
 ;
...
TXTNEW ;
 ;;229;EYE EXAMINATION;EYE;3;DVBCWEE5;A; ;1330
 ;;QUIT
