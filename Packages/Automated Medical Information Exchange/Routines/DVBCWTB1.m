DVBCWTB1 ;ALB/RLC TRAUMATIC BRAIN INJURY (TBI)- WKS; 12 FEB 2007
 ;;2.7;AMIE;**183**;Apr 10, 1995;Build 8
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For TRAUMATIC BRAIN INJURY (TBI)",PG=1
 W !?22,"Compensation and Pension Examination",!,?(80-$L(DVBAX)\2),DVBAX,!?(80-$L("# 1225 Worksheet")\2),"# 1240 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWTB2","DVBCWTB3","DVBCWTB4","DVBCWTB5" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
