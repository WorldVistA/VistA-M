DVBCQED1 ;;ALB-CIOFO/ECF - EAR DISEASE QUESTIONNAIRE ; 5/10/2010
 ;;2.7;AMIE;**174**;Apr 10, 1995;Build 2
 ;
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Ear Conditions",TT=40-($L(DVBAX)\2),PG=1
 W ?TT,DVBAX,!
 S DVBAX="(Including Vestibular and Infectious Conditions)",TT=40-($L(DVBAX)\2)
 W ?TT,DVBAX,!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQED2" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 ;
 ...
 W "Ear Conditions (Including Vestibular and Infectious Conditions)",!!!
 Q
