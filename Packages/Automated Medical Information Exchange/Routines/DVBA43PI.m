DVBA43PI ;BP-CIOFO/MM Post Init Exam file Update - ;3/27/2002
 ;;2.7;AMIE;**43**;Apr 10,1995
 ;
 ; This is the post-install for DVBA*2.7*43 to inactivate the old
 ; entries and create new entries in the AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*43 Post Installation --")
...
TXTOLD ;
 ;;164;REVIEW EXAMINATION FOR POST-TRAUMATIC STRESS DISORDER; ; ;DVBCWPE;I; ;0920
 ;;165;INITIAL EVALUATION FOR POST-TRAUMATIC STRESS DISORDER (PTSD); ; ;DVBCWPD;I; ;0910
 ;;167;MENTAL DISORDERS (EXCEPT PTSD AND EATING DISORDERS); ; ;DVBCWME;I; ;0905
 ;;QUIT
 ;
 ;
...
TXTNEW ;
 ;;171;REVIEW EXAMINATION FOR POST-TRAUMATIC STRESS DISORDER;REV EXAM FOR PTSD;MENTAL;DVBCWPE3;A; ;0920
 ;;172;INITIAL EVALUATION FOR POST-TRAUMATIC STRESS DISORDER (PTSD);STRESS DISORDER;MENTAL;DVBCWPD3;A; ;0910
 ;;173;MENTAL DISORDERS (EXCEPT PTSD AND EATING DISORDERS);MENTAL DISORDER;MENTAL;DVBCWME2;A; ;0905
 ;;QUIT
