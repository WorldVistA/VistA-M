DVBA125P ;ALB/RLC - Post Init Exam file Update ; 14 Jun 2005
 ;;2.7;AMIE;**125**;AUG 7,2003;Build 9
 ;
 ; This is the post-install for DVBA*2.7*125 to create a new entry in the
 ; AMIE EXAM file (#396.6).
 ;
EN ;
 D BMES^XPDUTL("DVBA*2.7*125 Post Installation --")
...
GET ;get exam data
 ...
 Q
 ;
 ; New exam to create and activate
 ; format:  ien;exam name;print name;body system;routine;status;;wks#
TXTNEW ;
 ;;223;TRAUMATIC BRAIN INJURY (TBI);TRAUMATIC BRAIN INJURY;13;DVBCTBI1;A; ;1225
 ;;QUIT
