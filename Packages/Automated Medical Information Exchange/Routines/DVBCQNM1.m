DVBCQNM1 ;;ALB-CIOFO/ECF - NEURO MIGRAINE QUESTIONNAIRE ; 6/20/2011
 ;;2.7;AMIE;**174**;Apr 10, 1995;Build 2
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Headaches (Including Migraine Headaches)",TT=40-($L(DVBAX)\2),PG=1
 W ?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQNM2" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 ;
 ...
 W "Headaches (Including Migraine Headaches)",!!!
 Q
