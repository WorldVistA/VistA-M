DVBCQKC3 ;;ALB-CIOFO/ECF - KIDNEY CONDITION QUESTIONNAIRE (V2); 6/15/2011
 ;;2.7;AMIE;**169**;Apr 10, 1995;Build 5
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Kidney Conditions (Nephrology)",TT=40-($L(DVBAX)\2),PG=1
 W !,?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQKC4","DVBCQKC5" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 ;
 ...
 W "Kidney Conditions (Nephrology)",!!
 Q
