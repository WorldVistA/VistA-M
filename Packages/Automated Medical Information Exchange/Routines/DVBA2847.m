DVBA2847 ;BPFO/MM - PATCH DVBA*2.7*147 INSTALL UTILITIES;7/22/2009
 ;;2.7;AMIE;**147**;Apr 10, 1995;Build 6
 ;
...
POSTP(NM) ;Rename templates loaded by the patch.
 ...
 ;the imported version of a template (i.e. ACROMEGALY~147F) to it's
 ;new name/version (i.e. ACROMEGALY~147T6).
 ;
 N DVBABIEN,DVBABIE2 ;ien of CAPRI TEMPLATE DEFINITIONS file
 N DVBABST  ;template NAME field (i.e. ACROMEGALY~147F)
 N DVBABS2  ;template NAME field (i.e. ACROMEGALY~147T6)
 ...
 .;look for template versions just loaded by the patch (~147F)
 ...
 ..;name to the new version name (i.e. ACROMEGALY~147F --> ACROMEGALY~147T6)
 ..I DVBACH=0  D
...
DISABLE(NM) ;Disable matching exam template entries.
 ...
 ;suffix (i.e. ~147T5) does not match the version suffix that will be used
 ;for templates loaded by the patch on the target system (i.e. ~147T6).
 ;
 ...
 N DVBABST  ;template NAME field (i.e. ACROMEGALY~147T5)
