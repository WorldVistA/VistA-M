SDESREQAPPCREATE ;ALB/RRM,MGD - VISTA SCHEDULING CREATE APPT REQ AND SCHEDULE APPT RPC ;Sept 16, 2022@16:35
...
CREATEREQANDAPPT(RETURNJSON,REQUEST) ;EP for SDES CREATE VET REQ SCHED APPT
 ...
 ;
 N APPTARRAY,SDCIDPREFDATE,DIK,DA,REQUESTIEN,EAS,PCMT,SDBEGDATE
 ...
 ;
 D VALIDATE^SDESCREATEAPPREQ(.REQUEST,.ERRORS)
 ...
 S REQUESTIEN=$$BUILDER^SDESCREATEAPPREQ(.REQUEST)
 ...
 ;if in the event an error occured during the creation and scheduling of the appointment, delete the appointment request
