SDESAPPTLETTERSV ;ALB/BWF,TJB,TJB - VISTA SCHEDULING RPCS - VISTA LETTER PRINT ; OCT 20, 2025
 ;;5.3;Scheduling;**825,917,922**;Aug 13, 1993;Build 7
...
PRINT1(PRINTRES,ERRORS,APPTIEN,TYPE,PDEV) ;
 N APPTIENS,SDTTM,DFN,SDRES,SC,APPTDATA,SDT,TIMEZONE
 S TYPE=$G(TYPE),PDEV=$G(PDEV)
 ...
 S TIMEZONE=$$TIMEZONEDATA^SDESUTIL($G(SC)),TIMEZONE=$P($G(TIMEZONE),U)
 I TYPE="P" D PREAPPT(.PRINTRES,.ERRORS,SC,APPTIEN,SDTTM,DFN,PDEV,TIMEZONE)
 I TYPE="C" D CANCEL(.PRINTRES,.ERRORS,SC,APPTIEN,SDTTM,DFN,PDEV)
 I TYPE="N" D NOSHOW(.PRINTRES,.ERRORS,SC,APPTIEN,SDTTM,DFN,PDEV)
 Q
PREAPPT(RESULTS,ERRORS,SC,APPTIEN,SDTTM,DFN,SDID,TIMEZONE) ;print pre-appointment letter
