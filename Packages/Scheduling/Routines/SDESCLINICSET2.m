...
SAVE(POP,SDIEN,FDA,SDCLINIC,PROVIDER,DIAGNOSIS,SPECIALINSTRUCT,PRIVLIAGEDUSER) ;
 ...
 I $D(PRIVLIAGEDUSER) D PRIVUSERS
 ;
...
PRIVUSERS ;Privileged user multiple 44.04
 ...
 ..S ACTION=PRIVLIAGEDUSER(KEY,PRIVUSER)
 ..S PUSR44IEN=$O(^SC(IEN,"SDPRIV",PRIVUSER,""))
 ..I PUSR44IEN="" S PUSR44IEN="+1"
 ..I ACTION="@",PUSR44IEN="+1" Q  ;Can't delete if not linked clinic
 ..S SDECFDA(44.04,PUSR44IEN_","_IEN_",",.01)=$S(ACTION="@":"@",1:PRIVUSER)
