SDES2BLCKANDMOV2 ;ALB/JHC,JAS - BLOCK AND MOVE 2 ; 05/06/2026
 ;;5.3;Scheduling;**941,944**;Aug 13, 1993;Build 2
...
BLOCKANDMOVE(JSON,SDCONTEXT,BLOCKANDMOVE) ;
 ...
 ; Next line is to prevent leaking variables from other APIs
 N %DT,APPTIEN,C,D,D0,DI,DIC,DIU,DQ,DSIHCL,DSIHFS,DSPV150,EVN,HL16,HL7STRG,HLA,HLECH,HLFS,HLQ,IEN,J,PIVOT,R,REF,RTN,S,SDCODES,SEQ,SLOTSTATUSSTRING,SUBIEN,TARGETCLINIC,VA,VACNTRY,VAERR,XQXFLG,Y,Z0
 ;
 ...
 D CREATE^SDES2CREATEAPPT2(.JSON,.SDCONTEXT,.APPOINTMENT)
 ;
 Q
 ;
VALIDATE(ERRORS,SDCONTEXT,APPTIEN,TARGETCLINIC,REMARKS,TARGETDATE,OVERBOOK,APPOINTMENT,CANCELAVAIL,ORIGINALCLINIC,TARGETSLOT,ORIGINATINGSLOTS,TIMECLINICOPENS,IENS44) ;
 ...
 D VALIDATE^SDES2CREATEAPPT2(.ERRORS,.SDCONTEXT,.APPOINTMENT,.VAL,1)
...
POPULATE(BLOCKANDMOVE,APPTIEN,TARGETCLINIC,TARGETDATE,ORIGINALCLINIC,CANCELAVAIL,SLOT,TARGETSLOT,OVERBOOK,ORIGSLOTS,ORIGINATINGSLOTS,TIMECLINICOPENS,IENS44,ERRORS) ;
 ...
 ;
 S OVERBOOK=$S($G(BLOCKANDMOVE("OVERBOOK"))=1:"O",1:"")
 D VALFIELD^SDES2VALUTIL(.VAL,.VALERR,44.003,9,OVERBOOK)
 S OVERBOOK=$G(VAL(44.003,9,"I"))
 ;
 ...
 I OVERBOOK="",'$G(TARGETSLOT("ClinAvail",1,"SlotsAvail")),"abcdefghijklmnopqrstuvwxyz"'[$G(TARGETSLOT("ClinAvail",1,"SlotsAvail")) S OVERBOOK="O"
 ;
