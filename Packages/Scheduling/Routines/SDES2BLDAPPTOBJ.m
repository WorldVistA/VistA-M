SDES2BLDAPPTOBJ ;ALB/LAB,JAS,BWF,LAB,JAS,TAW,AGW,MCB - VISTA SCHEDULING BUILD APPOINTMENT OBJECT ;APRIL 10, 2026
 ;;5.3;Scheduling;**871,877,880,893,909,932,942**;Aug 13, 1993;Build 2
...
GET40984INFO(APPTOBJ,APPTIEN,SDDFN,CLINIEN,CANCELID,RECCNT) ;
 N IENS,RESOURCEIEN,APPTDATA,APPTSTATDT,APPREQIEN,APPREQPTR,ORIGAPPTREQTYP,ARRAY40984,SDMSG,COUNT
 S IENS=APPTIEN_","
 ...
 ;
 S COUNT=0
 F  S COUNT=$O(ARRAY40984(409.84,IENS,1,COUNT)) Q:'COUNT  D
 .S APPTOBJ("Appointment",RECCNT,"Note",COUNT)=$$CLEANCMMTS^SDES2APPTUTIL($G(ARRAY40984(409.84,IENS,1,COUNT)))
 I '$D(APPTOBJ("Appointment",RECCNT,"Note")) S APPTOBJ("Appointment",RECCNT,"Note",1)=""
 ;
...
GETPATCOMMENTS(APPTOBJ,APPTIEN,RECCNT) ;
 ...
 .S COUNT=COUNT+1
 .S APPTOBJ("Appointment",RECCNT,"PatientComments",COUNT)=$$CLEANCMMTS^SDES2APPTUTIL($$GET1^DIQ(409.846,SUBIEN_","_APPTIEN_",",.01,"E"))
...
GETNOTEAUDIT(APPTOBJ,APPTIEN,RECCNT) ;
 ...
 .S APPTOBJ("Appointment",RECCNT,"NoteAuditing",COUNT,"Note")=$$CLEANCMMTS^SDES2APPTUTIL($$GET1^DIQ(409.847,SUBIEN_","_APPTIEN_",",2,"I"))
