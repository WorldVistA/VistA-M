SDEC40 ;ALB/SAT,WTC,LEG,TJB - VISTA SCHEDULING RPCS ;OCT 20, 2025@15:22
 ;;5.3;Scheduling;**627,665,694,785,813,922**;Aug 13, 1993;Build 7
 ;
 ;  ICR
 ;  ---
 ;   7024 - #40.8
...
PRT(DFN,SDC,SD,LT,SDLET,SDFORM) ;
 ...
 S SDECI=SDECI+1 S ^TMP("SDEC",$J,SDECI)=$$FILL^SDECU(69," ")_$C(13,10)
 I 'SDFORM D
...
BADADD ;Print patients with a Bad Address Indicator
 ...
 . . S SDECI=SDECI+1 S ^TMP("SDEC",$J,SDECI)="           "_SDNAM_$C(13,10)
 S SDECI=SDECI+1 S ^TMP("SDEC",$J,SDECI)=$C(13,10)
 S SDECI=SDECI+1 S ^TMP("SDEC",$J,SDECI)=$C(13,10)
