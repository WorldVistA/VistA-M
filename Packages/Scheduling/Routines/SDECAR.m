SDECAR ;ALB/SAT,MGD,KML,BLB,LAB,AGW - VISTA SCHEDULING RPCS ;Nov 21, 2023
 ;;5.3;Scheduling;**627,642,671,745,792,797,805,815,833,837,843,927**;Aug 13, 1993;Build 15
...
AROPEN(RET,ARAPP,ARIEN,ARDDT) ;SET Appointment Request Open/re-open
 ...
 N SDCANRSN,REOPENYN,PARENTREQUESTIEN,SUBIEN,FDA,MRTCFLG
 S PARENTREQUESTIEN=$$GET1^DIQ(409.85,ARIEN,43.8,"I")
 S MRTCFLG=$$GET1^DIQ(409.85,ARIEN,41,"I")
 I ((PARENTREQUESTIEN="")&(MRTCFLG)) D
 .Q:($$GET1^DIQ(409.85,ARIEN,23,"I")="O")
 .N CHILDIEN,FOUND
 .S CHILDIEN="",FOUND=0
 .F  S CHILDIEN=$O(^SDEC(409.85,ARIEN,2,"B",CHILDIEN)) Q:(CHILDIEN="")!(FOUND)  D
 ..S FOUND=($$GET1^DIQ(409.85,CHILDIEN_",",23,"I")="O")
 ..Q
 .I FOUND D
 ..S FDA(409.85,ARIEN,19)=""
 ..S FDA(409.85,ARIEN,20)=""
 ..S FDA(409.85,ARIEN,21)=""
 ..S FDA(409.85,ARIEN_",",23)="O"
 ..D FILE^DIE(,"FDA","ARMSG") K FDA
 ..Q
 .Q
 ...
 I ((REOPENYN="")!(REOPENYN=1)) D
 .Q:((MRTCFLG)&(PARENTREQUESTIEN=""))
 .S @ARFDA@(23)="OPEN"
 .;I "^3^9^10^12^17^18^"'[(U_SDCANRSN_U) S @ARFDA@(23)="OPEN"
 .D UPDATE^DIE("E","ARFDA","ARRET","ARMSG")
 .I (PARENTREQUESTIEN'="") D
 ..D UPDATEMRTCSEQNUM(PARENTREQUESTIEN,$$GET1^DIQ(409.85,ARIEN,.01,"I"))
 ..I ($$GET1^DIQ(409.85,PARENTREQUESTIEN,23,"I")="C") D
 ...S FDA(409.85,PARENTREQUESTIEN_",",23)="O"
 ...S FDA(409.85,PARENTREQUESTIEN_",",19)=""
 ...S FDA(409.85,PARENTREQUESTIEN_",",20)=""
 ...S FDA(409.85,PARENTREQUESTIEN_",",21)=""
 ...D FILE^DIE(,"FDA","ARMSG") K FDA
 ...Q
 ..S SUBIEN=0
 ..S SUBIEN=$O(^SDEC(409.85,PARENTREQUESTIEN,2,"B",ARIEN,SUBIEN)) Q:'SUBIEN
 ..S FDA(409.852,SUBIEN_","_PARENTREQUESTIEN_",",.02)="@"
 ..D FILE^DIE(,"FDA","ARMSG") K FDA
 ..Q
 .Q
 I ((REOPENYN=0)&(MRTCFLG)&(PARENTREQUESTIEN'="")) D
 .S SUBIEN=0
 .S SUBIEN=$O(^SDEC(409.85,PARENTREQUESTIEN,2,"B",ARIEN,SUBIEN)) Q:'SUBIEN
 .S FDA(409.852,SUBIEN_","_PARENTREQUESTIEN_",",.02)="@"
 .D FILE^DIE(,"FDA","ARMSG") K FDA
