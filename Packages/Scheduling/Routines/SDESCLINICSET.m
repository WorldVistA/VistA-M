SDESCLINICSET ;ALB/TAW,LAB,MGD - CLINIC CREATE AND UPDATE ;Dec 07, 2022
 ;;5.3;Scheduling;**799,805,820,824,825,831**;Aug 13, 1993;Build 4
 ...
 ;
CLINICEDIT(RET,CLINIEN,P1,P2,P3,P4,P5,P6,P7,P8,P9,P10,P11,P12,P13,P14,P15,P16,P17,P18,P19,P20,P21,P22,P23,P24,P25,P26,P27,P28,P29,P30,P31,P32,P33,P34,P35,P36,P37,P38,P39,P40,P41,P42,P43) ;
 S CLINIEN=$G(CLINIEN,"")
 ...
 Q
 ;
CLINICSET(RETURN,P0,P1,P2,P3,P4,P5,P6,P7,P8,P9,P10,P11,P12,P13,P14,P15,P16,P17,P18,P19,P20,P21,P22,P23,P24,P25,P26,P27,P28,P29,P30,P31,P32,P33,P34,P35,P36,P37,P38,P39,P40,P41,P42,P43) ;
 ...
 N DEFAULTCNT2,DEFALUTREMOVE,X,PRIVUSER,PRIVLIAGEDUSER,MI,SDSTARTHR,ERR,FDA,SDEAS,PRIAMIS,CREDITAMIS
 S POP=0
 I P0="" D
 .D VALIDATE(0)
 .I 'POP D CREATE
...
VALIDATE(EDIT) ;
 ...
 I SDSCHEDHOLIDAY'="@",SDSCHEDHOLIDAY'="Y" S SDSCHEDHOLIDAY=""
 I EDIT,SDSCHEDHOLIDAY="" S SDSCHEDHOLIDAY="@"
 ;
 ...
 ;
 S SDINCPERHR=$G(P38)
 I SDINCPERHR="@" S SDINCPERHR=""  ;Can't remove a require field
 I 'EDIT,SDINCPERHR="" D ERRLOG(117)
 I SDINCPERHR'="@",SDINCPERHR'="" D
...
UPDATE ;
 ...
 S:SDSTARTHR'="" FDA(44,X_",",1914)=SDSTARTHR
 S:SDPRINCLINIC'="" FDA(44,X_",",1916)=SDPRINCLINIC
 S:SDINCPERHR'="" FDA(44,X_",",1917)=SDINCPERHR
 S:SDOVBDAYMAX'="" FDA(44,X_",",1918)=SDOVBDAYMAX
 S:SDSCHEDHOLIDAY'="" FDA(44,X_",",1918.5)=SDSCHEDHOLIDAY
