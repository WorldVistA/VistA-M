SDES2EDITAPREQ2 ;ALB/JDJ - SDES2 EDIT APPT REQ2 ; MAY 7, 2026
 ;;5.3;Scheduling;**944**;Aug 13, 1993;Build 2
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 ;Cloned from SDES2EDITAPREQ
 ; Reference to DUZ^XUP is supported by IA #7487
 ;
 Q
 ; RPC: SDES2 EDIT APPT REQ2
 ;
 ; SDCONTEXT INPUT
 ;
...
EDITREQUEST(JSONRETURN,SDCONTEXT,REQUEST) ;
 ...
 I $D(ERRORS) S ERRORS("Request",1)="" D BUILDJSON^SDES2JSON(.JSONRETURN,.ERRORS) Q
 ;
 S REQIEN=$$BUILDER(.FILEDATA,$G(INSTITUTIONIEN),$G(SDCONTEXT("ACHERON AUDIT ID")))
 I REQIEN'="" D GETREQUEST^SDES2GETAPPTREQ(.RETURN,REQIEN)
 I '$D(RETURN) S RETURN("Request",1)=""
 ;
 D BUILDJSON^SDES2JSON(.JSONRETURN,.RETURN)
 Q
 ;
VALIDATE(REQUEST,FILEDATA,INSTITUTIONIEN,ERRORS) ;
 N VALRETURN,VALREQUESTIEN,CLINICIEN,CHILDIEN
 ;
...
BUILDER(REQUEST,INSTITUTIONIEN,EAS) ;
 N FDA,FDAERR,REQIEN,ORIGPID,LASTNOTE,X,Y
...
BUILDCOMMENTS(REQUEST,REQIEN) ;
 N NUM,DATERANGE1,DATERANGE2,DATERANGE3,EDITPATCOM
 S NUM=0
