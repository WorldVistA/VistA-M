SDES2APPTUTIL ;ALB/BLB,TJB/ANU/BLB/LAB,BLB,LAB,BWF,JAS,JAS,AGW,JHC,AGW - SDES2 CREATE APPOINTMENT UTILITIES ; MAY 08 2026
 ;;5.3;Scheduling;**866,871,875,877,878,880,881,890,893,905,907,922,909,944**;Aug 13, 1993;Build 2
...
GETPID(APPOINTMENT,PID,REQUESTTYPE,REQUESTIEN) ;
 ...
 Q
 ;
LOCKREQ(ERRORS,APPOINTMENT,REQUESTTYPE,REQUESTIEN,DFN,LOCKTYP) ;
 N GLOB
 ;
 S GLOB=$S(REQUESTTYPE="C":"^GMR(123,"_REQUESTIEN_",0)",REQUESTTYPE="A":"^SDEC(409.85,"_REQUESTIEN_",0)",REQUESTTYPE="R":"^SD(403.5,"_REQUESTIEN_",0)",1:"")
 I (GLOB="") D ERRLOG^SDESJSON(.ERRORS,60) Q
 I (LOCKTYP="L") D  Q:$D(ERRORS)
 .L +@GLOB:2 I '$T D ERRLOG^SDESJSON(.ERRORS,658) Q
 .D REQUESTTYPE(.ERRORS,.APPOINTMENT,REQUESTTYPE,REQUESTIEN,DFN)
 .Q
 I (LOCKTYP="U") D
 .L -@GLOB
 Q
