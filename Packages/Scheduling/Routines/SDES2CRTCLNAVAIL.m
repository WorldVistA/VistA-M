SDES2CRTCLNAVAIL ;ALB/BLB,BWF,JDJ,TJB,JDJ - SDES2 SET CLINIC AVAILABILITY ;MAR 12, 2026
 ;;5.3;Scheduling;**890,897,899,903,941**;Aug 13, 1993;Build 3
...
VALIDATEDATETIME(ERRORS,CLINICIEN,AVAILABILITY,NUMBEROFENTRIES) ;
 ...
 .I '$$CHECKDURATION^SDES2UTIL1($P($G(AVAILABILITY("START DATE TIME",COUNT)),".",2),$P($G(AVAILABILITY("END DATE TIME",COUNT)),".",2),$$GET1^DIQ(44,CLINICIEN,1912,"I")) D ERRLOG^SDES2JSON(.ERRORS,582)
