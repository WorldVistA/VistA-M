SDES2BLDAPPT44 ;ALB/LAB,TJB,LAB,JAS,JDJ,JHC,MCB - VISTA SCHEDULING BUILDING APPT OBJECT FOR CLINIC ;APRIL 10,2026
 ;;5.3;Scheduling;**871,877,880,887,895,922,942**;Aug 13, 1993;Build 2
...
GET44003INFO(APPTOBJ,CLINIEN,SDIEN,RECCNT) ; Build appointment object for HOSPITAL LOCATION appointemnt multiple.
 ...
 S APPTOBJ("Appointment",RECCNT,"OtherTests")=$$CLEANCMMTS^SDES2APPTUTIL($G(ARRAY44003(44.003,SDIEN,3,"I")))
 S APPTOBJ("Appointment",RECCNT,"OtherTravel")=$$CLEANCMMTS^SDES2APPTUTIL($G(ARRAY44003(44.003,SDIEN,6,"I")))
