SDESGETAPPTREQ ;ALB/BLB,RRM,MGD,DJS,BLB - GET APPT REQ RPCS ;Oct 31, 2022@15:35
 ;;5.3;Scheduling;**815,818,819,823,824,825,828,831,833**;Aug 13, 1993;Build 9
...
DOESREQUESTEXIST(ERRORS,APPTIEN) ;get request IEN from appointment IEN
 ...
 Q REQUESTIEN
 ;
BUILDPATCOMMENTS(REQUEST,REQUESTIEN,NUM) ; patient comments
 N SUBIEN,COUNT
 S SUBIEN=0,COUNT=0
...
BUILDMRTCS(REQUEST,REQUESTIEN,NUM) ; build MRTC entries
 ...
 Q
 ;
BUILDSDECONTACT(REQUEST,REQUESTIEN,NUM) ; build SDEC contact attempts, called by get consult/recall
 N CONTACTIEN,SUBIEN,CIENS,COUNT,CONTARY,CONTACTYPE
 S SUBIEN=0,COUNT=0,CONTACTIEN=0
 S CONTACTIEN=$O(^SDEC(409.86,"SRP",REQUESTIEN,CONTACTIEN))
...
GETREQUEST(REQUEST,REQUESTIEN) ;
 ...
 ;
 I $D(^SDEC(409.86,"SRP",REQUESTIEN)) D BUILDSDECONTACT(.REQUEST,REQUESTIEN,NUM) ;SDEC Contact type attempts
 ;
