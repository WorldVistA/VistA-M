SDESCLINICDATA ;ALB/TAW,MGD,RRM,CGP,BWF,ANU - VISTA Clinic data getter ;May 03, 2023@10:00
 ;;5.3;Scheduling;**788,823,825,828,831,844**;Aug 13, 1993;Build 12
...
APPTCLINIC(RETURN,IEN) ;
 ...
 S IENS=IEN_","
 ;ANU
 D GETS^DIQ(44,IEN,".01;3.5;8;10;60;62;99;99.1;2503","IE","CLINICARY","SDMSG")
 ...
 S RETURN("StopCodeAMIS")=$G(CLINICARY(44,IENS,8,"I"))
 S RETURN("StopCodeName")=$G(CLINICARY(44,IENS,8,"E"))
 S RETURN("CreditStopCodeAMIS")=$G(CLINICARY(44,IENS,2503,"I"))
