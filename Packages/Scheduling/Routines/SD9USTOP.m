SD9USTOP ;ALB/CAW,GTS,ESD,JAM - Stop Code/DSS Identifier Update 03/08/06
 ;;5.3;Scheduling;**479**;AUG 13, 1993
 ;
...
ADD ;** Add DSS IDs
 ...
 D BMES^XPDUTL(" [NOTE: These Stop Codes CANNOT be used UNTIL 05/1/06]")
...
NEW ;DSS IDs to add- ex ;;STOP CODE NAME^NUMBER^RESTRICTION TYPE^RESTRICTION DATE^CDR
 ;;POLYTRAUMA INDIV^197^P^4/1/2006
 ;;POLYTRAUMA GRP^198^P^4/1/2006
 ;;POLYTRAUMA PHONE^199^P^4/1/2006
 ;;QUIT
 ;
