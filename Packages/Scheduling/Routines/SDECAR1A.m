SDECAR1A ;ALB/SAT,CT - VISTA SCHEDULING RPCS ;MAY 12, 2020@12:15
 ;;5.3;Scheduling;**658,745**;Aug 13, 1993;Build 40
 ;
 Q
 ;
WLPC(ARDATA,ASDIEN) ;
...
CALLET(DFN,ARIEN)  ;COUNT CALLS AND LOG THE LAST LETTER FOR APPOINTMENTS  ;CT - *745 5/12/20
 N REQTYPE,CLINIC,PID,SERVICE
 S SDECALL="",SDECLET=""
 S REQTYPE=$$GET1^DIQ(409.85,ARIEN_",",4,"I") G:$G(REQTYPE)="" CALLETX
 S REQTYPE=$S(REQTYPE="APPT":"A",REQTYPE="MOBILE":"M",REQTYPE="W2VA":"W",REQTYPE="RTC":"RTC",1:"A")  ;set request type to equal what is stored in #409.86
 S CLINIC=$$GET1^DIQ(409.85,ARIEN_",",8,"I") G:$G(CLINIC)="" CALLETX
 S PID=$$GET1^DIQ(409.85,ARIEN_",",22,"I") G:$G(PID)="" CALLETX
 S PID=PID-1_".24"    ;SUBTRACT A DAY IN THE DATE AND ADD .24 TO IT TO MATCH WITH THE DATE IN THE CONTACT FILE, ZERO NODE
...
CALLCON(DFN,SDREC) ;GET CALL AND LETER DATA FOR A CONSULT  CLT - SD*5.3*745
 ...
 S CLINIC=$$GET1^DIQ(123,SDREC_",",2,"I") S:CLINIC="" CLINIC=$$GET1^DIQ(123,SDREC_",",.05,"I") G:$G(CLINIC)="" CALLCONX
