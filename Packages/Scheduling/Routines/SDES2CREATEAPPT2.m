SDES2CREATEAPPT2  ;ALB/TJB,TJB,AGW - SDES2 CREATE APPOINTMENT2 ; MAY 8, 2026
 ;;5.3;Scheduling;**940,941,944**;Aug 13, 1993;Build 2
...
CREATE(JSON,SDCONTEXT,APPOINTMENT) ;
 ...
 .S ERRORS("Appointment",1)="" D BUILDJSON^SDES2JSON(.JSON,.ERRORS)
 .Q
