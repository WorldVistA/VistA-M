SDESPATRPC ;ALB/TAW,RJT,ANU,MGD,DJS,RRM,MGD - PATIENT RPCS ;Apr 23, 2026
 ;;5.3;Scheduling;**792,804,805,807,809,814,816,820,823,824,943**;Aug 13, 1993;Build 5
 ;
...
NEEDVERIFY(NEEDVERIFY,DFN,LASTVERFWINDOW,NOCOVWINDOW) ;
 ...
 .S TMPDT=$G(PATDATA(2.312,IENS,3,"I"))
 .I +TMPDT,(+TMPDT'>DT) Q  ;term date of today is inactive coverage
 .S FEDPOLICY=""
 .S FEDPOLICY=$G(PATDATA(2.312,IENS,.01,"E"))
 .S FEDPOLICY=$$UP^XLFSTR(FEDPOLICY)
 .Q:((FEDPOLICY["MEDICAID")!(FEDPOLICY["MEDICARE")!(FEDPOLICY["TRICARE")!(FEDPOLICY["CHAMPVA"))
 .S FEDONLY="N"
 ;
 ...
 ;
 ;Check the Insurance Types (sub file .312) of the Patient File (#2)
 S SUBIEN=0
 ...
 .S TMPDT=$P($G(PATDATA(2.312,IENS,1.03,"I")),".")
 .I TMPDT D
 ...
 Q:$D(SDMSG)
 S COVBYHI=$G(PATDATA(2,DFN_",",.3192,"I"))
