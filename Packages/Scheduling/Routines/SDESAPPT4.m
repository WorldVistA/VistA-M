SDESAPPT4 ;ALB/RRM,DJS,ANU - GET APPT REQUESTS ;NOV 7, 2022
 ;;5.3;Scheduling;**824,828**;Aug 13, 1993;Build 8
...
APPTBYCLINICLIST(APPTLISTJSON,CLINICIENS) ;
 N APPTLIST,IENCOUNT,YESTERDAYEXTERNL,TODAYEXTERNAL,CLINICIEN,PRVUSERS
 S IENCOUNT=0
