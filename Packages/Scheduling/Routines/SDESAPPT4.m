SDESAPPT4 ;ALB/RRM,DJS,ANU,LAB - GET APPT REQUESTS ;FEB 8,2023
 ;;5.3;Scheduling;**824,828,836**;Aug 13, 1993;Build 20
...
APPTBYCLINICLIST(APPTLISTJSON,CLINICIENS) ;
 N APPTLIST,IENCOUNT,YESTERDAYEXTERNL,TODAYEXTERNAL,CLINICIEN,PRVUSERS,CLINTODAY,TODAY
 ...
 .N TEMPLIST
 .S CLINTODAY=$P($$ISOTFM^SDAMUTDT(TODAY,CLINICIENS(IENCOUNT)),".",1)
 .S YESTERDAYEXTERNL=$$FMADD^XLFDT(CLINTODAY,"","","",-1)
 .S YESTERDAYEXTERNL=$$FMTONET^SDECDATE(YESTERDAYEXTERNL)
 .S TODAYEXTERNAL=$$FMADD^XLFDT(CLINTODAY,"",23,59,59)
 ...
 Q
 ;;THIS IS FOR EAS TEAM VSE3539 TO GET ENTIRE APPT OBJECT
APPTBYCLNLISTEAS(APPTLISTJSON,CLINICIENS) ;
 ...
 .S TODAYEXTERNAL=$$FMADD^XLFDT(CLINTODAY,"",23,59,59)
 .S TODAYEXTERNAL=$$FMTONET^SDECDATE(TODAYEXTERNAL)
 .D APPTBYCLINIC2EXT(.TEMPLIST,CLINICIENS(IENCOUNT),YESTERDAYEXTERNL,TODAYEXTERNAL,"")
 .S CLINICIEN=CLINICIENS(IENCOUNT)
 .N DIVISION,INSTITUT,STATION
 .S DIVISION=$$GET1^DIQ(44,CLINICIEN,3.5,"I")
 .S INSTITUT=$$GET1^DIQ(40.8,DIVISION,.07,"I")
...
APPTBYCLINIC2EXT(SDAPPT,SDCLINICIEN,SDBEG,SDEND,SDEAS) ;
 ...
 ...S APPTIEN=""
 ...F  S APPTIEN=$O(^SDEC(409.84,"ARSRC",SDRESIEN,APPTDT,APPTIEN)) Q:APPTIEN=""  D
 ....;D SUMMARY2^SDESAPPTDATA(.APPTDATA,APPTIEN)
