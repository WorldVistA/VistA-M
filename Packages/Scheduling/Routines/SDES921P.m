SDES921P ;ALB/MGD - FY26 - Stop Code Updates; Sept 05, 2025@08:42
 ;;5.3;Scheduling;**921**;AUG 13, 1993;Build 1
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 ; Post-init routine updating stop codes in CLINIC STOP file (#40.7)
 ; for FY26 updates - effective 10/01/2025.
 ;
 Q
 ;
POST     ; Update stop codes in Clinic Stop file 40.7
 ;
 D BMES^XPDUTL("SD*5.3*921 Post-Install starts...")
 ...
 D MES^XPDUTL("SD*5.3*921 Post-Install is complete."),MES^XPDUTL("")
...
ADD      ; Add new stop code
 ...
 D BMES^XPDUTL("    [NOTE: These Stop Codes CANNOT be used UNTIL 10/01/2025]")
 ;
...
INACT    ; Inactivate stop code
 ...
 . . I $D(^DIC(40.7,SDIEN,0)) I $P(^DIC(40.7,SDIEN,0),U,3)="" D
...
REACT    ; Reactivate stop code
 ...
 . . . . K SDINTERR
 . . . I '$D(SDINTERR) D
 . . . . D BMES^XPDUTL("     >> Reactivated: "_+SDCODE_"   "_SDNM_" as of 10/01/2025")
 ;
...
CHG      ; Code name changes - ;;code name^code #^^new code name
 ;;PHYSICIAN ASSISTANT^186^^PHYSICIAN ASSIST/ASSOC (PA)
 ;;ADULT DAY HEALTH CARE^190^^VA BASED ADHC
 ;;QUIT
 ;
