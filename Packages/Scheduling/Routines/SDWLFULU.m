...
MESS ;
 ...
 S XMY("BENBOW.PHYLLIS2@FORUM.domain.ext")=""
 S XMY("DERDERIAN.JOHN@FORUM.domain.ext")=""
 S XMY("HOUTCHENS.THOMAS@FORUM.domain.ext")=""
 S XMY("BROWN.BONNIE@FORUM.domain.ext")=""
 S XMY("KROCHMAL.CHUCK@FORUM.domain.ext")=""
 S XMY("TAPPER.BRIAN@FORUM.domain.ext")=""
 S XMY("LANDRIE.LARRY@FORUM.domain.ext")=""
 S XMY("TOWSON.LINDA@FORUM.domain.ext")=""
