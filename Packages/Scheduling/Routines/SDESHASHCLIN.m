SDESHASHCLIN ;ALB/LAB,MGD,BWF,BLB,MGD - VISTA SCHEDULING RPCS HASH CLINIC ;June 05, 2025
 ;;5.3;Scheduling;**823,824,828,871,902,914**;Aug 13, 1993;Build 1
 ;;Per VHA Directive 6402, this routine should not be modified
 Q
 ;
HASHALL ;hash all clinics this will be a jobbed option: SDES HASH ALL CLINICS
 NEW CLINIC,CNT,LISTOFHASH,FDA,FDAERR,TMPCNT,CLINRET,CLIN
 S (CLIN,CNT)=0
 F  S CLIN=$O(^SC(CLIN)) Q:(+CLIN=0)  D
 . ;
 . I $$GET1^DIQ(44,CLIN,2505,"I"),$$GET1^DIQ(44,CLIN,2505,"I")<=DT,$$INACTIVE^SDESUTIL(CLIN),'+$$GET1^DIQ(44,CLIN,2506,"I") D
 . . D REMOVEPROVS(CLIN)
 . ;
 ...
 . S CURRENTHASH=$$LSHAN^XLFSHAN(160,"XLFMSG",TMPCNT)
 . Q:CURRENTHASH=$$GET1^DIQ(44,CLIN,2900,"I")
 . S FDA(44,CLIN_",",2900)=CURRENTHASH
 . S FDA(44,CLIN_",",2901)=$$NOW^XLFDT
 . D FILE^DIE(,"FDA","FDAERR") K FDA
 . K ^TMP($J,"XLFMSG")
 Q
 ;
REMOVEPROVS(CLINICIEN) ;
 N SUBIEN,FDA
 ;
 S SUBIEN=0
 F  S SUBIEN=$O(^SC(CLINICIEN,"PR",SUBIEN)) Q:'SUBIEN  D
 .S FDA(44.1,SUBIEN_","_CLINICIEN_",",.01)="@"
...
UPDTHASHONECLIN(JSONRETURN,CLIN,SDEAS) ;Create hash and update file, returns back hash for clinic
 N SDHASERROR,FDA,FDAERR,HASHREC,TMPCNT,CURRENTHASH
 S TMPCNT=0
 D VALIDATECLIN(.SDHASERROR,CLIN)
 D VALIDATEEAS(.SDHASERROR,.SDEAS)
 I '$D(SDHASERROR) D
...
BLDCLNREC(SDCLNJSON,SDCLNIEN,TMPCNT) ;Get Clinic data
 ...
 S SDCLNSREC("Clinic","EASTrackingNumber")=$G(SDDATA(44,SDCLNIEN_",",100,"I")) ;EAS TRACKING NUMBER
