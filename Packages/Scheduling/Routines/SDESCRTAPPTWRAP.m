SDESCRTAPPTWRAP  ;ALB/BLB,MGD - VISTA SCHEDULING RPCS ; Sept 21, 2022@16:20
 ;;5.3;Scheduling;**814,816,823,826,827,828**;Aug 13, 1993;Build 8
...
CREATE44(ARY44,ERRORS,ARRAYDELETE,RETURNIEN44) ;
 ...
 I $D(ARRAY44001FDA) D
 .L +^SC(ARY44("CLINICIEN")):3
 .I '$T D ERRLOG^SDESJSON(.ERRORS,186) D DELETERECORD(.ARRAYDELETE) Q
 .D UPDATE^DIE(,"ARRAY44001FDA","NEWIEN44001","SDERR1") K FDA44001FDA
 .L -^SC(ARY44("CLINICIEN"))
 I $D(ERRORS) Q 0
 I $D(SDERR1) D DELETERECORD(.ARRAYDELETE),ERRLOG^SDESJSON(.ERRORS,173) Q 0 ;delete all records in arraydelete
 ;
 L +^SC(ARY44("CLINICIEN")):3
 I '$T D ERRLOG^SDESJSON(.ERRORS,186) D DELETERECORD(.ARRAYDELETE) Q 0
 ...
 S ARRAYDELETE(44.003)=$G(IENS44(1))_$G(NEWIEN44003(1))_",",RETURNIEN44=$G(NEWIEN44003(1))
 Q 1
 ;
