SDESBLKANDMOVE ;ALB/TAW,MGD - BLOCK AND MOVE ;July 19, 2022
 ;;5.3;Scheduling;**797,799,800,801,803,804,805,807,819,820**;Aug 13, 1993;Build 10
...
APPTBLOCKMOVE(RETURN,APPTIEN,TORES,TODTNET,EASTRCKNGNMBR) ;
 ...
 I 'POP D APPDEL
 I 'POP D
 .I APPTLENGTH<TOTIMESCALE D APPADD(APPTIEN,TODTFM,TOTIMESCALE,TORES,TOENDDTFM) Q
 .I APPTLENGTH>=TOTIMESCALE D APPADD(APPTIEN,TODTFM,APPTLENGTH,TORES,TOENDDTFM)
...
VALIDATEINPUT ;Validate input parameters from the APPTBLOCKMOVE entry point
 ...
 Q
 ;
LOADAPPTDATA ;Load variables used throughout B&M
 N SDMSG
...
APPDEL ;Call APPDEL RPC to cancel the current appointment
 ...
 Q
 ;
APPADD(SDECAPPTIEN,SDECSTART,SDECLEN,SDECRES,SDECEND) ;entry point before calling APPADD^SDEC07
 ;Input:
 ...
 S SDAPTYP=$G(APPTARY(FN,SDECAPPTIENS,.22,"E")) ;Appointment Request Type
 S SDAPTYP=$S(SDAPTYP="APPT":"A",SDAPTYP="RECALL":"R",SDAPTYP="CONSULT":"C",SDAPTYP="EWL":"E",1:"")
 S SDAPTYP=SDAPTYP_"|"_$P(APPTARY(FN,SDECAPPTIENS,.22,"I"),";")
