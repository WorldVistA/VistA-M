SDESCREATEAPPREQ  ;ALB/BLB,MGD,BLB - VISTA SCHEDULING RPCS; Oct 17, 2022@20:49
 ;;5.3;Scheduling;**823,826,833**;Aug 13, 1993;Build 9
...
VALIDATE(REQUEST,ERRORS) ;
 ...
 ;
 I $D(REQUEST("MRTC")) D VALIDATEMRTCDATA(.ERRORS,.REQUEST,$G(REQUEST("PARENT REQUEST")),$G(REQUEST("MRTC","NEEDED")),$G(REQUEST("MRTC","DAYS BETWEEN APPTS")),$G(REQUEST("MRTC","HOW MANY NEEDED")))
 ;
...
BUILDER(REQUEST) ;
 ...
 ;
 I $D(REQUEST("REQUEST COMMENT"))!($D(REQUEST("PATIENT COMMENT")))!($D(REQUEST("PATIENT PREFERRED START DATE"))) D BUILDCOMMENTS(.REQUEST,REQUESTIEN)
 ;
