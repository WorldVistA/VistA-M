SDEC ;ALB/SAT,PC,LAB - VISTA SCHEDULING RPCS ;Apr 10, 2020@15:22
 ;;5.3;Scheduling;**627,643,642,651,658,665,672,679,686,694,745**;Aug 13, 1993;Build 40
...
APPDEL(SDECY,S1,S2,S3,S4,S5,S6,S7,S8) ;EP Cancels appointment *745
 D APPDEL^SDEC08(.SDECY,$G(S1),$G(S2),$G(S3),$G(S4),$G(S5),$G(S6),$G(S7),$G(S8)) Q
...
ARCLOSE(RET,S1,S2,S3,S4) ;Appt Request close 
