SDESRECALLREQ ;ALB/BWF/BLB,BLB/JAS,JHC,AGW - VISTA SCHEDULING RECALL/APPT REQUEST RPCS ; MAY 6, 2026
 ;;5.3;Scheduling;**835,847,853,875,877,909,944**;Aug 13, 1993;Build 2
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 ; Reference to DUZ^XUP is supported by IA #7487
 ;
 Q
REOPEN(RETURN,APPTIEN,SDAPTYP,NEWPID,SDECTYP,NOSHOWFLAG,EAS) ;for Recall Requests
 ...
 S REQIEN=$$BUILDER^SDES2CRTAPREQ(.REQUEST,INSTIEN,EAS)
