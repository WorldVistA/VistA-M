SDBT ; GENERATED FROM 'SDB' INPUT TEMPLATE(#485), FILE 44;11/25/19
 D DE G BEGIN
...
C1F1 N X,X1,X2 S DIXR=1510 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 K X M X=X2 D
...
C9F1 N X,X1,X2 S DIXR=1510 D C9X1(U) K X2 M X2=X D C9X1("O") K X1 M X1=X
 K X M X=X2 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . S X=X1(1)'=""!X1(2)'=""!X1(3)'=""!X1(4)'=""!X1(5)'=""!X1(6)'=""!X1(7)'=""!X1(8)'=""!X1(9)'=""
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
...
C17X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C17F2 S DIXR=1510 D C17X2(U) K X2 M X2=X D C17X2("O") K X1 M X1=X
 K X M X=X2 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . S X=X1(1)'=""!X1(2)'=""!X1(3)'=""!X1(4)'=""!X1(5)'=""!X1(6)'=""!X1(7)'=""!X1(8)'=""!X1(9)'=""
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
...
C43X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C43F2 S DIXR=1510 D C43X2(U) K X2 M X2=X D C43X2("O") K X1 M X1=X
 K X M X=X2 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . S X=X1(1)'=""!X1(2)'=""!X1(3)'=""!X1(4)'=""!X1(5)'=""!X1(6)'=""!X1(7)'=""!X1(8)'=""!X1(9)'=""
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
