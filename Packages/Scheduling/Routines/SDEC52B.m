SDEC52B ;ALB/MGD/ANU - VISTA SCHEDULING RPCS ;oct 20, 2022
 ;;5.3;Scheduling;**627,796,797,827**;Aug 13, 1993;Build 10
...
GET1PR(SDI,RECINACT,SDCNT)  ;
 ...
 S SDTERM=$$GET1^DIQ(200,PROVIEN,9.2,"I")
 Q:(RECINACT=0)&(SDTERM'=""&(SDTERM<DT))
 S SDCNT=SDCNT+1
