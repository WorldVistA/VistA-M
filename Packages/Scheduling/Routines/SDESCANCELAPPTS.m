SDESCANCELAPPTS ;ALB/BLB,MGD - VISTA SCHEDULING RPCS ;July 19, 2022
 ;;5.3;Scheduling;**818,820,828**;Aug 13, 1993;Build 8
...
CANCELAPPTS(JSONRETURN,APPTIEN,CLINICIEN,DFN,CANBYCLINORPAT,CANCELREASONIEN,NOTE,CANCELHASH,EAS) ;
 ...
 .D OPENAPPTREQUEST(REQUESTIEN,$G(APPTIEN))
 .D DELETEAPPTDATA(REQUESTIEN)
 ;
 I REQUESTTYPE="RECALL" D
 .D RECREQ^SDECRECREQ(.JSONRETURN,$G(APPTIEN),,,CANBYCLINORPAT)
 ;
 I REQUESTTYPE="CONSULT" D
 .S PROVIEN=$$GET1^DIQ(44,CLINICIEN,16,"I")
 .D REQSET^SDEC07A($P($$GET1^DIQ(409.84,$G(APPTIEN),.22,"I"),";"),PROVIEN,"",2,CANBYCLINORPAT,NOTE,$$GET1^DIQ(409.84,$G(APPTIEN),.01),$$GET1^DIQ(409.84,$G(APPTIEN),.07,"I"),$G(DFN))
 ;
...
OPENAPPTREQUEST(REQUESTIEN,APPTIEN) ;
 ...
 S REQUESTFDA(409.85,REQUESTIEN,22)=""
