SDESNOSHOW ;ALB/BWF - VISTA SCHEDULING RPCS NOSHOW/UNDO NOSHOW ; Nov 19, 2022
...
CONSREQUESTSET(PROVIDER,APPTDTTM,RESOURCE) ;
 ...
 .D REQSET^SDEC07A(CONSULTIEN,PROVIDER,,1,,NOTE,APPTDTTM,RESOURCE)
 Q
 ; update PID
UPDREQPID(IEN,VAL) ;
 N FDA
...
UPDCNSLT(SDAPID,DFN,SDCL,SDT) ;
 ...
 I $P(SDRTYP,";",2)="SD(403.5," D RECREQ^SDECRECREQ(.SDESRES,APPTIEN,SDRTYP)
 Q
