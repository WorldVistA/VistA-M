SD7USTOP ;ALB/CAW,GTS,ESD,JAM - Stop Code/DSS Identifier Update 11/02/05
 ;;5.3;Scheduling;**465**;AUG 13, 1993
 ;
...
REST ;Change restriction - ;;STOP CODE NAME^NUMBER^REST TYPE^RES DATE^OLD
 ;;COMMUNITY ADHC FOLLOWUP^191^P^10/1/2005^P
 ;;TELEPHONE/BLIND REHAB PROGRAM^229^P^10/1/2005^P
 ;;VICTORS^437^P^10/1/2005^P
 ;;LOW VISION CARE^439^P^10/1/2005^P
 ;;STORE & FORWARD TELEHLTH^694^S^10/1/2005^S
 ;;STORE & FWD TELEHLTH SAME STA^695^S^10/1/2005^S
 ;;STORE & FWD TELEHLTH DIFF STA^696^S^10/1/2005^S
 ;;QUIT
