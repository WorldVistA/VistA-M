SDCNP0 ;ALB/LDB,ANU,MGD,BLB - CANCEL APPT. FOR A PATIENT ; Aug 6, 2025
 ;;5.3;Scheduling;**132,167,478,517,572,592,627,658,801,803,804,884,918**;Aug 13, 1993;Build 4
...
SDEC(DFN,S,SDCLI,SDWH,SDSCR,SDREM,SDNOW,SDDUZ,SDF) ;update SDEC APPOINTMENT   /alb/sat  SD/627
 ...
 ;
 I $L($$GET1^DIQ(409.84,SDECAPPT,2)),$P($G(XQY0),U)="SDCANCEL" D
 .S VVSCANCEL=$$RESTPOST^SDESCANCELVVS(SDECAPPT,,"OTHER")
 .I '$G(VVSCANCEL) H 2
 ;
