...
PID ;-compare PID fields with DHCP
 ...
 ;Process if value exist-also handles multiple addr
 ...
 ..;IVM*2.0*164-Uncomment Conf, Add Res
 ...
 ...;IVM*2.0*219-Add Ext to ph
 ...I IVMFLD'="",(IVMFLD'="@") D
 ....I IVMEXT'="",(IVMEXT'="@") S IVMFLD=IVMFLD_"X"_IVMEXT
 ..;[Work]
...
ZTA ; -compare ZTA with DHCP
 ...
 ..;IVM*2.0*219-Add Ext to ph
 ..I IVMFLD'="",(IVMFLD'="@") D
 ...I ($P(IVMPHONE,$E(HLECH),4)'=""),IVMPIECE=2 S IVMFLD=IVMFLD_"X"_$P(IVMPHONE,$E(HLECH),4)
 ..I IVMFLD]"",(IVMFLD'=IVMDHCP) D STORE^IVMPREC9
 .I IVMFLD]"",(IVMFLD'=IVMDHCP) D STORE^IVMPREC9
 .I IVMXREF["ZTA08" D
...
ZAV ; compare ZAV with DHCP
 ;IVM*2.0*217-Moved ZAVA^IVMPREC6
 D ZAVA^IVMPREC6
 Q
 ;
ZGD ; - compare ZGD with DHCP
 ;IVM*2.0*219-Moved ZGDPA^IVMPRECA
 D ZGDPA^IVMPRECA
 Q
 ;
...
ZEM ; - compare ZEM with DHCP
 ...
 I $P(IVMSEG,HLFS,$E(IVMPIECE,1,2))]"" D
 .;set IVMFLD to incoming HL7 field
 .I 'IVMADFLG S IVMFLD=$P(IVMSEG,HLFS,$E(IVMPIECE,1,2))
...
RF1 ; -compare RF1 with DHCP
 ...
 ;IVM*2.0*217-Add Conf Ph
 I RF1TYPE="PHC",((IVMXREF="RF161CP")!(IVMXREF="RF162CP")!(IVMXREF="RF171CP")) D RF1PROC
...
RF1PROC ;
 ...
 ..;164-SET IVMEPC TO NONBLANK 
 ..;S IVMEPC=$E(IVMXREF,6)
 ..S IVMEPC=""
 ..;IVM*2.0*217-Add Conf Ph change source
 ..;I (IVMXREF="RF162E")!(IVMXREF="RF162C")!(IVMXREF="RF162B")!(IVMXREF="RF162P") S IVMEPC="2"
 ..I (IVMXREF="RF162E")!(IVMXREF="RF162C")!(IVMXREF="RF162CP")!(IVMXREF="RF162B")!(IVMXREF="RF162P") S IVMEPC="2"
 ...
 ..;IVM*2.0*214-Get PHONE NUMBER [WORK]
 ...
 ..;IVM*2.0*217-Get CONF PHONE
 ..I IVMDHCP="" S IVMDHCP=$S(RF1TYPE="PHC":$P($G(^DPT(DFN,.141)),HLFS,21),1:"")
 ...
 ...;167-Make Home ph rec auto-upload
