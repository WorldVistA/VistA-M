DINIT13 ;SFISC/YJK-INITIALIZE VA FILEMAN ;04JAN2016
...
DD F I=1:1 S X=$T(DD+I),Y=$P(X," ",3,99) G ^DINIT14:X?.P S @("^DD("_$E($P(X," ",2),3,99)_")=Y")
 ...
 ;;.4,21400,21,0 ^^3^3^3160104^
 ;;.4,21400,21,1,0 This computed field searches the Build File(#9.6) for Builds containing the Print Template.
 ;;.4,21400,21,2,0 A list of the identified Builds is created for display. 
 ;;.4,21400,21,3,0 Multiple Builds will be shown if appropriate.
