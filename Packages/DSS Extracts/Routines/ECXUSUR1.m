ECXUSUR1 ;ALB/TJL-Surgery Pre-Extract Unusual Volume Report ;6/15/17  15:44
 ;;3.0;DSS EXTRACTS;**49,71,105,111,128,148,161,166,184**;Dec 22, 1997;Build 124
 ;
...
STUFF ;gather data
 ...
 S ECXPDIV=$$RADDIV^ECXDEPT(ECDIV) ;184 - Production Division
 ;get data
...
FILE ; Store unusual records for display later
 ...
 S ^TMP($J,ECXPDIV,-VOL,-ECD0)=SURNAME_U_$S(ECXPORT:SURSSN,1:$E(SURSSN,6,9))_U_SURDT_U_ECD0_U_ECXENC_U_ECODE0_U_ECXPROC_U_ECCAN ;184 Added ECXPDIV 
 S COUNT=COUNT+1
