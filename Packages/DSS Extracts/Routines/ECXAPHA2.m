ECXAPHA2 ;ALB/TMD-Pharmacy Extracts Unusual Volumes Report ;4/9/19  15:47
 ;;3.0;DSS EXTRACTS;**40,49,84,104,105,113,136,143,144,174,178,184**;Dec 22, 1997;Build 124
 ;
...
FILE ; put records in temp file to print later
 ...
 ;S ECPPDU=$P(ECXPHA,U,7) ;184 - Price per Dispense Unit
 ;I ECXOPT'=2&'(ECXOPT=4&($G(ECXBCM)="I")) S ECUNIT=$P(ECXPHA,U,8)
 I ECXOPT'=2 S ECUNIT=$P(ECXPHA,U,8) ;184
