...
21 S DW="81;4",DV="*P80'X",DU="",DIFLD=81.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C21^DGX5FD7",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
31 S DW="81;5",DV="*P80'X",DU="",DIFLD=81.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGX5FD7",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
41 S DW="81;6",DV="*P80'X",DU="",DIFLD=81.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^DGX5FD7",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
51 S DW="81;7",DV="*P80'X",DU="",DIFLD=81.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C51^DGX5FD7",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
