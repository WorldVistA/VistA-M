...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,8) S:%]"" DE(1)=% S %=$P(%Z,U,9) S:%]"" DE(11)=% S %=$P(%Z,U,11) S:%]"" DE(21)=% S %=$P(%Z,U,12) S:%]"" DE(31)=% S %=$P(%Z,U,13) S:%]"" DE(41)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,4) S:%]"" DE(4)=% S %=$P(%Z,U,5) S:%]"" DE(14)=% S %=$P(%Z,U,6) S:%]"" DE(24)=% S %=$P(%Z,U,7) S:%]"" DE(34)=% S %=$P(%Z,U,8) S:%]"" DE(44)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="DGX5FD2",DQ=1
1 S DW="0;8",DV="*P80'X",DU="",DLB="ICD 4",DIFLD=8
 S DE(DW)="C1^DGX5FD2",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X3 I DGXX="" S Y="@61"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;4",DV="SX",DU="",DLB="POA FOR ICD 4",DIFLD=82.04
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,8) X
 Q
 ;
5 S DQ=6 ;@61
...
X7 I X K DGPTIT S DGNFLD="@70",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@70
...
X10 S DGNFLD="@80"
 Q
11 S DW="0;9",DV="*P80'X",DU="",DLB="ICD 5",DIFLD=9
 S DE(DW)="C11^DGX5FD2",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X13 I DGXX="" S Y="@71"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;5",DV="SX",DU="",DLB="POA FOR ICD 5",DIFLD=82.05
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,9) X
 Q
 ;
15 S DQ=16 ;@71
...
X23 I DGXX="" S Y="@81"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;6",DV="SX",DU="",DLB="POA FOR ICD 6",DIFLD=82.06
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,11) X
 Q
 ;
25 S DQ=26 ;@81
...
X33 I DGXX="" S Y="@91"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;7",DV="SX",DU="",DLB="POA FOR ICD 7",DIFLD=82.07
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,12) X
 Q
 ;
35 S DQ=36 ;@91
...
X43 I DGXX="" S Y="@101"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;8",DV="SX",DU="",DLB="POA FOR ICD 8",DIFLD=82.08
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X44 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,13) X
 Q
 ;
45 S DQ=46 ;@101
