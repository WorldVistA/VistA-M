DG53922P ;ALB/BKG - 2015 MEANS TEST THRESHOLDS ; 11/12/15 2:55pm
 ;;5.3;Registration;**922**;Aug 13, 1993;Build 3
 ;
 ; This routine will upload the 2016 Means Test Thresholds and
...
MT ; Update Means Test Thresholds
 ...
 S DGEXST=0
 D BMES^XPDUTL(">>>Means Test Thresholds for 2016 being installed...")
 I $D(^DG(43,1,"MT",3160000)) D
 .D BMES^XPDUTL(" ...Entry exists for income year 2016, entry being deleted")
 .D MES^XPDUTL("    and replaced with nationally released thresholds.")
 .S DIK="^DG(43,1,""MT"",",DA=3160000,DA(1)=1
 .D ^DIK,IX1^DIK
 .K DA,D0,DIK
 K DO
 S DIC="^DG(43,1,""MT"","
 ...
 ;
 I +Y'=3160000 D  Q
 . D BMES^XPDUTL("   ...Problem encountered adding 2016 thresholds.  Please try")
...
DATA ; lines to stuff in values (field////value)
 ...
 ;;17^10350^CHILD INCOME EXCLUSION
 ;;QUIT
 Q
 ;
MAPR ; Update Maximum Annual Pension Rates
 ...
 D SETPARM("DGMT MAPR GLOBAL RATE",2015,5)
 ;
 ;set MAPR max values
 D SETPARM("DGMT MAPR 0 DEPENDENTS",2015,12868)
 D SETPARM("DGMT MAPR 1 DEPENDENTS",2015,16851)
 D SETPARM("DGMT MAPR N DEPENDENTS",2015,2198)
 Q
 ;
