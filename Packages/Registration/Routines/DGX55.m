...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,26) S:%]"" DE(61)=%,DE(64)=% S %=$P(%Z,U,27) S:%]"" DE(67)=%,DE(70)=% S %=$P(%Z,U,28) S:%]"" DE(73)=%,DE(76)=% S %=$P(%Z,U,29) S:%]"" DE(85)=%,DE(88)=% S %=$P(%Z,U,30) S:%]"" DE(91)=%,DE(95)=%
 I  S %=$P(%Z,U,31) S:%]"" DE(55)=%,DE(58)=% S %=$P(%Z,U,32) S:%]"" DE(79)=%,DE(82)=%
...
1 S DW="81;14",DV="*P80'X",DU="",DIFLD=81.14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1626 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
X3 I DGXX="" S Y="@261"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;24",DV="SX",DU="",DIFLD=82.24,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@280"
 Q
11 S DW="81;15",DV="*P80'X",DU="",DIFLD=81.15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1627 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
X13 I DGXX="" S Y="@271"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;25",DV="SX",DU="",DIFLD=82.25,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X22 I '$D(DGBPC(2))!(DGDUP(2)) S Y="@8100"
 Q
23 S DW="300;2",DV="SX",DU="",DIFLD=300.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X26 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8200"
 Q
27 S DW="300;3",DV="SX",DU="",DIFLD=300.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="1:Yes;2:No;"
 G RE
...
X30 I '$D(DGBPC(4))!(DGDUP(4)) S Y="@8300"
 Q
31 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=31 D X31 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X31 D DRUG^DGPTSC01 I $D(DGTX) S Y="@8250"
 Q
32 S DW="300;4",DV="P45.61'X",DU="",DIFLD=300.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(45.61,"
 G RE
...
X34 S Y="@8300"
 Q
35 S DQ=36 ;@8250
36 S DW="300;4",DV="P45.61'X",DU="",DIFLD=300.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(45.61,"
 S X=DGTX
 S Y=X
 G Y
...
X39 I '$D(DGBPC(5))!(DGDUP(5)) S Y="@8400"
 Q
40 S DW="300;5",DV="SX",DU="",DIFLD=300.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X43 I '$D(DGBPC(6))!(DGDUP(6)) S Y="@8500"
 Q
44 S DW="300;6",DV="NJ2,0X",DU="",DIFLD=300.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
...
X47 I '$D(DGBPC(7))!(DGDUP(7)) S Y="@8990"
 Q
48 S DW="300;7",DV="NJ2,0X",DU="",DIFLD=300.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
...
X54 I '$D(DGEXQ(6)) S Y="@9040"
 Q
55 S DW="0;31",DV="S",DU="",DIFLD=31,DLB="WAS TREATMENT RELATED TO COMBAT?"
 S DU="Y:YES;N:NO;"
 S Y="YES"
 G Y
X55 Q
...
X56 S Y="@9050"
 Q
57 S DQ=58 ;@9040
58 S DW="0;31",DV="S",DU="",DIFLD=31,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
...
X60 I '$D(DGEXQ(1)) S Y="@9100"
 Q
61 S DW="0;26",DV="SX",DU="",DIFLD=26,DLB="WAS TREATMENT RELATED TO AGENT ORANGE EXPOSURE?"
 S DU="Y:YES;N:NO;"
 G RE
...
X62 S Y="@9150"
 Q
63 S DQ=64 ;@9100
64 S DW="0;26",DV="SX",DU="",DIFLD=26,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X66 I '$D(DGEXQ(2)) S Y="@9200"
 Q
67 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB="WAS TREATMENT RELATED TO IONIZING RADIATION EXPOSURE?"
 S DU="Y:YES;N:NO;"
 G RE
...
X68 S Y="@9250"
 Q
69 S DQ=70 ;@9200
70 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X70 S DGFLAG=2 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
71 S DQ=72 ;@9250
72 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=72 D X72 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X72 I '$D(DGEXQ(3)) S Y="@9300"
 Q
73 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB="WAS TREATMENT RELATED TO SERVICE IN SW ASIA?"
 S DU="Y:YES;N:NO;"
 G RE
X73 S DGFLAG=3 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
...
X74 S Y="@9350"
 Q
75 S DQ=76 ;@9300
76 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X76 S DGFLAG=3 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
77 S DQ=78 ;@9350
78 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=78 D X78 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X78 I '$D(DGEXQ(7)) S Y="@9400"
 Q
79 S DW="0;32",DV="S",DU="",DIFLD=32,DLB="WAS TREATMENT RELATED TO PROJ 112/SHAD?"
 S DU="Y:YES;N:NO;"
 G RE
X79 Q
...
X80 S Y="@9450"
 Q
81 S DQ=82 ;@9400
82 S DW="0;32",DV="S",DU="",DIFLD=32,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X84 I '$D(DGEXQ(4)) S Y="@9500"
 Q
85 S DW="0;29",DV="S",DU="",DIFLD=29,DLB="WAS TREATMENT RELATED TO MILITARY SEXUAL TRAUMA?"
 S DU="Y:YES;N:NO;"
 G RE
X85 Q
...
X86 S Y="@9550"
 Q
87 S DQ=88 ;@9500
88 S DW="0;29",DV="S",DU="",DIFLD=29,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X88 Q
89 S DQ=90 ;@9550
90 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=90 D X90 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X90 I '$D(DGEXQ(5)) S Y="@9600"
 Q
91 S DW="0;30",DV="S",DU="",DIFLD=30,DLB="WAS TREATMENT RELATED TO HEAD AND/OR NECK CANCER?"
 S DU="Y:YES;N:NO;"
 G RE
X91 Q
92 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=92 D X92 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X92 I X["Y",$D(DFN),$$FILEHNC^DGNTAPI1(DFN)
 Q
93 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=93 D X93 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X93 S Y="@9650"
 Q
94 S DQ=95 ;@9600
95 S DW="0;30",DV="S",DU="",DIFLD=30,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
96 S DQ=97 ;@9650
97 S DQ=98 ;@9999
98 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=98 D X98 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X98 K DGEXQ S Y=DGNFLD
 Q
99 G 1^DIE17
