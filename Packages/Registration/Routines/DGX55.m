...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 ...
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,1) S:%]"" DE(11)=% S %=$P(%Z,U,2) S:%]"" DE(21)=% S %=$P(%Z,U,3) S:%]"" DE(31)=% S %=$P(%Z,U,4) S:%]"" DE(41)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,10) S:%]"" DE(4)=% S %=$P(%Z,U,11) S:%]"" DE(14)=% S %=$P(%Z,U,12) S:%]"" DE(24)=% S %=$P(%Z,U,13) S:%]"" DE(34)=% S %=$P(%Z,U,14) S:%]"" DE(44)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="0;15",DV="*P80'X",DU="",DLB="ICD 10",DIFLD=15
...
X3 I DGXX="" S Y="@121"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;10",DV="SX",DU="",DLB="POA FOR ICD 10",DIFLD=82.1
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,15) X
 Q
 ;
5 S DQ=6 ;@121
...
X7 I X K DGPTIT S DGNFLD="@130",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@130
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD1,U,1)]"" S Y="@140"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@140"
 Q
11 S DW="81;1",DV="*P80'X",DU="",DLB="ICD 11",DIFLD=81.01
...
X13 I DGXX="" S Y="@131"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;11",DV="SX",DU="",DLB="POA FOR ICD 11",DIFLD=82.11
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,1) X
 Q
 ;
15 S DQ=16 ;@131
...
X23 I DGXX="" S Y="@141"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;12",DV="SX",DU="",DLB="POA FOR ICD 12",DIFLD=82.12
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,2) X
 Q
 ;
25 S DQ=26 ;@141
...
X33 I DGXX="" S Y="@151"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;13",DV="SX",DU="",DLB="POA FOR ICD 13",DIFLD=82.13
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,3) X
 Q
 ;
35 S DQ=36 ;@151
...
X43 I DGXX="" S Y="@161"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;14",DV="SX",DU="",DLB="POA FOR ICD 14",DIFLD=82.14
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X44 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,4) X
 Q
 ;
45 S DQ=46 ;@161
