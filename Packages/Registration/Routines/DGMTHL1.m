DGMTHL1 ;ALB/CJM/TDM,LBD,HM - Hardship Determinations - Build List Area;13 JUN 1997 08:00 am ;1/6/20 5:48pm
 ;;5.3;Registration;**182,456,536,858,996**;08/13/93;Build 47
 ;
...
SETREV(HARDSHIP) ;SET REVIEW DATE TO DEC 31 OF CURRENT YEAR SO THAT HARDSHIP WILL EXPIRE DECEMBER 31 11:59 PM OF CURRENT YEAR
 ;DG*5.3*996
 N REVDT,REVDTYR
 S REVDT=$E(DT,1,3),REVDT=REVDT_"1231",HARDSHIP("REVIEW")=REVDT
 Q
 ;
