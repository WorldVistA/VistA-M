...
DE S DIE="^DGPT(D0,""P"",",DIC=DIE,DP=45.05,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"P",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,4) S:%]"" DE(63)=% S %=$P(%Z,U,18) S:%]"" DE(1)=% S %=$P(%Z,U,19) S:%]"" DE(6)=% S %=$P(%Z,U,20) S:%]"" DE(11)=% S %=$P(%Z,U,21) S:%]"" DE(16)=% S %=$P(%Z,U,22) S:%]"" DE(21)=% S %=$P(%Z,U,23) S:%]"" DE(26)=%
 I  S %=$P(%Z,U,24) S:%]"" DE(31)=%
 I $D(^(1)) S %Z=^(1) S %=$P(%Z,U,1) S:%]"" DE(36)=% S %=$P(%Z,U,2) S:%]"" DE(41)=% S %=$P(%Z,U,3) S:%]"" DE(46)=% S %=$P(%Z,U,4) S:%]"" DE(51)=% S %=$P(%Z,U,5) S:%]"" DE(56)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;18",DV="*P80.1'X",DU="",DIFLD=17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C6F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1255,1692 S DIEZRXR(45.05,DIXR)=""
 Q
X6 N DGIT S DGIT=5 D GETAPI^DGICDGT("DGPTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
7 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=7 D X7 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X7 I X K DGPTIT S DGNFLD="@180",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
8 S DQ=9 ;@180
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD,U,20)]"" S Y="@190"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@190"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="0;20",DV="*P80.1'X",DU="",DIFLD=19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1258,1692 S DIEZRXR(45.05,DIXR)=""
 Q
...
C26F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1259,1692 S DIEZRXR(45.05,DIXR)=""
 Q
...
C31F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1260,1692 S DIEZRXR(45.05,DIXR)=""
 Q
...
C56S S X="" G:DG(DQ)=X C56F1 K DB
 S X=DG(DQ),DIC=DIE
 S ^DGPT(DA(1),"P","AP6",$E(X,1,30),DA)=""
C56F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1265,1692 S DIEZRXR(45.05,DIXR)=""
 Q
X56 N DGIT S DGIT=5 D GETAPI^DGICDGT("DGPTF","PROC",$G(DA(1)),"EN1",1)
 Q
 ;
57 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=57 D X57 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X57 I X K DGPTIT S DGNFLD="@280",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
58 S DQ=59 ;@280
59 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=59 D X59 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X59 K DGNFLD,DGDUP,DGADD S Y=""
 Q
60 S DQ=61 ;@800
