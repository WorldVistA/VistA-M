DGPMV2 ;ALB/MRL/MIR - PATIENT MOVEMENT PROCESSOR; 21 APR 1989
 ;;5.3;Registration;**40,1101**;Aug 13, 1993;Build 1
 ;
 ;DG*5.3*1101 Called new HELP doc for ADMIT DATE to exclude future date info
 ;
...
E W !?8,*7,"NOT A VALID SELECTION...CHOOSE BY DATE/TIME OR NUMBER." W:DGPMN !?8,"NEW MOVEMENT ENTRIES MUST INCLUDE A DATE AND TIME." Q
 ;
SHOW I $O(^UTILITY("DGPMVN",$J,0)) W !,"CHOOSE FROM" S %DT="RSE" W ! F I=0:0 S I=$O(^UTILITY("DGPMVN",$J,I)) Q:'I  D WR^DGPMV20
 W ! D HELPLP^DGPMV21(16) K I,I1,N,D,C,%DT Q   ;DG*5.3*1101
 ;
