...
X4 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8300"
 Q
...
X8 I '$D(DGBPC(4))!(DGDUP(4)) S Y="@8400"
 Q
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 D DRUG^DGPTSC01 I $D(DGTX) S Y="@8350"
 Q
...
X17 I '$D(DGBPC(5))!(DGDUP(5)) S Y="@8500"
 Q
...
X21 I '$D(DGBPC(6))!(DGDUP(6)) S Y="@8600"
 Q
