DGENUPLB ;ALB/TDM,KUM - PROCESS INCOMING (Z11 EVENT TYPE) HL7 MESSAGES ;4/10/13 6:53pm
 ;;5.3;REGISTRATION;**625,763,842,871,952,977,1014,1082,1149**;Aug 13,1993;Build 4
...
ZHP ;Process ZHP segment
 ...
 ; DG*5.3*1149 - Add Effective Date
 S $P(DGHBP(CTR),U,6)=$$CONVERT^DGENUPL1(SEG(6),"DATE",.ERROR)
 I ERROR D ADDERROR^DGENUPL(MSGID,$G(DGPAT("SSN")),"BAD VALUE, ZHP SEGMENT , SEQ 6",.ERRCOUNT) Q
 ;
 Q
 ;
