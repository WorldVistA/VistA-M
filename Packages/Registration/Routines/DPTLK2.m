DPTLK2 ;ALB/RMO,ERC - MAS Patient Look-up Add New Patient ;Dec 28, 2018@16:13
 ...
 I $$CASE^DPTNAME(DPTX),DPTX'?1U.ANP W:DIC(0)["Q" *7," ??" S DPTDFN=-1 G Q ; OSE/SMH - new 2 ; reject lower case only if language does not have case
 ; /OSE/SMH
 ; 
 ; DG*647
