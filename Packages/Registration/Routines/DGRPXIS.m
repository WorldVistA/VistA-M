DGRPXIS ; GENERATED FROM 'DGRP ENTER/EDIT ANNUAL INCOME' INPUT TEMPLATE(#475), FILE 408.21;06/26/96
 D DE G BEGIN
...
SET I X'?.ANP S DDER=1 Q 
 ...
 Q
BEGIN S DNM="DGRPXIS",DQ=1
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIEZ=475,U="^"
...
X22 S:DGDR'[907 Y="@908"
 Q
23 D:$D(DG)>9 F^DIE17 G ^DGRPXIS1
