...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,4) S:%]"" DE(1)=% S %=$P(%Z,U,5) S:%]"" DE(11)=% S %=$P(%Z,U,6) S:%]"" DE(21)=% S %=$P(%Z,U,7) S:%]"" DE(31)=% S %=$P(%Z,U,8) S:%]"" DE(41)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,14) S:%]"" DE(4)=% S %=$P(%Z,U,15) S:%]"" DE(14)=% S %=$P(%Z,U,16) S:%]"" DE(24)=% S %=$P(%Z,U,17) S:%]"" DE(34)=% S %=$P(%Z,U,18) S:%]"" DE(44)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="DGX5FD5",DQ=1
1 S DW="81;4",DV="*P80'X",DU="",DLB="ICD 14",DIFLD=81.04
 S DE(DW)="C1^DGX5FD5",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X3 I DGXX="" S Y="@161"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;14",DV="SX",DU="",DLB="POA FOR ICD 14",DIFLD=82.14
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,4) X
 Q
 ;
5 S DQ=6 ;@161
...
X7 I X K DGPTIT S DGNFLD="@170",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@170
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD1,U,5)]"" S Y="@180"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@180"
 Q
11 S DW="81;5",DV="*P80'X",DU="",DLB="ICD 15",DIFLD=81.05
 S DE(DW)="C11^DGX5FD5",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X13 I DGXX="" S Y="@171"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;15",DV="SX",DU="",DLB="POA FOR ICD 15",DIFLD=82.15
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,5) X
 Q
 ;
15 S DQ=16 ;@171
...
X23 I DGXX="" S Y="@181"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;16",DV="SX",DU="",DLB="POA FOR ICD 16",DIFLD=82.16
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,6) X
 Q
 ;
25 S DQ=26 ;@181
...
X33 I DGXX="" S Y="@191"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;17",DV="SX",DU="",DLB="POA FOR ICD 17",DIFLD=82.17
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,7) X
 Q
 ;
35 S DQ=36 ;@191
...
X43 I DGXX="" S Y="@201"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;18",DV="SX",DU="",DLB="POA FOR ICD 18",DIFLD=82.18
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X44 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,8) X
 Q
 ;
45 S DQ=46 ;@201
