...
62 S DW="0;9",DV="*P80'X",DU="",DIFLD=9,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C62^DGPTX51",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X64 I DGCODSYS="ICD9"!(DGTYPE=2)!(DGXX="") S Y="@71"
 Q
