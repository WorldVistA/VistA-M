...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 ...
 I $D(^(300)) S %Z=^(300) S %=$P(%Z,U,2) S:%]"" DE(74)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
X73 I '$D(DGBPC(2))!(DGDUP(2)) S Y="@8100"
 Q
74 S DW="300;2",DV="SX",DU="",DIFLD=300.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="1:Attempted Suicide;2:Accomplished Suicide;3:Self Inflicted Injury;"
 G RE
X74 S DGFLAG=2 D 501^DGPTSC01 K:DGER X K DGER,DGFLAG Q
 Q
 ;
...
X77 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8200"
 Q
78 D:$D(DG)>9 F^DIE17 G ^DGPTX52
