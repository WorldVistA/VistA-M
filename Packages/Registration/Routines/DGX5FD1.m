...
X25 S DGNFLD="@40"
 Q
26 S DW="0;5",DV="*P80'X",DU="",DIFLD=5,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C26S S X="" G:DG(DQ)=X C26F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C26F1 N X,X1,X2 S DIXR=1603 D C26X1(U) K X2 M X2=X D C26X1("O") K X1 M X1=X
 D
...
X35 S DGNFLD="@50"
 Q
36 S DW="0;6",DV="*P80'X",DU="",DIFLD=6,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C36S S X="" G:DG(DQ)=X C36F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C36F1 N X,X1,X2 S DIXR=1604 D C36X1(U) K X2 M X2=X D C36X1("O") K X1 M X1=X
 D
...
X45 S DGNFLD="@60"
 Q
46 S DW="0;7",DV="*P80'X",DU="",DIFLD=7,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C46S S X="" G:DG(DQ)=X C46F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C46F1 N X,X1,X2 S DIXR=1605 D C46X1(U) K X2 M X2=X D C46X1("O") K X1 M X1=X
 D
...
X55 S DGNFLD="@70"
 Q
56 S DW="0;8",DV="*P80'X",DU="",DIFLD=8,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C56^DGX5FD1",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C56S S X="" G:DG(DQ)=X C56F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C56F1 N X,X1,X2 S DIXR=1606 D C56X1(U) K X2 M X2=X D C56X1("O") K X1 M X1=X
 D
...
C66S S X="" G:DG(DQ)=X C66F1 K DB
 D ^DGX5FD3
C66F1 N X,X1,X2 S DIXR=1607 D C66X1(U) K X2 M X2=X D C66X1("O") K X1 M X1=X
 D
