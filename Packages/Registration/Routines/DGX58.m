...
1 S DW="81;15",DV="*P80'X",DU="",DLB="ICD 25",DIFLD=81.15
 S DE(DW)="C1^DGX58",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X3 I DGXX="" S Y="@271"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;25",DV="SX",DU="",DLB="POA FOR ICD 25",DIFLD=82.25
