...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=1178 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=1179 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=1180 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X5(DION) K X
 ...
 S X=$G(X(1))
 Q
6 N X,X1,X2 S DIXR=1181 D X6(U) K X2 M X2=X D X6("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X6(DION) K X
 ...
 S X=$G(X(1))
 Q
7 N X,X1,X2 S DIXR=1182 D X7(U) K X2 M X2=X D X7("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X7(DION) K X
 ...
 S X=$G(X(1))
 Q
8 N X,X1,X2 S DIXR=1183 D X8(U) K X2 M X2=X D X8("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X8(DION) K X
 ...
 S X=$G(X(1))
 Q
9 N X,X1,X2 S DIXR=1184 D X9(U) K X2 M X2=X D X9("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X9(DION) K X
 ...
 S X=$G(X(1))
 Q
10 N X,X1,X2 S DIXR=1185 D X10(U) K X2 M X2=X D X10("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X10(DION) K X
 ...
 S X=$G(X(1))
 Q
11 N X,X1,X2 S DIXR=1186 D X11(U) K X2 M X2=X D X11("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X25(DION) K X
 ...
 S X=$G(X(1))
 Q
26 N X,X1,X2 S DIXR=1238 D X26(U) K X2 M X2=X D X26("F") K X1 M X1=X
 I $G(X(2))]"" D
