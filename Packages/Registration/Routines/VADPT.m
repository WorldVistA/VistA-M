VADPT ;ALB/MRL/MJK,ERC,TDM,ARF - RETURN PATIENT VARIABLE ARRAYS [DRIVER];7/17/14
 ;;5.3;Registration;**193,343,389,415,489,498,688,754,887,996**;Aug 13, 1993;Build 47
...
Q S VAROOT="" K:$D(VAROOT)'=11 VAROOT K VATAG Q
 ;
KVA K VA
KVAR D KVAR^VADPT0 K:$D(VAIP("V")) @(VAIP("V")) K I,X,Y,VARRAY,VADM,VADEMO,VAPD,VADPT,VAOA,VASV,VAEL,VAMB,VARP,VAEN,VASD,VAIN,VAIP,VAPA,VAHOW,VAINDT,VAERR,^UTILITY("VADPT",$J),VA200,VATEST Q
