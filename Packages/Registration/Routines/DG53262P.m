DG53262P ;BP-CIOFO/MM - PTF QUARTERLY CENSUS DATES- ;11/10/99
 ;;5.3;Registration;**262**;Aug 13, 1993
 ;
 ;
...
EN ;
 ...
 S ERR=0
 ;
 ;-- ALL DATES ARE FOR FY2000, Q1 CENSUS
 ;
 ;-- Census Date 12-31-1999
 S CENDATE=2991231
 ;-- Close-out Date 01-14-2000
 S CLOSDATE=3000114
 ;
 ...
 ;-- currently active
 S ACTIVE=1
 ;-- Census Period Start Date 10-1-1999
 S CPSTART=2991001
 ;
 D BMES^XPDUTL(">>> Updating PTF Census Date File (#45.86) for 1st Quarter, FY 2000.")
