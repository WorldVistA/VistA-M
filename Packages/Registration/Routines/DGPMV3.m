DGPMV3 ;ALB/MIR - ENTER TRANSACTION INFORMATION; 8 MAY 89 ; 7/08/24 10:11am
 ;;5.3;Registration;**34,54,62,95,692,715,895,1104,1117**;Aug 13, 1993;Build 32
 ;
 ; Reference to RESET^PXCOMPACT in ICR #7327
 K ^UTILITY("DGPM",$J)
...
OKD K %DT W ! S DGPMER=0,(^UTILITY("DGPM",$J,DGPMT,DGPMDA,"P"),DGPMP)=^DGPM(DGPMDA,0),Y=DGPMDA D:DGPMT=6 PRIOR^DGPMV36 D @("D"_DGPMT_"^DGPMVDL"_$S(DGPMT>2:1,1:"")) G Q:DGPMER
 ...
 N FIRSTMOVE,MOVEDT,MOVESEQ,PTFPOINT,PXEOCNUM,PXEOCSEQ,STARTDT
 ;delete an admission
 I DGPMT=1 D
 . D REVERT^DGCOMPACT(DFN,PTF,DGPMT)
 ;delete a discharge
 I DGPMT=3 D
 ...
 . I $$CHKMVMT^DGCOMPACT(DFN,PTF)=1,$D(^PXCOMP(818,PXEOCNUM,10,PXEOCSEQ,40,PTFPOINT,1,"B",DGPMDA)) D  Q
 . . ;set 101 flag to No as this is the last movement
 . . D SETPTFFLG^DGCOMPACT(PTF,0)
 . . I $$GETBENTYP^PXCOMPACT(DFN)="I" D REVERT^DGCOMPACT(DFN,PTF)
 . I '$D(^PXCOMP(818,PXEOCNUM,10,PXEOCSEQ,40,PTFPOINT,1,"B",DGPMDA)) Q
 ...
 . . I $P($G(^PXCOMP(818,PXEOCNUM,10,PXEOCSEQ-1,0)),"^",2)=STARTDT D
 . . . S $P(^PXCOMP(818,PXEOCNUM,10,PXEOCSEQ-1,0),"^",2)=MOVEDT,$P(^PXCOMP(818,PXEOCNUM,10,PXEOCSEQ-1,0),"^",5)=MOVEDT
