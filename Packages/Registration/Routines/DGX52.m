...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,11) S:%]"" DE(1)=% S %=$P(%Z,U,12) S:%]"" DE(11)=% S %=$P(%Z,U,13) S:%]"" DE(21)=% S %=$P(%Z,U,14) S:%]"" DE(31)=% S %=$P(%Z,U,15) S:%]"" DE(41)=%
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,1) S:%]"" DE(51)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,6) S:%]"" DE(4)=% S %=$P(%Z,U,7) S:%]"" DE(14)=% S %=$P(%Z,U,8) S:%]"" DE(24)=% S %=$P(%Z,U,9) S:%]"" DE(34)=% S %=$P(%Z,U,10) S:%]"" DE(44)=% S %=$P(%Z,U,11) S:%]"" DE(54)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="DGX52",DQ=1
1 S DW="0;11",DV="*P80'X",DU="",DIFLD=11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C1^DGX52",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1627 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
C1X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C1F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
...
X3 I DGXX="" S Y="@81"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;6",DV="SX",DU="",DIFLD=82.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,11) X
 Q
 ;
5 S DQ=6 ;@81
...
X7 I X K DGPTIT S DGNFLD="@90",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@90
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD,U,12)]"" S Y="@100"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@100"
 Q
11 S DW="0;12",DV="*P80'X",DU="",DIFLD=12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX52",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1628 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
C11X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C11F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1184 S DIEZRXR(45.02,DIXR)=""
 Q
X11 N K D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA(1)),"EN")
 Q
 ;
...
X13 I DGXX="" S Y="@91"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;7",DV="SX",DU="",DIFLD=82.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,12) X
 Q
 ;
15 S DQ=16 ;@91
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C21F1 N X,X1,X2 S DIXR=1629 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
...
C21X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C21F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1185 S DIEZRXR(45.02,DIXR)=""
 Q
X21 N K D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA(1)),"EN")
 Q
 ;
...
X23 I DGXX="" S Y="@101"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;8",DV="SX",DU="",DIFLD=82.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,13) X
 Q
 ;
25 S DQ=26 ;@101
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C31F1 N X,X1,X2 S DIXR=1630 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 D
...
C31X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C31F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1186 S DIEZRXR(45.02,DIXR)=""
 Q
X31 N K D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA(1)),"EN")
 Q
 ;
...
X33 I DGXX="" S Y="@111"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;9",DV="SX",DU="",DIFLD=82.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,14) X
 Q
 ;
35 S DQ=36 ;@111
...
C41S S X="" G:DG(DQ)=X C41F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C41F1 N X,X1,X2 S DIXR=1631 D C41X1(U) K X2 M X2=X D C41X1("O") K X1 M X1=X
 D
...
C41X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C41F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1178 S DIEZRXR(45.02,DIXR)=""
 Q
X41 N K D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA(1)),"EN")
 Q
 ;
...
X43 I DGXX="" S Y="@121"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;10",DV="SX",DU="",DIFLD=82.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X44 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,15) X
 Q
 ;
45 S DQ=46 ;@121
...
C51S S X="" G:DG(DQ)=X C51F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C51F1 N X,X1,X2 S DIXR=1632 D C51X1(U) K X2 M X2=X D C51X1("O") K X1 M X1=X
 D
...
C51X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C51F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
...
X53 I DGXX="" S Y="@131"
 Q
54 D:$D(DG)>9 F^DIE17,DE S DQ=54,DW="82;11",DV="SX",DU="",DIFLD=82.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X54 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,1) X
 Q
 ;
55 S DQ=56 ;@131
