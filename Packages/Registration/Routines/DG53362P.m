...
EN ;
 ...
 S ERR=0
 ;
 ;-- ALL DATES ARE FOR FY2001, Q2 CENSUS
 ;
 ;-- Census Date 03-31-2001
 S CENDATE=3010331
 ;-- Close-out Date 04-13-2001
 S CLOSDATE=3010413
 ;
 ...
 ;-- currently active
 S ACTIVE=1
 ;-- Census Period Start Date 01-01-2001
 S CPSTART=3010101
 ;
 D BMES^XPDUTL(">>> Updating PTF Census Date File (#45.86) for 2nd Quarter, FY 2001.")
