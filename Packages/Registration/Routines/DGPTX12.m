...
BEGIN S DNM="DGPTX12",DQ=1
1 S DW="70;13",DV="FX",DU="",DLB="RECEIVING SUFFIX",DIFLD=76.2
 G RE
X1 D UP^DGHELP S DIC(0)="EFC",DIC="^DIC(45.81,",D="D1" D IX^DIC S DIC=DIE I +Y'>0!(X=" ") K X
 I $D(X),X'?.ANP K X
 Q
 ;
2 S DW="70;9",DV="S",DU="",DLB="C&P STATUS",DIFLD=78
