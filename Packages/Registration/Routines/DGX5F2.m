...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,8) S:%]"" DE(1)=% S %=$P(%Z,U,9) S:%]"" DE(11)=% S %=$P(%Z,U,26) S:%]"" DE(61)=%,DE(64)=% S %=$P(%Z,U,27) S:%]"" DE(67)=% S %=$P(%Z,U,31) S:%]"" DE(55)=%,DE(58)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,4) S:%]"" DE(4)=% S %=$P(%Z,U,5) S:%]"" DE(14)=%
...
X3 I DGCODSYS="ICD9"!(DGTYPE=2)!(DGXX="") S Y="@61"
 Q
...
11 S DW="0;9",DV="*P80'X",DU="",DLB="ICD 5",DIFLD=9
 S DE(DW)="C11^DGX5F2",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X13 I DGCODSYS="ICD9"!(DGTYPE=2)!(DGXX="") S Y="@71"
 Q
