...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,9) S:%]"" DE(1)=% S %=$P(%Z,U,26) S:%]"" DE(51)=%,DE(54)=% S %=$P(%Z,U,27) S:%]"" DE(57)=%,DE(60)=% S %=$P(%Z,U,28) S:%]"" DE(63)=%,DE(66)=% S %=$P(%Z,U,29) S:%]"" DE(75)=%,DE(78)=%
...
BEGIN S DNM="DGX5F2",DQ=1
1 S DW="0;9",DV="*P80'X",DU="",DLB="ICD 5",DIFLD=9
 S DE(DW)="C1^DGX5F2",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C1F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 ...
 Q
X1 N K,DGI S DGI=9 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA(1)),"EN")
 Q
 ;
...
X3 I DGCODSYS="ICD9"!(DGTYPE=2)!(DGXX="") S Y="@71"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;5",DV="S",DU="",DLB="POA FOR ICD 5",DIFLD=82.05
...
X9 K DGNFLD,DGDUP,DGADD,DGXX,DGCODSYS S Y=""
 Q
10 S DQ=11 ;@8000
...
X12 I '$D(DGBPC(2))!(DGDUP(2)) S Y="@8200"
 Q
...
X16 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8300"
 Q
...
X29 I '$D(DGBPC(5))!(DGDUP(5)) S Y="@8500"
 Q
...
X33 I '$D(DGBPC(6))!(DGDUP(6)) S Y="@8600"
 Q
...
X76 S Y="@9550"
 Q
77 S DQ=78 ;@9500
78 S DW="0;29",DV="S",DU="",DLB="TREATMENT FOR MST",DIFLD=29
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X80 I '$D(DGEXQ(5)) S Y="@9600"
 Q
81 D:$D(DG)>9 F^DIE17 G ^DGX5F3
