DGX4 ; GENERATED FROM 'DG401-10P' INPUT TEMPLATE(#1765), FILE 45;02/01/23
 D DE G BEGIN
...
X2 S DGTYPE=$P(^DGPT(D0,0),U,11),DGCODSYS=$$CODESYS^DGPTIC10(D0)
 Q
3 S D=0 K DE(1) ;40
 S DIFLD=40,DGO="^DGX41",DC="32^45.01D^S^",DV="45.01MDX",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
