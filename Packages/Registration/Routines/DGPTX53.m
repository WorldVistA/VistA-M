...
1 S DW="300;2",DV="SX",DU="",DIFLD=300.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X4 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8200"
 Q
5 S DW="300;3",DV="SX",DU="",DIFLD=300.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="1:Yes;2:No;"
 G RE
...
X12 S Y="@8300"
 Q
13 S DQ=14 ;@8250
14 S DW="300;4",DV="P45.61'X",DU="",DIFLD=300.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(45.61,"
 S X=DGTX
 S Y=X
 G Y
...
X17 I '$D(DGBPC(5))!(DGDUP(5)) S Y="@8400"
 Q
18 S DW="300;5",DV="SX",DU="",DIFLD=300.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X21 I '$D(DGBPC(6))!(DGDUP(6)) S Y="@8500"
 Q
22 S DW="300;6",DV="NJ2,0X",DU="",DIFLD=300.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
...
X32 I '$D(DGEXQ(6)) S Y="@9040"
 Q
33 S DW="0;31",DV="S",DU="",DIFLD=31,DLB="WAS TREATMENT RELATED TO COMBAT?"
 S DU="Y:YES;N:NO;"
 S Y="YES"
 G Y
X33 Q
...
X34 S Y="@9050"
 Q
35 S DQ=36 ;@9040
36 S DW="0;31",DV="S",DU="",DIFLD=31,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
...
X38 I '$D(DGEXQ(1)) S Y="@9100"
 Q
39 S DW="0;26",DV="SX",DU="",DIFLD=26,DLB="WAS TREATMENT RELATED TO AGENT ORANGE EXPOSURE?"
 S DU="Y:YES;N:NO;"
 G RE
...
X40 S Y="@9150"
 Q
41 S DQ=42 ;@9100
42 S DW="0;26",DV="SX",DU="",DIFLD=26,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X44 I '$D(DGEXQ(2)) S Y="@9200"
 Q
45 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB="WAS TREATMENT RELATED TO IONIZING RADIATION EXPOSURE?"
 S DU="Y:YES;N:NO;"
 G RE
...
X46 S Y="@9250"
 Q
47 S DQ=48 ;@9200
48 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X50 I '$D(DGEXQ(3)) S Y="@9300"
 Q
51 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB="WAS TREATMENT RELATED TO SERVICE IN SW ASIA?"
 S DU="Y:YES;N:NO;"
 G RE
...
X52 S Y="@9350"
 Q
53 S DQ=54 ;@9300
54 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X56 I '$D(DGEXQ(7)) S Y="@9400"
 Q
57 S DW="0;32",DV="S",DU="",DIFLD=32,DLB="WAS TREATMENT RELATED TO PROJ 112/SHAD?"
 S DU="Y:YES;N:NO;"
 G RE
X57 Q
...
X58 S Y="@9450"
 Q
59 S DQ=60 ;@9400
60 S DW="0;32",DV="S",DU="",DIFLD=32,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X62 I '$D(DGEXQ(4)) S Y="@9500"
 Q
63 S DW="0;29",DV="S",DU="",DIFLD=29,DLB="WAS TREATMENT RELATED TO MILITARY SEXUAL TRAUMA?"
 S DU="Y:YES;N:NO;"
 G RE
X63 Q
...
X64 S Y="@9550"
 Q
65 S DQ=66 ;@9500
66 S DW="0;29",DV="S",DU="",DIFLD=29,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X68 I '$D(DGEXQ(5)) S Y="@9600"
 Q
69 S DW="0;30",DV="S",DU="",DIFLD=30,DLB="WAS TREATMENT RELATED TO HEAD AND/OR NECK CANCER?"
 S DU="Y:YES;N:NO;"
 G RE
X69 Q
...
X71 S Y="@9650"
 Q
72 S DQ=73 ;@9600
73 S DW="0;30",DV="S",DU="",DIFLD=30,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
