DGX7 ; GENERATED FROM 'DG701-10D' INPUT TEMPLATE(#1763), FILE 45;06/24/20
 D DE G BEGIN
DE S DIE="^DGPT(",DIC=DIE,DP=45,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGPT(DA,""))=""
 I $D(^(70)) S %Z=^(70) S %=$P(%Z,U,10) S:%]"" DE(6)=% S %=$P(%Z,U,16) S:%]"" DE(16)=% S %=$P(%Z,U,17) S:%]"" DE(26)=% S %=$P(%Z,U,18) S:%]"" DE(36)=% S %=$P(%Z,U,19) S:%]"" DE(46)=% S %=$P(%Z,U,20) S:%]"" DE(56)=% S %=$P(%Z,U,21) S:%]"" DE(66)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,1) S:%]"" DE(9)=% S %=$P(%Z,U,2) S:%]"" DE(19)=% S %=$P(%Z,U,3) S:%]"" DE(29)=% S %=$P(%Z,U,4) S:%]"" DE(39)=% S %=$P(%Z,U,5) S:%]"" DE(49)=% S %=$P(%Z,U,6) S:%]"" DE(59)=% S %=$P(%Z,U,7) S:%]"" DE(69)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
X5 D CENSUS^DGPTIC10(DA)
 Q
6 S DW="70;10",DV="*P80'X",DU="",DIFLD=79,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C6F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1176,1596 S DIEZRXR(45,DIXR)=""
 Q
...
X8 I DGXX="" S Y="@1"
 Q
9 D:$D(DG)>9 F^DIE17,DE S DQ=9,DW="82;1",DV="SX",DU="",DIFLD=82.01,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X15 S DGNFLD="@20"
 Q
16 S DW="70;16",DV="*P80`X",DU="",DIFLD=79.16,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C16F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1187,1598 S DIEZRXR(45,DIXR)=""
 Q
...
X18 I DGXX="" S Y="@11"
 Q
19 D:$D(DG)>9 F^DIE17,DE S DQ=19,DW="82;2",DV="SX",DU="",DIFLD=82.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X25 S DGNFLD="@30"
 Q
26 S DW="70;17",DV="*P80'X",DU="",DIFLD=79.17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C26F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1192,1599 S DIEZRXR(45,DIXR)=""
 Q
...
X28 I DGXX="" S Y="@21"
 Q
29 D:$D(DG)>9 F^DIE17,DE S DQ=29,DW="82;3",DV="SX",DU="",DIFLD=82.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X35 S DGNFLD="@40"
 Q
36 S DW="70;18",DV="*P80'X",DU="",DIFLD=79.18,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C36F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1193,1600 S DIEZRXR(45,DIXR)=""
 Q
...
X38 I DGXX="" S Y="@31"
 Q
39 D:$D(DG)>9 F^DIE17,DE S DQ=39,DW="82;4",DV="SX",DU="",DIFLD=82.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X45 S DGNFLD="@50"
 Q
46 S DW="70;19",DV="*P80'X",DU="",DIFLD=79.19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C46F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1194,1601 S DIEZRXR(45,DIXR)=""
 Q
...
X48 I DGXX="" S Y="@41"
 Q
49 D:$D(DG)>9 F^DIE17,DE S DQ=49,DW="82;5",DV="SX",DU="",DIFLD=82.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X55 S DGNFLD="@55"
 Q
56 S DW="70;20",DV="*P80'X",DU="",DIFLD=79.201,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C56^DGX7",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C56S S X="" G:DG(DQ)=X C56F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N DG1 S DG1=$P(^DGPT(DA,0),""^"",1) N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  D:(+DG1>0) ADGRU^DGRUDD01(DG1)"
C56F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1195,1602 S DIEZRXR(45,DIXR)=""
 Q
X56 N DGI S DGI=6 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA),"EN3")
 Q
 ;
...
X58 I DGXX="" S Y="@51"
 Q
59 D:$D(DG)>9 F^DIE17,DE S DQ=59,DW="82;6",DV="SX",DU="",DIFLD=82.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X59 I X]"",$G(DA) K:'$$POA701^DGPTFUT1(X,DA,70,20) X
 Q
 ;
60 S DQ=61 ;@51
...
C66S S X="" G:DG(DQ)=X C66F1 K DB
 D ^DGX72
C66F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1196,1603 S DIEZRXR(45,DIXR)=""
 Q
X66 N DGI S DGI=7 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA),"EN3")
 Q
 ;
...
X68 I DGXX="" S Y="@56"
 Q
69 D:$D(DG)>9 F^DIE17,DE S DQ=69,DW="82;7",DV="SX",DU="",DIFLD=82.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X69 I X]"",$G(DA) K:'$$POA701^DGPTFUT1(X,DA,70,21) X
 Q
 ;
70 S DQ=71 ;@56
