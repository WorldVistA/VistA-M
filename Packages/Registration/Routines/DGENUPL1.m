DGENUPL1 ;ALB/CJM,ISA,KWP,CKN,LBD,LMD,TDM,TGH,DJS,HM,JAM,KUM - PROCESS INCOMING (Z11 EVENT TYPE) HL7 MESSAGES ;30 Oct 2017  7:32PM
 ;;5.3;REGISTRATION;**147,222,232,314,397,379,407,363,673,653,688,797,842,894,871,935,959,975,972,952,996,1014,1082**;Aug 13,1993;Build 29
 ;
PARSE(MSGIEN,MSGID,CURLINE,ERRCOUNT,DGPAT,DGELG,DGENR,DGCDIS,DGOEIF,DGSEC,DGNTR,DGMST,DGNMSE,DGHBP,DGOTH,DGZHF) ;
 ...
 ;  DGZHF - array for Presumptive Psychosis data (pass by ref) DG*5.3*1082
 ;
 N SEG,ERROR,COUNT,QFLG,NFLG,DGCCPC
 ;
 ...
 ;
 ; DG*5.3*1082 - ZHF is optional
 I 'ERROR S SEG="ZHF" I $$CHKNXT(CURLINE+1,SEG) D
 .D NXTSEG^DGENUPL(MSGIEN,.CURLINE,.SEG)
 .I SEG("TYPE")="ZHF" D ZHF^DGENUPLB Q
 ;
 ...
 .Q
 ;
 ; ZCE is optional and repeatable DG*5.3*1014
 S DGCCPC=0
 K DGOTH I 'ERROR S SEG="ZCE" I $$CHKNXT(CURLINE+1,SEG) D
 .D NXTSEG^DGENUPL(MSGIEN,.CURLINE,.SEG)
 .S QFLG=0 F  D  Q:QFLG
 ..I SEG("TYPE")'="ZCE" S QFLG=1,CURLINE=CURLINE-1 Q
 ..D ZCE^DGENUPLB
 ..D NXTSEG^DGENUPL(MSGIEN,.CURLINE,.SEG)
 ..Q
 .Q
 ...
 . D NXTSEG^DGENUPL(MSGIEN,.CURLINE,.SEG)
 . S QFLG=0 F  D  Q:QFLG!(ERROR)  ;DG*5.3*996; JAM; Trap error - do not continue processing
 . . I SEG("TYPE")'="ZHP" S QFLG=1,CURLINE=CURLINE-1 Q
 . . D ZHP^DGENUPLB Q:ERROR  ;DG*5.3*996; JAM; Trap error - do not continue processing
 . . D NXTSEG^DGENUPL(MSGIEN,.CURLINE,.SEG)
 ;
