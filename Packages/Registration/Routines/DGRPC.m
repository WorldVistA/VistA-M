DGRPC ;ALB/MRL,PJR,PHH,EG,BAJ,TDM,LBD,RN,ARF,JDB - CHECK CONSISTENCY OF PATIENT DATA ;6/29/11 3:50pm
 ;;5.3;Registration;**108,121,314,301,470,489,505,451,568,585,641,653,688,754,797,867,903,952,1027,1045,1081,1098,1111,1127**;Aug 13, 1993;Build 11
...
EN ; DG*5.3*1027 Screen 7 changes - call new consistency check
 ...
 ; DG*5.3*1127 modified to remove "always true" conditions for 9:VETERAN STATUS UNSPECIFIED and 13:POS UNSPECIFIED
 ...
 S DGCHK="," F I=0:0 S I=$O(^DGIN(38.6,I)) Q:'I!(I=99)  I $D(^(I,0)),$S(I=2:0,I=51:0,I=10:1,I=14:1,I=22:1,I=89:1,'$P(^(0),"^",5):1,1:0),I'=99,I'=15 S DGCHK=DGCHK_I_","
 ...
 ; DG*5.3*1127 removed 402:ELIGIBLE FOR MEDICAID INVALID, 403:DT MEDICAID LAST ASKED INVALID, 407:ELIGIBILITY STATUS INVALID
 ;             501:POW STATUS INVALID, 502:MIL DIS RETIREMENT INVALID, 503:DISCHARGE DUE TO DISAB INVALID
 ;             504:AGENT ORANGE EXPOSURE INVALID, 505:RADIATION EXPOSURE INVALID, 506:VALUE FOR SW ASIA COND INVALID
 ;             from consistency check OVER99 variable string since the rule was removed from INCONSISTENT DATA ELEMENT File (#38.6).
 ; S OVER99=",301,303,304,306,307,308,313,314,315,402,403,407,501,502,503,504,505,506,507,516,517,"
 S OVER99=",301,303,304,306,307,308,313,314,315,507,516,517,"
