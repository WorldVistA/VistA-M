DG53188P ;ALB/MM  - QUARTERLY PATIENT CENSUS CLOSEOUT OF PTF; 8/8/1998
 ;;5.3;Registration;**188**;Aug 13, 1993
 ;
 ;
...
EN ;
 ...
 S ERR=0
 ;
 ;-- ALL DATES ARE FOR FY1998, Q4 CENSUS
 ;
 ;-- Census Date 09-30-1998
 S CENDATE=2980930
 ;-- Close-out Date 10-16-1998
 S CLOSDATE=2981016
 ;
 ...
 ;-- currently active
 S ACTIVE=1
 ;-- Census Period Start Date 07-1-1998
 S CPSTART=2980701
 ;
 D BMES^XPDUTL(">>> Updating PTF Census Date File (#45.86) for 4th Quarter, FY 1998.")
