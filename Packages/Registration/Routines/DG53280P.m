...
EN ;
 ...
 S ERR=0
 ;
 ;-- ALL DATES ARE FOR FY2000, Q2 CENSUS
 ;
 ;-- Census Date 3-31-2000
 S CENDATE=3000331
 ;-- Close-out Date 04-14-2000
 S CLOSDATE=3000414
 ;
 ...
 ;-- currently active
 S ACTIVE=1
 ;-- Census Period Start Date 1-1-2000
 S CPSTART=3000101
 ;
 D BMES^XPDUTL(">>> Updating PTF Census Date File (#45.86) for 2nd Quarter, FY 2000.")
