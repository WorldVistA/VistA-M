DG53185P ;ALB/MM  - QUARTERLY PATIENT CENSUS CLOSEOUT OF PTF; 5/11/98
 ;;5.3;Registration;**185**;Aug 13, 1993
 ;
 ;
...
EN ;
 ...
 S ERR=0
 ;
 ;-- ALL DATES ARE FOR FY1998, Q3 CENSUS
 ;
 ;-- Census Date 06-30-1998
 S CENDATE=2980630
 ;-- Close-out Date 07-17-1998
 S CLOSDATE=2980717
 ;
 ...
 ;-- currently active
 S ACTIVE=1
 ;-- Census Period Start Date 04-1-1998
 S CPSTART=2980401
 ;
