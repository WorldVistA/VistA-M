DGRPC3 ;ALB/PJR,LBD,BAJ,TDM,JDB - CHECK CONSISTENCY OF PATIENT DATA (CONT) ;10/20/10 3:40pm
 ;;5.3;Registration;**451,632,673,657,688,754,797,867,903,952,1098,1109,1111,1127**;Aug 13, 1993;Build 11
...
OVER99CK N DGP,DGSD,RULE,FILERR
 ...
 ;DG*5.3*1127 commented next line to remove 402:ELIGIBLE FOR MEDICAID INVALID, 403:DT MEDICAID LAST ASKED INVALID and 407:ELIGIBILITY STATUS INVALID  
 ;F RULE=402,403,407 S DGLST=RULE_"^IVMZ7CE" D @DGLST I $D(FILERR(RULE)) S X=RULE D COMB
 ;DG*5.3*1127 removed  501:POW STATUS INVALID, 502:MIL DIS RETIREMENT INVALID, 503:DISCHARGE DUE TO DISAB INVALID
 ...
 F RULE=507,516,517 S DGLST=RULE_"^IVMZ7CS" D @DGLST I $D(FILERR(RULE)) S X=RULE D COMB
