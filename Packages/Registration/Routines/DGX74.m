...
DE S DIE="^DGPT(",DIC=DIE,DP=45,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGPT(DA,""))=""
 I $D(^(71)) S %Z=^(71) S %=$P(%Z,U,6) S:%]"" DE(1)=% S %=$P(%Z,U,7) S:%]"" DE(11)=% S %=$P(%Z,U,8) S:%]"" DE(21)=% S %=$P(%Z,U,9) S:%]"" DE(31)=% S %=$P(%Z,U,10) S:%]"" DE(41)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,16) S:%]"" DE(4)=% S %=$P(%Z,U,17) S:%]"" DE(14)=% S %=$P(%Z,U,18) S:%]"" DE(24)=% S %=$P(%Z,U,19) S:%]"" DE(34)=% S %=$P(%Z,U,20) S:%]"" DE(44)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="71;6",DV="*P80'X",DU="",DLB="SECONDARY DIAGNOSIS 15",DIFLD=79.246
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1240 S DIEZRXR(45,DIXR)=""
 Q
X1 N DGI S DGI=16 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA),"EN3")
 Q
 ;
...
X3 I DGXX="" S Y="@141"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;16",DV="SX",DU="",DLB="POA SECONDARY DIAGNOSIS 15",DIFLD=82.16
 ...
 G RE
X4 I X]"",$G(DA) K:'$$POA701^DGPTFUT1(X,DA,71,6) X
 Q
 ;
5 S DQ=6 ;@141
...
X7 I X K DGPTIT S DGNFLD="@150",Y="@800",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=8 D X8 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X8 S:$P($G(^DGPT(D0,71)),U,6,15)?."^" Y="@240"
 Q
9 S DQ=10 ;@150
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@160"
 Q
11 S DW="71;7",DV="*P80'X",DU="",DLB="SECONDARY DIAGNOSIS 16",DIFLD=79.247
...
C11F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1241 S DIEZRXR(45,DIXR)=""
 Q
X11 N DGI S DGI=17 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA),"EN3")
 Q
 ;
...
X13 I DGXX="" S Y="@151"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;17",DV="SX",DU="",DLB="POA SECONDARY DIAGNOSIS 16",DIFLD=82.17
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA) K:'$$POA701^DGPTFUT1(X,DA,71,7) X
 Q
 ;
15 S DQ=16 ;@151
...
C21F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1242 S DIEZRXR(45,DIXR)=""
 Q
X21 N DGI S DGI=18 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA),"EN3")
 Q
 ;
...
X23 I DGXX="" S Y="@161"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;18",DV="SX",DU="",DLB="POA SECONDARY DIAGNOSIS 17",DIFLD=82.18
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA) K:'$$POA701^DGPTFUT1(X,DA,71,8) X
 Q
 ;
25 S DQ=26 ;@161
...
C31F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1243 S DIEZRXR(45,DIXR)=""
 Q
X31 N DGI S DGI=19 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA),"EN3")
 Q
 ;
...
X33 I DGXX="" S Y="@171"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;19",DV="SX",DU="",DLB="POA SECONDARY DIAGNOSIS 18",DIFLD=82.19
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA) K:'$$POA701^DGPTFUT1(X,DA,71,9) X
 Q
 ;
35 S DQ=36 ;@171
...
C41F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 ...
 Q
X41 N DGI S DGI=20 D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA),"EN3")
 Q
 ;
...
X43 I DGXX="" S Y="@181"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;20",DV="SX",DU="",DLB="POA SECONDARY DIAGNOSIS 19",DIFLD=82.2
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X44 I X]"",$G(DA) K:'$$POA701^DGPTFUT1(X,DA,71,10) X
 Q
 ;
45 S DQ=46 ;@181
