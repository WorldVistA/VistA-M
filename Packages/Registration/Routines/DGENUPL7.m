DGENUPL7 ;ISA/KWP,CKN,TMK,TDM,LBD,HM - PROCESS INCOMING (Z11 EVENT TYPE) HL7 MESSAGES ;6/17/13 5:48pm
 ;;5.3;REGISTRATION;**232,367,397,417,379,431,513,628,673,653,742,688,797,871,972,952,977**;Aug 13,1993;Build 177
 ;
...
Z11(MSGIEN,MSGID,CURLINE,DFN,ERRCOUNT) ;
 ...
 N DGNEWVAL,DIV,SUB,OLDELG,OLDPAT,OLDDCDIS,OLDEIF,DGSEC,OLDSEC,DGNTR,DGMST,DGPHINC,DGHBP,DGOTH
 ;
 ...
 D
 .Q:'$$PARSE^DGENUPL1(MSGIEN,MSGID,.CURLINE,.ERRCOUNT,.DGPAT,.DGELG,.DGENR,.DGCDIS,.DGOEIF,.DGSEC,.DGNTR,.DGMST,.DGNMSE,.DGHBP,.DGOTH)
