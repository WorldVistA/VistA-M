...
DE S DIE="^DGPT(D0,""S"",",DIC=DIE,DP=45.01,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"S",DA,""))=""
 ...
 I  S %=$P(%Z,U,9) S:%]"" DE(21)=% S %=$P(%Z,U,10) S:%]"" DE(26)=% S %=$P(%Z,U,11) S:%]"" DE(31)=% S %=$P(%Z,U,12) S:%]"" DE(36)=% S %=$P(%Z,U,13) S:%]"" DE(41)=% S %=$P(%Z,U,14) S:%]"" DE(46)=% S %=$P(%Z,U,15) S:%]"" DE(51)=%
 I  S %=$P(%Z,U,16) S:%]"" DE(56)=% S %=$P(%Z,U,17) S:%]"" DE(61)=% S %=$P(%Z,U,18) S:%]"" DE(66)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
X5 S:DGJUMP'[1 (DGNFLD,Y)="@2"
 Q
6 S DW="0;1",DV="MDX",DU="",DIFLD=.01,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C6F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1205,1206,1207,1208,1209,1270,1271,1272,1273,1274,1275,1276,1277,1278,1279,1280,1281,1282,1283,1284,1285,1286,1287,1288,1289,1693 S DIEZRXR(45.01,DIXR)=""
 Q
X6 S %DT="ETX" D ^%DT S X=+Y K:Y<1 X I $D(X) D DT401^DGPTUTL1
 Q
 ;
7 D:$D(DG)>9 F^DIE17,DE S DQ=7,DW="0;3",DV="RP45.3'",DU="",DIFLD=3,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(45.3,"
 G RE
X7 Q
8 S DW="0;4",DV="S",DU="",DIFLD=4,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
10 S DW="0;6",DV="S",DU="",DIFLD=6,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X10 Q
11 S DW="0;7",DV="S",DU="",DIFLD=7,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X15 I DGADD,$P(DGHOLD,U,8)]"" S Y="@30"
 Q
16 S DW="0;8",DV="*P80.1'X",DU="",DIFLD=8,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C16F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1205,1693 S DIEZRXR(45.01,DIXR)=""
 Q
...
X20 I DGADD,$P(DGHOLD,U,9)]"" S Y="@40"
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW="0;9",DV="*P80.1'X",DU="",DIFLD=9,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1206,1693 S DIEZRXR(45.01,DIXR)=""
 Q
...
X25 I DGADD,$P(DGHOLD,U,10)]"" S Y="@50"
 Q
26 D:$D(DG)>9 F^DIE17,DE S DQ=26,DW="0;10",DV="*P80.1'X",DU="",DIFLD=10,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C26F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1207,1693 S DIEZRXR(45.01,DIXR)=""
 Q
...
X30 I DGADD,$P(DGHOLD,U,11)]"" S Y="@60"
 Q
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW="0;11",DV="*P80.1'X",DU="",DIFLD=11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C31F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1208,1693 S DIEZRXR(45.01,DIXR)=""
 Q
...
X35 I DGADD,$P(DGHOLD,U,12)]"" S Y="@70"
 Q
36 D:$D(DG)>9 F^DIE17,DE S DQ=36,DW="0;12",DV="*P80.1'X",DU="",DIFLD=12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C36F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1209,1693 S DIEZRXR(45.01,DIXR)=""
 Q
...
X40 I DGADD,$P(DGHOLD,U,13)]"" S Y="@80"
 Q
41 D:$D(DG)>9 F^DIE17,DE S DQ=41,DW="0;13",DV="*P80.1'X",DU="",DIFLD=13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C41F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1286,1693 S DIEZRXR(45.01,DIXR)=""
 Q
...
X45 I DGADD,$P(DGHOLD,U,14)]"" S Y="@90"
 Q
46 D:$D(DG)>9 F^DIE17,DE S DQ=46,DW="0;14",DV="*P80.1'X",DU="",DIFLD=14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C46F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1287,1693 S DIEZRXR(45.01,DIXR)=""
 Q
...
X50 I DGADD,$P(DGHOLD,U,15)]"" S Y="@100"
 Q
51 D:$D(DG)>9 F^DIE17,DE S DQ=51,DW="0;15",DV="*P80.1'X",DU="",DIFLD=15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C51^DGX41",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
C51 G C51S:$D(DE(51))[0 K DB
C51S S X="" G:DG(DQ)=X C51F1 K DB
C51F1 N X,X1,X2 S DIXR=1313 D C51X1(U) K X2 M X2=X D C51X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C51F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1288,1693 S DIEZRXR(45.01,DIXR)=""
 Q
X51 N DGIT S DGIT=8 D GETAPI^DGICDGT("DGPTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
52 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=52 D X52 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X52 I X K DGPTIT S DGNFLD="@100",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
53 S DQ=54 ;@100
...
X55 I DGADD,$P(DGHOLD,U,16)]"" S Y="@110"
 Q
56 D:$D(DG)>9 F^DIE17,DE S DQ=56,DW="0;16",DV="*P80.1'X",DU="",DIFLD=16,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C56^DGX41",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
C56 G C56S:$D(DE(56))[0 K DB
C56S S X="" G:DG(DQ)=X C56F1 K DB
C56F1 N X,X1,X2 S DIXR=1314 D C56X1(U) K X2 M X2=X D C56X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C56F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1289,1693 S DIEZRXR(45.01,DIXR)=""
 Q
X56 N DGIT S DGIT=8 D GETAPI^DGICDGT("DGPTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
57 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=57 D X57 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X57 I X K DGPTIT S DGNFLD="@110",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
58 S DQ=59 ;@110
...
X60 I DGADD,$P(DGHOLD,U,17)]"" S Y="@120"
 Q
61 D:$D(DG)>9 F^DIE17,DE S DQ=61,DW="0;17",DV="*P80.1'X",DU="",DIFLD=17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C61^DGX41",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
C61 G C61S:$D(DE(61))[0 K DB
C61S S X="" G:DG(DQ)=X C61F1 K DB
C61F1 N X,X1,X2 S DIXR=1291 D C61X1(U) K X2 M X2=X D C61X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C61F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1270,1693 S DIEZRXR(45.01,DIXR)=""
 Q
X61 N DGIT S DGIT=8 D GETAPI^DGICDGT("DGPTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
62 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=62 D X62 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X62 I X K DGPTIT S DGNFLD="@120",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
63 S DQ=64 ;@120
...
X65 I DGADD,$P(DGHOLD,U,18)]"" S Y="@130"
 Q
66 D:$D(DG)>9 F^DIE17,DE S DQ=66,DW="0;18",DV="*P80.1'X",DU="",DIFLD=18,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C66^DGX41",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
C66 G C66S:$D(DE(66))[0 K DB
C66S S X="" G:DG(DQ)=X C66F1 K DB
 D ^DGX42
C66F1 N X,X1,X2 S DIXR=1292 D C66X1(U) K X2 M X2=X D C66X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C66X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C66F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1271,1693 S DIEZRXR(45.01,DIXR)=""
 Q
X66 N DGIT S DGIT=8 D GETAPI^DGICDGT("DGPTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
67 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=67 D X67 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X67 I X K DGPTIT S DGNFLD="@130",Y="@800",DGPTIT(X_$C(59)_"ICD0(")=""
 Q
68 S DQ=69 ;@130
...
X70 I DGADD,$P(DGHOLD,U,19)]"" S Y="@140"
 Q
71 D:$D(DG)>9 F^DIE17 G ^DGX43
