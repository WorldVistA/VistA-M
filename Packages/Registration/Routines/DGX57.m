...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,10) S:%]"" DE(1)=% S %=$P(%Z,U,11) S:%]"" DE(11)=% S %=$P(%Z,U,12) S:%]"" DE(21)=% S %=$P(%Z,U,13) S:%]"" DE(31)=% S %=$P(%Z,U,14) S:%]"" DE(41)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,20) S:%]"" DE(4)=% S %=$P(%Z,U,21) S:%]"" DE(14)=% S %=$P(%Z,U,22) S:%]"" DE(24)=% S %=$P(%Z,U,23) S:%]"" DE(34)=% S %=$P(%Z,U,24) S:%]"" DE(44)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="81;10",DV="*P80'X",DU="",DLB="ICD 20",DIFLD=81.1
...
X3 I DGXX="" S Y="@221"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;20",DV="SX",DU="",DLB="POA FOR ICD 20",DIFLD=82.2
...
X10 S DGNFLD="@240"
 Q
11 S DW="81;11",DV="*P80'X",DU="",DLB="ICD 21",DIFLD=81.11
...
X13 I DGXX="" S Y="@231"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;21",DV="SX",DU="",DLB="POA FOR ICD 21",DIFLD=82.21
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X20 S DGNFLD="@250"
 Q
21 S DW="81;12",DV="*P80'X",DU="",DLB="ICD 22",DIFLD=81.12
...
X23 I DGXX="" S Y="@241"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;22",DV="SX",DU="",DLB="POA FOR ICD 22",DIFLD=82.22
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X30 S DGNFLD="@260"
 Q
31 S DW="81;13",DV="*P80'X",DU="",DLB="ICD 23",DIFLD=81.13
...
X33 I DGXX="" S Y="@251"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;23",DV="SX",DU="",DLB="POA FOR ICD 23",DIFLD=82.23
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X40 S DGNFLD="@270"
 Q
41 S DW="81;14",DV="*P80'X",DU="",DLB="ICD 24",DIFLD=81.14
...
X43 I DGXX="" S Y="@261"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;24",DV="SX",DU="",DLB="POA FOR ICD 24",DIFLD=82.24
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
