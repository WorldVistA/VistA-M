...
11 S DW="81;11",DV="*P80'X",DU="",DIFLD=81.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX57",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
21 S DW="81;12",DV="*P80'X",DU="",DIFLD=81.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C21^DGX57",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
31 S DW="81;13",DV="*P80'X",DU="",DIFLD=81.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGX57",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
41 S DW="81;14",DV="*P80'X",DU="",DIFLD=81.14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^DGX57",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
51 S DW="81;15",DV="*P80'X",DU="",DIFLD=81.15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C51^DGX57",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X62 I '$D(DGBPC(2))!(DGDUP(2)) S Y="@8100"
 Q
...
X66 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8200"
 Q
