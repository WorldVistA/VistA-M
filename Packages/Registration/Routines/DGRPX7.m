DGRPX7 ; GENERATED FROM 'DG LOAD EDIT SCREEN 7' INPUT TEMPLATE(#420), FILE 2;12/29/22
 D DE G BEGIN
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 ...
 I $D(^(.362)) S %Z=^(.362) S %=$P(%Z,U,12) S:%]"" DE(26)=%,DE(30)=% S %=$P(%Z,U,13) S:%]"" DE(27)=%,DE(31)=% S %=$P(%Z,U,14) S:%]"" DE(37)=%,DE(40)=%
 I $D(^(.385)) S %Z=^(.385) S %=$P(%Z,U,1) S:%]"" DE(44)=% S %=$P(%Z,U,2) S:%]"" DE(46)=%
...
X25 S:$P($G(^DPT(DFN,"VET")),U,1)="N" Y="@7021"
 Q
26 D:$D(DG)>9 F^DIE17,DE S DQ=26,DW=".362;12",DV="SX",DU="",DIFLD=.36205,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C26^DGRPX7"
...
X26 S DFN=DA D MV^DGLOCK I $D(X) S DFN=DA D EV^DGLOCK
 Q
 ;
27 D:$D(DG)>9 F^DIE17,DE S DQ=27,DW=".362;13",DV="SX",DU="",DIFLD=.36215,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C27^DGRPX7"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
C27S S X="" G:DG(DQ)=X C27F1 K DB
 ...
 D AUTOUPD^DGENA2(DA)
C27F1 Q
X27 S DFN=DA D MV^DGLOCK I $D(X) S DFN=DA D EV^DGLOCK
 Q
 ;
...
X28 S Y="@70211"
 Q
29 S DQ=30 ;@7021
30 D:$D(DG)>9 F^DIE17,DE S DQ=30,DW=".362;12",DV="SX",DU="",DIFLD=.36205,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C30^DGRPX7"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 S Y="NO"
 G Y
...
C30S S X="" G:DG(DQ)=X C30F1 K DB
 ...
 D AUTOUPD^DGENA2(DA)
C30F1 Q
X30 S DFN=DA D MV^DGLOCK I $D(X) S DFN=DA D EV^DGLOCK
 Q
 ;
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW=".362;13",DV="SX",DU="",DIFLD=.36215,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGRPX7"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 S Y="NO"
 G Y
...
X38 S Y="@70213"
 Q
39 S DQ=40 ;@70212
40 D:$D(DG)>9 F^DIE17,DE S DQ=40,DW=".362;14",DV="SX",DU="",DIFLD=.36235,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C40^DGRPX7"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 S Y="NO"
 G Y
...
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW=".385;1",DV="DX",DU="",DIFLD=.3851,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C44^DGRPX7"
 S X="@"
 S Y=X
...
C44S S X="" G:DG(DQ)=X C44F1 K DB
 D ^DGRPX76
C44F1 Q
X44 S %DT="PX" D ^%DT S X=Y K:Y<1 X I $D(X) D H^DGUTL I $G(X)>0 S DFN=DA D DTCHK^DGRP7CP
 Q
 ;
45 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=45 G A
46 D:$D(DG)>9 F^DIE17,DE S DQ=46,DW=".385;2",DV="*P27.18'X",DU="",DIFLD=.3852,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C46^DGRPX7"
 S DU="DG(27.18,"
 S X="@"
 S Y=X
...
C46S S X="" G:DG(DQ)=X C46F1 K DB
 D ^DGRPX78
C46F1 Q
X46 S:($G(X)]"")&(X'?1P.P) X=$$UPPER^DGUTL(X) S X=$$LOWER^DGUTL(X) S DIC("S")="I $P($G(^(0)),U)[""Original Award""" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
