...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,10) S:%]"" DE(1)=% S %=$P(%Z,U,11) S:%]"" DE(11)=% S %=$P(%Z,U,12) S:%]"" DE(21)=% S %=$P(%Z,U,13) S:%]"" DE(31)=% S %=$P(%Z,U,14) S:%]"" DE(41)=% S %=$P(%Z,U,15) S:%]"" DE(51)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,20) S:%]"" DE(4)=% S %=$P(%Z,U,21) S:%]"" DE(14)=% S %=$P(%Z,U,22) S:%]"" DE(24)=% S %=$P(%Z,U,23) S:%]"" DE(34)=% S %=$P(%Z,U,24) S:%]"" DE(44)=% S %=$P(%Z,U,25) S:%]"" DE(54)=%
 I $D(^(300)) S %Z=^(300) S %=$P(%Z,U,2) S:%]"" DE(63)=% S %=$P(%Z,U,3) S:%]"" DE(67)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="81;10",DV="*P80'X",DU="",DIFLD=81.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=835,1233 S DIEZRXR(45.02,DIXR)=""
 Q
...
X3 I DGXX="" S Y="@221"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;20",DV="SX",DU="",DIFLD=82.2,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,10) X
 Q
 ;
5 S DQ=6 ;@221
...
X7 I X K DGPTIT S DGNFLD="@230",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@230
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD1,U,11)]"" S Y="@240"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@240"
 Q
11 S DW="81;11",DV="*P80'X",DU="",DIFLD=81.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=835,1234 S DIEZRXR(45.02,DIXR)=""
 Q
...
X13 I DGXX="" S Y="@231"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;21",DV="SX",DU="",DIFLD=82.21,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,11) X
 Q
 ;
15 S DQ=16 ;@231
...
C21F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=835,1235 S DIEZRXR(45.02,DIXR)=""
 Q
...
X23 I DGXX="" S Y="@241"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;22",DV="SX",DU="",DIFLD=82.22,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,12) X
 Q
 ;
25 S DQ=26 ;@241
...
C31F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=835,1236 S DIEZRXR(45.02,DIXR)=""
 Q
...
X33 I DGXX="" S Y="@251"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;23",DV="SX",DU="",DIFLD=82.23,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,13) X
 Q
 ;
35 S DQ=36 ;@251
...
C41F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=835,1237 S DIEZRXR(45.02,DIXR)=""
 Q
...
X43 I DGXX="" S Y="@261"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;24",DV="SX",DU="",DIFLD=82.24,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X44 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,14) X
 Q
 ;
45 S DQ=46 ;@261
...
C51F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=835,1238 S DIEZRXR(45.02,DIXR)=""
 Q
...
X53 I DGXX="" S Y="@271"
 Q
54 D:$D(DG)>9 F^DIE17,DE S DQ=54,DW="82;25",DV="SX",DU="",DIFLD=82.25,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X54 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,15) X
 Q
 ;
55 S DQ=56 ;@271
...
X66 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8300"
 Q
67 S DW="300;3",DV="SX",DU="",DIFLD=300.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="1:Yes;2:No;"
 G RE
X67 S DGFLAG=3 D 501^DGPTSC01 K:DGER X K DGER,DGFLAG Q
 Q
 ;
