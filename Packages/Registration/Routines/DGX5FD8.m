...
11 S DW="81;9",DV="*P80'X",DU="",DIFLD=81.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX5FD8",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
21 S DW="81;10",DV="*P80'X",DU="",DIFLD=81.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C21^DGX5FD8",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
31 S DW="81;11",DV="*P80'X",DU="",DIFLD=81.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGX5FD8",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
41 S DW="81;12",DV="*P80'X",DU="",DIFLD=81.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^DGX5FD8",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
51 S DW="81;13",DV="*P80'X",DU="",DIFLD=81.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C51^DGX5FD8",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
