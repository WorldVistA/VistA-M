DGENELA1 ;ALB/CJM,RTK,TDM,PJR,RGL,LBD,EG,TMK,CKN,ERC,HM,KUM - Patient Eligibility API ;20 Jan 2015  3:27 PM
 ;;5.3;Registration;**147,327,314,367,497,451,564,631,672,659,583,746,653,688,841,909,972,952,1149**;Aug 13,1993;Build 4
...
CHKFIELD(SUB,VAL) ;
 ...
 ; DG*5.3*1149 - Change 99999 to 999999.99
 ;I SUB="VACKAMT",+VAL'=VAL&(VAL'?.N1"."2N)!(VAL>99999)!(VAL<0) S BAD=1
 I SUB="VACKAMT",+VAL'=VAL&(VAL'?.N1"."2N)!(VAL>999999.99)!(VAL<0) S BAD=1
