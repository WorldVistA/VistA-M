...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,8) S:%]"" DE(1)=% S %=$P(%Z,U,9) S:%]"" DE(11)=% S %=$P(%Z,U,10) S:%]"" DE(21)=% S %=$P(%Z,U,11) S:%]"" DE(31)=% S %=$P(%Z,U,12) S:%]"" DE(41)=% S %=$P(%Z,U,13) S:%]"" DE(51)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,18) S:%]"" DE(4)=% S %=$P(%Z,U,19) S:%]"" DE(14)=% S %=$P(%Z,U,20) S:%]"" DE(24)=% S %=$P(%Z,U,21) S:%]"" DE(34)=% S %=$P(%Z,U,22) S:%]"" DE(44)=% S %=$P(%Z,U,23) S:%]"" DE(54)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="81;8",DV="*P80'X",DU="",DIFLD=81.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C1^DGX54",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1639 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX18")
 K X M X=X2 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX18")
 G C1F2
C1X1(DION) K X
 S X(1)=$G(@DIEZTMP@("V",45.02,DIIENS,81.08,DION),$P($G(^DGPT(DA(1),"M",DA,81)),U,8))
 S X=$G(X(1))
 Q
...
X3 I DGCODSYS="ICD9"!(DGTYPE=2)!(DGXX="") S Y="@201"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;18",DV="SX",DU="",DIFLD=82.18,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,8) X
 Q
 ;
5 S DQ=6 ;@201
...
X7 I X K DGPTIT S DGNFLD="@210",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@210
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD1,U,9)]"" S Y="@220"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@220"
 Q
11 S DW="81;9",DV="*P80'X",DU="",DIFLD=81.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX54",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1640 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX19")
 K X M X=X2 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX19")
 G C11F2
C11X1(DION) K X
 S X(1)=$G(@DIEZTMP@("V",45.02,DIIENS,81.09,DION),$P($G(^DGPT(DA(1),"M",DA,81)),U,9))
 S X=$G(X(1))
 Q
...
X13 I DGXX="" S Y="@211"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;19",DV="SX",DU="",DIFLD=82.19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,9) X
 Q
 ;
15 S DQ=16 ;@211
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C21F1 N X,X1,X2 S DIXR=1641 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX20")
 K X M X=X2 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX20")
 G C21F2
C21X1(DION) K X
 S X(1)=$G(@DIEZTMP@("V",45.02,DIIENS,81.1,DION),$P($G(^DGPT(DA(1),"M",DA,81)),U,10))
 S X=$G(X(1))
 Q
...
X23 I DGXX="" S Y="@221"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;20",DV="SX",DU="",DIFLD=82.2,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,10) X
 Q
 ;
25 S DQ=26 ;@221
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C31F1 N X,X1,X2 S DIXR=1642 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX21")
 K X M X=X2 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX21")
 G C31F2
C31X1(DION) K X
 S X(1)=$G(@DIEZTMP@("V",45.02,DIIENS,81.11,DION),$P($G(^DGPT(DA(1),"M",DA,81)),U,11))
 S X=$G(X(1))
 Q
...
X33 I DGXX="" S Y="@231"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;21",DV="SX",DU="",DIFLD=82.21,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,11) X
 Q
 ;
35 S DQ=36 ;@231
...
C41S S X="" G:DG(DQ)=X C41F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C41F1 N X,X1,X2 S DIXR=1643 D C41X1(U) K X2 M X2=X D C41X1("O") K X1 M X1=X
 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX22")
 K X M X=X2 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX22")
 G C41F2
C41X1(DION) K X
 S X(1)=$G(@DIEZTMP@("V",45.02,DIIENS,81.12,DION),$P($G(^DGPT(DA(1),"M",DA,81)),U,12))
 S X=$G(X(1))
 Q
...
X43 I DGXX="" S Y="@241"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;22",DV="SX",DU="",DIFLD=82.22,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X44 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,12) X
 Q
 ;
45 S DQ=46 ;@241
...
C51S S X="" G:DG(DQ)=X C51F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C51F1 N X,X1,X2 S DIXR=1644 D C51X1(U) K X2 M X2=X D C51X1("O") K X1 M X1=X
 D
...
X53 I DGXX="" S Y="@251"
 Q
54 D:$D(DG)>9 F^DIE17,DE S DQ=54,DW="82;23",DV="SX",DU="",DIFLD=82.23,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X54 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,13) X
 Q
 ;
55 S DQ=56 ;@251
