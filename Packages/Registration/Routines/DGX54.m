...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,12) S:%]"" DE(8)=% S %=$P(%Z,U,13) S:%]"" DE(18)=% S %=$P(%Z,U,14) S:%]"" DE(28)=% S %=$P(%Z,U,15) S:%]"" DE(38)=%
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,1) S:%]"" DE(48)=% S %=$P(%Z,U,2) S:%]"" DE(58)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,6) S:%]"" DE(1)=% S %=$P(%Z,U,7) S:%]"" DE(11)=% S %=$P(%Z,U,8) S:%]"" DE(21)=% S %=$P(%Z,U,9) S:%]"" DE(31)=% S %=$P(%Z,U,10) S:%]"" DE(41)=% S %=$P(%Z,U,11) S:%]"" DE(51)=% S %=$P(%Z,U,12) S:%]"" DE(61)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="82;6",DV="SX",DU="",DIFLD=82.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X1 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,11) X
 Q
 ;
2 S DQ=3 ;@81
...
X4 I X K DGPTIT S DGNFLD="@90",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
5 S DQ=6 ;@90
6 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=6 D X6 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X6 I DGADD,$P(DGHOLD,U,12)]"" S Y="@100"
 Q
7 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=7 D X7 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X7 S DGNFLD="@100"
 Q
8 S DW="0;12",DV="*P80'X",DU="",DIFLD=12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C8S S X="" G:DG(DQ)=X C8F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C8F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
...
X10 I DGXX="" S Y="@91"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="82;7",DV="SX",DU="",DIFLD=82.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X11 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,12) X
 Q
 ;
12 S DQ=13 ;@91
...
X14 I X K DGPTIT S DGNFLD="@100",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
15 S DQ=16 ;@100
16 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=16 D X16 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X16 I DGADD,$P(DGHOLD,U,13)]"" S Y="@110"
 Q
17 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=17 D X17 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X17 S DGNFLD="@110"
 Q
18 S DW="0;13",DV="*P80'X",DU="",DIFLD=13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C18^DGX54",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C18S S X="" G:DG(DQ)=X C18F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C18F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
...
X20 I DGXX="" S Y="@101"
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW="82;8",DV="SX",DU="",DIFLD=82.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X21 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,13) X
 Q
 ;
22 S DQ=23 ;@101
...
C28S S X="" G:DG(DQ)=X C28F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C28F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
...
X30 I DGXX="" S Y="@111"
 Q
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW="82;9",DV="SX",DU="",DIFLD=82.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X31 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,14) X
 Q
 ;
32 S DQ=33 ;@111
...
C38S S X="" G:DG(DQ)=X C38F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C38F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
...
X40 I DGXX="" S Y="@121"
 Q
41 D:$D(DG)>9 F^DIE17,DE S DQ=41,DW="82;10",DV="SX",DU="",DIFLD=82.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X41 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,15) X
 Q
 ;
42 S DQ=43 ;@121
...
C48S S X="" G:DG(DQ)=X C48F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C48F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=835,1224 S DIEZRXR(45.02,DIXR)=""
 Q
X48 N K D GETAPI^DGICDGT("DG PTF","DIAG",$G(DA(1)),"EN",81)
 Q
 ;
...
X50 I DGXX="" S Y="@131"
 Q
51 D:$D(DG)>9 F^DIE17,DE S DQ=51,DW="82;11",DV="SX",DU="",DIFLD=82.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X51 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,1) X
 Q
 ;
52 S DQ=53 ;@131
...
C58S S X="" G:DG(DQ)=X C58F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C58F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
...
X60 I DGXX="" S Y="@141"
 Q
61 D:$D(DG)>9 F^DIE17,DE S DQ=61,DW="82;12",DV="SX",DU="",DIFLD=82.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
X61 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,2) X
 Q
 ;
62 S DQ=63 ;@141
