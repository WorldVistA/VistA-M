...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,2) S:%]"" DE(1)=% S %=$P(%Z,U,3) S:%]"" DE(11)=% S %=$P(%Z,U,4) S:%]"" DE(21)=% S %=$P(%Z,U,5) S:%]"" DE(31)=% S %=$P(%Z,U,6) S:%]"" DE(41)=% S %=$P(%Z,U,7) S:%]"" DE(51)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,12) S:%]"" DE(4)=% S %=$P(%Z,U,13) S:%]"" DE(14)=% S %=$P(%Z,U,14) S:%]"" DE(24)=% S %=$P(%Z,U,15) S:%]"" DE(34)=% S %=$P(%Z,U,16) S:%]"" DE(44)=% S %=$P(%Z,U,17) S:%]"" DE(54)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="81;2",DV="*P80'X",DU="",DIFLD=81.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1633 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX12")
 K X M X=X2 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX12")
 G C1F2
C1X1(DION) K X
 S X(1)=$G(@DIEZTMP@("V",45.02,DIIENS,81.02,DION),$P($G(^DGPT(DA(1),"M",DA,81)),U,2))
 S X=$G(X(1))
 Q
C1F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1225 S DIEZRXR(45.02,DIXR)=""
 Q
...
X3 I DGXX="" S Y="@141"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;12",DV="SX",DU="",DIFLD=82.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,2) X
 Q
 ;
5 S DQ=6 ;@141
...
X7 I X K DGPTIT S DGNFLD="@150",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@150
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD1,U,3)]"" S Y="@160"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@160"
 Q
11 S DW="81;3",DV="*P80'X",DU="",DIFLD=81.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX53",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1634 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX13")
 K X M X=X2 D
 . D NOTIFY^DGPTDD(.X1,.X2,.DA,"MOVEMENT","DX13")
 G C11F2
C11X1(DION) K X
 S X(1)=$G(@DIEZTMP@("V",45.02,DIIENS,81.03,DION),$P($G(^DGPT(DA(1),"M",DA,81)),U,3))
 S X=$G(X(1))
 Q
...
X13 I DGXX="" S Y="@151"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;13",DV="SX",DU="",DIFLD=82.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,3) X
 Q
 ;
15 S DQ=16 ;@151
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C21F1 N X,X1,X2 S DIXR=1635 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
...
X23 I DGXX="" S Y="@161"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;14",DV="SX",DU="",DIFLD=82.14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,4) X
 Q
 ;
25 S DQ=26 ;@161
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C31F1 N X,X1,X2 S DIXR=1636 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 D
...
X33 I DGXX="" S Y="@171"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;15",DV="SX",DU="",DIFLD=82.15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,5) X
 Q
 ;
35 S DQ=36 ;@171
...
C41S S X="" G:DG(DQ)=X C41F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C41F1 N X,X1,X2 S DIXR=1637 D C41X1(U) K X2 M X2=X D C41X1("O") K X1 M X1=X
 D
...
X43 I DGXX="" S Y="@181"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;16",DV="SX",DU="",DIFLD=82.16,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X44 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,6) X
 Q
 ;
45 S DQ=46 ;@181
...
C51S S X="" G:DG(DQ)=X C51F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C51F1 N X,X1,X2 S DIXR=1638 D C51X1(U) K X2 M X2=X D C51X1("O") K X1 M X1=X
 D
...
X53 I DGXX="" S Y="@191"
 Q
54 D:$D(DG)>9 F^DIE17,DE S DQ=54,DW="82;17",DV="SX",DU="",DIFLD=82.17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X54 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,7) X
 Q
 ;
55 S DQ=56 ;@191
