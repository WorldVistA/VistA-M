...
C5F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1205,1206,1207,1208,1209 S DIEZRXR(45.01,DIXR)=""
 Q
...
C15F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 ...
 Q
X15 N DGIT,DGI S DGIT=8,DGI=8 D GETAPI^DGICDGT("DG PTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
...
C20F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 ...
 Q
X20 N DGIT,DGI S DGIT=8,DGI=9 D GETAPI^DGICDGT("DG PTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
...
C25F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 ...
 Q
X25 N DGIT,DGI S DGIT=8,DGI=10 D GETAPI^DGICDGT("DG PTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
...
C30S S X="" G:DG(DQ)=X C30F1 K DB
 S X=DG(DQ),DIC=DIE
 S ^DGPT(DA(1),"S","AO",$E(X,1,30),DA)=""
C30F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1208 S DIEZRXR(45.01,DIXR)=""
 Q
X30 N DGIT,DGI S DGIT=8,DGI=10 D GETAPI^DGICDGT("DG PTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
...
C35S S X="" G:DG(DQ)=X C35F1 K DB
 S X=DG(DQ),DIC=DIE
 S ^DGPT(DA(1),"S","AO",$E(X,1,30),DA)=""
C35F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1209 S DIEZRXR(45.01,DIXR)=""
 Q
X35 N DGIT,DGI S DGIT=8,DGI=12 D GETAPI^DGICDGT("DG PTF","PROC",$G(DA(1)),"EN1")
 Q
 ;
