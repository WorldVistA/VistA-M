...
C8F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1197,1585 S DIEZRXR(45,DIXR)=""
 Q
...
C18F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1198,1586 S DIEZRXR(45,DIXR)=""
 Q
...
C28F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1199,1587 S DIEZRXR(45,DIXR)=""
 Q
...
C38F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1188,1588 S DIEZRXR(45,DIXR)=""
 Q
...
C48F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1189,1589 S DIEZRXR(45,DIXR)=""
 Q
...
C58F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1190,1590 S DIEZRXR(45,DIXR)=""
 Q
