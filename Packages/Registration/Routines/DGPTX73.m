...
X3 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@51"
 Q
...
X8 S:$P($G(^DGPT(D0,70)),U,20,24)_$P($G(^DGPT(D0,71)),U,1,3)?."^" Y="@120"
 Q
9 S DQ=10 ;@55
...
11 S DW="70;21",DV="*P80'X",DU="",DLB="SECONDARY DIAGNOSIS 6",DIFLD=79.21
 S DE(DW)="C11^DGPTX73",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X13 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@56"
 Q
...
X18 S:$P($G(^DGPT(D0,70)),U,21,24)_$P($G(^DGPT(D0,71)),U,1,3)?."^" Y="@120"
 Q
19 S DQ=20 ;@60
...
21 S DW="70;22",DV="*P80'X",DU="",DLB="SECONDARY DIAGNOSIS 7",DIFLD=79.22
 S DE(DW)="C21^DGPTX73",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X23 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@61"
 Q
...
X28 S:$P($G(^DGPT(D0,70)),U,22,24)_$P($G(^DGPT(D0,71)),U,1,3)?."^" Y="@120"
 Q
29 S DQ=30 ;@70
...
31 S DW="70;23",DV="*P80'X",DU="",DLB="SECONDARY DIAGNOSIS 8",DIFLD=79.23
 S DE(DW)="C31^DGPTX73",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X33 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@71"
 Q
...
X38 S:$P($G(^DGPT(D0,70)),U,23,24)_$P($G(^DGPT(D0,71)),U,1,3)?."^" Y="@120"
 Q
39 S DQ=40 ;@80
...
41 S DW="70;24",DV="*P80'X",DU="",DLB="SECONDARY DIAGNOSIS 9",DIFLD=79.24
 S DE(DW)="C41^DGPTX73",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X43 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@81"
 Q
