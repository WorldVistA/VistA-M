DGRPP ;ALB/MRL,AEG,LBD,ASF,LEG - REGISTRATION SCREEN PROCESSOR ;Apr 05, 2020@15:16
 ;;5.3;Registration;**92,147,343,404,397,489,689,688,828,797,871,997**;Aug 13, 1993;Build 42
 ;
...
EN ;
 ...
 D Q1,WHICH^DGRPP1 W ! K DGRP S DGRPAN="" F I=1:1:$L(DGRPVV(DGRPS)) I $S('DGRPV:1,DGRPS=6:I=1!(I=2)!(I=3),DGRPS=11:I=5,DGRPS=11.5:I=1,1:0) S:'$E(DGRPVV(DGRPS),I) DGRPAN=DGRPAN_I_","
...
JUMP ;
 ...
 ; DG*5.3*997 ; LEG; add screen 11.5
