...
SA F DGI=0:0 S DGI=$O(^DGS(41.1,"B",DFN,DGI)) Q:'DGI  I $D(^DGS(41.1,DGI,0)),($P(^(0),"^",13)']""),($P(^(0),"^",17)']"") D
 .N FDA,ERROR
 .S FDA(41.1,DGI_",",13)=DGDEATH,FDA(41.1,DGI_",",14)=+DUZ
 .S FDA(41.1,DGI_",",15)=1,FDA(41.1,DGI_",",16)=2,DGSCHAD=1
 .D FILE^DIE("","FDA","ERROR")
 .I $D(ERROR) D MSG^DIALOG("WE",,,,"ERROR")
 Q
 ;
