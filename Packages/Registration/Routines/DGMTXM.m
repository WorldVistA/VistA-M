DGMTXM ; GENERATED FROM 'DGMT ENTER/EDIT MARITAL STATUS' INPUT TEMPLATE(#467), FILE 408.22;01/05/16
 D DE G BEGIN
DE S DIE="^DGMT(408.22,",DIC=DIE,DP=408.22,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGMT(408.22,DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,5) S:%]"" DE(5)=% S %=$P(%Z,U,6) S:%]"" DE(7)=% S %=$P(%Z,U,8) S:%]"" DE(14)=% S %=$P(%Z,U,20) S:%]"" DE(9)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="DGMTXM",DQ=1
 ...
 M DIEZAR=^DIE(467,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=467,U="^"
...
X8 S:X Y="@102"
 Q
9 D:$D(DG)>9 F^DIE17,DE S DQ=9,DW="0;20",DV="SR",DU="",DLB="IF YOUR SPOUSE DID NOT LIVE WITH YOU LAST YEAR, DID YOU PROVIDE SUPPORT",DIFLD=.21
 S DE(DW)="C9^DGMTXM"
 S DU="1:YES;0:NO;"
 G RE
...
X11 S X=$S($P(^DGMT(408.22,DA,0),U,20)=1:"YES",1:"NO")
 Q
12 S DQ=13 ;@102
13 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=13 D X13 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X13 S:DGDR'["102" Y="@998"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="0;8",DV="SXR",DU="",DLB="DID YOU HAVE ANY DEPENDENT CHILDREN",DIFLD=.08
 S DE(DW)="C14^DGMTXM"
 S DU="1:YES;0:NO;"
