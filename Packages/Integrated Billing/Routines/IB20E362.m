IB20E362 ;ISP/PHH - ENVIRONMENT CHECK WITH PRE-INIT CODE; 11/24/2006
...
POS1 ; Ask if user wants to print or update and print if "APRIOR" X-ref is
 ; set for 12/1/2005.
 I '$D(^IBA(354.1,"APRIOR",3051201)) K DIR Q
 ...
 ;
 ;
POS2 ; Ask device to print the report to, if "APRIOR" X-ref is set for 12/1/05.
 I '$D(^IBA(354.1,"APRIOR",3051201)) K DIR Q
 K DIR
