IB20P406 ;DAY/RRA - DSS CLINIC STOP CODES IB*2.0*406 POST-INIT ; 3/13/07 12:55pm
 ;;2.0;INTEGRATED BILLING;**406**;21-MAR-94;Build 3
...
NCODE ;;code^billable type^description^override flag
 ;;156^1^HBPC PSYCHOLOGIST^^3081001
 ;;157^1^HBPC PSYCHIATRIST^^3081001
 ;;162^0^MEDICAL FOSTER HOME^^3081001
 ;;195^0^POLYTRAUMA TRANSIT REHAB IND^^3081001
 ;;196^0^POLYTRAUMA TRANSIT REHAB GRP^^3081001
 ;;230^0^PM&RS DRIVER TRAINING^1^3081001
 ;;438^0^INTERMEDIATE LOW VISION CARE^^3081001
 ;;593^0^RRTP OUTREACH SERVICES^^3081001
 ;;594^0^RRTP AFTERCARE COMMUNITY^^3081001
 ;;595^0^RRTP AFTERCARE VA^^3081001
 ;;596^1^RRTP ADMISSION SCREENING SVCS^^3081001
 ;;597^0^TELEPHONE - RRTP^^3081001
 ;;719^0^MHV SECURE MESSAGING^1^3081001
 ;
 ;codes update
OCODE ;;code^billable type^description^override flag
 ;;119^0^COMMUNITY NURSING HOME F/U^1^3081001
 ;;352^1^GRECC CLINICAL^^3081001
 ;
