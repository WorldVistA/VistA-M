IB20E611 ;DEV/BJR - ENVIRONMENT CHECK WITH PRE-INIT CODE ;10/13/2017 12:50pm
...
POS1 ; Ask if user wants to print or update and print if "APRIOR" X-ref is
 ; set for 12/1/2016.
 I '$D(^IBA(354.1,"APRIOR",3161201)) K DIR Q
 ...
 ;
 ;
POS2 ; Ask device to print the report to, if "APRIOR" X-ref is set for 12/1/16.
 I '$D(^IBA(354.1,"APRIOR",3161201)) K DIR Q
 K DIR
