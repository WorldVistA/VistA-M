IBYP468 ;ALB/CXW - IB*2.0*468 POST INIT: REASONABLE CHARGES V3.9 ; 16-DEC-2011
 ;;2.0;INTEGRATED BILLING;**468**;21-MAR-94;Build 17
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.9 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.9 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
