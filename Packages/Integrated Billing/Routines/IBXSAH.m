IBXSAH ; GENERATED FROM 'IB SCREEN10H' INPUT TEMPLATE(#1754), FILE 399;05/12/15
 D DE G BEGIN
DE S DIE="^DGCR(399,",DIC=DIE,DP=399,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGCR(399,DA,""))=""
 I $D(^("TX")) S %Z=^("TX") S %=$P(%Z,U,8) S:%]"" DE(61)=%
...
X48 S:IBDR20'["106" Y="@107"
 Q
49 S DW="UF31;3",DV="F",DU="",DLB="CMS-1500 Box 19",DIFLD=459
 G RE
