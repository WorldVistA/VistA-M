IBYP559 ;ALB/CXW - IB*2.0*559 POST INIT: REASONABLE CHARGES V3.18; 12-09-2015
 ;;2.0;INTEGRATED BILLING;**559**;21-MAR-94;Build 34
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.18 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.18 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
