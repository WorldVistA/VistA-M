...
DE S DIE="^DGCR(399,D0,""RC"",",DIC=DIE,DP=399.042,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGCR(399,D0,"RC",DA,""))=""
 ...
 I  S %=$P(%Z,U,9) S:%]"" DE(8)=% S %=$P(%Z,U,10) S:%]"" DE(14)=% S %=$P(%Z,U,12) S:%]"" DE(15)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
X10 I '$P(^DGCR(399,DA(1),"RC",DA,0),U,6) S Y="@658"
 Q
...
X13 I +$P(^DGCR(399,DA(1),"RC",DA,0),U,8) S Y="@659"
 Q
...
X16 I $P($G(^DGCR(399,DA(1),"RC",DA,0)),U,10)'=4!'$P(^DGCR(399,DA(1),"RC",DA,0),U,6) S Y="@659"
 Q
17 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=17 D X17 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X17 D LINKCPT^IBCEU5(DA(1),DA)
 Q
18 S DQ=19 ;@659
19 G 1^DIE17
