IB20E583 ;ALB/RRA - ENVIRONMENT CHECK WITH PRE-INIT CODE ; 10/27/2015 12:50pm
...
POS1 ; Ask if user wants to print or update and print if "APRIOR" X-ref is
 ; set for 12/1/2015.
 I '$D(^IBA(354.1,"APRIOR",3151201)) K DIR Q
 ...
 ;
 ;
POS2 ; Ask device to print the report to, if "APRIOR" X-ref is set for 12/1/15.
 I '$D(^IBA(354.1,"APRIOR",3151201)) K DIR Q
 K DIR
