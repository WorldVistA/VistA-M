IBYPSJ ;ALB/ARH - IB*2.0*365 POST INIT: REASONABLE CHARGES V2.9 ; 29-DEC-2006
 ;;2.0;INTEGRATED BILLING;**365**;21-MAR-94;Build 2
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.9 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.9 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
