IBYP542 ;ALB/CXW - IB*2.0*542 POST INIT: REASONABLE CHARGES V3.16; 11-DEC-2014
 ;;2.0;INTEGRATED BILLING;**542**;21-MAR-94;Build 29
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.16 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.16 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
