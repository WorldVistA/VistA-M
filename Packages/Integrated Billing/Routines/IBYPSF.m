IBYPSF ;ISP/RRA - IB*2.0*325 POST INIT: REASONABLE CHARGES V2.5 ; 01-OCT-2005
 ;;2.0;INTEGRATED BILLING;**325**;21-MAR-94
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.5 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.5 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
