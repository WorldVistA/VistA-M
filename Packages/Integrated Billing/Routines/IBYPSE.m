IBYPSE ;ISP/TJH - IB*2.0*298 POST INIT: REASONABLE CHARGES V2.4 ; 17-MAR-2005
 ;;2.0;INTEGRATED BILLING;**298**;21-MAR-94
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.4 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.4 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
