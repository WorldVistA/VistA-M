IBYP462 ;ALB/CXW - IB*2.0*462 POST INIT: REASONABLE CHARGES V3.8 ; 8-SEP-2011
 ;;2.0;INTEGRATED BILLING;**462**;21-MAR-94;Build 14
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.8 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.8 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
