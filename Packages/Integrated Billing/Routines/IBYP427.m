IBYP427 ;ALB/CXW - IB*2.0*427 POST INIT: REASONABLE CHARGES V3.5 ; 10-DEC-2009
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.5 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 D CPTLK^IBYPSP ;CPT linkage
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.5 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
