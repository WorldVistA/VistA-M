IBYP439 ;ALB/CXW - IB*2.0*439 POST INIT: REASONABLE CHARGES V3.6 ; 2-SEP-2010
 ;;2.0;INTEGRATED BILLING;**439**;21-MAR-94;Build 4
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.6 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.6 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
