...
X16 S:$$EDADDR^IBCSCE(+$G(DFN)) Y="@155"
 Q
17 D:$D(DG)>9 F^DIE17,DE S DQ=17,DW=".11;1",DV="FaXJ35",DU="",DIFLD=.111,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C17X1(DION) K X
 ...
 Q
C17F2 Q
X17 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>35!($L(X)<3) X D:$D(X) UP^DGHELP
 I $D(X),X'?.ANP K X
 Q
 ;
...
X20 S:X="" Y=.114
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW=".11;3",DV="FaXJ30",DU="",DIFLD=.113,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21X1(DION) K X
 ...
 Q
C21F2 Q
X21 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>30!($L(X)<3) X D:$D(X) UP^DGHELP
 I $D(X),X'?.ANP K X
 Q
 ;
22 D:$D(DG)>9 F^DIE17,DE S DQ=22,DW=".11;4",DV="FaXJ15",DU="",DIFLD=.114,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C22X1(DION) K X
 ...
 Q
C22F2 Q
X22 K:$L(X)>15!($L(X)<2) X D:$D(X) UP^DGHELP
 I $D(X),X'?.ANP K X
 Q
 ;
...
X25 S Z0=$S($D(^DPT(D0,.11)):+$P(^(.11),"^",5),1:0) K:'Z0 X Q:'Z0!'$D(^DIC(5,Z0,1,0))  S DIC="^DIC(5,Z0,1,",DIC(0)="QEM" D ^DIC S X=+Y K:Y'>0 X K Z0,DIC
 Q
 ;
26 D:$D(DG)>9 F^DIE17,DE S DQ=26,DW=".13;1",DV="FaXJ17",DU="",DIFLD=.131,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C26^IBXS11"
 G RE
...
C26S S X="" G:DG(DQ)=X C26F1 K DB
 D ^IBXS111
C26F1 Q
X26 S X=$TR(X,"x","X") K:$L(X)>17 X I $D(X) K:'(X?10N!(X?10N1"X"1.6N)) X
 I $D(X),X'?.ANP K X
 Q
 ;
27 S DQ=28 ;@155
...
X29 S:X="N" Y="@915" S:X="Y" DIE("NO^")=""
 Q
30 D:$D(DG)>9 F^DIE17,DE S DQ=30,DW=".121;7",DV="RDX",DU="",DIFLD=.1217,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C32F1 S DIEZRXR(2,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=603 S DIEZRXR(2,DIXR)=""
 Q
X32 S %DT="E" D ^%DT S X=Y K:Y<1 X I $D(X) S DFN=DA D TAD^DGLOCK
 Q
 ;
33 D:$D(DG)>9 F^DIE17,DE S DQ=33,DW=".121;1",DV="FXJ30",DU="",DIFLD=.1211,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C33F1 S DIEZRXR(2,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=603 S DIEZRXR(2,DIXR)=""
 Q
X33 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>30!($L(X)<2) X D:$D(X) UP^DGHELP I $D(X) S DFN=DA D TAD^DGLOCK
 I $D(X),X'?.ANP K X
 Q
 ;
...
X34 I X']"" W !?4,*7,"But I need at least one line of a Temporary address." S Y=.12105
 Q
35 D:$D(DG)>9 F^DIE17,DE S DQ=35,DW=".121;2",DV="FXJ30",DU="",DIFLD=.1212,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C35F1 S DIEZRXR(2,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=603 S DIEZRXR(2,DIXR)=""
 Q
X35 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>30!($L(X)<2) X D:$D(X) UP^DGHELP I $D(X) S DFN=DA D TAD^DGLOCK
 I $D(X),X'?.ANP K X
 Q
 ;
...
X36 S:X']"" Y=.1214
 Q
37 D:$D(DG)>9 F^DIE17,DE S DQ=37,DW=".121;3",DV="FXJ30",DU="",DIFLD=.1213,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C37F1 S DIEZRXR(2,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=603 S DIEZRXR(2,DIXR)=""
 Q
X37 K:$L(X)>30!($L(X)<2) X D:$D(X) UP^DGHELP I $D(X) S DFN=DA D TAD^DGLOCK
 I $D(X),X'?.ANP K X
 Q
 ;
38 D:$D(DG)>9 F^DIE17,DE S DQ=38,DW=".121;4",DV="FXJ30",DU="",DIFLD=.1214,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C38F1 S DIEZRXR(2,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=603 S DIEZRXR(2,DIXR)=""
 Q
X38 K:$L(X)>30!($L(X)<2) X D:$D(X) UP^DGHELP I $D(X) S DFN=DA D TAD^DGLOCK
 I $D(X),X'?.ANP K X
 Q
 ;
...
X40 K:X[""""!($A(X)=45) X I $D(X) S DFN=DA D TAD^DGLOCK I $D(X) K:$L(X)>20!($L(X)<5) X I $D(X) D ZIPIN^VAFADDR
 ...
 Q
 ;
41 D:$D(DG)>9 F^DIE17,DE S DQ=41,DW=".121;10",DV="FXJ17",DU="",DIFLD=.1219,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^IBXS11"
 G RE
...
C41S S X="" G:DG(DQ)=X C41F1 K DB
 D ^IBXS125
C41F1 Q
X41 S X=$TR(X,"x","X") K:$L(X)>17 X I $D(X) K:'(X?10N!(X?10N1"X"1.6N)) X I $D(X) S DFN=DA D TAD^DGLOCK
 I $D(X),X'?.ANP K X
 Q
 ;
42 S DQ=43 ;@915
