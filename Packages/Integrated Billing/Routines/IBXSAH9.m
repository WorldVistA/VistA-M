...
BEGIN S DNM="IBXSAH9",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;13",DV="*P355.97'",DU="",DLB="SEC INS PROVIDER ID TYPE",DIFLD=.13
 S DE(DW)="C1^IBXSAH9"
 S DU="IBE(355.97,"
 S X=DIPA("PRIDT")
 S Y=X
...
C1F1 Q
X1 Q
2 D:$D(DG)>9 F^DIE17,DE S DQ=2,DW="0;6",DV="FX",DU="",DLB="SECONDARY INS CO ID NUMBER",DIFLD=.06
 S DE(DW)="C2^IBXSAH9"
 S X=DIPA("PRID")
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
...
X3 S Y="@10383"
 Q
4 S DQ=5 ;@10373
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,DW="0;14",DV="*P355.97'",DU="",DLB="TERT INS PROVIDER ID TYPE",DIFLD=.14
 S DE(DW)="C5^IBXSAH9"
 S DU="IBE(355.97,"
 S X=DIPA("PRIDT")
 S Y=X
...
C5F1 Q
X5 Q
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW="0;7",DV="FX",DU="",DLB="TERTIARY INS CO ID NUMBER",DIFLD=.07
 S DE(DW)="C6^IBXSAH9"
 S X=DIPA("PRID")
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
