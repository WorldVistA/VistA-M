...
BEGIN S DNM="IBXS66",DQ=1
1 S DW="U1;2",DV="NJ8,2",DU="",DLB="OFFSET AMOUNT",DIFLD=202
 S DE(DW)="C1^IBXS66"
 G RE
...
X2 S:'X Y="@657"
 Q
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW="U1;3",DV="FX",DU="",DLB="OFFSET DESCRIPTION",DIFLD=203
 G RE
X3 K:$L(X)>24!($L(X)<3) X
 I $D(X),X'?.ANP K X
 Q
...
X5 I $P(^DGCR(399,DA,"U1"),"^",11)']"" S Y="@66"
 Q
6 S DW="U1;10",DV="RNJ10,2",DU="",DLB="*FY 1 CHARGES",DIFLD=210
 G RE
...
X10 S:'$D(^DGCR(399,DA,"I1")) Y="@672"
 Q
11 S DW="U2;4",DV="NJ11,2",DU="",DLB="PRIMARY PRIOR PAYMENT",DIFLD=218
 S DE(DW)="C11^IBXS66"
 G RE
...
X13 S:'$D(^DGCR(399,DA,"I2")) Y="@673"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="U2;5",DV="NJ11,2",DU="",DLB="SECONDARY PRIOR PAYMENT",DIFLD=219
 S DE(DW)="C14^IBXS66"
 G RE
...
X16 S:'$D(^DGCR(399,DA,"I3")) Y="@68"
 Q
17 D:$D(DG)>9 F^DIE17,DE S DQ=17,DW="U2;6",DV="NJ11,2",DU="",DLB="TERTIARY PRIOR PAYMENT",DIFLD=220
 S DE(DW)="C17^IBXS66"
 G RE
