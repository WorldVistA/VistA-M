IBYP693 ;ALB/CXW - IB*2.0*693 POST INIT: REASONABLE CHARGES V4.215 ; Dec 17, 2020@13:36
 ;;2.0;INTEGRATED BILLING;**693**;21-MAR-94;Build 77
...
POST ;
 N IBA,U S U="^"
 D BMSG("    Reasonable Charges v4.215 Post-Install .....")
 D CHGINA("") ; inactivate all RC charges in #363.2
 D BMSG("    Reasonable Charges v4.215 Post-Install Complete")
 Q
 ;
BMSG(IBA) ;
 D BMES^XPDUTL(IBA)
