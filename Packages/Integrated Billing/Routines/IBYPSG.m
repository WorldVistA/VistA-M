IBYPSG ;ALB/CXW - IB*2.0*334 POST INIT: REASONABLE CHARGES V2.6 ; 09-DEC-2005
 ;;2.0;INTEGRATED BILLING;**334**;21-MAR-94
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.6 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.6 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
