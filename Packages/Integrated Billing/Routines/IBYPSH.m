IBYPSH ;ALB/RRA - IB*2.0*355 POST INIT: REASONABLE CHARGES V2.7 ; 17-AUG-2006
 ;;2.0;INTEGRATED BILLING;**355**;21-MAR-94
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.7 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v2.7 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
