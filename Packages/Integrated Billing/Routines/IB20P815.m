IB20P815 ;MNTVBB/DTA - UPDATE TRICARE RX ADMINISTRATIVE FEE FOR CY 2025 ; 12/10/2024@16:15
 ;;2.0;INTEGRATED BILLING;**815**;21-MAR-94;Build 3
 ;;Per VA Directive 6402, this routine should not be modified.
 Q
POST ; 
 ; Update TRICARE pharmacy administrative fee for CY 2025 in Rate Schedule (#363) file
 N IBA,U S U="^"
 D BMSG("IB*2.0*815 Post-Install starts.....")
 D TRXAF
 D BMSG("IB*2.0*815 Post-Install is complete.")
 Q
 ;
TRXAF ; Rate Schedule
 N IBCT,IBI,IBT,IBX,IBRS,IBRSIN,IBRATY,IBEFFDT,IBADFE,IBDISP,IBADJUST
 D BMSG("  >>>Effect. JAN 01, 2025 of RX Rate Schedule Adjustment for the Rate Type:")
 ...
 . ; inactivate rx RS for cy 2024 and add new rx RS for cy 2025
...
RSF ; 3 Rate types^dispensing fee^adjustment
 ;;TRICARE^14.78^S X=X+14.78
 ;;TRICARE PHARMACY^14.78^S X=X+14.78
 ;;TRICARE REIMB. INS.^14.78^S X=X+14.78
 ;;Q
 ;
