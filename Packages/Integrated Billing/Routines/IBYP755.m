IBYP755 ;MNTVBB/DMR - IB*2.0*755 POST INIT: REASONABLE CHARGES V4.235 ; Dec 6, 2022@11:09
 ;;2.0;INTEGRATED BILLING;**755**;21-MAR-94;Build 4
...
POST ;
 N IBA,U S U="^"
 D BMSG("    Reasonable Charges v4.235 Post-Install .....")
 D CHGINA("") ; inactivate all RC charges in #363.2
 D BMSG("    Reasonable Charges v4.235 Post-Install Complete")
 Q
 ;
BMSG(IBA) ;
 D BMES^XPDUTL(IBA)
