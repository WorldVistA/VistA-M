IBNCPDP1 ;OAK/ELZ - IB BILLING DETERMINATION PROCESSING FOR NEW RX REQUESTS ;5/22/08
 ;;2.0;INTEGRATED BILLING;**223,276,339,363,383,405,384,411,434,437,435,455,452,473,494,534,550,617,624,636,647,648,649,712,813**;21-MAR-94;Build 11
...
RX(DFN,IBD) ; pharmacy package call, passing in IBD by ref
 ...
 N IBTRKR,IBTRKRN,IBTRN,IBX,IBVET
 ...
 ;
 ; -- check ePharmacy Billing parameters to verify if ePharmacy claim should be created based
 ; on patient's current eligibility status.
 S IBVET=$$ELIG^BPSEBP(DFN)
 I IBVET D  D CT G RXQ
 . S IBRMARK=$P(IBVET,"^",2)
 . S IBRES="0^"_IBRMARK
 ;
