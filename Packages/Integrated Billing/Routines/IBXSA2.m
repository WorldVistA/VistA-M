IBXSA2 ; GENERATED FROM 'IB SCREEN102' INPUT TEMPLATE(#1753), FILE 399;03/14/19
 D DE G BEGIN
...
X28 S:IBDR20'["103" Y="@104"
 Q
29 S D=0 K DE(1) ;222
 S DIFLD=222,DGO="^IBXSA21",DC="18^399.0222ISA^PRV^",DV="399.0222MR*SX",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
