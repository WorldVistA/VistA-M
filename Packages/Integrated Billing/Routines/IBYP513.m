IBYP513 ;ALB/CXW - IB*2.0*513 POST INIT: REASONABLE CHARGES V3.14; 18-NOV-2013
 ;;2.0;INTEGRATED BILLING;**513**;21-MAR-94;Build 24
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.14 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.14 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
