...
X2 I X="",$G(DIPA("OLDALTI1"))="" S Y="@10811"
 Q
...
X7 I '$G(DIPA("I2")) S Y="@109"
 Q
8 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=8 D X8 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X8 K DIPA("BRANCH") S DIPA("BRANCH")=$$ACINTEL^IBCSC10(DIPA("I2"),"@1082")
 Q
...
X12 I X="",$G(DIPA("OLDALTT2"))="" S Y="@1082"
 Q
13 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=13 D X13 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X13 I $P($G(^DGCR(399,DA,"M2")),U,3)="" S Y="@1082"
 Q
...
X16 I X="",$G(DIPA("OLDALTI2"))="" S Y="@10821"
 Q
...
X30 I X="",$G(DIPA("OLDALTI3"))="" S Y="@10831"
 Q
