IBYP491 ;ALB/CXW - IB*2.0*491 POST INIT: REASONABLE CHARGES V3.12 ; 16-NOV-2012
 ;;2.0;INTEGRATED BILLING;**491**;21-MAR-94;Build 22
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.12 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.12 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
