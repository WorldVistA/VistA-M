IBCRBC1 ;ALB/ARH - RATES: BILL CALCULATION BILLABLE EVENTS ; 22 MAY 96
 ;;2.0;INTEGRATED BILLING;**52,80,106,138,51,148,245,270,370,796**;21-MAR-94;Build 34
...
CPT(IBIFN,RS,CS) ; Determine charges for PROCEDURE billable events
 ...
 N IBPPRV,IBBS,IBCLIN,IBOE,IBSAVE,IBUNIT,IBCPTRX,IBMODS,IBCPTUT I '$G(IBIFN)!'$G(CS) Q
 ;
 ...
 ... S IBCPTUT=$S($P(IBX,U,10):$P(IBX,U,10),1:1)  ;796
 ... ;
 ...
 ... ;
 ... ;796 S IBSAVE="1^"_IBCPT_U_IBDIV_U_IBTYPE_U_IBCPTFN_U_IBCMPNT_U_IBBS_U_IBPPRV_U_IBCLIN_U_IBOE_U_IBMODS
 ... S IBSAVE=IBCPTUT_U_IBCPT_U_IBDIV_U_IBTYPE_U_IBCPTFN_U_IBCMPNT_U_IBBS_U_IBPPRV_U_IBCLIN_U_IBOE_U_IBMODS
