IBJTTC ;ALB/ARH/PJH - TPI AR COMMENT HISTORY ; 3/18/11 2:15pm
 ;;2.0;INTEGRATED BILLING;**39,377,431,432,447,547,770**;21-MAR-94;Build 119
...
BLD ;
 ...
 ;
 ;
 D ACCENCCOM(IBIFN,.IBLN)  ;IB*2*770;TPF;EBILL-3552,EBILL-3803  DISPLAY WORKLSIT ACTIVITY IN TPJI
 ;
 D CLEAN^DILF
 ;
 ...
 Q
 ;
ACCENCCOM(IBFN,IBLN) ;EP - ;IB*2*770;TPF;EBILL-3552,EBILL-3808  ADD ACC ENCOUNTER PREVIOUS ACTIVITY
 ;
 D INIT^IBACCWLPREV("",IBIFN,.IBLN) ;ACC ENCOUNTER PREVIOUS ACTIVITY
 ;
 Q 
 ;
