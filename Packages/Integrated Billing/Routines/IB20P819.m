IB20P819 ;MNTVBB/JWB - IB FY 2025 MID YEAR STOP CODES UPDATE ; JANUARY 31, 2025 @13:20
 ;;2.0;INTEGRATED BILLING;**819**;21-MAR-94;Build 11
 ;;Per VA Directive 6402, this routine should not be modified.
 ;
 Q
EN ;
 N IB819FILES,IB819FILE,IBCNT
 S IB819FILE=""
 S IB819FILES="352.5"
 S IBCNT=0
 F IBCNT=1:1:$L(IB819FILES,"^") D
 . S IB819FILE=$P(IB819FILES,"^",IBCNT)
 . D GLBBKUP
 . Q
 N IBEFFDT
 ...
 Q
 ;
START D BMES^XPDUTL("DSS Clinic Stop Codes for Mid Year FY 2025, Post-Install Starting")
 Q
 ;
FINISH D BMES^XPDUTL("DSS Clinic Stop Codes for Mid Year FY 2025, Post-Install Starting")
 Q
 ;
ADD ;add a new code
...
GLBBKUP  ; XTMP Backup of file(s)
 N IBBKUPNDE
 S IBBKUPNDE="IB*2*819-Update FY25 MID YEAR STOP CODES (#352.5)"
 S ^XTMP("IB20P819",0)=$$FMADD^XLFDT(DT,120)_"^"_DT_"^"_IBBKUPNDE
 M ^XTMP("IB20P819",IB819FILE,$H)=^IBE(IB819FILE)
 Q
 ;new stop codes - ADD
...
OCODE ;;code^billable type^description^override flag^effective date
 ;;172^1^HBPC ADV PRAC PROV(NP,CNS,PA)^^3250401
 ;;159^1^COMP AND INTEGRATIVE HEALTH^1^3250401
 ;;342^1^FAMILY PRACTICE^1^3250401
 ;;184^0^CARE/CASE MANAGER^1^3250401
 ;;322^1^COMP WOMENS PRI CARE^1^3250401
 ;;704^0^WOMENS PREVENTIVE CARE^1^3250401
 ;
