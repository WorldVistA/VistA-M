IB20P531 ;ALB/RRA - IB*2.0*531; DSS CLINIC STOP CODES ; 6/18/12 5:08pm
 ;;2.0;INTEGRATED BILLING;**531**;21-MAR-94;Build 1
...
NCODE ;;code^billable type^description^override flag^effective date
 ;;183^1^PEER SPECIALIST^1^3141001
 ;;443^0^DBQ REFERRAL CLINIC^1^3141001
 ;;555^0^HOMELESS VT COM EMP SVC INDIV^1^3141001
 ;;556^0^HOMELESS VT COM EMP SVC GRP^1^3141001
 ;;339184^2^MATERNITY CARE COORDINATOR^1^3141001
 ;
 ;existing stop codes - UPDATE
OCODE ;;code^billable type^description^override flag^effective date
 ;;999^0^OCCUPATIONAL HEALTH^1^3141001
 ;;225^1^SCI TELEHEALTH VIRTUAL^^3141001
 ;
