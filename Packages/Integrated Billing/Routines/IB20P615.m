IB20P615 ;ALB/MPA - IB*2.0*615; DSS CLINIC STOP CODES ;7/18/17 1:43pm
 ;;2.0;INTEGRATED BILLING;**615**;21-MAR-94;Build 8
...
NCODE ;;code^billable type^description^override flag^effective date
 ;;241^2^WHLCHR AND ADVCD MOB CLC^^3180401
 ;;499^0^ENVIRO HLTH REG EXAM^1^3180401
 ;
 ;existing stop codes - UPDATE
OCODE ;;code^billable type^description^override flag^effective date
 ;;142^1^WOUND TX & OSTOMY CARE^^3180401
 ;;185^1^NURSE PRACTITIONER^^3180401
 ;;186^1^PHYSICIAN ASSISTANT^^3180401
 ;;187^1^CLINICAL NURSE SPECIALIST^^3180401
 ;;201^2^PM & RS PHYSICIAN^^3180401
 ;;305^2^ENDOCRINOLOGY^^3180401
 ;;692^2^RTCL VTH PROV SIT (SAMDIV/STA)^^3180401
 ;;699^2^RTCL VTH EMG CONS(WKLD PATSIT)^^3180401
 ;
