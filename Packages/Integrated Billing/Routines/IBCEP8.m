IBCEP8 ;ALB/TMP/OIFO-BP/RBN - Functions for NON-VA PROVIDER ;11-07-00
 ;;2.0;INTEGRATED BILLING;**51,137,232,288,320,343,374,377,391,400,436,432,476,516*770**;21-MAR-94;Build 119
...
HELP ;
 ...
 ;
EXIT ;
 ;BEGIN;TPF;IB*2*770V????;EBILL-5411
 I ($G(IBACCNEWNPI("CALLER"))="PROVMAIN^IBACCWUTIL4"),$G(IBNPRV),$O(^IBA(355.93,IBNPRV,"NPISTATUS","B",""),-1) D
 .N IBACCNPIVALID,IBNEWNPI,IBNEWNPIDATE
 .S IBACCNPIVALID=$$NPI^XUSNPI("Non_VA_Provider_ID",IBNPRV)
 .I IBACCNPIVALID<0 W !,"Bad input parameters " Q
 .I 'IBACCNPIVALID W !,"NPI not valid" Q
 .I $P(IBACCNPIVALID,U,3)'="Active" W !,"NPI not active!" Q
 .S IBNEWNPI=$P(IBACCNPIVALID,U)
 .S IBNEWNPIDATE=$P(IBACCNPIVALID,U,2)
 .Q:$P(IBNEWNPIDATE,".")'=DT  ;IF NOT DT THEN ASSUME NOT JUST ADDED USING PROV. MAINT. BETTER WAY?                
 .S:IBNEWNPI'="" IBACCNEWNPI("NEWNPI",IBNEWNPI)=""
 ;END;TPF;IB*2*770V????;EBILL-5411
 ;
 K ^TMP("IBCE_PRVNVA_MAINT",$J)
 D CLEAN^VALM10
 K IBFASTXT
...
PRVFMT ;  called only by the INPUT TRANSFORM of #355.93,.01
 ...
 ;
 I $P($G(XQY0),U,1)="IBACC WL ACC CLAIMS WORKLIST" D PRVINIT,PRVMANT S OKRTN=1  ;TPF;IB*2*770v15;EBILL-4620
 ;
