IBXS4 ; GENERATED FROM 'IB SCREEN4' INPUT TEMPLATE(#510), FILE 399;10/26/11
 D DE G BEGIN
...
X15 S:IBDR20'["46" Y="@47"
 Q
16 S D=0 K DE(1) ;41
 S DIFLD=41,DGO="^IBXS42",DC="4^399.041IPA^OC^",DV="399.041M*P399.1'",DW="0;1",DOW="OCCURRENCE CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.1,"
...
X18 S:IBDR20'["47" Y="@44"
 Q
19 S D=0 K DE(1) ;40
 S DIFLD=40,DGO="^IBXS43",DC="1^399.04PA^CC^",DV="399.04M*P399.1'",DW="0;1",DOW="CONDITION CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.1,"
