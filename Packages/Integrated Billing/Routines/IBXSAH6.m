...
X26 S:$D(^IBA(355.93,DIPA("NVA_PRV"),"TAXONOMY"))>0 Y="@1037"
 Q
27 S D=0 K DE(1) ;42
 S DIFLD=42,DGO="^IBXSAH10",DC="3^355.9342IP^TAXONOMY^",DV="355.9342M*P8932.1'",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="USC(8932.1,"
