IBXS7 ; GENERATED FROM 'IB SCREEN7' INPUT TEMPLATE(#513), FILE 399;05/12/15
 D DE G BEGIN
DE S DIE="^DGCR(399,",DIC=DIE,DP=399,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGCR(399,DA,""))=""
 ...
 I $D(^("U")) S %Z=^("U") S %=$P(%Z,U,5) S:%]"" DE(37)=% S %=$P(%Z,U,6) S:%]"" DE(40)=% S %=$P(%Z,U,7) S:%]"" DE(39)=% S %=$P(%Z,U,12) S:%]"" DE(18)=%
