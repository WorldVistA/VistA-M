IBYP412 ;ALB/ARH - IB*2.0*412 POST INIT: REASONABLE CHARGES V3.3 ; 28-DEC-2008
 ;;2.0;INTEGRATED BILLING;**412**;21-MAR-94;Build 1
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.3 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.3 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
