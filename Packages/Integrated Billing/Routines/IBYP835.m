IBYP835 ;MNTVBB/DMR - IB*2.0*835 POST INIT: REASONABLE CHARGES V5.251 ; Dec 9, 2024@11:09
 ;;2.0;INTEGRATED BILLING;**835**;21-MAR-94;Build 5
...
POST ;
 ; Begin Update
 N IBA,U S U="^"
 D BMSG("    Reasonable Charges v5.251 Post-Install .....")
 D CHGINA("") ; inactivate all RC charges in #363.2
 D BMSG("    Reasonable Charges v5.251 Post-Install Complete")
 Q
 ;
BMSG(IBA) ;
 D BMES^XPDUTL(IBA)
