...
DE S DIE="^DGCR(399,",DIC=DIE,DP=399,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGCR(399,DA,""))=""
 ...
 I $D(^("M1")) S %Z=^("M1") S %=$P(%Z,U,2) S:%]"" DE(8)=%,DE(19)=%,DE(25)=% S %=$P(%Z,U,3) S:%]"" DE(37)=%,DE(48)=% S %=$P(%Z,U,10) S:%]"" DE(9)=%,DE(20)=%,DE(29)=%,DE(32)=% S %=$P(%Z,U,11) S:%]"" DE(38)=%,DE(49)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="IBXS32",DQ=1
1 S DW="M;11",DV="RP4",DU="",DLB="RESPONSIBLE INSTITUTION",DIFLD=111
 S DE(DW)="C1^IBXS32"
 S DU="DIC(4,"
 G RE
...
X2 K DIC("DR"),DLAYGO
 Q
3 S DQ=4 ;@31
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="0;21",DV="*S",DU="",DLB="CURRENT BILL PAYER SEQUENCE",DIFLD=.21
 S DE(DW)="C4^IBXS32"
...
X7 I '$$SUPPPT^IBCEP7B(DA,1) S Y="@3212"
 Q
8 D:$D(DG)>9 F^DIE17,DE S DQ=8,DW="M1;2",DV="FX",DU="",DLB="PRIMARY PROVIDER #",DIFLD=122
 S DE(DW)="C8^IBXS32"
 S Y="@"
...
X8 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
9 D:$D(DG)>9 F^DIE17,DE S DQ=9,DW="M1;10",DV="*P355.97'",DU="",DLB="PRIMARY ID QUALIFIER",DIFLD=128
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X18 S IBPSDAT=$$GETID^IBCEP7B(DA,1),IBPSID=$P(IBPSDAT,U),IBPSQUAL=$P(IBPSDAT,U,2) I IBPSID="" S Y="@321"
 Q
19 S DW="M1;2",DV="FX",DU="",DLB="PRIMARY PROVIDER #",DIFLD=122
 S DE(DW)="C19^IBXS32"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X19 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
20 D:$D(DG)>9 F^DIE17,DE S DQ=20,DW="M1;10",DV="*P355.97'",DU="",DLB="PRIMARY ID QUALIFIER",DIFLD=128
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
25 S DW="M1;2",DV="FX",DU="",DLB="PRIMARY PROVIDER #",DIFLD=122
 S DE(DW)="C25^IBXS32"
...
29 D:$D(DG)>9 F^DIE17,DE S DQ=29,DW="M1;10",DV="*P355.97'",DU="",DLB="PRIMARY ID QUALIFIER",DIFLD=128
 S DU="IBE(355.97,"
...
X30 S Y="@3215"
 Q
31 S DQ=32 ;@3214
32 S DW="M1;10",DV="*P355.97'",DU="",DLB="Primary ID Qualifier",DIFLD=128
 S DU="IBE(355.97,"
 G RE
...
X36 I '$$SUPPPT^IBCEP7B(DA,2) S Y="@3222"
 Q
37 S DW="M1;3",DV="FX",DU="",DLB="SECONDARY PROVIDER #",DIFLD=123
 S DE(DW)="C37^IBXS32"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X37 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
38 D:$D(DG)>9 F^DIE17,DE S DQ=38,DW="M1;11",DV="*P355.97'",DU="",DLB="SECONDARY ID QUALIFIER",DIFLD=129
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X47 S IBPSDAT=$$GETID^IBCEP7B(DA,2),IBPSID=$P(IBPSDAT,U),IBPSQUAL=$P(IBPSDAT,U,2) I IBPSID="" S Y="@322"
 Q
48 S DW="M1;3",DV="FX",DU="",DLB="SECONDARY PROVIDER #",DIFLD=123
 S DE(DW)="C48^IBXS32"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X48 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
49 D:$D(DG)>9 F^DIE17,DE S DQ=49,DW="M1;11",DV="*P355.97'",DU="",DLB="SECONDARY ID QUALIFIER",DIFLD=129
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
