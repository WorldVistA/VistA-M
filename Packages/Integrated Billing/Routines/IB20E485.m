IB20E485 ;ALB/PWC - ENVIRONMENT CHECK WITH PRE-INIT CODE ; 11/26/12 10:05am
...
POS1 ; Ask if user wants to print or update and print if "APRIOR" X-ref is
 ; set for 12/1/2011.
 I '$D(^IBA(354.1,"APRIOR",3111201)) K DIR Q
 ...
 ;
 ;
POS2 ; Ask device to print the report to, if "APRIOR" X-ref is set for 12/1/11.
 I '$D(^IBA(354.1,"APRIOR",3111201)) K DIR Q
 K DIR
