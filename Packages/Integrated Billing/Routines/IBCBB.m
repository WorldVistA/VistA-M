IBCBB ;ALB/AAS - EDIT CHECK ROUTINE TO BE INVOKED BEFORE ALL BILL APPROVAL ACTIONS ;2-NOV-89
 ;;2.0;INTEGRATED BILLING;**80,51,137,288,327,361,371,377,400,432,461,547,592,623,770**;21-MAR-94;Build 119
...
EN ;Entry to check for errors
 ...
 I $D(IBFL) N IBFL
 K ^TMP($J)
 ;JWS;7/29/2025;EBILL-3551;don't want output for acc auto-authorize
 I '$D(IBACCRPC) W !
