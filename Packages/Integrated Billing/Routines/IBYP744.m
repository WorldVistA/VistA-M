IBYP744 ;MNTVBB/DMR - IB*2.0*744 POST INIT: REASONABLE CHARGES V4.23 ; Oct 4, 2022@11:09
 ;;2.0;INTEGRATED BILLING;**744**;21-MAR-94;Build 7
...
POST ;
 N IBA,U S U="^"
 D BMSG("    Reasonable Charges v4.23 Post-Install .....")
 D CHGINA("") ; inactivate all RC charges in #363.2
 D BMSG("    Reasonable Charges v4.23 Post-Install Complete")
 Q
 ;
BMSG(IBA) ;
 D BMES^XPDUTL(IBA)
