IBYP628 ;ALB/CXW - IB*2.0*628 POST INIT: REASONABLE CHARGES V3.24;8/23/2018
 ;;2.0;INTEGRATED BILLING;**628**;21-MAR-94;Build 48
 ;;Per VA Directive 6402, this routine should not be modified.
 Q
 ;
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.24 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.24 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
