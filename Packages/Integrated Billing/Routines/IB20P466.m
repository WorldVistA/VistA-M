IB20P466 ;ALB/RDK - IB*2.0*466; DSS CLINIC STOP CODES ; 11/29/11 10:31am
 ;;2.0;INTEGRATED BILLING;**466**;21-MAR-94;Build 2
...
NCODE ;;code^billable type^description^override flag^effective date
 ;;250^1^REHAB SRVCS GROUP^^3120331
 ;;340^2^GENOMIC CARE^^3120331
 ;
 ;existing stop codes - UPDATE
OCODE ;;code^billable type^description^override flag^effective date
 ;;218^1^BLIND REHAB CENTER^^3120331
 ;;429^2^PATIENT CARE IN OR^^3120331
 ;;710^0^PREVENTIVE IMMUNIZATION^1^3120215
 ;
