IBYP719 ;ALB/CXW - IB*2.0*719 POST INIT: REASONABLE CHARGES V4.22 ; Sep 13, 2021@11:09
 ;;2.0;INTEGRATED BILLING;**719**;21-MAR-94;Build 83
...
POST ;
 N IBA,U S U="^"
 D BMSG("    Reasonable Charges v4.22 Post-Install .....")
 D CHGINA("") ; inactivate all RC charges in #363.2
 D BMSG("    Reasonable Charges v4.22 Post-Install Complete")
 Q
 ;
BMSG(IBA) ;
 D BMES^XPDUTL(IBA)
