IBYP843 ;MNTVBB/DMR - IB*2.0*843 POST INIT: REASONABLE CHARGES V5.26 ; Dec 9, 2025@11:09
 ;;2.0;INTEGRATED BILLING;**835**;21-MAR-94;Build 6
...
POST ;
 ; Begin Update
 N IBA,U S U="^"
 D BMSG("    Reasonable Charges v5.26 Post-Install .....")
 D CHGINA("") ; inactivate all RC charges in #363.2
 D BMSG("    Reasonable Charges v5.26 Post-Install Complete")
 Q
 ;
BMSG(IBA) ;
 D BMES^XPDUTL(IBA)
