IBYPSN ;ALB/ARH - IB*2.0*408 POST INIT: REASONABLE CHARGES V3.2 ; 25-SEP-2008
 ;;2.0;INTEGRATED BILLING;**408**;21-MAR-94;Build 1
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.2 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.2 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
