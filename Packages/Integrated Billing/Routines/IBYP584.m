IBYP584 ;ALB/CXW - IB*2.0*584 POST INIT: REASONABLE CHARGES V3.21 ;12-05-2016
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.21 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 D TYPE^IBYP584A
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.21 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
