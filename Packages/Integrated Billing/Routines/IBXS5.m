IBXS5 ; GENERATED FROM 'IB SCREEN5' INPUT TEMPLATE(#511), FILE 399;05/12/15
 D DE G BEGIN
...
15 D:$D(DG)>9 F^DIE17,DE S DQ=15,D=0 K DE(1) ;41
 S DIFLD=41,DGO="^IBXS52",DC="4^399.041IPA^OC^",DV="399.041M*P399.1'X",DW="0;1",DOW="OCCURRENCE CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.1,"
...
X18 S:IBDR20'["58" Y="@54"
 Q
19 S D=0 K DE(1) ;40
 S DIFLD=40,DGO="^IBXS53",DC="1^399.04PA^CC^",DV="399.04M*P399.1'X",DW="0;1",DOW="CONDITION CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.1,"
