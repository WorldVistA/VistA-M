IB20P765 ;MNTVBB/DMR - IB MID YEAR STOP CODES FOR FY 2023 ; August 25, 2022 @13:20
 ;;2.0;INTEGRATED BILLING;**765**;21-MAR-94;Build 1
...
EN ;
 ...
 Q
 ;
START D BMES^XPDUTL("DSS Clinic Stop Codes for FY 2023, Post-Install Starting")
 Q
 Q
 ;
FINISH D BMES^XPDUTL("DSS Clinic Stop Codes for FY 2023, Post-Install Starting")
 Q
 Q
 ;
 ;
...
NCODE ;;code^billable type^description^override flag^effective date
 ;;605^1^HOMESELF HEMDIAL FOLLOWUP^^3230401
 ;
 ;codes updated
OCODE ;;code^billable type^description^override flag
 ;;591^0^HEALTHCARE FOR REENTRY VETS^1^3230401
 ;;606^1^HOMESELF PERITNDIALY FOLLOWUP^^3230401
 ;;607^1^STAFFASSIST PERITNDIALY^^3230401
 ;;608^1^HOMESELF PERITNDIALY TRNING^^3230401
 ;
