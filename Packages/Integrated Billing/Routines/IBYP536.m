IBYP536 ;ALB/CXW - IB*2.0*536 POST INIT: REASONABLE CHARGES V3.15; 23-SEP-2014
 ;;2.0;INTEGRATED BILLING;**536**;21-MAR-94;Build 27
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.15 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.15 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
