IBYP556 ;ALB/CXW - IB*2.0*556 POST INIT: REASONABLE CHARGES V3.17; 09-14-2015
 ;;2.0;INTEGRATED BILLING;**556**;21-MAR-94;Build 33
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.17 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.17 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
