IBCRBG1 ;ALB/ARH - RATES: BILL SOURCE EVENTS (OPT,CPT) ; 5/21/96
 ;;2.0;INTEGRATED BILLING;**52,106,148,245,796**;21-MAR-94;Build 34
...
CPT(IBIFN,ARR) ; find all CPT codes for a bill (excludes ICD9)
 ...
 . I +IBX,IBX[";ICPT(" S ARR=ARR+1,ARR(+IBX,IBI)=$P(IBX,U,2)_U_$$GETMOD^IBEFUNC(IBIFN,IBI)_U_$P(IBX,U,6)_U_$P(IBX,U,18)_U_$P(IBX,U,7)_U_$P(IBX,U,20)_U_$P(IBX,U,16)_U_$P(IBX,U,21)_U_$P(IBX,U,22)_U_$P($G(^DGCR(399,IBIFN,"CP",IBI,2)),U,2)
 Q
