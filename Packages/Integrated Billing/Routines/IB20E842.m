IB20E842 ;MNTVBB/FSB - ENVIRONMENT CHECK WITH PRE-INIT CODE ; Dec 1, 2025@13:30
...
POS1 ; Ask if user wants to print or update and print if "APRIOR" X-ref is
 ; set for 12/1/2024.
 I '$D(^IBA(354.1,"APRIOR",3241201)) K DIR Q
 ...
 ;
 ;
POS2 ; Ask device to print the report to, if "APRIOR" X-ref is set for 12/1/24.
 I '$D(^IBA(354.1,"APRIOR",3241201)) K DIR Q
 K DIR
