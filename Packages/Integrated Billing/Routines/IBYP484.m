IBYP484 ;ALB/CXW - IB*2.0*484 POST INIT: REASONABLE CHARGES V3.11 ; 14-SEP-2012
 ;;2.0;INTEGRATED BILLING;**484**;21-MAR-94;Build 18
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.11 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.11 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
