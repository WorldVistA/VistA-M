IBYPSO ;ALB/CXW - IB*2.0*423 POST INIT: REASONABLE CHARGES V3.4 ; 08-SEP-2009
 ;;2.0;INTEGRATED BILLING;**423**;21-MAR-94;Build 2
...
POST ;
 N IBA
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.4 Post-Install .....",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 D CHGINA("") ; inactivate all RC charges in #363.2
 ;
 S IBA(1)="",IBA(2)="    Reasonable Charges v3.4 Post-Install Complete",IBA(3)="" D MES^XPDUTL(.IBA) K IBA
 ;
 Q
 ;
 ;
