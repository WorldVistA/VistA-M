IBACCWLRURREV2 ;EDE/TAZ - ACC (Automated Community Care) Claims - ADDITIONAL REVIEW SCREEN FOR RUR (cont'd); 12-SEP-2023 ; 12-SEP-2023
...
NM1 ;Process NM1 record
 ...
 . I CODE=77 D  Q
 .. ;I $P(DATA,D,9)="XX",$P(DATA,D,10)=$G(^TMP("IBACCWLRURREV",$J,"BP NPI")) S STOP=1 Q   ;eBILL-5440;WCJ;GRAY build
 .. S CODE="Service Location"
 . I CODE=82 S CODE="Rendering Provider" Q
 . I CODE=85 D  Q
 .. I $P(DATA,D,9)="XX" S ^TMP("IBACCWLRURREV",$J,"BP NPI")=$P(DATA,D,10)
