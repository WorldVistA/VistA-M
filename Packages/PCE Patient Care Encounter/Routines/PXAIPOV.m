PXAIPOV ;ISL/JVS,PKR,ESW - SET THE DIAGNOSIS/PROBLEM LIST NODES ;11/28/2018
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**28,73,69,108,112,130,124,174,168,203,199,211**;Aug 12, 1996;Build 325
 ;
 Q
...
SPOVPRIM(PXADATA,VISITIEN,PXAERR) ;If there is an exisiting primary diagnosis
 ...
 . I DIAG="" Q
 . I $D(@PXADATA@("DX/PL",IND,"PRIMARY")) S PDNEW=DIAG
 I PDNEW="" Q
 ;
