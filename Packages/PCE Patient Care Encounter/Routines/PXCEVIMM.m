PXCEVIMM ;ISL/dee,SLC/ajb - Used to edit and display V IMMUNIZATION ;12/10/2018
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**27,124,199,201,210,215,211**;Aug 12, 1996;Build 325
 ;;
 Q
 ;
...
DISPLN(PXCEINT,PCEDT) ; display lot number with manufacturer
 N LOTIEN,PXCEDILF,PXCEEXT,PXV2,PXVMAN
 S LOTIEN=+$O(^AUTTIML("B",PXCEINT,""))
 I LOTIEN=0 Q
 S PXCEEXT=$$EXTERNAL^DILFD(9000010.11,1207,"",LOTIEN,"PXCEDILF")
 S PXV2=$P(^AUTTIML(LOTIEN,0),"^",2),PXVMAN=$$EXTERNAL^DILFD(9999999.41,.02,"",PXV2,"PXCEDILF")
