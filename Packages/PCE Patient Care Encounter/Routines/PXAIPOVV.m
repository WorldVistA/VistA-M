PXAIPOVV ;ISL/JVS,PKR - VALIDATE DIAGNOSIS ;07/01/2019
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**121,194,199,211**;Aug 12, 1996;Build 8
 ;
...
VAL04 ;Setup error array for missing Provider Narrative.
 ...
 S PXAERR(11)=$G(PXAA("NARRATIVE")) S PXAERR(12)="We are unable to retrieve a narrative from the PROVIDER NARRATIVE file #9999999.27"
 D ERRSET
 Q
 ;
