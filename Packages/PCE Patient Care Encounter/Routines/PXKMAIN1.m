PXKMAIN1 ;ISL/JVS,ISA/ZOLTRAN - Main Routine for Data Capture ;Aug 04, 2025@08:48:01
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**22,73,124,178,210,216,211,217,244**;Aug 12, 1996;Build 37
...
LOOP ;+Copy delimited strings into sub-arrays. PXKSUB is the node.
 I PXKCAT="VST"!(PXKCAT="POV"),PXKSUB=900 D  Q
 .M PXKAV(900)=PXKAFT(900),PXKBV(900)=PXKBEF(900)
 .I $G(PXKBV(900))="" K PXKBV(900)
 F PXKI=1:1:$L(PXKAFT(PXKSUB),"^") D
 .;I PXKSUB=900 M PXKAV(PXKSUB)=PXKAFT(PXKSUB) Q
 .I $P(PXKAFT(PXKSUB),"^",PXKI)'="" S PXKAV(PXKSUB,PXKI)=$P(PXKAFT(PXKSUB),"^",PXKI)
 F PXKI=1:1:$L(PXKBEF(PXKSUB),"^") D
 .;I PXKSUB=900 M PXKBV(PXKSUB)=PXKAFT(PXKBEF) Q
 .I $P(PXKBEF(PXKSUB),"^",PXKI)'="" S PXKBV(PXKSUB,PXKI)=$P(PXKBEF(PXKSUB),"^",PXKI)
...
CLEAN ;--Clean out the PXKAV array
 ...
 . I PXKCAT="VST"!(PXKCAT="POV"),PXKJ=900 Q
...
DRDIE ;--Set the DR string and DO DIE
 ...
 . ;
 . I PXKCAT="POV",PXKNOD=800 Q
 . I PXKCAT="POV",PXKNOD=900 D UPDATE900^PXKFPOV(PXKPIEN,.PXKAV) Q
...
ER ;--PXKERROR MAKING IF NOT POPULATED CORRECTLY
 ...
 .. I PXKCAT="POV",PXKN=800!(PXKN=900) Q
