PXKENCOUNTER ;SLC/PKR - Builds an array of all encounter data. ;Aug 26, 2025@13:51:40
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**217,244**;Aug 12, 1996;Build 37
 Q
 ;
COEVENT(VISITIEN) ;Add to the ^TMP("PXKCO",$J, array the
 ...
 .. I NODE=800!(NODE=900) D  Q
 ... S OLD800="" K SAS
 ... D GETSAFORVISITDET^PXSPECAUTH(.SAS,.OLD800,CSTPIEN)
 ... M ^TMP(TMPSUB,$J,VISITIEN,"CSTP",CSTPIEN,900,"BEFORE")=SAS,^TMP(TMPSUB,$J,VISITIEN,"CSTP",CSTPIEN,900,"AFTER")=SAS
 ... I OLD800'="" S (^TMP(TMPSUB,$J,VISITIEN,"CSTP",CSTPIEN,800,"BEFORE"),^TMP(TMPSUB,$J,VISITIEN,"CSTP",CSTPIEN,800,"AFTER"))=OLD800
 ...
 .. I NODE=800!(NODE=900) D  Q
 ... S OLD800=""
 ... D GETSAFORVPOVDET^PXSPECAUTH(.SAS,.OLD800,VFIEN)
 ... M ^TMP(TMPSUB,$J,VISITIEN,"POV",VFIEN,900,"AFTER")=SAS
 ... M ^TMP(TMPSUB,$J,VISITIEN,"POV",VFIEN,900,"BEFORE")=SAS
 ... I OLD800'="" D
 .... S ^TMP(TMPSUB,$J,VISITIEN,"POV",VFIEN,800,"AFTER")=OLD800
 .... S ^TMP(TMPSUB,$J,VISITIEN,"POV",VFIEN,800,"BEFORE")=OLD800
...
ENCEVENT(VISITIEN,DONTKILL) ;Create the ^TMP("PKRENC",$J, array of all the
 ...
 I $G(VISITIEN)'>0 Q  ;PX/183
 I '$D(^AUPNVSIT(VISITIEN)) Q
 N CSTPIEN,ID,IND,NODE,NUMM,NUMP,NUMS,OLD800,PRV,PRVLIST,PS,TEMP,TMPSUB,SAS,VFIEN
 S TMPSUB="PXKENC"
 ...
 . I NODE=800!(NODE=900) D  Q
 .. S OLD800=""
 .. D GETSAFORVISITDET^PXSPECAUTH(.SAS,.OLD800,VISITIEN)
 .. M ^TMP(TMPSUB,$J,VISITIEN,"VST",VISITIEN,900)=SAS
 .. I OLD800'="" S ^TMP(TMPSUB,$J,VISITIEN,"VST",VISITIEN,800)=OLD800
 ...
 ... S OLD800="" K SAS
 ... D GETSAFORVISITDET^PXSPECAUTH(.SAS,.OLD800,CSTPIEN)
 ... M ^TMP(TMPSUB,$J,VISITIEN,"CSTP",CSTPIEN,900)=SAS
 ... I OLD800'="" S ^TMP(TMPSUB,$J,VISITIEN,"CSTP",CSTPIEN,800)=OLD800
 ...
 ... S OLD800=""
 ... D GETSAFORVPOVDET^PXSPECAUTH(.SAS,.OLD800,VFIEN)
 ... M ^TMP(TMPSUB,$J,VISITIEN,"POV",VFIEN,900)=SAS
 ... I OLD800'="" S ^TMP(TMPSUB,$J,VISITIEN,"POV",VFIEN,800)=OLD800
