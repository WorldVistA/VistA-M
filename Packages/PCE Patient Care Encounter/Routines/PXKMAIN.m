PXKMAIN ;ISL/JVS,PKR,ISA/ZOLTRAN - Main Routine for Data Capture ;Dec 15, 2025@09:34:25
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**22,59,73,88,69,117,130,124,174,164,210,215,216,211,244,NNN**;Aug 12, 1996;Build 37
...
AFTER ...D
 ....I PXKCAT="VST"!(PXKCAT="POV"),PXKSUB=900 M PXKAFT(900)=@PXKREF@(PXKCAT,PXKSEQ,PXKSUB,"AFTER") Q
 ....S PXKAFT(PXKSUB)=$G(@PXKREF@(PXKCAT,PXKSEQ,PXKSUB,"AFTER"))
BEFORE ...D
 ....I PXKCAT="VST"!(PXKCAT="POV"),PXKSUB=900 M PXKBEF(900)=@PXKREF@(PXKCAT,PXKSEQ,PXKSUB,"BEFORE") Q
 ...
 ...S PXDFG=0 I $G(PXKAV(0,1))["@"!('$D(PXKAV(0,1))) D
 ....S PXKAFT(PXKSUB)="" K PXKAV(0) S PXDFG=1
 ....I PXKCAT'="VST",PXKCAT'="POV" Q
 ....S PXKBEF(800)=$G(^TMP("PXK",$J,PXKCAT,PXKSEQ,800,"BEFORE")),PXKAFT(800)=""
 ....M PXKBEF(900)=^TMP("PXK",$J,PXKCAT,PXKSEQ,900,"BEFORE") S PXKAFT(900)=""
 ..Q:PXFG=1
 ...
 ..I 'PXKFGAD,'PXKFGDE,'PXKFGED,PXKCAT["VST" D
 ...D EN1^PXKMASC
...
EVENT ;--ENTRY POINT TO POST EXECUTE PCE'S EVENT
 ...
 . I $G(PXKVVST),$D(^AUPNVSIT(PXKVVST)) D VST^PXCEMST(PXKVVST) ;PX*1.0*NNN
 ;
