PXBGPOV ;ISL/JVS,ESW - GATHER POV (DIAGNOSIS) ;Aug 04, 2025@08:39:34
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**11,112,149,124,168,199,211,244**;Aug 12, 1996;Build 37
 ;
POV(VISIT) ;--Gather the entries in the V POV file
 ;
 N CODE,DA,DIC,DIQ,DR,GROUP,I,IEN,PKG,POV,POVI,PRIM,PROBLEM,PROVIDER
 N PXBC,PXBPL,PXBPLA,PXBREQ,PXCI,PXDXDATE,PXSAS,NODE800,QUANTITY,SNARR,SOURC
 ;
...
A ;--Set array with DIAGNOSIS codes
 ...
 ..D GETSAFORVPOV^PXSPECAUTH(.PXSAS,IEN)
 ..S CODE="",GROUP="" F  S CODE=$O(PXSAS(CODE)) Q:CODE=""  D
 ...I PXSAS(CODE)=""!(PXSAS(CODE)=-1) Q
 ...S GROUP=GROUP_CODE_":"_$S(PXSAS(CODE)=1:" Y",1:" N")_U
...
XLATE(VST,DX) ;Translate DX into POV from VST
 ...
 S ANS=IEN_U_DX_U_$P(VAL,U,12)
 ;S:IEN ANS=ANS_U_$G(^AUPNVPOV(IEN,800))
 Q ANS
 ;
