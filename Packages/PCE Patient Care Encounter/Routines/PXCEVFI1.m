PXCEVFI1 ;ISL/dee,esw - Routine to edit a Visit or V-file entry ;06/29/2017
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**23,73,112,136,143,124,184,185,210,215,216,211**;Aug 12, 1996;Build 325
 Q
 ;
...
REST ;Edit the rest of the fields.
 ...
 . I TEMP'="" D @TEMP
 . I TEMP="" D 
 .. I PXCECAT="IMM",FIELD=1303 S PXVRT=$P(PXCEAFTR(13),"^",2) D  Q:PXVRT=5  ; PX*1*216
 ...
 ..;If there is no value stored, make the default for
 ..;Event Date and Time NOW. If there is a stored value DIR("B") is
 ..;set above.
 .. I (FIELD=1201),$G(DIR("B"))="" S DIR("B")="NOW"
 .. D ^DIR
