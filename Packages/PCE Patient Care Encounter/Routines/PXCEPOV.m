PXCEPOV ;ISL/dee - Used to edit and display V POV ;04/08/2019
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**27,121,124,170,168,199,211**;Aug 12, 1996;Build 454
 ;
...
DISPLY01(PXCEPOV,PXCEDT) ;
 ...
 I PXCEPOV="" Q ""
 S ICDSTR=$$ICDDX^ICDEX($P(PXCEPOV,U,1),PXCEDT,"","I",0)
 ...
 I CODESYS=30 S TEXT=TEXT_" "_$$SENTENCE^XLFSTR($$LD^ICDEX(80,$P(PXCEPOV,U,1),PXCEDT))
 Q TEXT
 ;
SKIP ;
 Q
