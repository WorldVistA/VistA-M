PXRPC ;ISL/JLC - PCE DATA2PCE RPC ;12/11/2018
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**200,209,210,215,216,211**;Aug 12, 1996;Build 325
 ;
...
SAVE(OK,PCELIST,LOC,PKGNAME,SRC) ; save PCE information
 N VSTR
 N PXAPI,PXDEL,PKG,PROBLEMS,PXAVST,PXERROR,PXERRPROB,PXAPREDT
 ...
 D DATA2PCE(.OK,"PXAPI",PKG,SRC,PXAPREDT,.PXAVST,.PXERROR,.PXERRPROB)
 Q
 ;
DQSAVE(PCELIST,PXPCEARR,PXPCEDARR,PROBLEMS,SRC) ;
 ...
 Q
 ;
DATA2PCE(OK,PXPCEARR,PKG,SRC,PXAPREDT,PXAVST,PXERROR,PXERRPROB) ;
 I '($D(PXAVST)#2) S PXAVST=""
 S OK=$$DATA2PCE^PXAI(PXPCEARR,PKG,SRC,.PXAVST,"",0,.PXERROR,PXAPREDT,.PXERRPROB)
 Q
 ;
