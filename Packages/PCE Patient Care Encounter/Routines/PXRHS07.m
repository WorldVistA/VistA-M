PXRHS07 ;ISL/PKR - PCE V HEALTH FACTORS extract routine ;08/02/2024
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**13,123,211,217,247**;Aug 12, 1996;Build 5
...
ADDHF(HFIEN,VHFIEN,BEGDT,ENDDT) ;Check a specific health factor and determine
 ...
 I VDATA=-1 D  Q 0
 . N VISITIEN
 . S VISITIEN=$P(TMP0,U,3)
 . D NONEXISTENTVISIT^PXRHS02(9000010.23,VHFIEN,VISITIEN)
 ...
 ;If there is a measurement, return the MAGNITUDE, UCUM CODE, 
 ;PROMPT CAPTION and UCUM DISPLAY.
 S TMP220=$G(^AUPNVHF(VHFIEN,220))
 I TMP220'="" S TMP220=TMP220_U_$P(^AUTTHF(HFIEN,220),U,5,6)
