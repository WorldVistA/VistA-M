PXKENC ;ISL/DEE,ESW - Builds the array of all encounter data for the event point ;Aug 04, 2025@08:45:46
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**15,22,73,108,143,183,210,215,211,217,244**;Aug 12, 1996;Build 37
 Q
 ;
...
ENCEVENT(VISITIEN,DONTKILL) ;Create the ^TMP("PXKENC",$J, array of all the
 ...
 ;
 N ID,IND,IEN,FILE,VFILE,FILESTR,OLD800,PXKNODE,SAS,TEMP
 ...
 ... I FILESTR="VST",PXKNODE=900 D  Q
 .... D GETSAFORVISITDET^PXSPECAUTH(.SAS,.OLD800,VISITIEN)
 .... M @PXKROOT@(FILESTR,IEN,900)=SAS
 .... S @PXKROOT@(FILESTR,IEN,800)=OLD800
 ...
 .... I (FILE="POV") D
 ..... I (PXKNODE=802),(+TEMP'>0) S TEMP=""
 ..... I PXKNODE=900 D  Q
 ...... S OLD800=""
 ...... D GETSAFORVPOVDET^PXSPECAUTH(.SAS,.OLD800,IEN)
 ...... M @PXKROOT@(FILESTR,IEN,900)=SAS
 ...... I OLD800'="" S @PXKROOT@(FILESTR,IEN,800)=OLD800
...
COEVENT(VISITIEN) ;Add to the ^TMP("PXKCO",$J, array all of the
 ...
 .... ;
 .... I FILE="POV",PXKNODE=900 D  Q
 ..... D GETSAFORVPOVDET^PXSPECAUTH(.SAS,.OLD800,IEN)
 ..... M ^TMP("PXKCO",$J,VISITIEN,FILE,IEN,900,"BEFORE")=SAS
 ..... S ^TMP("PXKCO",$J,VISITIEN,FILE,IEN,800,"BEFORE")=OLD800
 ..... M ^TMP("PXKCO",$J,VISITIEN,FILE,IEN,900,"AFTER")=SAS
 ..... S ^TMP("PXKCO",$J,VISITIEN,FILE,IEN,800,"AFTER")=OLD800
 .... ;
