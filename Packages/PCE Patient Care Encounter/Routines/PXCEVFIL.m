PXCEVFIL ;ISL/DEE - Main routine to edit a visit or v-file entry ;Aug 04, 2025@08:45:17
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**9,30,22,73,88,89,104,147,124,169,210,215,211,244**;Aug 12, 1996;Build 37
 ;
 ; Reference to ^DPT(D0,"S", in ICR #1301
 ; Reference to DATE^SCDXUTL in ICR #1575
 ; Reference to FMDATE^SCDXUTL in ICR #1575
 ;
 Q
...
INIT ; -- init variables and list array
 ...
 .I PXCEVIEN>0 D GETSAFORVISITDET^PXSPECAUTH(.BEFORE900,.BEFORE800,PXCEFIEN)
 ...
 ... S PXCEAFTR(PXCENODE)=^TMP("PXK",$J,PXCECATS,1,PXCENODE,"BEFORE")
 .I PXCECAT="POV",+$G(PXCEFIEN)>0 D
 ..D GETSAFORVPOVDET^PXSPECAUTH(.BEFORE900,.BEFORE800,PXCEFIEN)
 ..S ^TMP("PXK",$J,PXCECAT,1,800,"BEFORE")=BEFORE800
 ..M ^TMP("PXK",$J,PXCECAT,1,900,"BEFORE")=BEFORE900
 Q:PXCEQUIT
 ;
