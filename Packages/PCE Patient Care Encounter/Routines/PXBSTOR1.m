PXBSTOR1 ;ISL/JVS - REMOVE THE DELETED PROVIDER FROM CPT'S ;Aug 04, 2025@08:41:54
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**88,124,244**;Aug 12, 1996;Build 37
 ;
 ;
 ;
 ;
...
SET() ;--SET IENS OF EACH FILE
 ...
 .D GETSAFORVPOVDET^PXSPECAUTH(.POVBF900,.POVBF800,$P(REQI,"^",9))
 E  S (POVBEF,POVBEF12,POVBEF17,POVBF812,POVBF800,POVBF900)=""
 ;
