PXRHS08 ;ISL/SBW,PKR - PCE Visit Patient Education data extract ;05/01/2025
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**13,16,211,217,247**;Aug 12, 1996;Build 5
...
ADDEDU(EDUIEN,VPEDIEN,BEGDT,ENDDT) ;
 ...
 . D NONEXISTENTVISIT^PXRHS02(9000010.16,VPEDIEN,VISITIEN)
 ...
 I TMP220'="" S TMP220=TMP220_U_$P(^AUTTEDT(EDUIEN,220),U,5,6)
