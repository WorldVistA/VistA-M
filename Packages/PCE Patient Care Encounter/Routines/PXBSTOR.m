PXBSTOR ;ISL/JVS - PASSING THE DATA TO THE V FILES ;Aug 04, 2025@08:41:23
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**73,88,149,124,164,203,199,244**;Aug 12, 1996;Build 37
 ;
 ; Reference to DIC(40.7 in ICR #1024
 ;
 ;  VARIABLE LIST
...
EN1 ;
 ...
 N CPTBF812,CPTIEN,CTR,POVAF800,POVAF812,POVAFT,POVAFT12,POVAF900,POVBEF
 N POVBEF12,POVBF800,POVBF812,POVBF900,POVI,POVIEN,PPRNARR,PRVAF812,PRVAFT
...
POV ;--POV PIECE 5 AND 6
 ...
 I $D(PXBREQ($P(REQI,U,5))) S POVAF800=$G(PXBREQ($P(REQI,U,5),"I")) M POVAF900=PXBREQ($P(REQI,U,5),900)
POV1 S ^TMP("PXK",$J,"POV",SEQ,0,"AFTER")=POVAFT
 ...
 M ^TMP("PXK",$J,"POV",SEQ,900,"AFTER")=POVAF900
 M ^TMP("PXK",$J,"POV",SEQ,900,"BEFORE")=POVBF900
 S ^TMP("PXK",$J,"POV",SEQ,"IEN")=POVIEN
 Q
 ;
DX ;CPT DIAGNOSIS - PX124
 N POVIEN,POVBF800,POVBF812,POVBEF12,POVBEF,POVBEF17,PXBVDT
 N IEN,ANS,POVAF800,POVAF812,POVAFT12,POVAFT,POVAFT17,POVAF900,POVBF900
 S IEN=$P(REQI,U,CTR),ANS=$$XLATE^PXBGPOV(PXBVST,IEN),POVIEN=+ANS
 I POVIEN D
 .S POVBEF=$G(^AUPNVPOV(POVIEN,0)),POVBEF12=$G(^(12)),POVBF812=$G(^(812)),POVBEF17=$G(^(17))
 .D GETSAFORVPOVDET^PXSPECAUTH(.POVBF900,.POVBF800,POVIEN)
 E  S (POVBF800,POVBF812,POVBEF12,POVBEF17,POVBEF,POVBF900)=""
 S POVAFT=POVBEF,POVAFT12=POVBEF12,POVAF812=POVBF812,POVAF800=POVBF800
 M POVAF900=POVBF900
 S POVAFT17=POVBEF17
 ...
 I $D(PXBREQ(IEN,900)) D
 .M POVAF900=PXBREQ(IEN,900)
 .S POVAF800=$G(PXBREQ(IEN,"I"))
