XVEMG ;DJB/VGL**VGlobal Lister ;Aug 23, 2019@12:20
...
START ;
 ...
 NEW FLAGC,FLAGC1,FLAGE,FLAGOPEN,FLAGQ
...
IMPORT ;Set up for scroller
 ...
 S XVVT("HD",1)=$E(LINE,1,(MAR-LHEADER+1)\2)_HEADER_$E(LINE,1,(MAR-LHEADER)\2)
 S XVVT("FT",1)=LINE
