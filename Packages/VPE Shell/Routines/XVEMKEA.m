XVEMKEA ;DJB/KRN**Screen Mode Line Editor ;Aug 21, 2019@13:53
 ...
 ;
SCREEN(PROMPT,LMAR,RMAR,NOTIME) ;Edit a line of text
 ;PROMPT = Prompt
 ;LMAR=Left Margin
 ;RMAR=Right Margin
 ;NOTIME=No Timeout
...
EX ;
 ...
 ;
READ ;
 S X=$$READ^XVEMKRN("",1,,NOTIME),XVVSHC=$G(XVV("K"))
...
INIT ;
 ...
 D CRSRSAVE^XVEMKY2
 D BLANK^XVEMKY3
 S CD=$G(CD),PROMPT=$G(PROMPT),LMAR=$G(LMAR),RMAR=$G(RMAR),NOTIME=$G(NOTIME,0)
