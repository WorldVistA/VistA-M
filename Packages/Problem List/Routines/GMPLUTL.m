GMPLUTL ; SLC/MKB/KER/TC -- PL Utilities ;07/01/2019
 ;;2.0;Problem List;**3,6,8,10,16,26,35,39,36,42,40,50,53**;Aug 25, 1994;Build 8
 ;
 ; External References
 ;   DBIA    348  ^DPT(
...
CREATE(PL,PLY) ; Creates a new problem
 ...
 I $P($$PROVNARR^GMPLX(PL("NARRATIVE"),""),U,1)=-1 S PLY(0)="Invalid problem narrative" Q
