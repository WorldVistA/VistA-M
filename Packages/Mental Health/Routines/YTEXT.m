YTEXT ;SLC/TGA,HIOFO/FT - TEXT I/O FOR STAFF REMARKS ;03/20/13 2:50pm
 ;;5.01;MENTAL HEALTH;**37,108**;Dec 30, 1994;Build 17
 ;
 Q
 ; Called from the top by MENU option YSCOMMENT which was deleted with YS*5.01*60
 ;
