YSXRAC4 ; COMPILED XREF FOR FILE #601.2213 ; 12/28/04
 ; 
 S DA(3)=DA(2) S DA(2)=0 S DA(1)=0 S DA=0
A1 ;
 I $D(DIKILL) K DIKLM S:DIKM1=3 DIKLM=1 S:DIKM1'=3&'$G(DIKPUSH(3)) DIKPUSH(3)=1,DA(3)=DA(2),DA(2)=DA(1),DA(1)=DA,DA=0 S:DIKM1<2 DA(1)=0 G @DIKM1
...
3 ;
 ...
 S X=$P(DIKZ(0),U,2)
 I X'="" K ^YTD(601.2,DA(3),1,DA(2),1,DA(1),"R","AD",$E(X,1,30),DA)
 G:'$D(DIKLM) C Q:$D(DIKILL)
END Q
