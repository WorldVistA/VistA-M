...
BEGIN ;
 ...
 W ?65 X DXS(2,9.2) I $P(X,".",2) S X=$E($P(X,".",2)_"0000",1,4),%=X>1159 S:X>1259 X=X-1200 S X=X\100_":"_$E(X#100+100,2,3)_" "_$E("AP",%+1)_"M" K DIP K:DN Y W X
...
A1 ;
 ...
 S X=$G(^YS(615.2,D0,10,D1,0)) D N:$X>0 Q:'DN  S DIWL=1,DIWR=60 S Y=$P(X,U,2) S X=Y D ^DIWP
 D A^DIWW
 Q
A1R ;
