YTRPWRP ;DALOI/YH - Report Calls ;8/2/10 2:44pm
 ;;5.01;MENTAL HEALTH;**71,76,96,60,187**;Dec 30, 1994;Build 73
 ;
...
INTRMNT(ROOT,YSDFN,YSXT) ; -- return report text
 ...
 D DEM^VADPT,PID^VADPT S YSNM=VADM(1),YSSEX=$P(VADM(5),U),YSDOB=$P(VADM(3),U,2),YSAGE=VADM(4),YSSSN="xxx-xx-"_VA("BID"),YSSX=YSSEX
