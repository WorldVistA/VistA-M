YTRPWRP ;DALOI/YH,HIOFO/FT - Report Calls ;1/29/13 8:48am
 ;;5.01;MENTAL HEALTH;**71,76,96,60,108**;Dec 30, 1994;Build 17
 ;
...
INTRMNT(ROOT,YSDFN,YSXT) ; -- return report text
 ;entry point for YTRP INSTRUMENT REPORT rpc
 ...
 S YSHDR="xxx-xx-"_$E(YSSSN,8,11)_"  "_YSNM_YSBLNK,YSHDR=$E(YSHDR,1,44)_YSSEX_" AGE "_YSAGE,YSHD=DT
 K ^TMP("YSDATA",$J)
