YTRPWRP ;DALOI/YH - Report Calls ;8/2/10 2:44pm
 ;;5.01;MENTAL HEALTH;**71,76,96,60,187,218**;Dec 30, 1994;Build 9
 ;
...
INTRMNT(ROOT,YSDFN,YSXT) ; -- return report text
 ...
 S YSNM=VADM(1),YSDOB=$P(VADM(3),U,2),YSAGE=VADM(4),YSSSN="xxx-xx-"_VA("BID")
 S YSSEX=$S($L($P($G(VADM(14,5)),U,2)):$P(VADM(14,5),U,2),1:$P(VADM(5),U)),YSSX=YSSEX
