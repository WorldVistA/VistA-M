YTSCMQ ;SLC/BLD- MHAX ANSWERS SPECIAL HANDLING FOR Composite Morningness Questionnaire (CMQ)
...
DATA1 ;
 ...
 N I,II
 S TOTSCORE=0
 F I=3:1:15 Q:'$D(YSDATA(I))  S TOTSCORE=$G(TOTSCORE)+$$GET1^DIQ(601.75,$P(YSDATA(I),"^",3)_",",4,"I")
 Q
 ;
SCORESV ;
 N YSSCGROUP,I
