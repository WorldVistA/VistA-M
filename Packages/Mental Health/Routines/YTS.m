YTS ;SLC/DKG,TGA,HIOFO/FT - START TESTS, QUESTIONNAIRES & REPORTS ;10/4/13 1:53pm
 ;;5.01;MENTAL HEALTH;**37,54,60,108**;Dec 30, 1994;Build 17
 ;
...
NX ;
 ...
 S YSSX=YSSEX,YSBL="           ",YSHDR="xxx-xx-"_$E(YSSSN,8,11)_"  "_YSNM_YSBL_YSBL_YSBL,YSHDR=$E(YSHDR,1,44)_YSSX_" AGE "_YSAGE_" "_YSDT(0),YSHD=DT
...
HX2FS ;
 ...
 ;Q  S YSM=1 G ADM
INT ;
 D ^YSLRP G:YSDFN<1 END D C:$P(YSDFN(0),U,2)="" G:YSDFN<1 END S YSXTP=1 D NX,HX2F S T1=1,YSXT=$O(^YTT(601,"B",YSXT,0)),T1(0)=$P(^YTT(601,YSXT,"P"),U,4) G ^YTDP
 Q
 ;
