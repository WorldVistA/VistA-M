YTSPEB27 ;SLC/KCM - Score PEBS-27 ; 3/25/22 2:02pm
...
SCORESV ; calculate the score
 ...
 . S J=J+1
 . I SCLID=1430 S ^TMP($J,"YSCOR",J)=SCLNM_"="_TOTAL
 . I SCLID=1431 S ^TMP($J,"YSCOR",J)=SCLNM_"="_HEALTH
 . I SCLID=1432 S ^TMP($J,"YSCOR",J)=SCLNM_"="_LABOR
 . I SCLID=1433 S ^TMP($J,"YSCOR",J)=SCLNM_"="_CHILD
 . I SCLID=1434 S ^TMP($J,"YSCOR",J)=SCLNM_"="_HUMAN
 . I SCLID=1435 S ^TMP($J,"YSCOR",J)=SCLNM_"="_SKILL
 Q
...
REPORT(SCORES) ; build the scoring display for the report
 ...
 S X=""
 S X=X_"|      PEBS-27 total score:"_TOTAL
