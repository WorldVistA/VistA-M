YTCLERK1 ;SLC/DJP,HIOFO/FT - CONTINUATION OF ^YTCLERK; ;2/20/13 1:26pm
 ;;5.01;MENTAL HEALTH;**10,19,76,108**;Dec 30, 1994;Build 17
 ;A31 ;
 ...
 ;ZAP1 ;
 ;W !!,"By entering ""Y"", the test will be deleted from the patient's file.",! G ZAP
 ;Q
 ;REMMPR ;
