YTBI ;ALB/ASF,HIOFO/FT - BECK INVENTORY DRIVERS ; 2/13/13 4:50pm
 ;;5.01;MENTAL HEALTH;**76,96,108**;Dec 30, 1994;Build 17
 ;No external references
 Q  ;called from ^YTT(601,221,"A")
...
B2 ;
 ...
 Q
BSIRPT ;Called from ^YTT(601,221,"R")
...
BDI ;Called from ^YTT(601,223,"R")
 ...
 Q
BDI2 ;Called from ^YTT(601,245,"R") and ^YTT(601.6,254,1)
