YTAUIRR ;ALB/ASF,HIOFO/FT - AUI-R REPORT ;2/12/13 3:36pm
 ;;5.01;MENTAL HEALTH;**37,85,108**;Dec 30, 1994;Build 17
 ;Reference to VADPT APIs supported by DBIA #10061
 ;Reference to ^XLFDT APIs supported by DBIA #10103
 ;
 ;called from ^YTT(601,7,"R") and ^YTT(601.6,7,1)
F0 ;
 S R="",J=1
T0 ;
...
DTA ;
 ...
 S YSSX=YSSEX,YSBL="           ",YSHDR="xxx-xx-"_$E(YSSSN,8,11)_"  "_YSNM_YSBL_YSBL_YSBL,YSHD=DT
