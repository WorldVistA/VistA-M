YSCLENV ;DALISC/MJD - YS*5.01*22 PATCH ENVIRNMENT CHECK ROUTINE
 ;;5.01;MENTAL HEALTH;**18,22**;Dec 30, 1995
...
VK ;
 ...
 I '$D(^YSCL(603.01,0))&($G(VER)'=5.01) K DIR
 QUIT
 ;
EOR ;;YS*5.01*22 PATCH ENVIRONMENT CHECK ROUTINE;;
