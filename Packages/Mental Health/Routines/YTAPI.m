YTAPI ;ALB/ASF,HIOFO/FT - PSYCH TEST API ;2/20/13  3:01pm
 ;;5.01;MENTAL HEALTH;**53,71,76,77,108**;Dec 30, 1994;Build 17
 ;
PARSE(YS) ; -- array parsing
 ...
 K %DT
 Q
LISTALL(YSDATA,YS) ;entry point for YTAPI LISTALL rpc
 S YSDATA(1)="[ERROR]",YSDATA(2)="THIS RPC IS NO LONGER ACTIVE" Q  ;no longer active
 ...
 ;S YSDATA(N)=X
 ;Q
LISTONE(YSDATA,YS) ;entry point for YTAPI LISTONE rpc
 S YSDATA(1)="[ERROR]",YSDATA(2)="THIS RPC IS NO LONGER ACTIVE" Q  ;no longer active
