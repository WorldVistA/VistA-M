YTAIMS ;ALB/ASF,HIOFO/FT - TEST PKG: AIMS ;2/20/13 9:46am
 ;;5.01;MENTAL HEALTH;**54,66,108**;Dec 30, 1994;Build 17
 ;
 ;Reference to ^%ZOSF("NO-TYPE-AHEAD" supported by IA #10096
 ;Reference to ^VA(200 supported by IA #10060
 ;Reference to $$GET1^DIQ() supported by IA #2056
 ;
 Q  ;called from ^YTT(601,234,"A")
 ...
 ;G D1
 ;
REPT ;generate printout. Called from ^YTT(601,234,"R")
 D DTA^YTREPT
