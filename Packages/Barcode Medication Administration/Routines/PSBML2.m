PSBML2 ;BIRMINGHAM/TEJ-BCMA UTILITY TO EDIT THE PSB MED LOG ;03/06/16 3:06pm
 ;;3.0;BAR CODE MED ADMIN;**3,18,22,23,13,45,42,70,72,83,99,121,124,130**;Mar 2004;Build 1
...
UPDATED ;
 ...
 ...;Clear old units, PSB*3*99
 ...I Y="DD",(PSBREC(0)="G"!(PSBREC(0)="RM")) D
 ....S PSBMLT=1 F  S PSBMLT=$O(^PSB(53.79,+PSBIEN,.5,PSBMLT)) Q:'PSBMLT  D
 .....I $G(PSBFDA(PSBDD,PSBMLT_","_PSBIEN,.01))="" D VAL^PSBML(PSBDD,PSBMLT_","_PSBIEN,.01,"@")
 ...
 ;FIX FOR ONE-TIME WITH PRN ORDER PSB*3*124
 N CPSP,CPS55,CPSDFN,CPSCH
 I PSBXORN["U" D
 .S CPSP=0
 .S CPS55=$$GET1^DIQ(53.79,+PSBIEN,.11,"I")
 .S CPSDFN=$$GET1^DIQ(53.79,+PSBIEN,.01,"I")
 .S CPSCH=$P($G(^PS(55,CPSDFN,5,+CPS55,2)),U,1)
 .I $$ONE^PSJBCMA(CPSDFN,+CPS55,CPSCH)="O" S CPSP=1
 .I (CPSP=1)&($$GET1^DIQ(53.79,+PSBIEN,.12,"I")="P")&($$GET1^DIQ(53.79,+PSBIEN,.09,"I")="N") D
 ..S PSBDFN=$$GET1^DIQ(53.79,+PSBIEN,.01,"I") D ENR^PSJBCMA4(PSBDFN,$$GET1^DIQ(53.79,+PSBIEN,.11))
 Q
