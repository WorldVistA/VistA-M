PSBOIV ;BIRMINGHAM/TEJ-IV BAG STATUS REPORT; Oct 16, 2024@13:13
 ;;3.0;BAR CODE MED ADMIN;**32,68,70,106,150**;Mar 2004;Build 1
...
EN ; Entry
 ...
 ;PSB*3.0*150: added check for expired status.
 S INX="" F  S INX=$O(PSBLIST2(INX)) Q:INX=""  I '$D(PSBBGS(INX))&'$D(PSBNOX(INX))&($G(PSBLIST2(INX,"OStatus"))'="Expired") K PSBLIST2(INX) K PSBLIST2(INX)
