PSBOMH1 ;BIRMINGHAM/EFC-MAH,NMG; Feb 03, 2026@09:59
 ;;3.0;BAR CODE MED ADMIN;**6,3,9,11,26,38,45,51,50,57,67,64,72,83,97,112,116,120,82,159**;Mar 2004;Build 3
...
EN ;
 ...
 N PSBGIVN,PSBDT,PSBADMDT,X,Y,I,S,PSBINIT,PSBNAME,PRELINE1,PSBORD,PSBIEN,PSBR1,PSBADIEN,PSBABR,PSBLINE1,PSBLINE2,PSBRTXTW,PSBS,PSBTAR
 ...
 ....F S=1:1 Q:PSBM<1  S PSBM=PSBZ-S  I (PSBM>0) I (PSBT(PSBM)["GIVEN")  D
 .....S PSBGIVN=+$$FINDGIVE^PSBUTL(PSBIEN)
 .....S PSBFLG="1" S PRELINE1=$P(PSBT(PSBM),"'",2)_" "_$$FMTE^XLFDT(PSBGIVN,"1Z")_" "_$E($P(PSBT(PSBM),"'",4),1,3) Q
 ...I $D(^PSB(53.79,PSBIEN,.9,$P(PSBDT,"."))) D
 ....D INSTR^PSBOMH
 ....S ^TMP("PSB",$J,"LEGEND",PSBINIT,PSBNAME)=""
