...
LA2 K TV,Y S TOUT=0,A=1 D IN G QUIT:TOUT,LA2:$E(IN,2)'="R" D QC S SEL=$E(Y(1),47),SEL=$S(SEL=1:8,SEL=0:4,1:2)
 S TOUT=0 F A=2:1:SEL D IN,QC G QUIT:TOUT
 F I=0:0 S I=$O(TC(I)) Q:I<1  X TC(I,2) S @TC(I,1)=V
 S ID=+$E(Y(1),4,10),V=$E(Y(1),31,43) D NUM S (IDE,CUP)=+V,TRAY=1
