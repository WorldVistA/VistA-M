LABIOH ;SLC/RWF - ROUTINE FOR BIOVATION HEME KEYPADS ;7/20/90  07:32 ;
 ...
 ;CROSS LINK BY ID OR IDE; use format 5
...
LA2 K TV,TY,Y S TOUT=0,A=1,RMK="" D IN G QUIT:TOUT,LA2:$E(IN,1,2)'="@1" D QC
 S TOUT=0,BAD=0,L1=+$E(IN,3) F A=2:1:$S(L1=6:7,L1=5:8,1:9) D IN,QC G QUIT:TOUT
 S V=$E(Y(6),1,3) D NUM I V]"" S X=$S(V>99:$E(V,3),1:""),V=$S(V>99:$E(V,1,2)_0,1:V),TY(V)=X
 F I=1:4:32 S V=$E(Y(5),I,I+2) D NUM I V]"" S X=$S(V>99:$E(V,3),1:""),V=$S(V>99:$E(V,1,2)_0,1:V),TY(V)=X
 ...
 S V=$E(Y(7),1,6) D NUM S (ID,IDE,CUP)=+V,TRAY=1
...
CODE I LALCT'="U" S:V]"" V=$P($S(TC(I,4)]"":TC(I,4),1:"Noted$1+$2+$3+$4+$Rare$Occ$Few$Mod$Many"),"$",V+1) Q
 I LALCT="U" S:V]"" V=$P($S(^TMP("LA",$J,I,4)]"":^(4),1:"Noted$1+$2+$3+$4+$Rare$Occ$Few$Mod$Many"),"$",V+1) Q
