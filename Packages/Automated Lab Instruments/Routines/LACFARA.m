...
LA2 K TV S TOUT=0 D IN G QUIT:TOUT,LA2:$E(IN,1,2)'="01",LA2:$E(IN,21,22)'="03" F I=1:1:2 S TOUT=0 D IN G QUIT:TOUT
LA2A S TOUT=0 D IN G QUIT:TOUT,LA2:'$L(IN) S TRAY=1,CUP=+$E(IN,17,20),(ID,IDE)=+$E(IN,22,32),V=$E(IN,9,12) D NUM S TEST=V
 F I=0:0 S I=$O(TC(I)) Q:I<1  I TEST=TC(I,4),$E(IN,54)="N" S REMARK=$E(IN,56,57) I REMARK="00"!(REMARK="04")!(REMARK="07")!(REMARK>18) S @TC(I,1)=+$J(+$E(IN,33,44),0,+$E(IN,46,47))
