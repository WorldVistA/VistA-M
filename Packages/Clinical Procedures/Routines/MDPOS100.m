MDPOS100 ;HPS/JEL - MD*1*100 Post Installation Routine ;Dec 16, 2024@10:48
 ;;1.0;CLINICAL PROCEDURES;**100**;Apr 01, 2004;Build 2
...
EN ;
 ...
 D EN^XPAR("SYS","MDK GUI VERSION","HEMODIALYSIS.EXE:1.0.100.1",1)
 ;
 D MES^XPDUTL(" MD*1.0*100 Post Init complete")
 ;
 Q
ROLLBACK ;
 ...
 ;
 D MES^XPDUTL(" MD*1.0*93 Rollback complete")
 ;
 Q
