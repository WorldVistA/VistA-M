SROAOUT ;BIR/SJA - OUTCOMES DATA ;04/03/07
 ;;3.0;Surgery;**125,135,142,160,174,175**;24 Jun 93;Build 6
...
ASK W !!,"Select Outcomes Information to Edit: " R X:DTIME I '$T!("^"[X) G END
 ...
 I X="A" S X="0:15"
 I X?.N1":".N S Y=$E(X),Z=$P(X,":",2) I Y<0!(Z>15)!(Y>Z) D HELP G:SRSOUT END G START
 D HDR^SROAUTL
...
HELP W @IOF,!!!!,"Enter the number or range of numbers you want to edit.  Examples of proper",!,"responses are listed below."
 W !!,"1. Enter 'A' to update all information.",!!,"2. Enter a number (0-15) to update the information in that field.  (For",!,"   example, enter '4' to update Mediastinitis)"
