SROACL1 ;BIR/MAM - CARDIAC PREOP CLINICAL DATA ; AUGUST 11, 2011
 ;;3.0;Surgery;**38,71,95,125,153,160,174,176,182,184,200,203**;24 Jun 93;Build 7
 ;
...
HW(SRSD,SRED,SVTYPE) ; get weight & height from Vitals
 ...
 K ^UTILITY($J,"GMRVD"),RESULTS S GMRVSTR=SVTYPE,GMRVSTR(0)=$S(SVTYPE="HT":"0",1:SRSD)_"^"_SRED_"^^" ;SR203;was SRSD_"^"_SRED_"^^"
 ...
 ;SR200: return all of RESULTS - but with WT in 1st piece
 I $D(RESULTS(SVTYPE)) S SRI=$O(RESULTS(SVTYPE,0)) Q $P(RESULTS(SVTYPE,SRI),"^",3)_U_RESULTS(SVTYPE,SRI)
 Q ""
