...
PRINT ; print information
 ...
 ;
 S SRNAME=$P(^SRO(133.8,SRSS,0),"^"),SRNAME=$P(^SRO(137.45,SRNAME,0),"^")
 ;
...
MORE S SRNAME=$P(^SRO(133.8,SRRECNO,0),"^"),SRNAME=$P(^SRO(137.45,SRNAME,0),"^")
 I SRNAME'=SRSNM Q
 S DFN=SRW D DEM^VADPT S SRSDPT=VADM(1),^TMP("SR",$J,SRSDPT,SRRECNO,SRSUB)=""
 Q
HDR ; print heading
 I $D(ZTQUEUED) D ^SROSTOP I SRHALT S SRSOUT=1 Q
 S SRHDR=1 W:$Y @IOF W !,"Surgery Waiting List sorted by Patient ",!,"Surgical Specialty is "_SRSNM,!,"Printed "_SRTIME,!!,"Date Entered",?15,"Patient",?40,"Operative Procedure",! F LINE=1:1:80 W "="
 Q
