SROATCM1 ;BIR/MAM - STUFF TRANMISSION IN ^TMP ;09/28/2011
 ;;3.0;Surgery;**38,71,79,90,88,93,95,111,125,135,134,142,153,160,174,175,176,177,182,184**;24 Jun 93;Build 35
 ...
 S SHEMP="{"_$J(SRASITE,3)_$J(SRTN,7)_" 1 "_DT_$J(AGE,3)_$J(SEX,1)_$J(SRSDATE,12,4)_$J(SRPID,21)_$J($P($G(SRA(208)),"^",11),2)
