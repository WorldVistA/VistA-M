SROUTC ;BIR/SJA - OUTCOMES DATA ;03/13/06
 ;;3.0;Surgery;**125,135,153,174,175**;24 Jun 93;Build 6
...
DISP S SRPAGE="PAGE: 1",SRHDR(.5)="OUTCOMES INFORMATION" D HDR^SROAUTL
 ...
 W !,?40,"15. Wound Disruption: ",?76,$P(SRAO(15),"^")
 W !! F MOE=1:1:80 W "-"
 Q
YN ; store answer
...
DEL ; delete existing Post/Intraoperative occurrences.
 ...
 Q
MAP S SROC=$S(EMILY=1:17,EMILY=2:23,EMILY=3:9,EMILY=4:25,EMILY=5:16,EMILY=6:26,EMILY=7:6,EMILY=8:27,EMILY=9:33,EMILY=10:37,EMILY=11:12,EMILY=12:13,EMILY=14:39,EMILY=15:22,1:34)
 Q
