SROANEST ;BIR/TJH - ANESTHESIA ENTRY ; Jun 23, 2025@10:00
 ;;3.0;Surgery;**119,150,152,221**;24 Jun 93;Build 2
SINPUT ;
 N SRSTART
...
ANESTIME(SRDFN,SRFDATE,SRTDATE) ; API to return multiple anesthesia records and times
 N SRCASE,SRREC,SRRECC,SRCNT,SRNON,SRX,SRDATE,SRRES,SRSC,SRCV,SRQO,SRIR,SREC,SRMST,SRHNC,SRAO,SRSREC,SRCST,SRCET,SRTTIME,SR,SRDIAG,SRSHAD
 ...
 S SRREC=0
 F  S SRREC=$O(SRCASE(SRREC)) Q:('SRREC)!(SRRES<0)  D
 .S SRCASE=SRCASE(SRREC)
 ...
 .S SRRES=1,SRRECC=0
 .F  S SRRECC=$O(^SRF(SRCASE,50,SRRECC)) Q:(SRRECC="B")!(SRRECC="")  D  Q:SRRES<0
 ..S SRCST=$$GET1^DIQ(130.213,SRRECC_","_SRCASE_",",.01,"I"),SRCET=$$GET1^DIQ(130.213,SRRECC_","_SRCASE_",",1,"I")
 ..I 'SRCET K ^TMP("SRANES",$J,SRCASE) S SRRES=-2 Q
 ..S SRTTIME=0 D CALC
