SRSWL2 ;B'HAM ISC/MAM - WAITING LIST, BRIEF-ONE SPECIALTY ; 17 OCT 1989  7:35 AM
 ;;3.0; Surgery ;;24 Jun 93
 W ! K %ZIS,POP,IOP,IO("Q") S %ZIS("A")="Print the Waiting List on which Device: ",%ZIS="Q" D ^%ZIS Q:POP
 I $D(IO("Q")) K IO("Q") S ZTDESC="SURGERY WAITING LIST",ZTRTN="BEG^SRSWL2",(ZTSAVE("SRSS"),ZTSAVE("SRSNM"))="" D ^%ZTLOAD G END
...
HDR ; print heading
 ...
 W:$Y @IOF W !,"Surgery Waiting List for "_SRSNM,!,"Printed "_SRTIME,!!,"Date Entered",?15,"Patient",?40,"Operative Procedure",! F LINE=1:1:80 W "="
 Q
PRINT ; print information
 ...
 S SROLD=0 D OLD^SRSWLST I SROLD W !,"* Procedure performed since entry on the list ("_SROLD("DATE")_")"
 W ! F LINE=1:1:80 W "-"
 Q
