SRONIN ;BIR/MAM,ADM - NURSE INTRAOPERATIVE REPORT ;10/24/2011
 ;;3.0;Surgery;**68,50,100,129,134,153,157,175,176,182,184**;24 Jun 93;Build 35
...
ES D RPT^SRONRPT(SRTN) N SRAY,SRERR,SRI,SRP,SRSIG,SRTIU,X1
 ...
 Q
ALLIN N SRDONR1,SRDONR2,SRMISSD,SRFLD,SRI,SRJJ,SRJK,SRM,SRMISS1,SRMISS2,SRMISS3,SRMISS85,SRMIS508,SRMIS630,SRMIS633,SRMIS636,SRMISSAT,SRO,SROO,SRP,SRPF,SRX,SRY,SRZ,SRABORT
 S (SREDIT,SRMISS,SRMISS1,SRMISS2,SRMISS3,SRMISS85,SRMIS508,SRMISSAT,SRSOUT,SRMIS633,SRMIS636,SRMIS630,SRMISSD)=0
 S SRABORT=$$ABORT^SRTOVRF(SRTN) Q:SRABORT
 S (SRDONR1,SRDONR2)=0
 S SRDONR1=$$VER1^SRTOVRF(SRTN),SRDONR2=$$VER2^SRTOVRF(SRTN)
 K DA,DIC,DIQ,DR
 S DIC="^SRF(",DA=SRTN,DIQ="SRY",DIQ(0)="I",DR=".205;.232;44;45;46;47;48;606;605;600;601;602;603;604;607;608;609;610;611;506;.69;1.13;630;633;636;74"
 ...
 F SRJJ=.69,74 I $G(SRX(SRJJ))'="" S SRMISS1=1
 ...
 I SRMISS1!SRMISS2!$G(SRMISS85)!$G(SRMIS508)!(SRMISS3)!(SRMISSAT)!(SRMIS630)!(SRMIS633)!(SRMIS636)!(SRMISSD) S SRMISS=1 D MESS Q:SRSOUT  I SREDIT D EDIT Q
 Q
