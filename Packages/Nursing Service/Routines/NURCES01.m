NURCES01 ;HIRMFO/YH-END OF SHIFT REPORT PART 1/2 ;5/17/17
 ;;4.0;NURSING SERVICE;**45**;Apr 25, 1997;Build 12
PRINT1 ;
 D ^NURSAPCH
...
PART2 ;
 ...
 Q
ASSN ;Assessment, Safety and Special Needs
 I '$G(NPR)  D FITLINE^NURCES5(" ",62,.NPR)
 D FITLINE^NURCES5(" ",62,.NPR)
 D FITLINE^NURCES5("Assessment: [ ]FALL  [ ]I&O   [ ]SL    [ ]PICC",62,.NPR)
 D FITLINE^NURCES5("            [ ]MID   [ ]ASPR",62,.NPR)
 D FITLINE^NURCES5(" ",62,.NPR)
 D FITLINE^NURCES5("SAFETY: (isolation, elopement risk, restraints,",62,.NPR)
 D FITLINE^NURCES5("         critical lab values,fall/risk score ______)",62,.NPR)
 D FITLINE^NURCES5(" ",62,.NPR)
 D FITLINE^NURCES5("SPECIAL NEEDS: (equipment, oxygen, etc.)",62,.NPR)
 D FITLINE^NURCES5(" ",62,.NPR)
 Q
