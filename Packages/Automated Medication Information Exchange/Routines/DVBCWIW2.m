DVBCWIW2 ;ALB/RLC  INTESTINES (LARGE AND SMALL) ; 16 JAN 2007
 ;;2.7;AMIE;**120**;Apr 10, 1995;Build 4
 ;
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="For INTESTINES (LARGE AND SMALL)",PG=1
 W !?22,"Compensation and Pension Examination",!,?(IOM-$L(DVBAX)\2),DVBAX,!?33,"# 0315 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWIW3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 S PG=PG+1 W @IOF,!,"Page: ",PG,!!,"Compensation and Pension Exam for "_NAME,!
 W "For INTESTINES (LARGE AND SMALL)",!!!
 Q
