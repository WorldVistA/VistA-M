DVBCQAL1 ;;ALB-CIOFO/ECF - AMYOTROPHIC LATERAL SCLEROSIS QUESTIONNAIRE ; 5/15/2011
 ;;2.7;AMIE;**167**;Apr 10, 1995;Build 1
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Amyotrophic Lateral Sclerosis",TT=40-($L(DVBAX)\2),PG=1
 W !,?TT,DVBAX
 S DVBAX="(Lou Gehrig's Disease)",TT=40-($L(DVBAX)\2)
 W !,?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQAL2","DVBCQAL3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
