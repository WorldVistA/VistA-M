DVBCWPM ;ALB/ESW PULMONARY TB AND MYCO DISEASE WKS ; 7 Oct, 2000
...
EN D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 ...
 W !?TT,DVBAX
 S DVBAX="PULMONARY TUBERCULOSIS AND MYCOBACTERIAL DISEASES",TT=IOM-$L(DVBAX)\2,PG=1
 ; $L("# XXXX Worksheet")=16 for all worksheets
 ;
 W !!?TT,DVBAX,!?(IOM-16\2),"# 1515 Worksheet",!!
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCWPM1" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 S PG=PG+1 W @IOF,!,"Page: ",PG,!?10,"Compensation and Pension Exam for "_NAME,!!
 W "PULMONARY TUBERCULOSIS AND MYCOBACTERIAL DISEASES",!!!
 Q
