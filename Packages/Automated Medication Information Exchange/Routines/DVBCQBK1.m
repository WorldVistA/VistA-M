DVBCQBK1 ;;ALB-CIOFO/ECF - BACK (THORACOLUMBAR SPINE) QUESTIONNAIRE ; 5/15/2011
 ;;2.7;AMIE;**167**;Apr 10, 1995;Build 1
EN ;
 D:'$D(IOF) SETIOF W:(IOST?1"C-".E) @IOF
 S DVBAX="Back (Thoracolumbar Spine) Conditions",TT=40-($L(DVBAX)\2),PG=1
 W ?TT,DVBAX
 ...
 K ^TMP($J,"DVBAW")
 F ROU="DVBCQBK2","DVBCQBK3" S X=ROU X ^%ZOSF("LOAD")
 K DIF,XCNP,ROU
 N LP,TEXT
 S LP=0,STOP=0
...
HD2 ;
 ...
 W "Back (Thoracolumbar Spine) Conditions",!!!
 Q
