LRSORC1A ;DALISC/DRH - LRSORC Continued ;APR 2, 2025@11:54
 ;;5.2;LAB SERVICE;**201,344,351,384,449,585**;Sep 27, 1994;Build 18
INIT ;
 S U="^"
 D CONTROL
 Q
...
PRINT ;
 ...
 ....;LR*5.2*585: ADJUSTED TRUNCATION FROM 14 TO 16 CHARACTERS AND MOVED LRSPDAT TO LINE BELOW.
 ....W !,$E(PNM,1,22),?23,$E(SSN,1,11) W:LRDPF=2 ?35,$E(LRLOC,1,12),?48,$E(LRAN,1,16)
 ....W ?63
 ....W !," ",LRSPDAT," ",LRSPEC
 ....D PRNTST
 Q
