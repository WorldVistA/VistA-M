LR7OR1 ;DALIO/JMC - Get Lab results ;MAR 13, 2013@09:08
 ;;5.2;LAB SERVICE;**121,187,219,230,256,310,340,348,350,427,459,507**;Sep 27, 1994;Build 5
 ;
RR(DFN,ORD,SDATE,EDATE,SUB,TEST,FLAG,COUNT,SPEC,UNVER) ;Get LAB results for patient
 ...
 I SUB["CH" D CH^LR7OR2(SDATE-.00001,EDATE+.00001,$G(TEST),COUNT,$G(SPEC),$G(UNVER))
