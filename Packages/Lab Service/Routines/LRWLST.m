LRWLST ;FHS/DALOI - ACCESSION SETUP. LROE1,LRSTIK & LRFAST CALL HERE ; Aug 9, 2004
 ;;5.2;LAB SERVICE;**46,65,100,121,153,202,290,424,444,466**;Sep 27, 1994;Build 2
...
SET ;
 ...
 Q
FWL ;
 I $O(^LAB(60,LRTSTS,2,0))>0 D EXP S:$D(^LRO(69,LRODT,1,LRSN,2,$P(^TMP("LR",$J,"TMP",LRIX),U,3),0)) $P(^LRO(69,LRODT,1,LRSN,2,$P(^TMP("LR",$J,"TMP",LRIX),U,3),0),U,8)=1 Q
 ;
 I '$D(LRNCWL) D
 . N LRTEST,LRPARENT
