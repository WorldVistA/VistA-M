ORY316ES ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*316) ;NOV 17,2009 at 13:36
...
S ;
 ...
 W !," Created: NOV 17,2009 at 13:36  at  VMPDEV20.FO-BAYPINES.MED.VA.GOV"
 W !," Current Date: ",$$NOW^ORY3160,"  at  ",$$NETNAME^OCXSEND,!!
...
RUN ;
 ...
 ..;
 ..I OPCODE="KEY" D DOT S LOCAL="",D0=$$GETFILE^ORY3160(+$P(TEXT,U,1),$P(TEXT,U,2),.LOCAL) S QUIT=(D0=(-10)) Q
 ..I OPCODE="R" S REF="REMOTE("_$P(TEXT,":",1)_":"_D0_$P(TEXT,":",2,99)_")" Q
 ..I OPCODE="D",$D(REF) S @REF=$P(TEXT,U,1,999) K REF Q
 ..;
 ..I OPCODE="EOR" S QUIT=$$COMPARE^ORY3161(.LOCAL,.REMOTE) K LOCAL,REMOTE Q
 ...
 ..;
 ..W !,"Unknown OpCode: ",OPCODE,"  in: ",TEXT S QUIT=$$PAUSE^ORY3160 W !
 ;
 K ^TMP("OCXRULE",$J)
 ;
 I $D(^OCXS) D
