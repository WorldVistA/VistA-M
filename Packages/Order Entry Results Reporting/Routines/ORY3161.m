ORY3161 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*316) ;NOV 17,2009 at 13:36
...
MULT(CREF,OCXDD) ;
 ...
 ...S QUIT=$$LOADWORD^ORY3162(RREF,OCXDD,OCXFLD,OCXSUB)
 .;
...
DSPFLD(CREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 ;
 W:($D(@RREF@(OCXFLD,OCXSUB))) !,?(5+(($L(OCXDDPTH,",")+2)*4)),"(R) VMPDEV20.FO-BAYPINES.MED.VA.GOV: ",@RREF@(OCXFLD,OCXSUB)
