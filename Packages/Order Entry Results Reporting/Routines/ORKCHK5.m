ORKCHK5 ; slc/CLA - Support routine called by ORKCHK to do ACCEPT mode order checks ;10/28/11
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**6,32,74,94,123,190,280,357**;Dec 17, 1997;Build 52
 Q
 ;
