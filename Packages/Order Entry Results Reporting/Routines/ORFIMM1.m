...
BLD(RESULTS,LIST,INPUTS) ;
 ...
 ..I "AIDH"[ENCTYPE D  Q
 ...I TYPE=0 D
 ....I INT>$$NOW^XLFDT() S RESULTS(CNT)="-1^Administration Date/Time cannot be a future date/time.",HASERR=1 Q
 ...I TYPE=1,INT>DT S RESULTS(CNT)="-1^Administration Date cannot be for a future date.",HASERR=1 Q
 ...I TYPE=5,INT>$$NOW^XLFDT() S RESULTS(CNT)="-1^Read Date/Time cannot be a future date/time.",HASERR=1 Q
 ...S ADMINDATE=INT,$P(DELSTR,U,$S(TYPE=5:27,1:PIECE))=INT
 ..I TYPE=1,INT>DT S RESULTS(CNT)="-1^Administration Date cannot be for a future date.",HASERR=1 Q
 ..S ADMINDATE=INT,$P(DELSTR,U,$S(TYPE=5:27,1:PIECE))=INT
 .I PARM="pnumImmLot",TYPE=1 S INT=""
 .I PARM="" Q
