ORLPREM ;ISP/LMT,AGP - CPRS Team List from a Reminder Patient List ;Sep 23, 2025@13:07:51
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**377,498,508**;Dec 17, 1997;Build 39
 ;
 ; Reference to ^PXRM(810.4, in ICR #6762
 ;
ENTASK ;
 ;
 ; ZEXCEPT: ZTREQ
...
EN(ORREM,ORLSTMAP) ;
 ...
 ;
 ; Set ^TMP Global to populate 100.21
 S ORCNT=0
 S DFN=0
 S ORTNM="ORRM LIST"
 F  S DFN=$O(^TMP($J,ORTNM,ORREMNM,1,DFN)) Q:'DFN  D
 . S ORCNT=ORCNT+1
 . I 'ORSCRBYDIV D
 . . S ORLST=$G(ORLSTMAP("SYS"))
 . . I 'ORLST Q
 . . S ORIENS="+"_ORCNT_","_ORLST_","
 . . S ^TMP($J,ORLST,100.2101,ORIENS,.01)=DFN_";DPT("
 . I ORSCRBYDIV D
 . . S ORDIV=$$GETDIV(DFN)
 . . I ORDIV,$G(ORLSTMAP(ORDIV)) D  Q
 ...
 . S ^TMP($J,ORLST,100.21,ORLST_",",12.1)=$$NOW^XLFDT
 . S ^TMP($J,ORLST,100.21,ORLST_",",12.2)=ORREM_";PXRM(810.4,"
 . D UPDATE^DIE("","^TMP("_$J_","_ORLST_")")
 . L -^OR(100.21,ORLST)
 . ;
 . I $D(^TMP("DIERR",$J)) D
...
SENDMSG(ORERR,ORERRARR,ORREM,ORLST) ;
 ;
 ; ZEXCEPT: XQY0,ZTSK
 N ORCNT,ORI,ORINSTR,ORLST,ORREM,ORSUB,ORTO,ORMSGNUM
 K ^TMP("ORMSG",$J)
 ;
 S ORCNT=0
