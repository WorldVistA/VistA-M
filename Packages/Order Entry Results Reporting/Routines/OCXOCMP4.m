OCXOCMP4 ;SLC/RJS,CLA - ORDER CHECK CODE COMPILER (Sort Code Segments) ; Jan 29, 2025@10:55:10
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**32,221,632**;Dec 17,1997;Build 9
...
EN() ;
 ...
 D IN(OCXU," S OCXTSPI=+$G(OCXTSPIFC,"_+$G(OCXTSPI)_")") ; allow override of triggered rule ignore period default see IPOVERRIDE^OCXOERR
 I $G(OCXTRACE) D
