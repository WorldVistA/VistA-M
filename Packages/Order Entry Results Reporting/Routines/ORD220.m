ORD220 ; COMPILED XREF FOR FILE #100.842 ; 07/29/21
 ; 
...
1 ;
B S DA=$O(^OR(100,DA(2),8,DA(1),6,DA)) I DA'>0 S DA=0 Q:DIKM1=1  G A
2 ;
 S DIKZ(0)=$G(^OR(100,DA(2),8,DA(1),6,DA,0))
 S X=$P($G(DIKZ(0)),U,1)
 I X'="" S ^OR(100,DA(2),8,DA(1),6,"B",$E(X,1,30),DA)=""
