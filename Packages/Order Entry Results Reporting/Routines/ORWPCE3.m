ORWPCE3 ; SLC/KCM/REV/JM/TC - Get a PCE encounter for a TIU document ;Dec 13, 2021@06:55:26
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,116,190,280,306,371,361,385,377,498,405**;Dec 17, 1997;Build 211
 ;
PCE4NOTE(LST,IEN,DFN,VSITSTR) ; Return encounter for an associated note   IA#4214,6132,6614
 ...
 N ICOM,MIDX,MIEN,MCNT,MODS,VIS,VISCNT,VISTEMP,CPIECE,GFINDS,GCNT,ITEM,ORDATA
 ...
 . S VISIT=$P(X12,U,7)
 . I 'VISIT S VISIT=$P(X0,U,3),PRIMARY=1
