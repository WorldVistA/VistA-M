ORBSMART ; SLC/JMH - SMART NOTIFICATIONS;Jul 08, 2025@14:52:50
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**377,498,593,508**;Dec 17, 1997;Build 39
 ;
...
GETRMLST(ORLST,ORLNM,OVER,RETDATA) ;Get a list of patients from Reminder call
 ...
 K ^TMP($J,ORTNM)
 S ORRMIN("SUB")=ORTNM
 S ORRMIN("LR",ORLNM,1)=ORLNM_U_DT_U_DT_U_0_U_$G(OVER,1)_U_RETDATA
