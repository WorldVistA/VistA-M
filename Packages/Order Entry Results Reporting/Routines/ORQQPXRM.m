ORQQPXRM ;SLC/PJH - Functions for reminder data ;Mar 27, 2018@12:05
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,116,173,187,190,215,243,306,389,377**;Dec 17, 1997;Build 582
 ;
...
DIALOG(ORY,ORREM,DFN) D DIALOG^PXRMRPCC(.ORY,ORREM,DFN) Q  ; DBIA 3080
 ;
...
TDIALOG(ORY,ORDLG,DFN) D DIALOG^PXRMRPCD(.ORY,ORDLG,DFN) Q
 ;
