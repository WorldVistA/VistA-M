ORMPS1 ;SLC/MKB - Process Pharmacy ORM msgs cont ;May 19, 2020@13:55:26
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**86,92,94,116,134,152,158,149,190,195,215,265,275,243,280,350,382,397,413**;Dec 17, 1997;Build 32
...
OUT1 S ORDIALOG($$PTR("QUANTITY"),1)=$$FIND^ORM(+RXE,11)
 ...
 . S ORDIALOG(INSTR,I)=$$UNESC^ORMPS2($P(ORQT(I),U,8))
