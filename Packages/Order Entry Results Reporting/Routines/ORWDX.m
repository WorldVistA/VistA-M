ORWDX ;SLC/KCM,REV,JLI - Order dialog utilities ;Mar 03, 2026@07:17:28
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,125,131,132,141,164,178,187,190,195,215,246,243,283,296,280,306,350,424,421,461,490,397,377,539,405,588,601,508**;Dec 17, 1997;Build 39
...
SEND1 N ORVP,ORWI,ORWERR,ORWREL,ORWSIG,ORWNATR,ORDERID,ORBEF,ORLR,ORLAB,X,I
 ...
 . I $G(^OR(100,+ORDERID,5))="" S ^OR(100,+ORDERID,5)="^^^^^"
