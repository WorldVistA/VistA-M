ORFEDT ;SLC/AGP - GENERIC EDIT FORM ; Aug 25, 2025@14:27:07
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**405,625**;Dec 17, 1997;Build 10
 Q
 ;
BLDPRMPT(PROMPTS) ;
...
BLDDEFLS(DEFAULTS,DEFLIST) ;
 N CNT,LNAME,LNODE,MARRAY,MCNT,NODE,VCNT
 S (LNAME,MCNT,VCNT)=0
 S CNT=0 F  S CNT=$O(DEFAULTS(CNT)) Q:CNT'>0  D
 .S NODE=DEFAULTS(CNT)
 .I $P(NODE,U)="VIS OFFERED" S VCNT=VCNT+1,LNAME=$P(NODE,U),DEFLIST($P(NODE,U),VCNT)=$P(NODE,U,2,$L(NODE,U)) Q
