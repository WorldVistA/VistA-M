ORWPCE ;SLC/JM,REV - Wrap Calls to PCE and AICS ;10/9/2018
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,116,173,190,195,215,243,295,280,306,361,385,398,377**;Dec 17, 1997;Build 582
 ;
...
GETMOD(MODINFO,ORMODIEN,ORDATE) ;Returns info for a specific CPT Modifier
 ...
 Q
DIAG(LST,CLINIC,ORDATE,ORDFN) ; get list of diagnoses for clinic
 N ORI S ORI=0
 S:'+$G(ORDATE) ORDATE=DT
