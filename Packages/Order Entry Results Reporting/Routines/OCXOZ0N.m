OCXOZ0N ;SLC/RJS,CLA - Order Check Scan ;JUN 2,2026 at 09:53
...
INT2DT(OCXDT,OCXF) ;      This Local Extrinsic Function converts an OCX internal format
 ; Date into an External Format (Human Readable) date.   'OCXF=SHORT FORMAT OCXF=LONG FORMAT
 ;
 ...
 S OCXCYR=($H\1461)*4+1841+(($H#1461)\365.25)
 S OCXYR=(OCXDT\1461)*4+1841
 S OCXDT=OCXDT#1461
 S OCXLPYR=(OCXDT\365.25)
 S OCXDT=OCXDT-(OCXLPYR*365)
 S OCXYR=OCXYR+OCXLPYR
 S OCXCNT="031^059^090^120^151^181^212^243^273^304^334^365"
 S:((OCXYR#4)=0) OCXCNT="031^060^091^121^152^182^213^244^274^305^335^366"
