ORQ20 ; SLC/MKB - Detailed Order Report cont ; Jul 09, 2024@12:51:26
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**12,27,92,94,116,141,177,186,190,215,243,434,493,539,586**;Dec 17, 1997;Build 5
 ;
...
ACT ; -- add Activity [from ^ORQ2]
 ...
 N NVA,USER,DSPG S DSPG=+$P(^OR(100,+ORIFN,0),U,11) S:$P($G(^ORD(100.98,DSPG,0)),U)="NON-VA MEDICATIONS" NVA=1
