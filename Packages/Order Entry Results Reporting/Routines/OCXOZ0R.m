OCXOZ0R ;SLC/RJS,CLA - Order Check Scan ;JUN 2,2026 at 09:53
...
R48R1B ; Send Order Check, Notication messages and/or Execute code for  Rule #48 'SITE FLAGGED ORDER'  Relation #1 'NEW SITE FLAGGED ORDER AND INPATIENT'
 ...
 ; Run Execute Code
 ;
 D FIREFLOI^ORB3F1($$GETDATA(DFN,"58^127",34),$$GETDATA(DFN,"58^127",147),$$INT2DT($$GETDATA(DFN,"58^127",9),0),$$GETDATA(DFN,"58^127",146))
 Q:$G(OCXOERR)
 Q
 ;
...
R48R2B ; Send Order Check, Notication messages and/or Execute code for  Rule #48 'SITE FLAGGED ORDER'  Relation #2 'NEW SITE FLAGGED ORDER AND OUTPATIENT'
 ...
 ; Run Execute Code
 ;
 D FIREFLOI^ORB3F1($$GETDATA(DFN,"58^128",34),$$GETDATA(DFN,"58^128",147),$$INT2DT($$GETDATA(DFN,"58^128",9),0),$$GETDATA(DFN,"58^128",146))
 Q:$G(OCXOERR)
 Q
 ;
