ORY31602 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*316) ;NOV 17,2009 at 13:36
...
DATA ;
 ...
 ;;KEY^863.7:^GCC FREE TEXT CONTAINS NC ELEMENT IN SET
 ;;R^"863.7:",.01,"E"
 ;;D^GCC FREE TEXT CONTAINS NC ELEMENT IN SET
 ;;R^"863.7:",.02,"E"
 ...
 ;;KEY^863.9:^CONTAINS NOCASE ELEMENT IN SET
 ;;R^"863.9:",.01,"E"
