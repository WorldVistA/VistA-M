ORY5391 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*539) ;JAN 13,2021 at 11:13
...
MULT(CREF,OCXDD) ;
 ...
 ...S QUIT=$$LOADWORD^ORY5392(RREF,OCXDD,OCXFLD,OCXSUB)
 .;
...
DSPFLD(CREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 ;
 W:($D(@RREF@(OCXFLD,OCXSUB))) !,?(5+(($L(OCXDDPTH,",")+2)*4)),"(R) C32AD.DEVSLC.FO-SLC.DOMAIN.EXT: ",@RREF@(OCXFLD,OCXSUB)
