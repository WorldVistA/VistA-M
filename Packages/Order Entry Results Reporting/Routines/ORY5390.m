ORY5390 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*539) ;JAN 13,2021 at 11:13
...
WARN(RTN,MSG,LINES) ;
 ...
 W !!,"--------------",MSG,DASH
 ;
 W !,RTN,?10,"[C32AD.DEVSLC.FO-SLC.DOMAIN.EXT] -> [",$$NETNAME^OCXSEND,"] Line"
 ;
