ORY3164 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*316) ;NOV 17,2009 at 13:36
...
EDITFLD(OCXCREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 .S OCXGREF=$$GETREF^ORY3162(+OCXDD,.OCXDA,OCXLVL-1) Q:'$L(OCXGREF)
 .D DIE^ORY3162(OCXDD,OCXGREF,OCXFLD,@OCXCREF@(OCXDD,OCXFLD,"E"),.OCXDA,OCXLVL-1)
 ;
 Q QUIT
 ;
DELFLD(OCXCREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 S OCXGREF=$$GETREF^ORY3162(+OCXDD,.OCXDA,OCXLVL-1) Q:'$L(OCXGREF)
 D DIE^ORY3162(OCXDD,OCXGREF,OCXFLD,"@",.OCXDA,OCXLVL-1)
 ;
 Q QUIT
 ;
CREATE(OCXCREF,OCXDD,OCXDA,OCXLVL) ;
 ...
 N OCXFLD,OCXGREF
 ;
 S OCXGREF=$$GETREF^ORY3162(+OCXDD,.OCXDA,OCXLVL) Q:'$L(OCXGREF)  S:'OCXDA OCXDA=$O(@(OCXGREF_"""@"")"),-1)+1
 ;
 I '$D(@(OCXGREF_"0)")) S @(OCXGREF_"0)")=U_$$FILEHDR^OCXSENDD(+OCXDD)_U_U
 ;
 S OCXFLD=0 F  S OCXFLD=$O(@OCXCREF@(OCXDD,OCXFLD)) Q:'OCXFLD  Q:(OCXFLD[":")  I '$$EXFLD^ORY3161(+OCXDD,OCXFLD) D
 .I $L($G(@OCXCREF@(OCXDD,OCXFLD,"E"))) D DIE^ORY3162(OCXDD,OCXGREF,OCXFLD,@OCXCREF@(OCXDD,OCXFLD,"E"),.OCXDA,OCXLVL)
 ;
 D PUSH(.OCXDA)
