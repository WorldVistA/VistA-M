OCXOZ0Q ;SLC/RJS,CLA - Order Check Scan ;JUN 2,2026 at 09:53
...
R42R2B ; Send Order Check, Notication messages and/or Execute code for  Rule #42 'ABNORMAL LAB RESULTS'  Relation #2 'ABNORMAL LAB TEST'
 ...
 Q
 ;
R44R1A ; Verify all Event/Elements of  Rule #44 'ORDER REQUIRES ELECTRONIC SIGNATURE'  Relation #1 'ELECTRONIC SIGNATURE'
 ;  Called from EL48+5^OCXOZ0G.
 ;
 Q:$G(OCXOERR)
 ;
 ;      Local Extrinsic Functions
