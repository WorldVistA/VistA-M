GMRVKPO4 ;HIRMFO/YH-GRAPH KYOCERA PRINT COMMANDS (PART 1) ;5/20/97
...
CALL W !,"CALL BOX, '%';"
 ...
 W !,"CALL RSP" S J(1)=250,J(2)=J(1)+9 D WRTCALL^GMRVBP4
 ...
 W !,"CALL PULS" S J(1)=282,J(2)=J(1)+9 D WRTCALL^GMRVBP4
PO2Q ;
 W !,"CALL POXL" S J(1)=1431,J(2)=J(1)+9 D WRTCALL^GMRVBP4
 W !,"CALL POXP" S J(1)=1451,J(2)=J(1)+9 D WRTCALL^GMRVBP4
 W !,"CALL POXM" S J(1)=1471,J(2)=J(1)+9 D WRTCALL^GMRVBP4
 W !,"CALL NEWP" S J(1)=311,J(2)=J(1)+9 D WRTCALL^GMRVBP4
 W !,"CALL PLQ" S J(1)=331,J(2)=J(1)+9 D WRTCALL^GMRVBP4
