DGBTCR1 ;ALB/SCK - BENEFICIARY TRAVEL FORM 70-3542d; 2/7/88@08:00  6/11/93@09:30 ; 7/12/10 1:42pm
...
PRINT K I S $P(I,"=",65)="" W !?66,"|",I,"|",!?7,VADM(1),?50 I $D(^DIC(13,+VADM(9),0)) W $P(^(0),"^",4)
 ...
 K I S $P(I,"=",65)="" W ?67,I,"|"
 W !?7 W:VAPA(2)'="" VAPA(2) W:VAPA(2)="" VAPA(3) W:VAPA(2)=""&(VAPA(3)="") VAPA(4),?40,DGBTST,?50,$P(VAPA(11),U,2)
 W ?66,"| 2. Name and Address of Issuing Health Care Facility",?131,"|"
 W !?7 W:VAPA(3)'="" VAPA(3) W:VAPA(2)'=""&(VAPA(3)="") VAPA(4),?40,DGBTST,?50,$P(VAPA(11),U,2),?66,"|",?131,"|"
 W ?66,"|",?131,"|"
 W !?7 W:VAPA(2)'=""&(VAPA(3)'="") VAPA(4),?40,DGBTST,?50,$P(VAPA(11),U,2)
 W ?66,"|",?88,$P(DGBTINS,"^"),?131,"|"
 W !?66,"|",?88 W:$P(DGBTINS1,"^")'="" $P(DGBTINS1,"^") W:$P(DGBTINS1,"^")="" $P(DGBTINS1,"^",2) W:$P(DGBTINS1,"^")=""&($P(DGBTINS1,"^",2)="") DGBTINS2 W ?131,"|"
 W !?7,DGBTSSN,?21,$E($P(VADM(10),"^",2),1),?22,$P(VADM(5),"^"),?30,DGBTDOB,?50,DGBTDIV
