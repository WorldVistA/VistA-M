DGBTEND ;ALB/SCK - BENEFICIARY TRAVEL CLEAN-UP VARIABLES ROUTINE;12/15/92 3/19/93 ; 8/2/10 3:03pm
...
END I DGBTTOUT=1 I $D(^DGBT(392,DGBTDT,0)) F I=0,"A","D","M","R","T" S ^DGBT(392,DGBTDT,I)=$S($D(DGBTVAR(I)):DGBTVAR(I),1:"")
 ...
 S DGBTX1=$S(Y="D":"SCREEN^DGBTCD",Y="E":"SCREEN^DGBTCE",Y="P":"START^DGBTCR",1:"") I DGBTX1]"" D @DGBTX1 D:DGBTTOUT QUIT^DGBTCE1 G:DGBTX1="START^DGBTCR" PATIENT^DGBTE G END
 G END
