GMTSPST2 ;BIR/RMS - MED RECON TOOL #2 (MEDICATION WORKSHEET) ; Oct 10, 2025@12:40
 ;;2.7;Health Summary;**92,100,120,139,152**;Oct 20, 1995;Build 2
 ;
 ...
 ;References to ^OR(100 supported by DBIA 5771
 ;
...
DRUGNAME(RXIEN) ;
 ...
 Q DRUGNM
GETPEND(RXSIEN) ;
 N PSOQPDN,PSOQDIND,PSOQ100,PSOQSCT,GMTSPST2,A,ORIFN,STAT,GMTSFLG,GMTSCNT,GMTSSTS
 ...
 ;I $E(A,$L(A))="N" D STATE
 S GMTSSTS=$S(A["P":"**PENDING** ",A["N":"z**NON-VA** ",1:"") ;DM-152
 I (A["N")!(A["P") D
 . S (GMTSFLG,STAT)=0,GMTSCNT=1
 . I A["N",'$D(GMTSPST2(2)) S RXS("D",GMTSSTS_PSOQPDN,1)=""
 . I $$GETSTATUS(PSOQ100)["DISCONTINUED" S STAT=1
 . F PSOQSCT=2:1:$O(GMTSPST2(":"),-1) Q:STAT'=1  D
 . . I $E(GMTSPST2(PSOQSCT),1,3)="to " S GMTSFLG=1
 . . I GMTSFLG,(PSOQSCT<GMTSPST2) S GMTSCNT=GMTSCNT+1,RXS("D",GMTSSTS_PSOQPDN,GMTSCNT)=GMTSPST2(PSOQSCT+1)
 . I (GMTSFLG=0) F PSOQSCT=2:1:$O(GMTSPST2(":"),-1) S RXS("D",GMTSSTS_PSOQPDN,PSOQSCT)=GMTSPST2(PSOQSCT)
 K ^TMP($J,"GMTSPST2")
 Q
GETSTATUS(PSOQ100) ;DM-152
 N GMTSPREV,GMTSSTAT
 S GMTSSTAT=""
 S GMTSPREV=$P($G(^OR(100,PSOQ100,3)),U,5)
 S GMTSSTAT=$$GET1^DIQ(100,GMTSPREV_",",5)_U_$$GET1^DIQ(100,PSOQ100_",",5)
 Q GMTSSTAT
GETTYPE(RXIEN) ;
 N RETURN,CLASS,DRUG
 S RETURN="D"
