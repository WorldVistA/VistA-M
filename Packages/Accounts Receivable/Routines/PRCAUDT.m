...
V ;;4.5;Accounts Receivable;**1,21,57,97,143,107,173,321,342,349,446**;Mar 20, 1995;Build 15
...
SIG N PRCADUZ
 ...
 D NOW^%DTC I $D(PRCANM) D
 . ; Replace direct global sets with fileman calls PRCA*4.5*446
 . N FDA,IENS
 . S IENS=PRCABN_","
 . S FDA(430,IENS,90)=$S('$G(PRAUTOA):+DUZ,1:PRCADUZ)
 . S FDA(430,IENS,91)=PRCANM
 . S FDA(430,IENS,92)=%
 . D FILE^DIE("","FDA")
 . S PRCASIG=1
 Q
SIG1 S PRCANM=$P($G(^VA(200,DUZ,20)),U,2) I PRCANM]"" D EN^PRCASIG(.PRCANM,DUZ,PRCABN_+$P(^PRCA(430,PRCABN,0),U,3))
 ; Replace direct global sets with fileman calls PRCA*4.5*446
 N FDA,IENS
 S IENS=PRCABN_","
 S FDA(430,IENS,91)=PRCANM
