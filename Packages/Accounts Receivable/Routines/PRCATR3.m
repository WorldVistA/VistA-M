PRCATR3 ; GENERATED FROM 'PRCA TRANS PROFILE' PRINT TEMPLATE (#421) ; 10/11/16 ; (FILE 433, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 S X=$G(^PRCA(433,D0,8)) D T Q:'DN  W ?12,$E($P(X,U,6),1,75)
  D N:$X>12 Q:'DN  W ?12 S I(1)=7,J(1)=433.041 F D1=0:0 Q:$O(^PRCA(433,D0,7,D1))'>0  S D1=$O(^(D1)) D:$X>89 T Q:'DN  D A1
 G A1R
A1 ;
