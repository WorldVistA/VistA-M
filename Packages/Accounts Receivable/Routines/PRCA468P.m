PRCA468P ;MNTVBB/RFS - Update for Annual Interest Rate in File 342 AR SITE PARAMETER ;11/20/25
 ;;4.5;Accounts Receivable;**468**;Mar 20, 1995;Build 1
...
PRCANEW ;Add new rates in File 342 AR SITE PARAMETER
 ...
 .S DA=X
 .S DIE="^RC(342,"_DA(1)_",4,",DR=".01///3260101;.02///.05;.03///1.68;.04///.06;.05///389.75"
 .D ^DIE
 .K DIE,DR,DA,DA(1)
 .D BMES^XPDUTL("** Done **")
 .Q
 S X=X+1
 K DO
 S DIC="^RC(342,"_DA(1)_",4,",DIC(0)="L",DIC("DR")=".01///3260101;.02///.05;.03///1.68;.04///.06;.05///389.75"
