...
PRINT ;
 ...
 I $G(FBSSNRF)="" W !!,FBNAME,?32,FBID,?48,$P(VAEL(1),"^",2),!?3,FBTYPE," DATE: ",$$DATX^FBAAUTL(FBDT),?36,FBTYPE," TYPE: ",$E(FB("TP"),1,28)
 I $G(FBSSNRF)=1 W !!,$E(FBNAME,1,20)," (",$P(FBID,"-",3),")",?29,$$GETICN^FBAAUTL(DFN),?48,$P(VAEL(1),"^",2),!?3,FBTYPE," DATE: ",$$DATX^FBAAUTL(FBDT),?36,FBTYPE," TYPE: ",$E(FB("TP"),1,28)
