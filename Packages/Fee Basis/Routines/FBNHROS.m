...
START U IO W:$E(IOST,1,2)["C-" @IOF K ^TMP($J)
 ...
 .D:FBHED HED
 .I $G(FBSSNRF)="" W !?4,$P(FBP,";"),?37,FBSSN,?53,$$DATX^FBAAUTL(FBAD),?66,$$DATX^FBAAUTL(FBTD)
 .I $G(FBSSNRF)=1 W !?4,$E($P(FBP,";"),1,20)," (",$P(FBSSN,"-",3),")",?33,$$GETICN^FBAAUTL(FBDFN),?53,$$DATX^FBAAUTL(FBAD),?66,$$DATX^FBAAUTL(FBTD)
