FBXIP184 ;MNT/BJR - PATCH INSTALL ROUTINE ; 4/7/2021@7:55
 ;;3.5;FEE BASIS;**184**;JAN 30, 1995;Build 4
...
POST ; post-install entry point
 ...
 N FBX
 F FBX="EN" D
 . S Y=$$NEWCP^XPDUTL(FBX,FBX_"^FBXIP184")
...
EN ; Begin Post-Install
 ...
 Q
CF ; add conversion factors for calendar year 2021 RBRVS fee schedule
 ...
 D BMES^XPDUTL("  Filing conversion factor for RBRVS 2021 fee schedule.")
 N DD,DO,DA,DIE,DR,X,Y
 S DA(1)=0 F  S DA(1)=$O(^FB(162.99,DA(1))) Q:'DA(1)  D
 . S DA=$O(^FB(162.99,DA(1),"CY","B",2021,0))
 . I DA'>0 D  Q:DA'>0
 ...
 . S DR=".02///"_$S(DA(1)=1:21.56,1:34.8931)
 . D ^DIE
 Q
 ;FBXIP184
