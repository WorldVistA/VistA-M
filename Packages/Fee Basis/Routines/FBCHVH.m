FBCHVH ;AISC/DMK - VENDOR PAYMENT HISTORY ;7/17/2003
 ;;3.5;FEE BASIS;**55,61,122,108,135,144,123,164,194**;JAN 30, 1995;Build 8
...
WRT I $Y+6>IOSL D HANG^FBAAUTL1:$E(IOST,1,2)["C-" Q:FBAAOUT  I $D(^FBAAI(FBI,4)) D HEDC
 ...
 I $G(FBSSNRF)="" W VADM(1)_"  "_$P(VADM(2),"^",2),?48,FBCSID
 I $G(FBSSNRF)=1 W $E(VADM(1),1,20)," (",$$SSN^FBAAUTL(DFN,1),")",?29,$$GETICN^FBAAUTL(DFN),?48,FBCSID
