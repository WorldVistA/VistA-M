FBXIP183 ;MNT/BJR - PATCH INSTALL ROUTINE ; 4/23/2020@10:54
 ;;3.5;FEE BASIS;**183**;JAN 30, 1995;Build 2
...
POST ; post-install entry point
 ...
 N FBX
 F FBX="EN" D
 . S Y=$$NEWCP^XPDUTL(FBX,FBX_"^FBXIP183")
...
EN ; Begin Post-Install
 ...
 Q
CF ; add conversion factors for calendar year 2020 RBRVS fee schedule
 ...
 D BMES^XPDUTL("  Filing conversion factor for RBRVS 2020 fee schedule.")
 N DD,DO,DA,DIE,DR,X,Y
 S DA(1)=0 F  S DA(1)=$O(^FB(162.99,DA(1))) Q:'DA(1)  D
 . S DA=$O(^FB(162.99,DA(1),"CY","B",2020,0))
 . I DA'>0 D  Q:DA'>0
 ...
 . S DR=".02///"_$S(DA(1)=1:22.2774,1:36.0896)
 . D ^DIE
 Q
 ;FBXIP183
