FBCHCR ;AISC/CMR-CIVIL HOSPITAL COST REPORT ;7/23/01
 ;;3.5;FEE BASIS;**32,194**;JAN 30, 1995;Build 8
...
PRINT I $Y+5>IOSL W !!!?22,"** Indicates an Ancillary Payment"
 ...
 I $G(FBSSNRF)=1 D
 . W !,$E(FBNAME,1,23),?24,$$SSNL4^FBAAUTL($$SSN^FBAAUTL(DFN)),?40
 . W $S(FBREF="FB7078":$P(^FB7078(FBREF1,0),"^"),1:$$DATX^FBAAUTL($P(^FB583(FBREF1,0),"^"))),?53,$S($G(FBAMT):$J($FN(FBAMT,",",2),10),1:""),?63,$S(FBANC:"**",1:""),?71,FBDRG,?75,$J(FBLOS,5)
 I $G(FBSSNRF)="" D
