FBCNHCEN ;AISC/CMR-CNH/CH CENSUS DATA ;1/13/98
 ;;3.5;FEE BASIS;**12,194**;JAN 30, 1995;Build 8
...
PRINT I $Y+3>IOSL,($E(IOST,1,2)["C-") S DIR(0)="E" D ^DIR K DIR I 'Y S FBAAOUT=1 Q
 ...
 I $G(FBSSNRF)="" W !?4,FBNAME,?32,$$FMTE^XLFDT(FBDOB),?46,$$SSN^FBAAUTL(DFN),?60,$$PSA^FBAAUTL5(FBPSA),?67,$$FMTE^XLFDT(FBAFD)
 I $G(FBSSNRF)=1 W !?4,FBNAME,?32,$$FMTE^XLFDT(FBDOB),?46,$$SSNL4^FBAAUTL($$SSN^FBAAUTL(DFN)),?60,$$PSA^FBAAUTL5(FBPSA),?67,$$FMTE^XLFDT(FBAFD)
 Q
