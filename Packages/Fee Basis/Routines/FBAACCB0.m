FBAACCB0 ;AISC/GRR-CLERK CLOSE BATCH CONTINUED ;5/12/1999
 ;;3.5;FEE BASIS;**5,4,116,194**;JAN 30, 1995;Build 8
...
ENT S FBAAOUT=0
 ...
 Q
HEDP I $G(FBSSNRF)="" W ?23,"'+' Represents Cancellation Activity",!?4,"Patient Name",?36,"SSN",?49,"Date",?56,"Travel Amount",!,Q,! Q
 I $G(FBSSNRF)=1 W ?23,"'+' Represents Cancellation Activity",!?4,"Patient Name",?36,"ICN",?49,"Date",?56,"Travel Amount",!,Q,! Q
WRTT I $Y+7>IOSL D ASKH:$E(IOST,1,2)["C-" Q:FBAAOUT  W @IOF D HEDP
 I (A2'=".00"),$G(FBSSNRF)="" W !,$S($D(QQ):QQ_") ",1:""),$S($G(FBCAN)]"":"+",1:""),?4,N,?32,$E(S,1,3),"-",$E(S,4,5),"-",$E(S,6,10),?47,$E(D,4,5),"/",$E(D,6,7),"/",$E(D,2,3),?59,"$ ",$J(A2,4,2)  D PMNT^FBAACCB2 Q
 I (A2'=".00"),$G(FBSSNRF)=1 W !,$S($D(QQ):QQ_") ",1:""),$S($G(FBCAN)]"":"+",1:""),?4,$E(N,1,15)," (",$E(S,6,10),")",?28,$$GETICN^FBAAUTL(J),?47,$E(D,4,5),"/",$E(D,6,7),"/",$E(D,2,3),?59,"$ ",$J(A2,4,2)  D PMNT^FBAACCB2 Q
