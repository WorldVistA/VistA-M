FBNHDEC ;AISC/GRR-DISPLAY EPISODE OF CARE ;25AUG88
 ;;3.5;FEE BASIS;**194**;JAN 30, 1995;Build 8
...
HED I $G(FBSSNRF)="" W @IOF,"Veteran: ",$P(^DPT(DFN,0),"^",1),?43,"SSN: ",$$SSN^FBAAUTL(DFN),!,?5,"Date/Time",?25,"Transaction",?42,"Type",!  ;194
 I $G(FBSSNRF)=1 W @IOF,"Veteran: ",$P(^DPT(DFN,0),"^",1)," (",$P($$SSN^FBAAUTL(DFN),"-",3),")",?43,"ICN: ",$$GETICN^FBAAUTL(DFN),!,?5,"Date/Time",?25,"Transaction",?42,"Type",!  ;194
 Q
ADDT ;;
