FBXIP179 ;ALB/BJR - PATCH INSTALL ROUTINE ;2/14/2017 1:59pm
 ;;3.5;FEE BASIS;**179**;JAN 30, 1995;Build 7
...
POST ; post-install entry point
 ...
 N FBX
 F FBX="EN" D
 . S Y=$$NEWCP^XPDUTL(FBX,FBX_"^FBXIP179")
...
EN ; Begin Post-Install
 ...
 Q
CF ; add conversion factors for calendar year 2018 RBRVS fee schedule
 ...
 D BMES^XPDUTL("  Filing conversion factor for RBRVS 2018 fee schedule.")
 N DD,DO,DA,DIE,DR,X,Y
 S DA(1)=0 F  S DA(1)=$O(^FB(162.99,DA(1))) Q:'DA(1)  D
 . S DA=$O(^FB(162.99,DA(1),"CY","B",2018,0))
 . I DA'>0 D  Q:DA'>0
 ...
 . S DR=".02///"_$S(DA(1)=1:22.1887,1:35.9996)
 . D ^DIE
 Q
 ;FBXIP179
