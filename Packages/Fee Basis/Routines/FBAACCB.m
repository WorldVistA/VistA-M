FBAACCB ;AISC/GRR - CLERK CLOSE BATCH ;7/9/14  16:16
 ;;3.5;FEE BASIS;**4,61,77,116,154,164,194**;JAN 30, 1995;Build 8
...
WRT I $Y+8>IOSL D ASKH^FBAACCB0:$E(IOST,1,2)["C-" Q:FBAAOUT  W @IOF D HED
 ...
 I $G(FBSSNRF)="" W !!,N,?35,$$SSN^FBAAUTL(J),?58,B(1617),?67,$$DATX^FBAAUTL($G(FBVCHDT)),!,?3,V,?42,VID,?55,FBIN,?67,$$DATX^FBAAUTL(FBIN(1))
 I $G(FBSSNRF)=1 W !!,$E(N,1,25)," (",$P($$SSN^FBAAUTL(J),"-",3),")",?35,$$GETICN^FBAAUTL(J),?58,B(1617),?67,$$DATX^FBAAUTL($G(FBVCHDT)),!,?3,V,?42,VID,?55,FBIN,?67,$$DATX^FBAAUTL(FBIN(1))
