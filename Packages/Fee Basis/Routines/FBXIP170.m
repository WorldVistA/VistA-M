FBXIP170 ;ALB/BJR-PATCH INSTALL ROUTINE ; 10/06/2015 12:59pm
 ;;3.5;FEE BASIS;**170**;JAN 30, 1995;Build 5
...
POST ; post-install entry point
 ...
 N FBX
 F FBX="EN" D
 . S Y=$$NEWCP^XPDUTL(FBX,FBX_"^FBXIP170")
...
EN ; Begin Post-Install
 ...
 Q
CF ; add conversion factors for calendar year 2016 RBRVS fee schedule
 ...
 D BMES^XPDUTL("  Filing conversion factor for RBRVS 2016 fee schedule.")
 N DD,DO,DA,DIE,DR,X,Y
 S DA(1)=0 F  S DA(1)=$O(^FB(162.99,DA(1))) Q:'DA(1)  D
 . S DA=$O(^FB(162.99,DA(1),"CY","B",2016,0))
 . I DA'>0 D  Q:DA'>0
 ...
 . S DR=".02///"_$S(DA(1)=1:22.4426,1:35.8043)
 . D ^DIE
 Q
 ;FBXIP170
