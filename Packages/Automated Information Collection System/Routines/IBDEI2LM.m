...
Q Q
 ...
 ;;=^IBE(358.4,
 ;;^UTILITY(U,$J,358.4,0)
 ;;=IMP/EXP SELECTION GROUP^358.4I^2118^2118
 ...
 ;;=INPT or OBS ADMIT & D/C SAME STAY^11^2
 ...
 ;;=DEMENTIA/NEUROCOGNITIVE DISORDERS^9^3
 ;;^UTILITY(U,$J,358.4,28,0)
 ;;=DEPRESSIVE DISORDERS^10^3
 ;;^UTILITY(U,$J,358.4,29,0)
 ;;=DISSOCIATIVE DISORDERS ^12^3
 ;;^UTILITY(U,$J,358.4,30,0)
 ;;=EATING & FEEDING DISORDERS^13^3
 ;;^UTILITY(U,$J,358.4,31,0)
 ;;=EDUCATIONAL/OCCUPATIONAL PROBLEMS^14^3
 ;;^UTILITY(U,$J,358.4,32,0)
 ;;=GENDER DYSPHORIA^17^3
 ;;^UTILITY(U,$J,358.4,33,0)
 ;;=HOUSING/ECONOMIC PROBLEMS^18^3
 ;;^UTILITY(U,$J,358.4,34,0)
 ;;=MEDICATION-INDUCED MOVEMENT DISORDERS^20^3
 ;;^UTILITY(U,$J,358.4,35,0)
 ;;=OBSESSIVE-COMPULSIVE & RELATED DISORDERS^22^3
 ;;^UTILITY(U,$J,358.4,36,0)
 ;;=ORGANIC DISORDERS^23^3
 ;;^UTILITY(U,$J,358.4,37,0)
 ;;=PERSONAL HX & CURRENT CIRCUMSTANCES^26^3
 ;;^UTILITY(U,$J,358.4,38,0)
 ;;=ADHD^2^3
 ;;^UTILITY(U,$J,358.4,39,0)
 ;;=COUNSELING/MED ADVICE^6^3
 ;;^UTILITY(U,$J,358.4,40,0)
 ;;=SOCIAL ENVIRONMENT PROBLEMS^33^3
 ;;^UTILITY(U,$J,358.4,41,0)
 ;;=PARAPHILIC DISORDERS^25^3
 ;;^UTILITY(U,$J,358.4,42,0)
 ;;=PERSONALITY DISORDERS^27^3
 ;;^UTILITY(U,$J,358.4,43,0)
 ;;=CRIME/LEGAL SYSTEM PROBLEMS^7^3
 ;;^UTILITY(U,$J,358.4,44,0)
 ;;=PSYCHOSOCIAL/PERSONAL/ENVIRONMENTAL^28^3
 ;;^UTILITY(U,$J,358.4,45,0)
 ;;=RELATIONAL PROBLEMS^29^3
 ;;^UTILITY(U,$J,358.4,46,0)
 ;;=SCHIZOPHRENIA/OTH PSYCHOTIC DISORDERS^30^3
 ;;^UTILITY(U,$J,358.4,47,0)
 ;;=SEXUAL DYSFUNCTION^31^3
 ;;^UTILITY(U,$J,358.4,48,0)
 ;;=SLEEP DISORDERS^32^3
 ;;^UTILITY(U,$J,358.4,49,0)
 ;;=SUBSTANCE ABUSE-ALCOHOL^35^3
 ;;^UTILITY(U,$J,358.4,50,0)
 ;;=SUBSTANCE ABUSE-AMPHETAMINE^36^3
 ;;^UTILITY(U,$J,358.4,51,0)
 ;;=SUBSTANCE ABUSE-CANNABIS^38^3
 ;;^UTILITY(U,$J,358.4,52,0)
 ;;=SUBSTANCE ABUSE-HALLUCINOGEN^40^3
 ;;^UTILITY(U,$J,358.4,53,0)
 ;;=SUBSTANCE ABUSE-OPIOID^42^3
 ;;^UTILITY(U,$J,358.4,54,0)
 ;;=SUBSTANCE ABUSE-PSYCHOACTIVE DRUGS^43^3
 ;;^UTILITY(U,$J,358.4,55,0)
 ;;=SUBSTANCE ABUSE-SEDATIVE/HYPNOTIC^44^3
 ;;^UTILITY(U,$J,358.4,56,0)
 ;;=SUBSTANCE ABUSE-TOBACCO^45^3
 ;;^UTILITY(U,$J,358.4,57,0)
 ;;=SUBSTANCE ABUSE-COCAINE^39^3
