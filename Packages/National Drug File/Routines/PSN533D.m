PSN533D ;BIR/DMA-post install routine to load data ; 04 Oct 2017  3:46 PM
 ...
 N ZTDESC,ZTDTH,ZTIO,ZTRTN,ZTSAVE,PSNMULTI,MJJ,MIENS,MFLDS,OFLDS,OIENS
 ...
 .I FILE=50.68,(FLDS="14,.01")&(IENS[",") I $D(^PSNDF(50.68,+DIA,2,0)) S CNT1=0 D
 ..F  S CNT1=$O(^PSNDF(50.68,+DIA,2,CNT1)) Q:CNT1=""  S DIK="^PSNDF(50.68,"_+DIA_",2,",DA=CNT1,DA(1)=+DIA D ^DIK
 .;
 .I $G(PSNMULTI) D
