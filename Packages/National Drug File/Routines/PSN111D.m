PSN111D ;BIR/DMA-post install routine to load data ; 31 Jan 2006  1:57 PM
 ;;4.0; NATIONAL DRUG FILE;**111**; 30 Oct 98
 ;
 ; Reference to ^PSDRUG supported by DBIA #2192
 ; Reference to PSN^PSSHUIDG supported by DBIA #3621
 ; Reference to ^GMR(120.8) supported by DBIA #4606
 ;
 N CL,CLA,CMOP,CT,DA,DA1,DIA,DIC,DIE,DIK,DINUM,DR,FDA,FILE,FLDS,GE,GROOT,GROOT1,IENS,IN,INA,IND,INDX,INV,J,JJ,K,LI,LINE,NA,NAME,ND,NEW,NFI,POST,PR,PSN,PSN1,PSN11,PSN21,PSNDF,R1,ROOT,ROOT1,ROOT2,ROOT3,SUBS,VAC,VAIN,VAPN,X,XMDUZ,XMSUB,XMTEXT,XMY,XMZ
