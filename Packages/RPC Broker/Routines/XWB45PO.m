...
EN ;
 ...
 S XVALS(1)="XUSBSE TEST1^XWB BROKER EXAMPLE^{h6'={zC3{8=-JP1!O^R^9502^127.0.0.1"
 S XVALS(2)="XUSBSE TEST2^XWB BROKER EXAMPLE^]?zvB$<ZwW6e$yG&9S<^M^9502^127.0.0.1"
 S XVALS(3)="XUSBSE TEST3^XWB BROKER EXAMPLE^9~ioRB[m`Q9yS?/j?q?5^H^80^127.0.0.1"
 N I F I=1:1:3 D
 . W !,I
