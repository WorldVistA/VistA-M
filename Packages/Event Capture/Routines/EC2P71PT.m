EC2P71PT ;ALB/GTS/JAP/GT - PATCH EC*2.0*71 Post-Init Rtn ;1/05/2005 
...
ENTUP ; 
 ...
 D ADDPROC^EC725U30  ;add new procedures
 D NAMECHG^EC725U30  ;change desription
 D CPTCHG^EC725U31   ;change CPT code
 D INACT^EC725U31   ;inactivate code
 D REACT^EC725U31    ;reactivate code
 ;* set vrrv node (file #725)
 S ECVRRV=$$GET1^DID(725,"","","PACKAGE REVISION DATA")
 S ECVRRV=ECVRRV_"^EC*2*71"
...
MSGTXT ; Message intro
 ...
 ;; after installation of patch EC*2*71 which updated the EC NATIONAL
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P71PT",ZTDESC="File #720.3 Review from EC*2*71",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P71",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
