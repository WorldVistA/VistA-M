EC2P80PT ;ALB/GTS/JAP/GT - PATCH EC*2.0*80 Post-Init Rtn ;01/24/2006 
...
ENTUP ; 
 ...
 D ADDPROC^EC725U38  ;add new procedures
 D NAMECHG^EC725U38  ;change desription
 D CPTCHG^EC725U39  ;change CPT code
 D INACT^EC725U39   ;inactivate code
 D REACT^EC725U39    ;reactivate code
 ;* set vrrv node (file #725)
 S ECVRRV=$$GET1^DID(725,"","","PACKAGE REVISION DATA")
 S ECVRRV=ECVRRV_"^EC*2*80"
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P80PT",ZTDESC="File #720.3 Review from EC*2*80",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P80",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
