...
ENTUP ; 
 ...
 D ADDPROC^EC725U36  ;add new procedures
 D NAMECHG^EC725U36  ;change desription
 D CPTCHG^EC725U37  ;change CPT code
 D INACT^EC725U37   ;inactivate code
 D REACT^EC725U37    ;reactivate code
 ;* set vrrv node (file #725)
 S ECVRRV=$$GET1^DID(725,"","","PACKAGE REVISION DATA")
 S ECVRRV=ECVRRV_"^EC*2*79"
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P79PT",ZTDESC="File #720.3 Review from EC*2*79",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P79",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
