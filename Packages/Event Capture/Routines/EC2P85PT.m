EC2P85PT ;ALB/GTS/JAP/GT - PATCH EC*2.0*85 Post-Init Rtn ;07/24/2006 
...
ENTUP ; 
 ...
 D ADDPROC^EC725U42  ;add new procedures
 D NAMECHG^EC725U42  ;change desription
 D CPTCHG^EC725U43  ;change CPT code
 D INACT^EC725U43   ;inactivate code
 D REACT^EC725U43    ;reactivate code
 ;* set vrrv node (file #725)
 S ECVRRV=$$GET1^DID(725,"","","PACKAGE REVISION DATA")
 S ECVRRV=ECVRRV_"^EC*2*85"
...
MSGTXT ; Message intro
 ...
 ;; after installation of patch EC*2*85 which updated the EC NATIONAL
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P85PT",ZTDESC="File #720.3 Review from EC*2*85",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P85",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
