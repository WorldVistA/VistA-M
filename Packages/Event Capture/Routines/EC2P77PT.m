EC2P77PT ;ALB/GTS/JAP/GT - PATCH EC*2.0*77 Post-Init Rtn ;6/29/2005 
...
ENTUP ; 
 ...
 D ADDPROC^EC725U34  ;add new procedures
 D NAMECHG^EC725U34  ;change desription
 D CPTCHG^EC725U35  ;change CPT code
 D INACT^EC725U35   ;inactivate code
 D REACT^EC725U35    ;reactivate code
 ;* set vrrv node (file #725)
 S ECVRRV=$$GET1^DID(725,"","","PACKAGE REVISION DATA")
 S ECVRRV=ECVRRV_"^EC*2*77"
...
MSGTXT ; Message intro
 ...
 ;; after installation of patch EC*2*77 which updated the EC NATIONAL
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P77PT",ZTDESC="File #720.3 Review from EC*2*77",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P77",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
