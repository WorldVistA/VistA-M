EC725U22 ;ALB/GTS/JAP/GT - EC National Procedure Update; 9/11/2003
...
NEW ;national procedures to add;;descript^nation #^CPT code^beg seq^end seq
 ;;NONVIDEO MONIT UNSPECIF PROGRM^CC001
 ;;NONVIDEO MONIT CD CARDIAC DIS^CC002
 ;;NONVIDEO MONIT CG COAG MGMT^CC003
 ;;NONVIDEO MONIT DE DEMENTIA^CC004
 ;;NONVIDEO MONIT DM DIABETES MEL^CC005
 ;;NONVIDEO MONIT HT HYPERTENSION^CC006
 ;;NONVIDEO MONIT ID INFECTIOUS D^CC007
 ;;NONVIDEO MONIT MH MENTAL HLTH^CC008
 ;;NONVIDEO MONIT MM MULT COMORB^CC009
 ;;NONVIDEO MONIT PL PALLIATIVE^CC010
 ;;NONVIDEO MONIT PN PAIN MGMT^CC011
 ;;NONVIDEO MONIT PD PULMONARY D^CC012
 ;;NONVIDEO MONIT RH REHAB^CC013
 ;;NONVIDEO MONIT SC SPINAL CORD^CC014
 ;;NONVIDEO MONIT WC WOUND CARE^CC015
 ;;HH PURCH VISITS/MO-CHIROPRACTR^HH127
 ;;HH REF VA PD CHIROPRACTR^HH128
 ;;HH REF END VA PD CHIROPRACTR^HH129
 ;;QUIT
