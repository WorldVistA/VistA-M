EC2P22PT ;ALB/GTS/JAP/JAM - PATCH EC*2.0*22 Post-Init Rtn ; 12/10/99
...
MSGTXT ; Message intro
 ...
 ;; after installation of patch EC*2*22 which updated the EC NATIONAL
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P22PT",ZTDESC="File #720.3 Review from EC*2*22",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P22",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
