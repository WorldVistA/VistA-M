EC2P26PT ;ALB/GTS/JAP/JAM - PATCH EC*2.0*26 Post-Init Rtn ; 10/27/00
...
MSGTXT ; Message intro
 ...
 ;; after installation of patch EC*2*26 which updated the EC NATIONAL
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P26PT",ZTDESC="File #720.3 Review from EC*2*26",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P26",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
