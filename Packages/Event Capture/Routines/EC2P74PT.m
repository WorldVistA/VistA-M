EC2P74PT ;ALB/GTS/JAP/GT - PATCH EC*2.0*74 Post-Init Rtn ;4/07/2005 
...
ENTUP ; 
 ...
 D ADDPROC^EC725U32  ;add new procedures
 D NAMECHG^EC725U32  ;change desription
 D CPTCHG^EC725U33   ;change CPT code
 D INACT^EC725U33   ;inactivate code
 D REACT^EC725U33    ;reactivate code
 ;* set vrrv node (file #725)
 S ECVRRV=$$GET1^DID(725,"","","PACKAGE REVISION DATA")
 S ECVRRV=ECVRRV_"^EC*2*74"
...
MSGTXT ; Message intro
 ...
 ;; after installation of patch EC*2*74 which updated the EC NATIONAL
...
F7203 ;* inspect/report 720.3
 ...
 D BMES^XPDUTL("  ")
 S ZTRTN="F7203Q^EC2P74PT",ZTDESC="File #720.3 Review from EC*2*74",ZTIO=""
...
LINE(TEXT) ; Add line to message global
 S COUNT=COUNT+1,^TMP($J,"EC2P74",COUNT)=TEXT
 Q
 ;
MAIL ; Send message
