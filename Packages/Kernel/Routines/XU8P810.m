XU8P810 ; OAK/CKU - Post-Install for 810 ; Nov 19, 2024@18:29:06
 ;;8.0;KERNEL;**810**;Jul 10, 1995;Build 16
 ;Per VA Directive 6402, this routine should not be modified.
 ;  Post Installation Routine for patch XU*8.0*801
 ;
...
MAIN ; Control subroutine
 N XU8ERRX,XU8DATA
 ;
 ; "XU PKI ORR" to record Micro Focus Reflection access in the SIGN-ON LOG
 K XU8DATA
 S XU8DATA(1)="XU PKI ORR" ; Name
 S XU8DATA(2)="XUS SIGNON" ; Context Option
 S XU8DATA(4)="u25/Zyg8BBX10821WSQ1ZFZZysVm9hWJSdMDikAjQ1o=" ; Security phrase (already hashed using sha256)
...
CREATE(XU8DATA) ; Create new REMOTE APPLICATION entry
 ...
 S XU8FDA(8994.5,"?+1,",.03)=XU8DATA(4) ; APPLICATIONCODE
 D UPDATE^DIE("","XU8FDA","XU8IEN","XU8MSG")
 I $D(XU8MSG) D
