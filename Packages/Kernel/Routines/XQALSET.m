XQALSET ;ISC-SF.SEA/JLI - SETUP ALERTS ;Apr 01, 2025  @14:43
 ;;8.0;KERNEL;**1,6,65,75,114,125,173,207,285,443,602,653,816**;Jul 10, 1995;Build 1
...
SETIEN(XQA1,XQI) ; determine unique XQAID value for alert
 ...
 . I $D(^XTV(8992.1,"B",XQAID)) Q  ; Patch 816
