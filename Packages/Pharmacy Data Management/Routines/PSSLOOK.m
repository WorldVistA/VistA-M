PSSLOOK ;BIR/WRT-Drug file lookup ; 17 Jan 2018  10:59 AM
 ;;1.0;PHARMACY DATA MANAGEMENT;**3,7,15,16,20,24,29,38,68,61,87,90,127,147,170,189,192,200,195,213,203**;9/30/97;Build 14
 ;
...
GETDATA S NODE0=^PSDRUG(IFN,0),GN=$P(NODE0,"^",1),CL=$P(NODE0,"^",2),DEA=$P(NODE0,"^",3),WRN=$P(NODE0,"^",8),NF=$P(NODE0,"^",9),MESS=$P(NODE0,"^",10),VNF=$P(NODE0,"^",11),CLASS="",WARN="" S:NF=1 NF="N/F" S:VNF=1 VNF="V-N/F"
 ...
 D GETS^DIQ(50.03,PSSMAX_","_IFN_",","*","E","PSSDAT","PSSERR")
 S PSSDT=$G(PSSDAT(50.03,PSSMAX_","_IFN_",",.01,"E"))
 S PSSUSR=$G(PSSDAT(50.03,PSSMAX_","_IFN_",",1,"E"))
 S PSSVAL=$G(PSSDAT(50.03,PSSMAX_","_IFN_",",3,"E"))
