PSSJXR ; DRIVER FOR COMPILED XREFS FOR FILE #55 ; 08/27/19
 ; 
...
DI S DIKM1=0,DIKUM=0,DA(0)="",DV=0 F  S DV=$O(DA(DV)) Q:DV'>0  S DIKUM=DIKUM+1,DIKUP(DV)=DA(DV)
 ...
 I $D(DIKKS) D:DIKZ1=DH(1) ^PSSJXR1 S DA=DIKUP D:DIKZ1=DH(1) ^PSSJXR21 D:DIKZ1'=DH(1) KILL D:DIKZ1'=DH(1) DA D:DIKZ1'=DH(1) SET D DA Q
 I $D(DIKIL) D:DIKZ1=DH(1) ^PSSJXR1 S:DIKZ1=DH(1) DIKM1=1 D:DIKZ1'=DH(1) KILL S DA=DIKUP D:DIKM1>0 KIL1 D DA Q
 I $D(DIKST) D:DIKZ1=DH(1) ^PSSJXR21 D:DIKZ1'=DH(1) SET D DA Q
...
C I @("$O("_DIK_"DA))'>0") S DA=$$C1(DA),^(0)=$P(@(DIK_"0)"),U,1,2)_U_DA_U_DCNT K DCNT L:$D(DIKLK) -@DIKLK Q
 S (DIKY,DA)=$O(^(DA)) G C:$P($G(^(DA,0)),U)']"" S DU=1,DCNT=DCNT+1 S:DA="" (DIKY,DA)=-1 D:DIKZ1=DH(1) ^PSSJXR21 D:DIKZ1'=DH(1) SET D:DIKZ1'=DH(1) DA K DB(0) S DA=DIKY G C
 Q
...
KILL S DIKILL=1,DIKZK=2
 ...
 I DIKZ1=55.05,DIKUM'<1 S DIKM1=1 D A1^PSSJXR7,A1^PSSJXR11 Q
 I DIKZ1=55.051,DIKUM'<2 S DIKM1=2 D A1^PSSJXR11 Q
 I DIKZ1=55.06,DIKUM'<1 S DIKM1=1 D A1^PSSJXR8,A1^PSSJXR12,A1^PSSJXR13,A1^PSSJXR14,A1^PSSJXR19,A1^PSSJXR20 Q
 ...
 I DIKZ1=55.6114,DIKUM'<2 S DIKM1=2 D A1^PSSJXR19 Q
 I DIKZ1=55.6132,DIKUM'<2 S DIKM1=2 D A1^PSSJXR20 Q
 Q
SET S DISET=1,DIKZK=1 K DIKPUSH
 I DIKZ1=55.01,DIKUM'<1 S DIKM1=1 D A1^PSSJXR22,A1^PSSJXR30,A1^PSSJXR35,A1^PSSJXR36,A1^PSSJXR37 Q
 I DIKZ1=55.0105,DIKUM'<1 S DIKM1=1 D A1^PSSJXR23 Q
 I DIKZ1=55.0108,DIKUM'<1 S DIKM1=1 D A1^PSSJXR24 Q
 I DIKZ1=55.0109,DIKUM'<1 S DIKM1=1 D A1^PSSJXR25 Q
 I DIKZ1=55.02,DIKUM'<2 S DIKM1=2 D A1^PSSJXR30 Q
 I DIKZ1=55.03,DIKUM'<1 S DIKM1=1 D A1^PSSJXR26 Q
 I DIKZ1=55.05,DIKUM'<1 S DIKM1=1 D A1^PSSJXR27,A1^PSSJXR31 Q
 I DIKZ1=55.051,DIKUM'<2 S DIKM1=2 D A1^PSSJXR31 Q
 I DIKZ1=55.06,DIKUM'<1 S DIKM1=1 D A1^PSSJXR28,A1^PSSJXR32,A1^PSSJXR33,A1^PSSJXR34,A1^PSSJXR39,A1^PSSJXR40 Q
 I DIKZ1=55.0611,DIKUM'<2 S DIKM1=2 D A1^PSSJXR32 Q
 I DIKZ1=55.07,DIKUM'<2 S DIKM1=2 D A1^PSSJXR33 Q
 I DIKZ1=55.09,DIKUM'<2 S DIKM1=2 D A1^PSSJXR34 Q
 I DIKZ1=55.11,DIKUM'<2 S DIKM1=2 D A1^PSSJXR35 Q
 I DIKZ1=55.1138,DIKUM'<2 S DIKM1=2 D A1^PSSJXR36 Q
 I DIKZ1=55.1153,DIKUM'<2 S DIKM1=2 D A1^PSSJXR37 Q
 I DIKZ1=55.17,DIKUM'<1 S DIKM1=1 D A1^PSSJXR29,A1^PSSJXR38 Q
 I DIKZ1=55.174,DIKUM'<2 S DIKM1=2 D A1^PSSJXR38 Q
 I DIKZ1=55.6114,DIKUM'<2 S DIKM1=2 D A1^PSSJXR39 Q
 I DIKZ1=55.6132,DIKUM'<2 S DIKM1=2 D A1^PSSJXR40 Q
 Q
