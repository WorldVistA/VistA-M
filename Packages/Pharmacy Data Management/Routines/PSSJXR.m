PSSJXR ; DRIVER FOR COMPILED XREFS FOR FILE #55 ; 09/12/12
 ; 
...
DI S DIKM1=0,DIKUM=0,DA(0)="",DV=0 F  S DV=$O(DA(DV)) Q:DV'>0  S DIKUM=DIKUM+1,DIKUP(DV)=DA(DV)
 ...
 I $D(DIKKS) D:DIKZ1=DH(1) ^PSSJXR1 S DA=DIKUP D:DIKZ1=DH(1) ^PSSJXR18 D:DIKZ1'=DH(1) KILL D:DIKZ1'=DH(1) DA D:DIKZ1'=DH(1) SET D DA Q
 I $D(DIKIL) D:DIKZ1=DH(1) ^PSSJXR1 S:DIKZ1=DH(1) DIKM1=1 D:DIKZ1'=DH(1) KILL S DA=DIKUP D:DIKM1>0 KIL1 D DA Q
 I $D(DIKST) D:DIKZ1=DH(1) ^PSSJXR18 D:DIKZ1'=DH(1) SET D DA Q
...
C I @("$O("_DIK_"DA))'>0") S DA=$$C1(DA),^(0)=$P(@(DIK_"0)"),U,1,2)_U_DA_U_DCNT K DCNT L:$D(DIKLK) -@DIKLK Q
 S (DIKY,DA)=$O(^(DA)) G C:$P($G(^(DA,0)),U)']"" S DU=1,DCNT=DCNT+1 S:DA="" (DIKY,DA)=-1 D:DIKZ1=DH(1) ^PSSJXR18 D:DIKZ1'=DH(1) SET D:DIKZ1'=DH(1) DA K DB(0) S DA=DIKY G C
 Q
C1(A) Q:$P($G(@(DIK_"A,0)")),U)]"" A
 F  S @("A=+$O("_DIK_"A),-1)") Q:$P($G(@(DIK_"A,0)")),U)]""!(A'>0)
 Q A
KILL S DIKILL=1,DIKZK=2
 I DIKZ1=55.01,DIKUM'<1 S DIKM1=1 D A1^PSSJXR2,A1^PSSJXR8,A1^PSSJXR13,A1^PSSJXR14,A1^PSSJXR15 Q
 ...
 I DIKZ1=55.06,DIKUM'<1 S DIKM1=1 D A1^PSSJXR7,A1^PSSJXR10,A1^PSSJXR11,A1^PSSJXR12,A1^PSSJXR16,A1^PSSJXR17 Q
 ...
 I DIKZ1=55.1153,DIKUM'<2 S DIKM1=2 D A1^PSSJXR15 Q
 I DIKZ1=55.6114,DIKUM'<2 S DIKM1=2 D A1^PSSJXR16 Q
 I DIKZ1=55.6132,DIKUM'<2 S DIKM1=2 D A1^PSSJXR17 Q
 Q
SET S DISET=1,DIKZK=1 K DIKPUSH
 I DIKZ1=55.01,DIKUM'<1 S DIKM1=1 D A1^PSSJXR19,A1^PSSJXR25,A1^PSSJXR30,A1^PSSJXR31,A1^PSSJXR32 Q
 I DIKZ1=55.0105,DIKUM'<1 S DIKM1=1 D A1^PSSJXR20 Q
 I DIKZ1=55.0108,DIKUM'<1 S DIKM1=1 D A1^PSSJXR21 Q
 I DIKZ1=55.02,DIKUM'<2 S DIKM1=2 D A1^PSSJXR25 Q
 I DIKZ1=55.03,DIKUM'<1 S DIKM1=1 D A1^PSSJXR22 Q
 I DIKZ1=55.05,DIKUM'<1 S DIKM1=1 D A1^PSSJXR23,A1^PSSJXR26 Q
 I DIKZ1=55.051,DIKUM'<2 S DIKM1=2 D A1^PSSJXR26 Q
 I DIKZ1=55.06,DIKUM'<1 S DIKM1=1 D A1^PSSJXR24,A1^PSSJXR27,A1^PSSJXR28,A1^PSSJXR29,A1^PSSJXR33,A1^PSSJXR34 Q
 ...
 I DIKZ1=55.1153,DIKUM'<2 S DIKM1=2 D A1^PSSJXR32 Q
 I DIKZ1=55.6114,DIKUM'<2 S DIKM1=2 D A1^PSSJXR33 Q
 I DIKZ1=55.6132,DIKUM'<2 S DIKM1=2 D A1^PSSJXR34 Q
 Q
