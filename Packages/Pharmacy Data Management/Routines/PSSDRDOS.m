PSSDRDOS ;BIR/RTR - Display Dosing related information for DRUG File(#50) entry ; Aug 20, 2011@16:00
 ;;1.0;PHARMACY DATA MANAGEMENT;**160,173,195,178,206,254**;9/30/97;Build 109
 ;
...
NGC ;Print First Databank data from Dosing records
 ...
 .S PSSDCR2=$G(^TMP($J,"PSSFDBDI",PSSVVHGC,"doseRanges",PSSDCR1,1,0))  ;254
 .Q:($$UPPER^PSSHRCOM($P(PSSDCR2,"^",4)))'="SINGLE DOSE"&($$UPPER^PSSHRCOM($P(PSSDCR2,"^",4))'="MAINTENANCE")  ;254
 .S:$P(PSSDCR2,"^",6)'="" PSSDCRMR($P(PSSDCR2,"^",6))=""  ;254
 ...
 .F PSSDCR8=2,4,6,8 D
 ..S:$P(PSSDCR5,"^",PSSDCR8)'="" PSSDCRUN($P(PSSDCR5,"^",PSSDCR8))="" S:$P(PSSDCR6,"^",PSSDCR8)'="" PSSDCRUN($P(PSSDCR6,"^",PSSDCR8))=""  ;254
 .F PSSDCR8=2,4 D
 ..S:$P(PSSDCR7,"^",PSSDCR8)'="" PSSDCRUN($P(PSSDCR7,"^",PSSDCR8))=""  ;254
