PSSPRICE ;EPIP/WC - PHARMACY PRICE TRACKER FILE 50;03-06-2017  ; 20 Dec 2017  8:18 AM
 ;;1.0;PHARMACY DATA MANAGEMENT;**203**;2/28/17;Build 14
 Q  ; call by line tag
...
HIS ;LOGS CHANGES IN FILE 50 HISTORY PRICE DISPENSE #950
 ; first delete any price updates greater than 60 days old from multiple
 ...
 N FDA
 S FDA(50.03,"?+1,"_PSSIEN_",",.01)=PSSTIME
 S FDA(50.03,"?+1,"_PSSIEN_",",1)=PSSDUZ
 S FDA(50.03,"?+1,"_PSSIEN_",",3)=PSSNEW
 D UPDATE^DIE("","FDA")
