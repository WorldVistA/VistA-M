WVALERTR ;HIOFO/FT - RETURN RADIOLOGY/NM REPORT IN TMP GLOBAL  ;10/15/19
...
EN(WVIEN,DIAGNS) ; Set up radiology report data
 N LOOP,WVDUP,WVERR,WVIENS,WVJCN,WVJCN1,WVLCNT,WVRADCSE,WVRADDFN,WVSECDXS
 ...
 S CNT=0 F  S CNT=$O(^RADPT(WVRADDFN,"DT",WVRADDTE,"P",WVRADCSE,"DX",CNT)) Q:CNT'>0  D
...
RADREP(WVIENS,WVRPTIEN,WVSECDXS) ;
 ...
 S DIAGNS=^TMP($J,"WV RPT",74,WVRPTIEN_",",113,"E")
 I $D(WVSECDXS) D
 .S FIRST=1,WVSECDX=""
