GMRCIUT1 ;SLC/JFR - UTILITIES FOR INTER-FACILITY CONSULTS ; Jul 31, 2025@11:23
 ;;3.0;CONSULT/REQUEST TRACKING;**189,205,207**;DEC 27, 1997;Build 10
...
RESP(GMRCAC,GMRCMID,GMRCOC,GMRCDA,GMRCERR,GMRCMSG) ;
 ...
 ;
 Q:GMRCAC="AA"  ;
 Q:$G(GMRCMSG)=""  ; P207 WTC 7/31/25
 Q:$G(GMRCERR)=206  ; P207 WTC 7/31/25 
 ;
