GMRCISEG ;SLC/JFR - CREATE IFC HL7 SEGMENTS ; Jan 27, 2025@06:03:57
 ;;3.0;CONSULT/REQUEST TRACKING;**22,66,154,202,189,205**;DEC 27, 1997;Build 3
...
ORC(GMRCO,GMRCOC,GMRCOS,GMRCACT)    ;build ORC for all but new orders
 ...
 . N ACTVT S ACTVT=$P(^GMR(123,GMRCO,40,GMRCACT,0),U,2) ; WTC P205 8/15/24
 . I GMRCOC="XX" D  Q
 ...
 . I GMRCOC="SC" D  Q
 .. I GMRCOS="IP" S GMRCPCS(16)="R^RECEIVE^99GMRC" I $$CNVTD^GMRCIEVT(GMRCO),ACTVT=3 S GMRCPCS(16)="U^UNSCHEDULED^99GMRC" ; WTC P205 8/15/24
