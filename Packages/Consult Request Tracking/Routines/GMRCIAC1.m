GMRCIAC1 ;SLC/JFR - FILE IFC ACTIVITIES cont'd ; Jan 27, 2025@06:02:32
 ;;3.0;CONSULT/REQUEST TRACKING;**22,66,73,154,193,201,205**;DEC 27, 1997;Build 3
 ;
...
SF(GMRCAR,GMRCCRNR,GMRCMSGI) ;add significant findings ;MKN GMRC*3*154 added GMRCCRNR and GMRCMSGI
 ...
 I '$$LOCKREC^GMRCUTL1(GMRCDA) D  Q  ;couldn't lock record
 . D APPACK^GMRCIAC2(GMRCDA,"AR",901,GMRCCRNR,GMRCMSGI,$NA(^TMP("GMRCIS",$J))) ;send app. ACK ;MKN GMRC*3*154 added GMRCCRNR and GMRCMSGI. P205 WTC 8/22/24
