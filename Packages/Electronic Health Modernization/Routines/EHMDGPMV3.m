EHMDGPMV3 ;ALB/WTC - EHRM - AUTOMATED PATIENT DISCHARGE TOOL; Jul 24, 2024@13:18:19
...
DR ;select input template for transaction type
 ...
 ;
 ;  Changed template from DGPM DISCHARGE to EHM DGPM DISCHARGE - EHM*1*15.
 S DR=$S(DGPMT=1:"[DGPM ADMIT]",DGPMT=2:"[DGPM TRANSFER]",DGPMT=3:"[EHM DGPM DISCHARGE]",DGPMT=4:"[DGPM CHECK-IN LODGER]",DGPMT=5:"[DGPM LODGER CHECK-OUT]",DGPMT=6:"[DGPM SPECIALTY TRANSFER]",1:"") G Q:DR="" K DQ,DG D ^DIE K DIE ; WTC 7/16/2024
 I $D(Y)#2 S DGPMOUT=1
