PSOORNE5 ;BIR/SAB - display orders from backdoor con't ;Oct 21, 2022@11:20
 ;;7.0;OUTPATIENT PHARMACY;**11,27,32,46,78,99,117,131,146,171,180,210,222,268,206,225,391,444,504,441,545,770**;DEC 1997;Build 145
...
PEN ;pending orders
 ...
 K PSOTPPEX,PSOTPPEN
 I '$G(PSOFIN),$G(PSODFN) S PSOPLCK=$$L^PSSLOCK(PSODFN,0) I '$G(PSOPLCK) S VALMSG=$S($P($G(PSOPLCK),"^",2)'="":$P($G(PSOPLCK),"^",2)_" is working on this patient.",1:"Another person is entering orders for this patient."),VALMBCK="" K PSOPLCK Q
 K PSOPLCK
...
OK S PAT=PSODFN,PSORNSV=ORN,PSORNLT=PSLST D ORD^PSOORFIN S PSLST=PSORNLT,ORD=ORSV,ORN=PSORNSV K ORSV,PSORNSV,PSORNLT,PSODRUG S VALMBCK="R"
 ...
 K:'$G(MEDP) PAT
 D CLEAN^PSOVER1
 I '$G(PSOFIN),$G(PSODFN) D UL^PSSLOCK(PSODFN)
 Q
