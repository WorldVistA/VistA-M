PSOBAI ;BIR/EJW,JAM - BAD ADDRESS PROCESSING ;02/02/2006
 ;;7.0;OUTPATIENT PHARMACY;**233,258,268,264,819**;DEC 1997;Build 6
 ;
 ;External reference PSOBAI^DGADDUTL supported by DBIA 7620
...
UPDATE ;
 ...
 ; PSO*7.0*819 - Call to tag PSOPAT (ICR 7620) for address and cell number edit replaces the code below.
 D PSOPAT^DGADDUTL(DFN)
 D ULK
 ;
