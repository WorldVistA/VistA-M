PSOCAN ;BIR/JMB - Rx discontinue and reinstate ;12/03/18  10:47
 ;;7.0;OUTPATIENT PHARMACY;**11,21,24,27,32,37,88,117,131,185,253,251,375,379,390,413,372,416,508,477,617,781**;DEC 1997;Build 3
...
CHK K VADM,DEAD S DFN=PSODFN D DEM^VADPT I $G(VADM(6))="" S DEAD=0 Q
 N PSOSDA S PSOSDA=DA     ;p781
 S (PSODEATH,DEAD)=1 W !!,?10,VADM(1)_" DIED "_$P($G(VADM(6)),"^",2) D CAN^PSOCAN3 S:'$G(DA) DA=PSOSDA S:'$G(PSODFN) PSODFN=DFN K PSODEATH,PSOSDA     ;p781
 Q
