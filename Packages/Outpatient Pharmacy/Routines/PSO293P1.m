...
MAIL ;
 ...
 . S XMY("ANWER.MOHAMED@FORUM.domain.ext")=""
 . S XMY("WILLIAMSON.ERIC@FORUM.domain.ext")=""
 . S XMY("WILLETTE.CANDY@FORUM.domain.ext")=""
 . S XMY("CONSENTINO.ALBERT@FORUM.domain.ext")=""
 . S XMY("JONES.TRES@FORUM.domain.ext")=""
 . S XMY("BRUUN.JESSE@FORUM.VA.GO")=""
 . S XMY("ROCHA.MARCELO@FORUM.domain.ext")=""
 D SETTXT
 ;
