PSORREF0 ;AITC/BWF,RBD - Remote RX refill API ;12 Dec 2024  4:27 PM
 ;;7.0;OUTPATIENT PHARMACY;**454,497,774**;DEC 1997;Build 15
 ;
...
PROCESS(PSORMSG) ;
 ...
 ; Don't call EN^PSOR52 if Orig. Fill Flagged (PSOOFILL) - RBD *774
 D CHECK Q:$G(PSODF)  G:PSOREF("DFLG") PROCESSX Q:PSOOFILL  D EN^PSOR52(.PSOREF)
