PSOBPSU1 ;BIRM/MFR - BPS (ECME) Utilities 1 ;10/15/04
 ;;7.0;OUTPATIENT PHARMACY;**148,260,281,287,303,289,290,358,359,385,403,427,448,482,512,680,766,767,782**;DEC 1997;Build 11
...
ECMESND(RX,RFL,DATE,FROM,NDC,CMOP,RVTX,OVRC,CNDC,RESP,IGSW,ALTX,CLA,PA,RXCOB,PSOVRIEN,PSOPLAN,PSORTYPE,DIAG,PREG) ;
 ...
 I +RESP=2 D
 . I RESP'["Billing Parameter set to ""Not Bill""" S ACT="Not ECME Billable: "_$P(RESP,"^",2)
 . E  S ACT=$P(RESP,"^",2)
