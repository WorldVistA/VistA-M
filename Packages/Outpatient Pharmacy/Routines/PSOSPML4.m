PSOSPML4 ;BIRM/MFR - Single Prescription ASAP Data Listman Driver ;09/01/12
 ;;7.0;OUTPATIENT PHARMACY;**408,451,625,659,662,770,810**;DEC 1997;Build 9
 ;
...
EXPORT ; - Export Rx
 ...
 ;
 ;p810 PSOASVER needs to be defined for help menu
 I '$G(PSOASVER) D
 . N STATE
 . S STATE=$$RXSTATE^PSOBPSUT(RXIEN,0)
 . S PSOASVER=$$GET1^DIQ(58.41,STATE,1,"I") S:PSOASVER="" PSOASVER="4.2"
 ...
 . I $G(BATCHIEN),$G(BATCHIEN)'=$G(BATIEN) S BATCHIEN=$G(BATIEN)     ;p810
 . ;
