PSOSPML2 ;BIRM/MFR - View/Process Export Batch Listman Driver ;10/7/20  16:12
 ;;7.0;OUTPATIENT PHARMACY;**408,451,625,810**;DEC 1997;Build 9
 ;
 N BATCHIEN,DIR,DIRUT,DTOUT,DUOUT,X,DIC,VALM,VALMCNT,VALMHDR,VALMBCK,VALMSG,PSOLSTLN,BAT
 ;
