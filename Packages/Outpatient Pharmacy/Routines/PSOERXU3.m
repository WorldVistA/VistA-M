PSOERXU3 ;ALB/BWF - eRx utilities ; 5/26/2017 9:57am
 ;;7.0;OUTPATIENT PHARMACY;**508,591,606,581,617,646,700,746,770**;DEC 1997;Build 145
 ;
 Q
...
RRRESCR(ERXIEN,OPT) ;
 ...
 .I '$D(OPT) S OK=0 Q
 .; Allows users to Re-Accept Un-accepted pass-through Rx Renewals
 .I OPT="ACCEPT",MTYPE="RE",RESTYPE="A"!(RESTYPE="AWC")," RJ RM REM PR RXP "'[(" "_$E(ERXSTAT,1,3)_" ") S OK=1 Q
 .I $E(RESTYPE)'="D",ERXSTAT="RXW"!(ERXSTAT="RXI") S OK=1 Q
 ...
 .I "RXP,RXC,RXF,RXE"[ERXSTAT S OK=0 Q
