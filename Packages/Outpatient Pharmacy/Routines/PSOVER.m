PSOVER ;BIR/SAB - verify rx's by clerk ;07/03/95
 ;;7.0;OUTPATIENT PHARMACY;**16,21,27,117,131,146,251,375,387,379,391,372,416,597**;DEC 1997;Build 1
...
DONEX K PSOOPT,SER,LOCKARRY,LOCKINA,PSOLKVRX,DTOUT,DIRUT,PSORX("DFLG"),PSOOVNOD,PSOOVSTA
 Q
OERR ;
 N PSOEDITF,PSOVEDIT,PSOOORN,XQORNOD,Y,PSOVBCK,INT S PSOVEDIT=0
