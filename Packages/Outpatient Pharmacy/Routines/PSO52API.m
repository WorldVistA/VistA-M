PSO52API ;BHAM ISC/SAB- Encap II API to return Rx data ;04/07/05 10:30 am
 ;;7.0;OUTPATIENT PHARMACY;**213,229,252,387,386,566**;DEC 1997;Build 5
...
PROCESS ;
 ...
 ; 
 I $G(NODE)']"" D ZE,TW,TH,MI,ST,RF,CM,AT,LB,CPRS,PT^PSO52B,SD^PSO52B,TB^PSO52B,OI^PSO52B,MLT^PSO52B S DAT="I" D IB Q
