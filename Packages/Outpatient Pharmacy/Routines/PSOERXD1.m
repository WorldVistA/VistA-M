PSOERXD1 ;ALB/BWF - eRx Drug display/actions ; 8/3/2016 5:14pm
 ;;7.0;OUTPATIENT PHARMACY;**467,520,551,582,581,635,617,651,689**;DEC 1997;Build 13
 ;
...
INIT ;
 ...
 S LINE=LINE+1 D SET^VALM10(LINE," (1) Vista Drug: "_VADRG_" "_$P($$VADRSCH^PSOERXUT(VADRGIEN),"^",3)_PSNF)
