PSOORUT1 ;BIR/SAB,RBD - Utility routine for oerr interface ;24 Dec 2024  9:57 AM
 ;;7.0;OUTPATIENT PHARMACY;**1,14,30,46,132,148,233,274,225,305,289,251,387,385,313,427,444,454,508,562,441,736,753,774**;DEC 1997;Build 15
 ;
...
SHOWREM ;
 ...
 ...N STATABBF S STATABBF=STATABBR  ; 774 - Formatted status abbreviation 
 ...
 ...S:RRXISSDT1="-" RRXISSDT1="  -  " S:RRXLFDT1="-" RRXLFDT1="  -  "   ; When Date(s) blank, fix Alignment - RBD *774
 ...S IEN=$G(IEN)+1,PSORCNT=PSORCNT+1
 ...S (RRXDNSP,RRXISP)=""
 ...N PARK S PARK=$G(^XTMP("PSORRX1",$J,PSODFN,REMSITE,STAT,RRXDNAME,"PARK"))  ; 774 - Remotely parked
 ...I STATABBF="A",$G(PARK) S STATABBF="AP"       ; 774 - Only display parked for active Rx
 ...S RRXQSP=" "_STATABBF                         ; 774 - Formatted status abbrevation
 ...
 ...S $P(RRXQSP," ",4)=""
 ...I $L(STATABBR)=2!$G(PARK) S RRXQSP=$E(RRXQSP,1,$L(RRXQSP)-1)
