PSOERXU7 ;ALB/BLB,RM - eRx Utilities/RPC's ; Oct 22, 2025@11:00
 ;;7.0;OUTPATIENT PHARMACY;**581,617,700,746,769,770,812**;DEC 1997;Build 1
 ;
 Q
MEDDIS(ERXIEN,LINE) ;
...
OPACCESS(OPTION,DUZ,ERXIEN) ;
 ...
 I MTYPE="CR",(MSTAT="I"!(MSTAT="HC")),OPTION="PSO ERX REMOVE" Q 1 ;pso,812
