PSOCMOPR ;BHAM ISC/PDW - CMOP CONTROLLED SUBSTANCE RX DISPENSE REPORT ;11/04/2020
 ;;7.0;OUTPATIENT PHARMACY;**33,52,617**;DEC 1997;Build 110
...
PRTDATE ; print by date output
 ...
 S PAT=PAT_" "_SSN
 N ERXIND S ERXIND=$$ERXIEN^PSOERXUT(RX) ;PSO-617
 S RX=$$GET1^DIQ(52,RX,.01)
 ;
 D PG Q:$G(PSOQUIT)
 W !,DATE,?C1,$S(ERXIND'="":"&",1:""),RX_" ("_FILL_")",?C2,PAT,?C3,ST,?C4,FAC,!,DRUG,?C5,"QTY: ",QTY,! ;PSO-617
 Q
...
PRTDRUG ; print by Drug
 ...
 W !,DATE,?D1,$S(ERXIND'="":"&",1:""),RX,?D2,QTY,?D3,PAT,?D4,ST,?D5,FAC ;PSO-617
 Q
EXIT ;EXIT
