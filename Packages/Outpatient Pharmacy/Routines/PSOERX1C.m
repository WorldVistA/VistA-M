PSOERX1C ;ALB/BWF - eRx Utilities ; 11/27/2019 10:20am
 ;;7.0;OUTPATIENT PHARMACY;**467,520,527,508,551,581,617,646,700,746,769,770,814**;DEC 1997;Build 6
 ;
 Q
 ; select an item
PRINT(PSOIEN,OP) ;
...
PRINTQ(PSOIEN,OP) ;
 ...
 W !!,"eRx Reference #: ",$$GET1^DIQ(52.49,PSOIEN,.01,"E"),"  CCP MSH ID: ",$$GET1^DIQ(52.49,PSOIEN,25,"E")
 W LTXT S LTXT=""
 S ERXDSUB=$$GET1^DIQ(52.49,PSOIEN,5.8,"I")
 S ERXDSUB=$S(ERXDSUB=1:"NO",ERXDSUB=0:"YES",1:"")
 ;;BEGIN TEST
