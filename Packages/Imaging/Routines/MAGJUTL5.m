MAGJUTL5 ;WOIFO/JHC,DAC - VistARad RPCs ; 03 Jun 2017  11:00 AM
 ;;3.0;IMAGING;**65,76,101,90,115,104,120,133,152,153,184**;Mar 19, 2002;Build 22
...
GETVER(SVRVER,SVRTVER,ALLOWCL,VIXVER) ;
 ...
 ;
 S SVRVER="3.0.184",SVRTVER=2  ; P184 DAC - <*> Edit this line for each patch/T-version
 ;
 S ALLOWCL="|3.0.153|3.0.152|3.0.133|3.0.120|"  ; P184 DAC - back-compatible with prior client(s)
 S VIXVER=""
