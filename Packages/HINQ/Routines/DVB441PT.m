DVB441PT ;ALB/ZJF POST-INSTALL FOR PATCH DVB*4*41
 ;;4.0;HINQ;**41**;03/25/92
 ;
 ;This routine will be run as a post-installation for patch DVB*4*41.
 ;This routine will add two new disability codes to the DISABILITY
 ;CONDITION file (#31).
 ;
POST ;entry point for post-install, setting up checkpoints
 N %
 S %=$$NEWCP^XPDUTL("DVBLINE","EN^DVB441PT",1)
 Q
 ;
EN ;begin processing
 ;
...
NEWCODE ;codes to be added or changed
 ;;7351^LIVER TRANSPLANT^LIVER TRANSPLANT
 ;;7354^HEPATITIS C^HEPATITIS C
 ;;$EXIT
 Q
